...
void LoadGameState(void)
{
    ...
    if (sector < 0) {
        ...
        gSaveVersion = p;
        ReadFlash(gSaveSectorNum + 10, 0, &gSaveGameState, sizeof(struct TCG_SaveSectorData));
...
void SaveGameState(void)
{
    ...
    for (i = 0; i < 6 - 1; i++) {
        ...
        failure
            = ProgramFlashSectorAndVerifyNBytes(gSaveSectorNum + 10, &gSaveGameState, sizeof(struct TCG_SaveSectorData));
