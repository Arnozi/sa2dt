# 0 "build/collect_rings/src/sa2/malloc_vram.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/malloc_vram.c"
...
# 2 "build/collect_rings/src/sa2/malloc_vram.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/malloc_vram.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 4 "build/collect_rings/src/sa2/malloc_vram.c" 2
# 44 "build/collect_rings/src/sa2/malloc_vram.c"
...
void VramResetHeapState(void) { { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(gVramHeapState); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gVramHeapState))/(16/8)))); dmaRegs[2]; }; }; }
