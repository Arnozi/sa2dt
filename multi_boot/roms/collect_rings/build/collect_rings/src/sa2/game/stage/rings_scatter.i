# 0 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
...
# 2 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
# 1 "../../../include/trig.h" 1
...
# 4 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
# 1 "../../../include/rect.h" 1
...
# 6 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 8 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 10 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 11 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 12 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 14 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 15 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 16 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
...
# 18 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
# 1 "../../../include/constants/songs.h" 1
# 19 "build/collect_rings/src/sa2/game/stage/rings_scatter.c" 2
# 44 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
typedef struct {
               s32 x;
               s32 y;
               s16 velX;
...
void InitPlayerHitRingsScatter(void)
{
    ...
    void *dmaDest;
    u32 size;
# 106 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
    {
    ...
    *tgtTask = t;
    ...
    s->frameFlags = ((2) << (12))
        ...
        ;
    rs->unk2B6 = 0;
# 157 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
    rs->unk2B4 = 0x94;
    rs->unk2B0 = 0x12;


    dmaDest = rs->rings;
    { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(dmaDest); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(rs->rings))/(16/8)))); dmaRegs[2]; }; };
}

void InitScatteringRings(s32 x, s32 y, s32 numRings)
{
    RingsScatter *rs = (void *)(0x03000000 + ((gRingsScatterTask)->data));
    ...
    for (i = 0, ip = 0; i < (signed)(sizeof(rs->rings) / sizeof((rs->rings)[0])); ring++, i++) {
        ...
        if (ring->unkC == 0) {
            ...
            if (r3 >= 0) {
                ...
                r2 = r0;
# 227 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
...
# 845 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
__attribute__((naked)) void RingsScatterSinglepakMain(void) { asm(".include " "\"asm/non_matching/game/stage/rings_scatter/RingsScatterSinglepakMain_CollectRings.inc\""); if (0)

{
    RingsScatter *rs = (void *)(0x03000000 + ((gCurTask)->data));
    ScatterRing *ring = &rs->rings[0];
    Sprite *s = &rs->sprRing;
    s32 sp08 = rs->unk2B0;
    s32 sp0C = rs->unk2B4;
    ...
    for (i = 0; i < (signed)(sizeof(rs->rings) / sizeof((rs->rings)[0])); ring++, i++) {
        ...
        if ((ring->unkC <= sp0C) && ((p->charState != 20) || (p->timerInvulnerability == 0)) && ((!(p->moveState & 0x00000080)))
            ...
            if ((((unsigned)screenX + 8 - 1) < 255) && (screenY > -8) && (screenY < (160 + 8))) {
                if ((ring->unkC >= 32) || ((gStageTime & 0x2) == 0)) {
                    if ((!sp10) || (s->oamBaseIndex == 0xFF)) {
                        ...
                        if (iwram_end != oamAlloced) {
                            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(oam); dmaRegs[1] = (vu32)(oamAlloced); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(OamDataShort))/(16/8)))); dmaRegs[2]; };

                            { u32 v; (oamAlloced)->all.attr0 &= ~0xFF; v = (screenY - (u16)s->dimensions->offsetY); (oamAlloced)->all.attr0 += v & 0xFF; };
                            { u32 v; (oamAlloced)->all.attr1 &= ~0x1FF; v = (screenX - (u16)s->dimensions->offsetX); (oamAlloced)->all.attr1 += v & 0x1FF; };
                        }
                    }
                }
            }
...
# 988 "build/collect_rings/src/sa2/game/stage/rings_scatter.c"
