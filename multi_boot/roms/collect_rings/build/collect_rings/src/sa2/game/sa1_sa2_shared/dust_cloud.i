# 0 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c"
...
# 2 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c" 2
...
# 3 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c" 2
# 1 "../../../include/task.h" 1
...
# 4 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c" 2
...
# 5 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c" 2
...
# 7 "build/collect_rings/src/sa2/game/sa1_sa2_shared/dust_cloud.c" 2
...
void CreateDustCloud(s16 x, s16 y)
{
    ...
    Sprite *s = (void *)(0x03000000 + ((t)->data));

    s->x = x;
    s->y = y;
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x3240);;
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 108;
    s->variant = 0;
...
static void Task_CreateDustCloud(void)
{
    Sprite *s = (void *)(0x03000000 + ((gCurTask)->data));
    s16 oldX, oldY;
