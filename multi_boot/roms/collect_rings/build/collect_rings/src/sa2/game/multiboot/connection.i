# 0 "build/collect_rings/src/sa2/game/multiboot/connection.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiboot/connection.c"
...
# 2 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/flags.h" 1
# 4 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/sprite.h" 1
# 5 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/task.h" 1
# 6 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 8 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 9 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 10 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 11 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 12 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 13 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 14 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 15 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 16 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 17 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 18 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 20 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 21 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 22 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 23 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 24 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 25 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 27 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 29 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/constants/songs.h" 1
# 30 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/constants/text.h" 1
# 31 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
# 1 "../../../include/constants/tilemaps.h" 1
# 32 "build/collect_rings/src/sa2/game/multiboot/connection.c" 2
...
# 151 "build/collect_rings/src/sa2/game/multiboot/connection.c"
void LinkCommunicationError(void)
{
    struct Task *t;
    ...
    MultiSioStop();
    MultiSioInit(0);
    t = TaskCreate(sub_0201299C, sizeof(ConnectionErrorScreen), 0x1000, 0, ((void *)0));
    errorScreen = (void *)(0x03000000 + ((t)->data));
    m4aMPlayAllStop();
    m4aSoundVSyncOff();
    gFlags &= ~0x4;
    gDispCnt = 0x2340;
    gBldRegs.bldCnt = 0;
    gBldRegs.bldY = 0;
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x6000000 + ((gBgCntRegs[0] & 0xC) * 0x1000)); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); dmaRegs[2]; }; };
