# 0 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c"
# 1 "../../../include/core.h" 1
...
# 2 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 3 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c" 2
# 1 "../../../include/flags.h" 1
# 4 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c" 2
...
# 6 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c" 2
# 1 "../../../include/game/multiboot/collect_rings/time_display.h" 1



# 1 "../../../include/global.h" 1
# 5 "../../../include/game/multiboot/collect_rings/time_display.h" 2


extern u32 gCollectRingsLastLapTime;

void CreateCollectRingsTimeDisplay(void);
# 7 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c" 2
...
# 9 "build/collect_rings/src/sa2/game/multiboot/collect_rings/time_display.c" 2
...
const u16 gUnknown_080E0270[16u] = INCBIN_U16("graphics/80E0270.gbapal");
...
void CreateCollectRingsTimeDisplay(void)
{
    ...
    timeDisplay = (void *)(0x03000000 + ((t)->data));
    ...
    for (i = 0; i < 16u; i++) {
        gObjPalette[(7)*16u + (i)] = (gUnknown_080E0270[i]);;
    }
...
void sub_808328C(void)
{
    if (!(gStageFlags & 0x0400)) {
        TimeDisplay *timeDisplay = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    TimeDisplay *timeDisplay = (void *)(0x03000000 + ((t)->data));
