# 0 "build/collect_rings/src/sa2/game/stage/stage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/stage/stage.c"
...
# 2 "build/collect_rings/src/sa2/game/stage/stage.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/stage/stage.c" 2
# 1 "../../../include/sprite.h" 1
# 4 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 6 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 7 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 8 "build/collect_rings/src/sa2/game/stage/stage.c" 2
# 1 "../../../include/game/sa1_sa2_shared/pause_menu.h" 1



void CreatePauseMenu(void);
# 9 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 10 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 11 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 12 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 13 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 15 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 16 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 17 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 18 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 21 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 25 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 26 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 27 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 30 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 32 "build/collect_rings/src/sa2/game/stage/stage.c" 2

# 1 "../../../include/constants/songs.h" 1
# 34 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 37 "build/collect_rings/src/sa2/game/stage/stage.c" 2
...
# 121 "build/collect_rings/src/sa2/game/stage/stage.c"
extern const VoidFn sStageInitProcs[1];
...
# 186 "build/collect_rings/src/sa2/game/stage/stage.c"
void CreateGameStage(void)
{
    u8 i;
...
# 232 "build/collect_rings/src/sa2/game/stage/stage.c"
    {
        InitCamera(0);
...
# 310 "build/collect_rings/src/sa2/game/stage/stage.c"
}
...
void Task_GameStage(void)
{
    ...
    u32 timeStep;
# 339 "build/collect_rings/src/sa2/game/stage/stage.c"
    {
...
# 443 "build/collect_rings/src/sa2/game/stage/stage.c"
        else {
            gStageFlags |= 0x0001;
            CreateMultiplayerFinishHandler();
        }
    }
# 477 "build/collect_rings/src/sa2/game/stage/stage.c"
}
...
# 703 "build/collect_rings/src/sa2/game/stage/stage.c"
...
# 808 "build/collect_rings/src/sa2/game/stage/stage.c"
...
# 875 "build/collect_rings/src/sa2/game/stage/stage.c"
void StageInit_CollectRings(void)
{
