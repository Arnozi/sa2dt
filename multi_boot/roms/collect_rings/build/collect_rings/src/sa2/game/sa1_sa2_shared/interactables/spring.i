# 0 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c"
...
# 2 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
void VramFree(void *);
# 4 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 5 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
# 1 "../../../include/task.h" 1
...
# 6 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 10 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 11 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 12 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 13 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 15 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
# 1 "../../../include/constants/player_transitions.h" 1
# 16 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
# 1 "../../../include/constants/songs.h" 1
# 17 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 47 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c"
...
# 93 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c"
static const u8 gUnknown_02015B24[10][2] = {
...
static const u8 sSpringDirToPlayerTransition[10]
    = { 14, 15, 16, 17, 18,
        19, 20, 21, 18, 19 };
...
void CreateEntity_Spring(u8 springType, MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Spring *spring = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &spring->s;
    ...
    s->frameFlags = 0x2200;
# 156 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/spring.c"
...
static void Task_Spring_Idle(void)
{
    Sprite_Spring *spring = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &spring->s;
...
{
    s16 xPos = ((spring->base.meX)*8 + (spring->base.regionX)*256);
    s16 yPos = ((me->y)*8 + (spring->base.regionY)*256);
    s->x = xPos - gCamera.x;
    s->y = yPos - gCamera.y;

    if (((player->moveState & 0x00400000) == 0) && Coll_Player_Interactable(s, xPos, yPos, player) != 0) {
