# 0 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
# 1 "../../../include/core.h" 1
...
# 2 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
# 1 "../../../include/task.h" 1
# 3 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 4 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 8 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 9 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 11 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 12 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 13 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 14 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 15 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 17 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 19 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 21 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 22 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 27 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 29 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
...
# 31 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
# 1 "../../../include/constants/char_states.h" 1
# 32 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2

# 1 "../../../include/constants/songs.h" 1
# 34 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c" 2
# 54 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
...
void CreateMultiplayerPlayer(u8 id)
{
    ...
    mpp->pos.x = 0;
    mpp->pos.y = 0;
# 181 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
    {
...
# 591 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
__attribute__((naked)) void Task_CreateMultiplayerPlayer(void) { asm(".include " "\"asm/non_matching/game/multiplayer/mp_player__Task_CreateMultiplayerPlayer__CollectRings.inc\""); if (0)
...

{
    ...
    if ((gMultiSioStatusFlags & (0x0001 << (id)))) {
        ...
        if (gMultiSioStatusFlags & (0x0001 << (id)) && recv->pat0.unk0 == 0x5000) {
            ...
            goto thing;
# 739 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
        }
    } else {
    thing:
...
# 1827 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
void sub_8018120(void)
{
    MultiplayerPlayer *mpp = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &mpp->s;
...
# 1895 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
bool32 sub_8018300(void)
{
    ...
    if (mpp->unk60 == 0) {
        ...
        if (val2 & 2) {
# 1969 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
            {
            ...
            mpp->unk60 = 30;
# 2004 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
            return 1;
        }
...
# 2115 "build/collect_rings/src/sa2/game/multiplayer/mp_player.c"
void sub_8018818(void)
{
    u32 i;
