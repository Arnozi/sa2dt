# 0 "build/collect_rings/src/sa2/game/multiplayer/indicators.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiplayer/indicators.c"
...
# 2 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
...
# 3 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
# 1 "../../../include/trig.h" 1
...
# 4 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
...
# 6 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
...
# 8 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
...
# 9 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
...
# 11 "build/collect_rings/src/sa2/game/multiplayer/indicators.c" 2
# 165 "build/collect_rings/src/sa2/game/multiplayer/indicators.c"
typedef struct {
               u8 playerId;
               SpriteTransform transform;
               Sprite spr;
...
void CreateOpponentPositionIndicator(u8 sid)
{
    ...
    spr->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x3640);
    spr->oamFlags = ((1) << 6);
    spr->graphics.size = 0;
    spr->animCursor = 0;
    spr->qAnimDelay = 0;
...
# 269 "build/collect_rings/src/sa2/game/multiplayer/indicators.c"
static void Task_8019898(void)
{
