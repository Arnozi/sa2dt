# 0 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
...
char *strlwr (char *);
char *strupr (char *);
# 2 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
...
# 4 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
# 1 "../../../include/task.h" 1
...
# 5 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 24 "../../../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 7 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
...
# 9 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
...
# 10 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
...
# 12 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
...
# 16 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
# 1 "../../../include/constants/interactables.h" 1
# 17 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
# 1 "../../../include/constants/songs.h" 1
# 18 "build/collect_rings/src/sa2/game/interactables_1/spikes.c" 2
# 26 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
typedef struct {
               SpriteBase base;
               Sprite s;
...
# 55 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
void CreateEntity_Spikes_Up(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 128 * 32);;
...
# 133 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
static void Task_SpikesUpMain(void)
{
...
# 153 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
    HandleSpikeMovementUp(s, me, spikes, &gPlayer);
# 167 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
...
# 530 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
...
# 986 "build/collect_rings/src/sa2/game/interactables_1/spikes.c"
