# 0 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c"
...
# 2 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 4 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 5 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 6 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 7 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
void ReceiveRoomEvent_PlatformChange(union MultiSioData *msioData, u8 someId)
{
    if (gEntitiesManagerTask != ((void *)0)) {
        EntitiesManager *em = (void *)(0x03000000 + ((gEntitiesManagerTask)->data));
