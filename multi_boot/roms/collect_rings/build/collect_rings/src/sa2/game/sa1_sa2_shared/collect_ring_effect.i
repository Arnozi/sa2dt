# 0 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c"
...
# 2 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
# 1 "../../../include/task.h" 1
...
# 3 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 6 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 7 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 8 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 10 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 11 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 13 "build/collect_rings/src/sa2/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
void CreateCollectRingEffect(s16 x, s16 y)
{
    if (gActiveCollectRingEffectCount < 8) {
        ...
        RingEffect *re = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &re->s;
        ...
        s->x = x;
        s->y = y;
        s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x3040);
        s->oamFlags = ((15) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 107;
        s->variant = 0;
...
void Task_CollectRingEffect(void)
{
    RingEffect *re = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &re->s;
