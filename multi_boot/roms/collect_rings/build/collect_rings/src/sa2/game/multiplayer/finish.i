# 0 "build/collect_rings/src/sa2/game/multiplayer/finish.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiplayer/finish.c"
...
# 2 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 4 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
# 1 "../../../include/task.h" 1
# 5 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 6 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 8 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 9 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 11 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 14 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 16 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 18 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
...
# 20 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
# 1 "../../../include/constants/text.h" 1
# 21 "build/collect_rings/src/sa2/game/multiplayer/finish.c" 2
# 37 "build/collect_rings/src/sa2/game/multiplayer/finish.c"
typedef struct {
    Sprite s;
    u8 unk30;
    u8 unk31;
...
# 404 "build/collect_rings/src/sa2/game/multiplayer/finish.c"
void Task_801A04C(void)
{
    u32 x = 0;
        ...
        if (gGameMode == 5) {
            ...
            *((u32 *)sp04) = *((u32 *)gMultiplayerCharRings);
            ...
            if (gGameMode == 5) {
                ...
                goto _0801A2DA;
# 519 "build/collect_rings/src/sa2/game/multiplayer/finish.c"
            }

        }
# 558 "build/collect_rings/src/sa2/game/multiplayer/finish.c"
    _0801A2DA:
