# 0 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c"
# 1 "../../../include/core.h" 1
...
# 2 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 4 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 5 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 6 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 8 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2

# 1 "../../../include/game/multiplayer/multiplayer_event_mgr.h" 1
# 9 "../../../include/game/multiplayer/multiplayer_event_mgr.h"
...
# 10 "../../../include/game/multiplayer/multiplayer_event_mgr.h" 2
...
# 10 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 11 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 12 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 14 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2

# 1 "../../../include/constants/char_states.h" 1
# 16 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
# 1 "../../../include/constants/songs.h" 1
# 17 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c" 2
...
{
    u8 id = ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id;
    ...
    if (gRoomEventQueueWritePos == gRoomEventQueueSendPos) {
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(&gMultiSioSend.pat0.unk8[3]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(RoomEvent) - 1)/(16/8)))); dmaRegs[2]; }; };
    } else {
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gRoomEventQueue[gRoomEventQueueSendPos]); dmaRegs[1] = (vu32)(&gMultiSioSend.pat0.unk8[3]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(RoomEvent) - 1)/(16/8)))); dmaRegs[2]; };
...
void ReceiveRoomEvent_ItemEffect(union MultiSioData *recv, u8 i)
{
    ...
    MultiplayerPlayer *us = (void *)(0x03000000 + ((gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id])->data));

    if (!(us->unk5C & 1) && (!(gPlayer.moveState & 0x00000080)) && gMultiplayerRanks[((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id] == -1) {
        switch (recv->pat0.unkF) {
# 166 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c"
            case 4: {
                if (gGameMode != 4
...
# 293 "build/collect_rings/src/sa2/game/multiplayer/multiplayer_event_mgr.c"
struct Task *CreateMultiplayerSendEventMgr(void)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(&gRoomEventQueue); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gRoomEventQueue))/(32/8)))); dmaRegs[2]; }; };
