# 0 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c"
...
# 2 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "../../../include/sprite.h" 1
# 4 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2

# 1 "../../../include/task.h" 1
# 6 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 7 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 9 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 10 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 11 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 12 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 13 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 15 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "../../../include/constants/player_transitions.h" 1
# 16 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c" 2
...
void CreateEntity_Ramp(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Ramp *ramp = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &ramp->s;
    ...
    s->graphics.anim = 103;
# 59 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/ramp.c"
    temp2 = temp;
...
static void Task_Ramp(void)
{
    ...
    Sprite_Ramp *ramp = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &ramp->s;
    ...
    do {
        ...
        screenX = ((ramp->base.meX)*8 + (ramp->base.regionX)*256);
        screenY = ((me->y)*8 + (ramp->base.regionY)*256);
    ...
    if (!(player->moveState & 0x00400000)) {
        ...
        if (r1 != 0) {
            if (((r1 & 0x80000) && (ramp->unk3C & 2) && (player->qSpeedAirX > -1))
                ...
                s32 halfWidth = ((int)((player->qWorldX) >> 8)) - hbLeft;
                if (halfWidth > 0) {
                    if (halfWidth > hbWidth) {
                        if (!(player->moveState & 0x00000002) && (player->qSpeedGround > ((s32)((4)*256)))) {
                            player->transition = 22;
                        ...
                        s32 playerMiddleY = ((int)((player->qWorldY) >> 8)) + player->spriteOffsetY - screenY;
                        s32 temp6 = ((int)((s->hitboxes[0].top * (((s32)((halfWidth)*256)) / hbWidth)) >> 8));
                        ...
                        if (playerMiddleY >= temp6) {
                            if (!(player->moveState & 0x00000002) && (player->qSpeedGround > ((s32)((4)*256)))
                                ...
                                player->qWorldY += ((s32)((temp6 - playerMiddleY)*256));
                                player->rotation = 0;
            ...
            if (var) {
                if (((ramp->unk3C & 2) != 0 && ((int)((player->qWorldX) >> 8)) < s->x) || ((ramp->unk3C & 2) == 0 && ((int)((player->qWorldX) >> 8)) > s->x)) {
                    if (!(player->moveState & 0x00000002) && player->qSpeedGround > ((s32)((4)*256))) {
                        player->transition = 22;
                        player->unk6E = (ramp->unk3C & 1) * 3;
                    }
                } else if (((ramp->unk3C & 2) != 0 && ((int)((player->qWorldX) >> 8)) > s->x) || ((ramp->unk3C & 2) == 0 && ((int)((player->qWorldX) >> 8)) < s->x)) {
                    player->moveState &= ~0x00000008;
                    player->stoodObj = ((void *)0);
                }
            }
        }
    }

    if ((((u32)(screenX - gCamera.x + (256 / 2)) > 240 + 256) || (screenY - gCamera.y + (256 / 2) < 0) || (screenY - gCamera.y > 160 + (256 / 2)))) {
        me->x = ramp->base.meX;
