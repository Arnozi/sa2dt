# 0 "build/collect_rings/src/sa2/game/game.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/game.c"
...
# 2 "build/collect_rings/src/sa2/game/game.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/game.c" 2
# 1 "../../../include/flags.h" 1
# 4 "build/collect_rings/src/sa2/game/game.c" 2
# 1 "../../../include/task.h" 1
# 5 "build/collect_rings/src/sa2/game/game.c" 2
...
void GameInit(void);
# 7 "build/collect_rings/src/sa2/game/game.c" 2
...
# 8 "build/collect_rings/src/sa2/game/game.c" 2
...
# 10 "build/collect_rings/src/sa2/game/game.c" 2
...
# 11 "build/collect_rings/src/sa2/game/game.c" 2
...
# 12 "build/collect_rings/src/sa2/game/game.c" 2
...
# 14 "build/collect_rings/src/sa2/game/game.c" 2

# 1 "../../../include/game/decomp_credits.h" 1



extern void CreateDecompCreditsScreen(bool32 hasProfile);
# 16 "build/collect_rings/src/sa2/game/game.c" 2
...
# 17 "build/collect_rings/src/sa2/game/game.c" 2
...
# 18 "build/collect_rings/src/sa2/game/game.c" 2
...
# 21 "build/collect_rings/src/sa2/game/game.c" 2
...
# 22 "build/collect_rings/src/sa2/game/game.c" 2
...
# 23 "build/collect_rings/src/sa2/game/game.c" 2
...
# 26 "build/collect_rings/src/sa2/game/game.c" 2
...
# 29 "build/collect_rings/src/sa2/game/game.c" 2
...
# 30 "build/collect_rings/src/sa2/game/game.c" 2
...
# 36 "build/collect_rings/src/sa2/game/game.c" 2
# 135 "build/collect_rings/src/sa2/game/game.c"
void GameInit(void)
{
    u32 i;
