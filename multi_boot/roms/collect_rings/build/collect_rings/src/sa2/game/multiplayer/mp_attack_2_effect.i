# 0 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c"
...
# 2 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c" 2
...
# 5 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c" 2
...
# 7 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c" 2

# 1 "../../../include/constants/zones.h" 1
# 9 "build/collect_rings/src/sa2/game/multiplayer/mp_attack_2_effect.c" 2





MultiPlayerBgCtrlRegs *gMPAttackEffect2Regs = ((void *)0);
...
void CreateMPAttack2Effect(void)
{
    ...
    if (((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) && !((((gCurrentLevel) & ((3 + 1) - 1)) == 2) || (((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && !gFinalBossActive) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
        if (gMPAttackEffect2Regs != ((void *)0)) {
            ...
            MultiPlayerBgCtrlRegs *regs = (void *)(0x03000000 + ((t)->data));
...
static void Task_MPAttackEffect2(void)
{
    MultiPlayerBgCtrlRegs *regs = (void *)(0x03000000 + ((gCurTask)->data));
    s16 *p;
