# 0 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c"
...
# 2 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 5 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 6 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 7 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 11 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2

# 1 "../../../include/constants/songs.h" 1
# 13 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
# 1 "../../../include/constants/player_transitions.h" 1
# 14 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 31 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c"
...
__attribute__((naked)) void Task_GrindRail(void) { asm(".include " "\"asm/non_matching/game/sa1_sa2_shared/interactables/Task_GrindRail_CollectRings.inc\""); if (0)
...

{
    ...
    s32 r7 = ((int)((p->qWorldY) >> 8)) + p->spriteOffsetY;


    s16 x, y;

    Sprite_GrindRail *rail = (void *)(0x03000000 + ((gCurTask)->data));
            ...
            if ((p->qSpeedAirY >= 0) && r6 && !(kind & 0x80)) {
                if ((p->moveState & 0x01000000)) {
                    if ((!(kind & 0x1) && (p->moveState & 0x00000001)
                        ...
                        *(u8 *)((void *)(0x03000000 + ((gCurTask)->data)) + ((size_t)&((Sprite_GrindRail *)0)->kind)) |= 0x80;
    ...
    if ((((u16)(x + (256 / 2)) > 240 + 256) || (y + (256 / 2) < 0) || (y > 160 + (256 / 2)))) {
        me->x = stackSpriteX;
...
static void CreateEntity_GrindRail(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u8 railType)
{
# 203 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c"
    struct Task *t = TaskCreate(Task_GrindRail, 10, 0x2010, 0, ((void *)0));
    void *rail;
    {
        rail = (void *)(0x03000000 + ((t)->data));
        rail += 9;
        *(u8 *)rail = railType;
    }
    {
    ...
    {
        MapEntity **rail = (void *)(0x03000000 + ((t)->data));
        rail++;
        rail--;
        *rail = me;
    }
    {
        u8 *rail = (void *)(0x03000000 + ((t)->data));
        rail += 8;
        *rail = me->x;
    }
...
{
# 246 "build/collect_rings/src/sa2/game/sa1_sa2_shared/interactables/grind_rail.c"
    struct Task *t = TaskCreate(Task_GrindRail_Air, 10, 0x2010, 0, ((void *)0));
    void *rail;
    {
        rail = (void *)(0x03000000 + ((t)->data));
        rail += 9;
...
{
    struct Task *t = TaskCreate(GrindRailAudioDelay, sizeof(u16), 0x2010, 0, ((void *)0));
    u16 *audioTimer = (void *)(0x03000000 + ((t)->data));
    *audioTimer = 0;
}

static void GrindRailAudioDelay(void)
{
    u16 *audioTimer = (void *)(0x03000000 + ((gCurTask)->data));
    if (++(*audioTimer) > 60) {
        m4aSongNumStart(26);
        TaskDestroy(gCurTask);
    }
