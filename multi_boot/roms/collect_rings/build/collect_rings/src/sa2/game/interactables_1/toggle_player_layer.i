# 0 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c"
...
# 2 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c" 2
...
# 4 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c" 2
...
# 6 "../../../include/game/stage/camera.h" 2
...
# 6 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c" 2
...
# 7 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c" 2


# 1 "../../../include/constants/interactables.h" 1
# 10 "build/collect_rings/src/sa2/game/interactables_1/toggle_player_layer.c" 2
...
{
    TogglePlayerLayer *toggle = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if ((screenX <= ((int)((gPlayer.qWorldX) >> 8))) && (screenX + (me->width * 8) >= ((int)((gPlayer.qWorldX) >> 8))) && (screenY <= ((int)((gPlayer.qWorldY) >> 8)))
        && (screenY + (me->height * 8) >= ((int)((gPlayer.qWorldY) >> 8)))) {
...
void CreateEntity_Toggle_PlayerLayer(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, __attribute__((unused)) u8 spriteY)
{
    struct Task *t = TaskCreate(Task_MapEntity_Toggle_PlayerLayer, sizeof(TogglePlayerLayer), 0x2000, 0, ((void *)0));
    TogglePlayerLayer *toggle = (void *)(0x03000000 + ((t)->data));
    SpriteBase *base = &toggle->base;
