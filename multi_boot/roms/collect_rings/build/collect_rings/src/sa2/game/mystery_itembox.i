# 0 "build/collect_rings/src/sa2/game/mystery_itembox.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/mystery_itembox.c"
# 1 "../../../include/core.h" 1
...
# 2 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
# 1 "../../../include/malloc_vram.h" 1
# 3 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
# 4 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
# 6 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
# 7 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
# 8 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
# 1 "../../../include/game/sa1_sa2_shared/dust_cloud.h" 1



void CreateDustCloud(s16 x, s16 y);
# 9 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
# 14 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
# 1 "../../../include/constants/char_states.h" 1
# 15 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
# 1 "../../../include/constants/player_transitions.h" 1
# 16 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
# 1 "../../../include/constants/songs.h" 1
# 17 "build/collect_rings/src/sa2/game/mystery_itembox.c" 2
...
static const u16 gUnknown_080E02AA[][3] = { { 105, 0, 4 },
                                            { 105, 1, 4 } };
...
void CreateEntity_MysteryItemBox(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    itemBox->unk82 = gUnknown_080E029A[gMultiplayerPseudoRandom % (sizeof(gUnknown_080E029A) / sizeof((gUnknown_080E029A)[0]))];
    itemBox->iconOffsetY = ((s32)((0.0)*256));
...
{
    Sprite_MysteryItemBox *itemBox = (void *)(0x03000000 + ((gCurTask)->data));
    SpriteTransform *transform;
    Sprite *identifier;
    ...
    itemBox->box.frameFlags |= ((1) << (5));
    itemBox->identifier.frameFlags |= ((1) << (5));
...
static void sub_808623C(void)
{
    ...
    itemBox->box.frameFlags &= ~((0x1F) << (0));

    itemBox->box.frameFlags |= gOamMatrixIndex;
    itemBox->identifier.frameFlags &= ~((0x1F) << (0));
...
static void sub_8086504(Sprite_MysteryItemBox *itemBox)
{
    switch (itemBox->unk82) {
        case 0: {
            u8 boxVal = sRingBonuses[(u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % (sizeof(sRingBonuses) / sizeof((sRingBonuses)[0]))];
...
static void sub_808665C(void)
{
    ...
    if (itemBox->framesSinceOpened++ >= (1 * 60)) {
        sub_8086504(itemBox);
    } else {
        itemBox->iconOffsetY -= ((s32)((1.0)*256));
    }
...
static void sub_80866FC(void)
{
    ...
    if (itemBox->framesSinceOpened++ >= (int)(0.5 * 60)) {
        gCurTask->main = sub_808673C;
        return;
    }
...
{
    Sprite_MysteryItemBox *itemBox = (void *)(0x03000000 + ((t)->data));
...
static void sub_80868A8(Sprite_MysteryItemBox *itemBox, u32 p2)
{
    ...
    itemBox->identifier.y = itemBox->box.y + ((int)((itemBox->iconOffsetY) >> 8));
