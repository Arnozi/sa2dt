# 0 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c"
...
# 2 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/core.h" 1
...
# 3 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 5 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 6 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 7 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2

# 1 "../../../include/game/multiboot/connection.h" 1
# 16 "../../../include/game/multiboot/connection.h"
void sub_8081200(void);
void StartSinglePakConnect(void);
void ShowSinglePakResults(void);
# 9 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 7 "../../../include/game/multiplayer/multipak_connection.h" 2
...
# 10 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/game/multiboot/collect_rings/results.h" 1
...
# 11 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/task.h" 1
# 12 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/sprite.h" 1
# 13 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 14 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 15 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 16 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 17 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 18 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 19 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 20 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 21 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 24 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2


# 1 "../../../include/data/collect_rings.h" 1
...
# 27 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
# 29 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/constants/songs.h" 1
# 30 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/constants/text.h" 1
# 31 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
# 1 "../../../include/constants/tilemaps.h" 1
# 32 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c" 2
...
void CreateMultiplayerSinglePakResultsScreen(u32 a)
{
    ...
    gTilemapsRef = *((Tilemap ***)(0x02000000 + 0x33000));

    gRefSpriteTables = (const struct SpriteTables *)(0x02000000 + 0x20000);
...
void sub_8081FB0(void)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)0x6000000 + 0x9FE0); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((64)/(32/8)))); dmaRegs[2]; }; };
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)0x6000000 + 0xCFE0); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((64)/(32/8)))); dmaRegs[2]; }; };
}
...
void sub_8082038(struct MultiplayerSinglePakResultsScreen *screen)
{
    ...
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = (((((0)*(3 + 1)) + (1))*3) + 2);
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
...
void sub_8082B80(struct MultiplayerSinglePakResultsScreen *resultsScreen)
{
    ...
    for (i = 0; i < 4; i++) {
        ...
        sub_8082CEC(&resultsScreen->unk80[i].unk0, (u8*)(0x6000000 + 0x10000) + (i * 0x800), val, 0, 0x78, i * 40 + 20, ((16) << 6), i, 0x1000);
    }
}
...
void Task_MultiplayerSinglePakResultsScreenInit(void)
{
    ...
    resultsScreen = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (++resultsScreen->unk430 > 0xF0) {
        ...
        if (resultsScreen->unk434) {
            for (i = 0; i < 3; i++) {
                ...
                s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2500 + (i * 0x180));
...
# 311 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c"
        ...
        for (i = 0; i < 4; i++) {
            if (!(gMultiSioStatusFlags & (0x0001 << (i + 8)))) {
                if (gMultiplayerRanks[i] & 1) {
                    sub_80078D4(3, i * 40, (i + 1) * 40, 240 - resultsScreen->unk430, 160 - i * 40);
                } else {
                    sub_80078D4(3, i * 40, (i + 1) * 40, resultsScreen->unk430 - 240, 160 - i * 40);
                }
            } else {
                if (gMultiplayerRanks[i] & 1) {
                    sub_80078D4(3, gMultiplayerRanks[i] * 40, (gMultiplayerRanks[i] + 1) * 40, 240 - resultsScreen->unk430,
                                (i * 5 - gMultiplayerRanks[i] * 5) * 8);
                } else {
                    sub_80078D4(3, gMultiplayerRanks[i] * 40, (gMultiplayerRanks[i] + 1) * 40, resultsScreen->unk430 - 240,
                                (i * 5 - gMultiplayerRanks[i] * 5) * 8);
                }
            }
        }
...
void sub_80823FC(void)
{
    ...
    s32 val2 = 0;
    u8 val = 0;
    struct MultiplayerSinglePakResultsScreen *resultsScreen = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (packet->pat0.unk0 == 0x4012) {
        ...
        if (!resultsScreen->unk434) {
            ...
            background->unk18 = 0;
            background->unk1A = 0;
            background->tilemapId = (((((0)*(3 + 1)) + (2))*3) + 0);
            switch (gMultiplayerLanguage) {
                case 0:
                    background->unk1E = 0;
        ...
        for (i = 0; i < 4 && (((gMultiplayerConnections) >> (i)) & 1); i++) {
            if (!((0x0001 << (i)) & gMultiSioStatusFlags)) {
                ...
                if (i == ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id || packet->pat0.unk0 == 0x4010) {
                    val2++;
                }
            }
        }
...
void sub_808267C(void)
{
    ...
    if (packet->pat3.unk0 == ((0x80) | 0x4000)) {
        u32 i;
    ...
    if ((gMultiSioStatusFlags & 0x0080) == 0x0080) {
        ...
        for (i = 0; i < 4; i++) {
            if ((((gMultiplayerConnections) >> (i)) & 1)) {
                packet = &gMultiSioRecv[i];
                if (packet->pat0.unk0 != ((0x51) | 0x4000)) {
                    return;
                }
            }
        }
        packet = &gMultiSioSend;
        packet->pat3.unk0 = ((0x80) | 0x4000);
...
void sub_8082788(void)
{
    ...
    for (i = 0; i < 4; i++) {
        if (!(gMultiSioStatusFlags & (0x0001 << (i + 8)))) {
            sub_80078D4(3, i * 40, (i + 1) * 40, 0, 160 - i * 40);
        } else {
...
{
    struct Task *t
        = TaskCreate(Task_MultiplayerSinglePakResultsScreenInit, sizeof(struct MultiplayerSinglePakResultsScreen), 0x2000, 0, ((void *)0));
    struct MultiplayerSinglePakResultsScreen *resultsScreen = (void *)(0x03000000 + ((t)->data));
...
# 636 "build/collect_rings/src/sa2/game/multiboot/collect_rings/results.c"
void sub_8082BF8(struct MultiplayerSinglePakResultsScreen *resultsScreen)
{
    ...
    for (i = 0; i < (s32)(sizeof(resultsScreen->unk160) / sizeof((resultsScreen->unk160)[0])); i++) {
        sub_8082CEC(&resultsScreen->unk160[i], (u8*)(0x6000000 + 0x10000) + (i * 4 + 0x100) * 0x20, 115, i, 0, 0, ((4) << 6), 0,
                    0x1000);
    }
}
...
void sub_8082C58(struct MultiplayerSinglePakResultsScreen *resultsScreen)
{
    ...
    for (i = 0; i < (s32)(sizeof(resultsScreen->unk370) / sizeof((resultsScreen->unk370)[0])); i++) {
        sub_8082CEC(&resultsScreen->unk370[i], (u8*)(0x6000000 + 0x10000) + 0x2500 + i * 0xC0, 113, i, 0, 0,
                    ((4) << 6), 0, 0x1000);
    }
}
