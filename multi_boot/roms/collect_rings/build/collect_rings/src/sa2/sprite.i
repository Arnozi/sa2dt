# 0 "build/collect_rings/src/sa2/sprite.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "build/collect_rings/src/sa2/sprite.c"
...
char *strlwr (char *);
char *strupr (char *);
# 2 "build/collect_rings/src/sa2/sprite.c" 2
...
# 3 "build/collect_rings/src/sa2/sprite.c" 2
# 1 "../../../include/core.h" 1
...
# 4 "build/collect_rings/src/sa2/sprite.c" 2
# 1 "../../../include/flags.h" 1
# 5 "build/collect_rings/src/sa2/sprite.c" 2
# 1 "../../../include/sprite.h" 1
# 6 "build/collect_rings/src/sa2/sprite.c" 2
# 1 "../../../include/trig.h" 1
...
# 7 "build/collect_rings/src/sa2/sprite.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "build/collect_rings/src/sa2/sprite.c" 2
...
# 9 "build/collect_rings/src/sa2/sprite.c" 2
...
# 11 "build/collect_rings/src/sa2/sprite.c" 2
# 19 "build/collect_rings/src/sa2/sprite.c"
...
# 120 "build/collect_rings/src/sa2/sprite.c"
u32 Base10DigitsToHexNibbles(u16 num)
{
    u8 i;
    u16 result;
...
# 290 "build/collect_rings/src/sa2/sprite.c"
static AnimCmdResult animCmd_GetTiles(void *cursor, Sprite *s)
{
...
# 345 "build/collect_rings/src/sa2/sprite.c"
static AnimCmdResult animCmd_AddHitbox(void *cursor, Sprite *s)
{
...
__attribute__((naked)) void sub_8004E14(Sprite *sprite, SpriteTransform *transform) { asm(".include " "\"asm/non_matching/engine/sa2__sub_8004E14.inc\""); if (0)
{
    ...
    if (sprite->dimensions != (void *)-1) {
...

        {
            ...
            s16 offsetX, offsetY;
            s32 x, y;
# 584 "build/collect_rings/src/sa2/sprite.c"
            {
                if (transform->qScaleX > 0) {
...
# 737 "build/collect_rings/src/sa2/sprite.c"
                if (sprite->frameFlags & ((1) << (5))) {
...
# 821 "build/collect_rings/src/sa2/sprite.c"
            }
        }
    }
}
...
# 957 "build/collect_rings/src/sa2/sprite.c"
OamData *OamMalloc(u8 order)
{
    if (order > 31) {
        order = 31;
