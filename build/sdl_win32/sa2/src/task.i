...
# 24 "/usr/share/mingw-w64/include/assert.h" 3
...
# 114 "src/task.c"
    ...
    task->dataSize = (task->data != (TaskPtr32)
# 129 "src/task.c" 3 4
                                              ((void *)0)
# 129 "src/task.c"
                                                  ) ? structSize : 0;
...
# 254 "src/task.c"
    ...
    void *result = Platform_malloc(req *1);
