    ...
    switch (gSio32MultiLoadArea.state) {
        ...
        case 1:
            if (gSio32MultiLoadArea.type == 0x0001) {
                ...
                (*(vu16 *)(REG_BASE + 0x128)) = 0x1000;
            (*(vu32 *)(REG_BASE + 0x120)) = 0;
            ...
            if (gSio32MultiLoadArea.type == 0x0001) {
                ...
                (*(vu16 *)(REG_BASE + 0x128)) |= 0x4000 | 0x0080;
                (*(vu16 *)(REG_BASE + 0x208)) = 0;
...
void Sio32MultiLoadIntr(void)
{
    ...
    u32 recvTmp = (*(vu32 *)(REG_BASE + 0x120));
    ...
    if (gSio32MultiLoadArea.type == 0x0001) {
        ...
        if (gSio32MultiLoadArea.dataCounter < 0)
            (*(vu32 *)(REG_BASE + 0x120)) = 0xfefefefe;
        else if (gSio32MultiLoadArea.dataCounter < 0x8000 / 4)

            (*(vu32 *)(REG_BASE + 0x120)) = gSio32MultiLoadArea.datap[gSio32MultiLoadArea.dataCounter];
        else
            (*(vu32 *)(REG_BASE + 0x120)) = gSio32MultiLoadArea.checkSum;
    } else {
...
void Sio32MultiLoadInit(u32 type, void *datap)
{
    ...
    *(vu32 *)(REG_BASE + 0x128) = 0x2000 | 0x0003;
    ...
    if (type) {
        ...
        (*(vu16 *)(REG_BASE + 0x128)) = 0x1000;
        (*(vu16 *)(REG_BASE + 0x128)) = 0x1000 | 0x0001 | 0x0000;
    }
}
