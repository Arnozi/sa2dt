# 0 "src/malloc_ewram.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/malloc_ewram.c"
...
void EwramInitHeap(void)
{
    ...
    root->next = 
# 15 "src/malloc_ewram.c" 3 4
                ((void *)0)
# 15 "src/malloc_ewram.c"
                    ;
...
void *EwramMalloc(u32 req)
{
    ...
    if (req == 0) {
        return 
# 25 "src/malloc_ewram.c" 3 4
              ((void *)0)
# 25 "src/malloc_ewram.c"
                  ;
    }

    return Platform_malloc(req *1);
# 76 "src/malloc_ewram.c"
}
...
void EwramFree(void *p)
{
    ...
    if (p != 
# 81 "src/malloc_ewram.c" 3 4
            ((void *)0)
# 81 "src/malloc_ewram.c"
                ) {
        Platform_free(p);
    }
# 118 "src/malloc_ewram.c"
}
