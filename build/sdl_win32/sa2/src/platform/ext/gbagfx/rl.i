# 0 "src/platform/ext/gbagfx/rl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/platform/ext/gbagfx/rl.c"
...
# 4 "src/platform/ext/gbagfx/rl.c" 2
# 1 "/usr/lib/gcc/x86_64-w64-mingw32/13-win32/include/stdbool.h" 1 3 4
# 5 "src/platform/ext/gbagfx/rl.c" 2
...
# 6 "src/platform/ext/gbagfx/rl.c" 2
...
# 6 "include/platform/ext/gbagfx/rl.h"
...
# 7 "src/platform/ext/gbagfx/rl.c" 2
...
unsigned char *RLDecompress(unsigned char *src, int srcSize, int *uncompressedSize)
{
    ...
    if (dest == 
# 17 "src/platform/ext/gbagfx/rl.c" 3
               ((void *)0)
# 17 "src/platform/ext/gbagfx/rl.c"
                   )
        goto fail;
...
# 29 "src/platform/ext/gbagfx/rl.c" 3 4
       _Bool 
# 29 "src/platform/ext/gbagfx/rl.c"
...
fail:
    do { fprintf(
# 61 "src/platform/ext/gbagfx/rl.c" 3
   (__acrt_iob_func(2))
# 61 "src/platform/ext/gbagfx/rl.c"
   , "Fatal error while decompressing RL file.\n"); exit(1); } while (0);
}
...
void RLDecompressUnsafe(unsigned char *src, unsigned char *dest, int *uncompressedSize)
{
    ...
    if (dest == 
# 68 "src/platform/ext/gbagfx/rl.c" 3
               ((void *)0)
# 68 "src/platform/ext/gbagfx/rl.c"
                   )
        goto fail;
...
# 77 "src/platform/ext/gbagfx/rl.c" 3 4
       _Bool 
# 77 "src/platform/ext/gbagfx/rl.c"
            compressed = ((flags & 0x80) != 0);
...
fail:
    do { fprintf(
# 109 "src/platform/ext/gbagfx/rl.c" 3
   (__acrt_iob_func(2))
# 109 "src/platform/ext/gbagfx/rl.c"
   , "Fatal error while decompressing RL file.\n"); exit(1); } while (0);
}
...
unsigned char *RLCompress(unsigned char *src, int srcSize, int *compressedSize)
{
    ...
    if (dest == 
# 124 "src/platform/ext/gbagfx/rl.c" 3
               ((void *)0)
# 124 "src/platform/ext/gbagfx/rl.c"
                   )
        goto fail;
...
# 138 "src/platform/ext/gbagfx/rl.c" 3 4
       _Bool 
# 138 "src/platform/ext/gbagfx/rl.c"
            compress = 
# 138 "src/platform/ext/gbagfx/rl.c" 3 4
                       0
# 138 "src/platform/ext/gbagfx/rl.c"
...
fail:
    do { fprintf(
# 196 "src/platform/ext/gbagfx/rl.c" 3
   (__acrt_iob_func(2))
# 196 "src/platform/ext/gbagfx/rl.c"
   , "Fatal error while compressing RL file.\n"); exit(1); } while (0);
}
