# 0 "src/platform/ext/gbagfx/lz.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/platform/ext/gbagfx/lz.c"
...
# 6 "src/platform/ext/gbagfx/lz.c" 2
...
# 7 "src/platform/ext/gbagfx/lz.c" 2
...
unsigned char *LZDecompress(unsigned char *src, int srcSize, int *uncompressedSize)
{
 ...
 if (dest == 
# 17 "src/platform/ext/gbagfx/lz.c" 3
            ((void *)0)
# 17 "src/platform/ext/gbagfx/lz.c"
                )
  goto fail;
  ...
  for (int i = 0; i < 8; i++) {
   if (flags & 0x80) {
    ...
    if (destPos + blockSize > destSize) {
     ...
     fprintf(
# 44 "src/platform/ext/gbagfx/lz.c" 3
            (__acrt_iob_func(2))
# 44 "src/platform/ext/gbagfx/lz.c"
...
fail:
 do { fprintf(
# 69 "src/platform/ext/gbagfx/lz.c" 3
(__acrt_iob_func(2))
# 69 "src/platform/ext/gbagfx/lz.c"
...
void LZDecompressUnsafe(unsigned char *src, unsigned char *dest, int *uncompressedSize)
{
 ...
 if (dest == 
# 76 "src/platform/ext/gbagfx/lz.c" 3
            ((void *)0)
# 76 "src/platform/ext/gbagfx/lz.c"
                )
  goto fail;
  ...
  for (int i = 0; i < 8; i++) {
   if (flags & 0x80) {
    ...
    if (destPos + blockSize > destSize) {
     blockSize = destSize - destPos;
     fprintf(
# 97 "src/platform/ext/gbagfx/lz.c" 3
            (__acrt_iob_func(2))
# 97 "src/platform/ext/gbagfx/lz.c"
                  , "Destination buffer overflow.\n");
    }
...
fail:
 do { fprintf(
# 122 "src/platform/ext/gbagfx/lz.c" 3
(__acrt_iob_func(2))
# 122 "src/platform/ext/gbagfx/lz.c"
, "Fatal error while decompressing LZ file.\n"); exit(1); } while (0);
}
...
unsigned char *LZCompress(unsigned char *src, int srcSize, int *compressedSize, const int minDistance)
{
 ...
 if (dest == 
# 137 "src/platform/ext/gbagfx/lz.c" 3
            ((void *)0)
# 137 "src/platform/ext/gbagfx/lz.c"
                )
  goto fail;
...
fail:
 do { fprintf(
# 205 "src/platform/ext/gbagfx/lz.c" 3
(__acrt_iob_func(2))
# 205 "src/platform/ext/gbagfx/lz.c"
, "Fatal error while compressing LZ file.\n"); exit(1); } while (0);
}
