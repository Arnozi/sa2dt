# 0 "src/platform/shared/audio/m4a_sound_mixer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/platform/shared/audio/m4a_sound_mixer.c"
...
# 2 "src/platform/shared/audio/m4a_sound_mixer.c" 2
...
# 4 "src/platform/shared/audio/m4a_sound_mixer.c" 2
...
# 6 "src/platform/shared/audio/m4a_sound_mixer.c" 2
...
# 7 "src/platform/shared/audio/m4a_sound_mixer.c" 2
...
# 28 "src/platform/shared/audio/m4a_sound_mixer.c"
static float audioBuffer[4907];
...
void SoundMain(void)
{
    ...
    if (mixer->MPlayMainHead != 
# 50 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                               ((void *)0)
# 50 "src/platform/shared/audio/m4a_sound_mixer.c"
                                   ) {
...
static inline bool32 TickEnvelope(struct MixerSource *chan, struct WaveData *wav)
{
# 140 "src/platform/shared/audio/m4a_sound_mixer.c"
...
void SoundMainBTM(void *ptr) { { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, ptr, 0x04000000 | 0x01000000 | ((
# 323 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                              __builtin_offsetof (
# 323 "src/platform/shared/audio/m4a_sound_mixer.c"
                              struct MP2KTrack
# 323 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                              , 
# 323 "src/platform/shared/audio/m4a_sound_mixer.c"
...
void MP2KClearChain(struct MixerSource *chan)
{
    ...
    if (chan->track == 
# 330 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                      ((void *)0)
# 330 "src/platform/shared/audio/m4a_sound_mixer.c"
                          ) {
        return;
    }
    ...
    if (prev != 
# 336 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
               ((void *)0)
# 336 "src/platform/shared/audio/m4a_sound_mixer.c"
                   ) {
        prev->next = next;
    } else {
        track->chan = next;
    ...
    if (next != 
# 342 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
               ((void *)0)
# 342 "src/platform/shared/audio/m4a_sound_mixer.c"
                   ) {
        next->prev = prev;
    }

    chan->track = 
# 346 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                 ((void *)0)
# 346 "src/platform/shared/audio/m4a_sound_mixer.c"
                     ;
}
...
void MP2K_event_fine(struct MP2KPlayerState *unused, struct MP2KTrack *track)
{
    ...
    for (struct MixerSource *chan = track->chan; chan != 
# 362 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                                                        ((void *)0)
# 362 "src/platform/shared/audio/m4a_sound_mixer.c"
                                                            ; chan = chan->next) {
        if (chan->status & 0xC7) {
            chan->status |= 0x40;
        }
...
void MP2KPlayerMain(struct MP2KPlayerState *player)
{
    ...
    if (player->nextPlayerFunc != 
# 510 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                                 ((void *)0)
# 510 "src/platform/shared/audio/m4a_sound_mixer.c"
                                     ) {
    ...
    while (player->tempoCounter >= 150) {
        ...
        for (u32 i = 0; i < player->trackCount; i++) {
            ...
            while (chan != 
# 535 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                          ((void *)0)
# 535 "src/platform/shared/audio/m4a_sound_mixer.c"
                              ) {
            ...
            if (currentTrack->status & 0x40) {
                { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, currentTrack, 0x04000000 | 0x01000000 | ((
# 545 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
               __builtin_offsetof (
# 545 "src/platform/shared/audio/m4a_sound_mixer.c"
               struct MP2KTrack
# 545 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
               , 
# 545 "src/platform/shared/audio/m4a_sound_mixer.c"
...
# 545 "src/platform/shared/audio/m4a_sound_mixer.c"
    ...
    do {
        ...
        for (struct MixerSource *chan = track->chan; chan != 
# 632 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                                                            ((void *)0)
# 632 "src/platform/shared/audio/m4a_sound_mixer.c"
                                                                ; chan = chan->next) {
...
void TrackStop(struct MP2KPlayerState *player, struct MP2KTrack *track)
{
    if (track->status & 0x80) {
        for (struct MixerSource *chan = track->chan; chan != 
# 666 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                                                            ((void *)0)
# 666 "src/platform/shared/audio/m4a_sound_mixer.c"
                                                                ; chan = chan->next) {
            if (chan->status != 0) {
                u8 cgbType = chan->type & 0x07;
                if (cgbType != 0) {
            ...
            chan->track = 
# 675 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                         ((void *)0)
# 675 "src/platform/shared/audio/m4a_sound_mixer.c"
                             ;
        }
        track->chan = 
# 677 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                     ((void *)0)
# 677 "src/platform/shared/audio/m4a_sound_mixer.c"
                         ;
    }
}
...
void MP2K_event_nxx(u8 clock, struct MP2KPlayerState *player, struct MP2KTrack *track)
{
    ...
    if (cgbType != 0) {
        if (mixer->cgbChans == 
# 754 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                              ((void *)0)
# 754 "src/platform/shared/audio/m4a_sound_mixer.c"
                                  ) {
            return;
        }
        ...
        chan = 
# 771 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
              ((void *)0)
# 771 "src/platform/shared/audio/m4a_sound_mixer.c"
                  ;
    ...
    if (chan == 
# 806 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
               ((void *)0)
# 806 "src/platform/shared/audio/m4a_sound_mixer.c"
                   ) {
        return;
    }
    ...
    chan->prev = 
# 812 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                ((void *)0)
# 812 "src/platform/shared/audio/m4a_sound_mixer.c"
                    ;
    chan->next = track->chan;
    if (track->chan != 
# 814 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                      ((void *)0)
# 814 "src/platform/shared/audio/m4a_sound_mixer.c"
                          ) {
...
void MP2K_event_endtie(struct MP2KPlayerState *unused, struct MP2KTrack *track)
{
    ...
    while (chan != 
# 878 "src/platform/shared/audio/m4a_sound_mixer.c" 3 4
                  ((void *)0)
# 878 "src/platform/shared/audio/m4a_sound_mixer.c"
                      ) {
