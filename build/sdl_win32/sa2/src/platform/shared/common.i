# 0 "src/platform/shared/common.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/platform/shared/common.c"
# 1 "include/core.h" 1
...
# 2 "src/platform/shared/common.c" 2
...
# 3 "src/platform/shared/common.c" 2
...
__attribute__((aligned(256))) uint16_t PLTT[0x400 / sizeof(uint16_t)] = { 0 };
__attribute__((aligned(256))) uint8_t VRAM[(0x18000 + (0x800 * (12)))] = { 0 };
...
void IntrMain(void)
{
# 30 "src/platform/shared/common.c"
    u16 flags = (*(vu16 *)(REG_BASE + 0x200)) & (*(vu16 *)(REG_BASE + 0x202));
    u16 flag;
