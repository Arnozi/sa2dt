...
output_burst:
    if (mp->sendflag) {
        ...
        i = (*(vu16 *)(REG_BASE + 0x128)) & (0x0080 | 0x0040 | 0x0030 | 0x0008 | 0x0004);
        if (i != 0x0008) {
            (mp)->client_bit = 0; (mp)->probe_count = 0; (mp)->response_bit = 0; (mp)->check_wait = 15; (mp)->sendflag = 0; (mp)->handshake_timeout = 0; (*(vu16 *)(REG_BASE + 0x134)) = 0; (*(vu16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003; (*(vu16 *)(REG_BASE + 0x12a)) = 0;;
            return i ^ 0x0008;
        }
    }
...
static s32 MultiBootSend(struct MultiBootParam *mp, u16 data)
{
    ...
    i = (*(vu16 *)(REG_BASE + 0x128)) & (0x0080 | 0x0008 | 0x0004);
    if (i != 0x0008) {
        (mp)->client_bit = 0; (mp)->probe_count = 0; (mp)->response_bit = 0; (mp)->check_wait = 15; (mp)->sendflag = 0; (mp)->handshake_timeout = 0; (*(vu16 *)(REG_BASE + 0x134)) = 0; (*(vu16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003; (*(vu16 *)(REG_BASE + 0x12a)) = 0;;
        return i ^ 0x0008;
    }
    (*(vu16 *)(REG_BASE + 0x12a)) = data;
    (*(vu16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003 | 0x0080;
    mp->sendflag = 1;
    return 0;
}
...
void MultiBootInit(struct MultiBootParam *mp) { (mp)->client_bit = 0; (mp)->probe_count = 0; (mp)->response_bit = 0; (mp)->check_wait = 15; (mp)->sendflag = 0; (mp)->handshake_timeout = 0; (*(vu16 *)(REG_BASE + 0x134)) = 0; (*(vu16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003; (*(vu16 *)(REG_BASE + 0x12a)) = 0;; }
...
# 543 "src/multi_boot.c"
    for (i = 0; i < 31069; ++i)
        if (((*(vu16 *)(REG_BASE + 0x128)) & 0x0080) == 0)
            break;
