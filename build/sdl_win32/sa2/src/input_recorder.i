# 0 "src/input_recorder.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/input_recorder.c"
...
# 3 "src/input_recorder.c" 2
# 1 "include/task.h" 1
# 4 "src/input_recorder.c" 2
...
void EwramFree(void *);
# 5 "src/input_recorder.c" 2
# 1 "include/input_recorder.h" 1
# 6 "src/input_recorder.c" 2
# 17 "src/input_recorder.c"
struct InputRecorder gInputRecorder __attribute__((aligned(8))) = { 0 };
u16 *gInputRecorderTapeBuffer = 
# 18 "src/input_recorder.c" 3 4
                               ((void *)0)
# 18 "src/input_recorder.c"
                                   ;
