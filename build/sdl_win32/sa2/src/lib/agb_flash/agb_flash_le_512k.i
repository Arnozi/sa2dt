# 0 "src/lib/agb_flash/agb_flash_le_512k.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/lib/agb_flash/agb_flash_le_512k.c"
...
# 2 "src/lib/agb_flash/agb_flash_le_512k.c" 2
...
# 3 "src/lib/agb_flash/agb_flash_le_512k.c" 2
...
u16 EraseFlashChip_LE(void)
{
    ...
    (*(vu16 *)(REG_BASE + 0x204)) = ((*(vu16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | gFlash->wait[0];
...
u16 ProgramFlashSector_LE(u16 sectorNum, void *src)
{
    ...
    if (sectorNum > 15)
        return 0x80FF;
# 136 "src/lib/agb_flash/agb_flash_le_512k.c"
    ...
    (*(vu16 *)(REG_BASE + 0x204)) = ((*(vu16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | 3;
    return result;
}
