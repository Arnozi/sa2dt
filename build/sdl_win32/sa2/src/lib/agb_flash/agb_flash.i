...
# 10 "include/lib/agb_flash/flash_internal.h"
...
u16 SetFlashTimerIntr(u8 timerNum, void (**intrFunc)(void));
extern u16 (*EraseFlashSector)(u16);
# 4 "src/lib/agb_flash/agb_flash.c" 2
...
# 11 "src/lib/agb_flash/agb_flash.c" 3 4
                             ((void *)0)
# 11 "src/lib/agb_flash/agb_flash.c"
                                 ;
u16 (*WaitForFlashWrite)(u8 phase, u8 *addr, u8 lastData) = 
# 12 "src/lib/agb_flash/agb_flash.c" 3 4
                                                           ((void *)0)
# 12 "src/lib/agb_flash/agb_flash.c"
                                                               ;
u16 (*ProgramFlashSector)(u16 sectorNum, void *src) = 
# 13 "src/lib/agb_flash/agb_flash.c" 3 4
                                                     ((void *)0)
# 13 "src/lib/agb_flash/agb_flash.c"
                                                         ;
const struct FlashType *gFlash = 
# 14 "src/lib/agb_flash/agb_flash.c" 3 4
                                ((void *)0)
# 14 "src/lib/agb_flash/agb_flash.c"
                                    ;
u16 gFlashNumRemainingBytes = 0;
u16 (*EraseFlashChip)() = 
# 16 "src/lib/agb_flash/agb_flash.c" 3 4
                         ((void *)0)
# 16 "src/lib/agb_flash/agb_flash.c"
                             ;
u16 (*EraseFlashSector)(u16 sectorNum) = 
# 17 "src/lib/agb_flash/agb_flash.c" 3 4
                                        ((void *)0)
# 17 "src/lib/agb_flash/agb_flash.c"
                                            ;
const u16 *gFlashMaxTime = 
# 18 "src/lib/agb_flash/agb_flash.c" 3 4
                          ((void *)0)
# 18 "src/lib/agb_flash/agb_flash.c"
                              ;
...
void SwitchFlashBank(u8 bankNum)
{
    ...
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0xB0));
    ((*(vu8 *)(FLASH_BASE + (0x0000))) = (bankNum));
}
# 41 "src/lib/agb_flash/agb_flash.c"
u16 ReadFlashId(void)
{
    u16 flashId;
...
u16 SetFlashTimerIntr(u8 timerNum, void (**intrFunc)(void))
{
    ...
    sTimerNum = timerNum;
    gTimerReg = &(*(vu16 *)((REG_BASE + 0x100) + ((sTimerNum) * 4)));
...
void StartFlashTimer(u8 phase)
{
    ...
    gSavedIme = (*(vu16 *)(REG_BASE + 0x208));
    (*(vu16 *)(REG_BASE + 0x208)) = 0;
    gTimerReg[1] = 0;
    (*(vu16 *)(REG_BASE + 0x200)) |= ((1 << 3) << sTimerNum);
    gFlashTimeoutFlag = 0;
    sTimerCount = *maxTime++;
    *gTimerReg++ = *maxTime++;
    *gTimerReg-- = *maxTime++;
    (*(vu16 *)(REG_BASE + 0x202)) = ((1 << 3) << sTimerNum);
...
void ReadFlash(u16 sectorNum, u32 offset, void *dest, u32 size)
{
    ...
    (*(vu16 *)(REG_BASE + 0x204)) = ((*(vu16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | (3 << 0);
