...
# 271 "src/game/sa1_sa2_shared/itembox.c"
            ...
            { gRingCount = newRingCount; if (gCurrentLevel != ((7)*(3 + 1)) + (1)) { s32 newLivesCount = ({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}); if (newLivesCount != ({((100) != 0) ? ((s32)(oldRingCount) / (s32)(100)) : 0;}) && (gGameMode == 0)) { u32 newLives = gNumLives; if (++newLives > 255) { newLives = 255; } gNumLives = newLives; gMusicManagerState.unk3 = 16; } } if (gGameMode == 5) { if (gRingCount > 255) { gRingCount = 255; } } m4aSongNumStart(117); };
        } break;
        ...
        case 8: {
            ...
            for (playerId = 0; playerId < 4 && gMultiplayerPlayerTasks[playerId] != 
# 297 "src/game/sa1_sa2_shared/itembox.c" 3 4
                                                                                                       ((void *)0)
# 297 "src/game/sa1_sa2_shared/itembox.c"
                                                                                                           ; playerId++) {
                ...
                mpp = (void *)((gMultiplayerPlayerTasks[playerId])->data);
...
void Task_ItemBoxMain(void)
{
    Entity_ItemBox *itembox = (void *)((gCurTask)->data);
...
{
    Entity_ItemBox *itembox = (void *)((t)->data);
