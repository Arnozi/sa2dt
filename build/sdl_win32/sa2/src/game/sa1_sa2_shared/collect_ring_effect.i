# 0 "src/game/sa1_sa2_shared/collect_ring_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/collect_ring_effect.c"
...
# 2 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
# 1 "include/task.h" 1
...
# 3 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 6 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 7 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 8 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 10 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 11 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
# 13 "src/game/sa1_sa2_shared/collect_ring_effect.c" 2
...
void CreateCollectRingEffect(s16 x, s16 y)
{
    if (gActiveCollectRingEffectCount < 8) {
        struct Task *t = TaskCreate(Task_CollectRingEffect, sizeof(RingEffect), 0x2000, 0, 
# 27 "src/game/sa1_sa2_shared/collect_ring_effect.c" 3 4
                                                                                          ((void *)0)
# 27 "src/game/sa1_sa2_shared/collect_ring_effect.c"
                                                                                              );
