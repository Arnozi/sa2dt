# 0 "src/game/sa1_sa2_shared/music_manager.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/music_manager.c"
...
# 2 "src/game/sa1_sa2_shared/music_manager.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/music_manager.c" 2
...
# 5 "src/game/sa1_sa2_shared/music_manager.c" 2
...
# 6 "src/game/sa1_sa2_shared/music_manager.c" 2
...
# 7 "src/game/sa1_sa2_shared/music_manager.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/sa1_sa2_shared/music_manager.c" 2

# 1 "include/constants/songs.h" 1
# 11 "src/game/sa1_sa2_shared/music_manager.c" 2

static void MusManager_UpdateBgmParams(void);
void MusManager_Fadeout(u16 fadeoutSpeed);
# 40 "src/game/sa1_sa2_shared/music_manager.c"
...
# 93 "src/game/sa1_sa2_shared/music_manager.c"
const u16 gUnkMusicMgrData[0] = {};
# 103 "src/game/sa1_sa2_shared/music_manager.c"
void Task_StageMusicManager(void)
{
    ...
    if ((gMusicManagerState.unk0 == 0) && (!(gPlayer.moveState & 0x00000080))) {
        ...
        if ((gMusicManagerState.unk1 & (0x10 | 0x20 | 0x40 | 0x80)) == (0x10 | 0x20)) {
            ...
            gMusicManagerState.unk5 = (1);;
        } else

            if ((songHeader == gSongTable[31].header) && (gMPlayInfo_BGM.status & 0x0000ffff)
            ...
            m4aSongNumStart(31);
        } else if ((songHeader == gSongTable[29].header) && (gMPlayInfo_BGM.status & 0x0000ffff)
                   && !(gMPlayInfo_BGM.status & 0x80000000) && !(gPlayer.itemEffect & 0x02)) {
            gMusicManagerState.unk5 = (1);;
            m4aSongNumStop(29);
        } else if ((songHeader != gSongTable[407].header) && (songHeader != gSongTable[29].header)
...
# 177 "src/game/sa1_sa2_shared/music_manager.c"
...
void CreateStageMusicManager(void)
{
    TaskCreate(Task_StageMusicManager, 0, 0x4000, 0, 
# 203 "src/game/sa1_sa2_shared/music_manager.c" 3 4
                                                    ((void *)0)
# 203 "src/game/sa1_sa2_shared/music_manager.c"
                                                        );
