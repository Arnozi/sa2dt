...
# 82 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
   ((void *)0)
# 82 "src/game/sa1_sa2_shared/rings_manager.c"
       ,
    
# 83 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
   ((void *)0)
# 83 "src/game/sa1_sa2_shared/rings_manager.c"
       ,
    
# 84 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
   ((void *)0)
# 84 "src/game/sa1_sa2_shared/rings_manager.c"
       ,
};
...
# 115 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                                                          ((void *)0)
# 115 "src/game/sa1_sa2_shared/rings_manager.c"
                                                                              );
    ...
    mgrRings = (void *)((t)->data) + 
# 125 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                             __builtin_offsetof (
# 125 "src/game/sa1_sa2_shared/rings_manager.c"
                             RingsManager
# 125 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                             , 
# 125 "src/game/sa1_sa2_shared/rings_manager.c"
...

{
    ...
    if (!(gStageFlags & 0x0002)) {
        ...
        rings = *(u32 **)((void *)((gCurTask)->data) + 
# 174 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                               __builtin_offsetof (
# 174 "src/game/sa1_sa2_shared/rings_manager.c"
                                               RingsManager
# 174 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                               , 
# 174 "src/game/sa1_sa2_shared/rings_manager.c"
...
# 174 "src/game/sa1_sa2_shared/rings_manager.c"
        ...
        rings = *(u32 **)((void *)((gCurTask)->data) + 
# 204 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                               __builtin_offsetof (
# 204 "src/game/sa1_sa2_shared/rings_manager.c"
                                               RingsManager
# 204 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                               , 
# 204 "src/game/sa1_sa2_shared/rings_manager.c"
...
# 259 "src/game/sa1_sa2_shared/rings_manager.c"
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
            ...
            for (i = 0; i < 4; i++) {
                ...
                if (i != id && gMultiplayerPlayerTasks[i] != 
# 279 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                                            ((void *)0)
# 279 "src/game/sa1_sa2_shared/rings_manager.c"
                                                                ) {
        ...
        if (gPlayer.itemEffect & 0x08 && gGameMode != 5) {
            for (; ((0)*8 + (regionY)*256) < gCamera.y + 240 && regionY < v_regionCount; regionY++) {
                ...
                for (regionX = ((gCamera.x) >> 8); ((0)*8 + (regionX)*256) < gCamera.x + 426; regionX++) {
                    u32 offset = (*((u32 *)((((u8 *)(rings)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
                    ...
                    if (offset != 0) {
                        ...
                        while (meRing->x != (u8)(-1)) {
                            ...
                            ry = ((meRing->y)*8 + (regionY)*256);
                            if (rx - gCamera.x < -8 || (rx - gCamera.x) + 8 > 426 + 2 * 8
...
# 386 "src/game/sa1_sa2_shared/rings_manager.c"
...

        {
            for (; ((0)*8 + (regionY)*256) < gCamera.y + 240 && regionY < v_regionCount; regionY++) {
                ...
                for (regionX = ((gCamera.x) >> 8); ((0)*8 + (regionX)*256) < gCamera.x + 426 && regionX < h_regionCount;
                     regionX++) {
                    u32 offset = (*((u32 *)((((u8 *)(rings)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
                        ...
                        while (meRing->x != (u8)(-1)) {
                            ...
                            if (rx - gCamera.x < -8 || (rx - gCamera.x) + 8 > 426 + 2 * 8
                                ...
                                if ((drawCount == 0) || s->oamBaseIndex == 0xFF) {
                                    ...
                                    DmaSet(3, oamDat, oamAllocated, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(OamDataShort))/(16/8))));
# 447 "src/game/sa1_sa2_shared/rings_manager.c"
                                    oamAllocated->split.x = ((rx - gCamera.x) - dimensions->offsetX);
                                    oamAllocated->split.y = ((ry - gCamera.y) - dimensions->offsetY);
...
{
    void *rings = *(void **)((void *)((t)->data) + 
# 468 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                           __builtin_offsetof (
# 468 "src/game/sa1_sa2_shared/rings_manager.c"
                                           RingsManager
# 468 "src/game/sa1_sa2_shared/rings_manager.c" 3 4
                                           , 
# 468 "src/game/sa1_sa2_shared/rings_manager.c"
