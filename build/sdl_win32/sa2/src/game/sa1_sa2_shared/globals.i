# 0 "src/game/sa1_sa2_shared/globals.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/globals.c"
...
# 2 "src/game/sa1_sa2_shared/globals.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/globals.c" 2
...
# 4 "src/game/sa1_sa2_shared/globals.c" 2
...
# 5 "src/game/sa1_sa2_shared/globals.c" 2
...
bool8 __attribute__((aligned(4))) gBossRingsShallRespawn = 0;

u32 gMultiplayerPseudoRandom = 0;
u8 gRoomEventQueueWritePos = 0;
s8 __attribute__((aligned(4))) gUnknown_0300543C = 0;
u16 __attribute__((aligned(4))) gBossCameraClampYLower = 0;
...
u16 __attribute__((aligned(16))) gMultiplayerNames[4][6] = {};

u32 gCourseTime = 0;

CheeseTarget __attribute__((aligned(8))) gCheeseTarget = {};
...
u16 __attribute__((aligned(4))) gBossCameraClampYUpper = 0;
...
u8 gMultiplayerMissingHeartbeats[4] = {};
u8 gMultiplayerUnlockedLevels = 0;
struct Task *gEntitiesManagerTask = 
# 64 "src/game/sa1_sa2_shared/globals.c" 3 4
                                   ((void *)0)
# 64 "src/game/sa1_sa2_shared/globals.c"
                                       ;
...
u8 __attribute__((aligned(4))) gSpecialRingCount = 0;

u8 __attribute__((aligned(4))) gNumSingleplayerCharacters = 0;
s32 gWorldSpeedX = 0;
...
u8 __attribute__((aligned(4))) gMultiplayerUnlockedCharacters = 0;




struct Task *gMultiplayerPlayerTasks[4] = {};
...
bool8 __attribute__((aligned(4))) gBoostEffectTasksCreated = 0;
# 111 "src/game/sa1_sa2_shared/globals.c"
u8 gFrameInputsBuf[4] = {};
u8 gNewInputCountersIndex = 0;
u8 __attribute__((aligned(4))) gFrameInputsBufIndex = 0;


struct InputCounters __attribute__((aligned(8))) gNewInputCounters[32] = {};
