...
{
    struct Task *t = TaskCreate(Task_DemoManagerMusicFadeout, sizeof(DemoMusicFadeout), 0xFFFE, 0, 
# 275 "src/game/sa1_sa2_shared/demo_manager.c" 3 4
                                                                                                  ((void *)0)
# 275 "src/game/sa1_sa2_shared/demo_manager.c"
                                                                                                      );
    DemoMusicFadeout *mf = (void *)((t)->data);
    mf->volume = 0x100;
...
void Task_DemoManagerMusicFadeout(void)
{
    DemoMusicFadeout *mf = (void *)((gCurTask)->data);
