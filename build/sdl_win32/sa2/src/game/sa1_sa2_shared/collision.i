# 0 "src/game/sa1_sa2_shared/collision.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/collision.c"
...
# 2 "src/game/sa1_sa2_shared/collision.c" 2
# 1 "include/rect.h" 1
...
# 3 "src/game/sa1_sa2_shared/collision.c" 2
...
# 4 "src/game/sa1_sa2_shared/collision.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "src/game/sa1_sa2_shared/collision.c" 2
...
# 6 "src/game/sa1_sa2_shared/collision.c" 2
...
# 7 "src/game/sa1_sa2_shared/collision.c" 2
# 1 "include/game/sa1_sa2_shared/dust_cloud.h" 1



void CreateDustCloud(s16 x, s16 y);
# 8 "src/game/sa1_sa2_shared/collision.c" 2
...
# 1 "include/task.h" 1
# 7 "include/game/sa1_sa2_shared/entities_manager.h" 2
...
# 8 "include/game/sa1_sa2_shared/entities_manager.h" 2
...
# 9 "src/game/sa1_sa2_shared/collision.c" 2
...
# 12 "src/game/sa1_sa2_shared/collision.c" 2
...
# 14 "src/game/sa1_sa2_shared/collision.c" 2
...
# 15 "src/game/sa1_sa2_shared/collision.c" 2
# 1 "include/game/stage/trapped_animals.h" 1
...
# 16 "src/game/sa1_sa2_shared/collision.c" 2
...
# 18 "src/game/sa1_sa2_shared/collision.c" 2
# 1 "include/constants/player_transitions.h" 1
# 19 "src/game/sa1_sa2_shared/collision.c" 2
# 1 "include/constants/songs.h" 1
# 20 "src/game/sa1_sa2_shared/collision.c" 2
...
u32 Coll_Player_Entity_RectIntersection(Sprite *s, s32 sx, s32 sy, Player *p, Rect8 *rectPlayer)
{
    ...
    if ((((((sx) + (&s->hitboxes[0])->left) <= ((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left) && (((sx) + (&s->hitboxes[0])->left) + ((&s->hitboxes[0])->right - (&s->hitboxes[0])->left)) >= ((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left)) || (((sx) + (&s->hitboxes[0])->left) >= ((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left) && (((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left) + ((rectPlayer)->right - (rectPlayer)->left)) >= ((sx) + (&s->hitboxes[0])->left))) && (((((sy)) + (&s->hitboxes[0])->top) <= (((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top) && ((((sy)) + (&s->hitboxes[0])->top) + ((&s->hitboxes[0])->bottom - (&s->hitboxes[0])->top)) >= (((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top)) || ((((sy)) + (&s->hitboxes[0])->top) >= (((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top) && ((((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top) + ((rectPlayer)->bottom - (rectPlayer)->top)) >= (((sy)) + (&s->hitboxes[0])->top))))) {
        result |= 0x00080000;
    }
...
u32 Coll_Player_PlatformCrumbling(Sprite *s, s32 sx, s32 sy, Player *p)
{
    ...
    if ((((((s32)(((&s->hitboxes[0])->left + (sx)) << 8)) <= ((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256))) && (((s32)(((&s->hitboxes[0])->left + (sx)) << 8)) + ((s32)((((&s->hitboxes[0])->right - (&s->hitboxes[0])->left)) << 8))) >= ((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256)))) || (((s32)(((&s->hitboxes[0])->left + (sx)) << 8)) >= ((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256))) && (((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256))) + ((s32)(((((Rect8 *)rectPlayer)->right - ((Rect8 *)rectPlayer)->left)) << 8))) >= ((s32)(((&s->hitboxes[0])->left + (sx)) << 8)))) && ((((s32)((((&s->hitboxes[0])->top) + ((sy))) << 8)) <= ((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256)))) && (((s32)((((&s->hitboxes[0])->top) + ((sy))) << 8)) + ((s32)((((&s->hitboxes[0])->bottom - (&s->hitboxes[0])->top)) << 8))) >= ((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256))))) || (((s32)((((&s->hitboxes[0])->top) + ((sy))) << 8)) >= ((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256)))) && (((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256)))) + ((s32)(((((Rect8 *)rectPlayer)->bottom - ((Rect8 *)rectPlayer)->top)) << 8))) >= ((s32)((((&s->hitboxes[0])->top) + ((sy))) << 8))))) && (p->qSpeedAirY >= 0)) {
...
bool32 Coll_Player_Entity_HitboxN(Sprite *s, s32 sx, s32 sy, s16 hbIndex, Player *p, s16 hbIndexPlayer)
{
    ...
    if (((((((sx) + s->hitboxes[hbIndex].left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[hbIndexPlayer].left) && ((((sx)) + (s->hitboxes[hbIndex]).left) + ((s->hitboxes[hbIndex]).right - (s->hitboxes[hbIndex]).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[hbIndexPlayer].left)) || (((sx) + s->hitboxes[hbIndex].left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[hbIndexPlayer].left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[hbIndexPlayer]).left) + ((sprPlayer->hitboxes[hbIndexPlayer]).right - (sprPlayer->hitboxes[hbIndexPlayer]).left)) >= ((sx) + s->hitboxes[hbIndex].left))) && (((((sy)) + s->hitboxes[hbIndex].top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[hbIndexPlayer].top) && ((((sy)) + s->hitboxes[hbIndex].top) + ((s->hitboxes[hbIndex]).bottom - (s->hitboxes[hbIndex]).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[hbIndexPlayer].top)) || ((((sy)) + s->hitboxes[hbIndex].top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[hbIndexPlayer].top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[hbIndexPlayer].top) + ((sprPlayer->hitboxes[hbIndexPlayer]).bottom - (sprPlayer->hitboxes[hbIndexPlayer]).top)) >= (((sy)) + s->hitboxes[hbIndex].top)))))) {
        return 1;
    }
...
bool32 Coll_Player_Boss_Attack(Sprite *s, s32 sx, s32 sy, s16 hbIndex, Player *p)
{
    ...
    if (((((((sx) + s->hitboxes[hbIndex].left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left) && ((((sx)) + (s->hitboxes[hbIndex]).left) + ((s->hitboxes[hbIndex]).right - (s->hitboxes[hbIndex]).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left)) || (((sx) + s->hitboxes[hbIndex].left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1]).left) + ((sprPlayer->hitboxes[1]).right - (sprPlayer->hitboxes[1]).left)) >= ((sx) + s->hitboxes[hbIndex].left))) && (((((sy)) + s->hitboxes[hbIndex].top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) && ((((sy)) + s->hitboxes[hbIndex].top) + ((s->hitboxes[hbIndex]).bottom - (s->hitboxes[hbIndex]).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top)) || ((((sy)) + s->hitboxes[hbIndex].top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) + ((sprPlayer->hitboxes[1]).bottom - (sprPlayer->hitboxes[1]).top)) >= (((sy)) + s->hitboxes[hbIndex].top)))))) {
...
bool32 Coll_Cheese_Enemy_Attack(Sprite *sprTarget, s32 sx, s32 sy, s16 hbIndex, Player *p)
{
    ...
    if (gCheese) {
        ...
        if (((((((sx) + sprTarget->hitboxes[hbIndex].left) <= ((((int)((cheese->posX) >> 8))) + cheese->s.hitboxes[1].left) && ((((sx)) + (sprTarget->hitboxes[hbIndex]).left) + ((sprTarget->hitboxes[hbIndex]).right - (sprTarget->hitboxes[hbIndex]).left)) >= ((((int)((cheese->posX) >> 8))) + cheese->s.hitboxes[1].left)) || (((sx) + sprTarget->hitboxes[hbIndex].left) >= ((((int)((cheese->posX) >> 8))) + cheese->s.hitboxes[1].left) && ((((((int)((cheese->posX) >> 8)))) + (cheese->s.hitboxes[1]).left) + ((cheese->s.hitboxes[1]).right - (cheese->s.hitboxes[1]).left)) >= ((sx) + sprTarget->hitboxes[hbIndex].left))) && (((((sy)) + sprTarget->hitboxes[hbIndex].top) <= (((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top) && ((((sy)) + sprTarget->hitboxes[hbIndex].top) + ((sprTarget->hitboxes[hbIndex]).bottom - (sprTarget->hitboxes[hbIndex]).top)) >= (((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top)) || ((((sy)) + sprTarget->hitboxes[hbIndex].top) >= (((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top) && ((((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top) + ((cheese->s.hitboxes[1]).bottom - (cheese->s.hitboxes[1]).top)) >= (((sy)) + sprTarget->hitboxes[hbIndex].top)))))) {
            return 1;
        }
    }
...
bool32 Coll_Player_Enemy_Attack(Sprite *s, s32 sx, s32 sy, u8 hbIndex)
{
    ...
    dead = player->moveState & 0x00000080;
    movestate = player->moveState;

    if (!dead) {
        if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && ((s8)eb->base.me->x == (-3))) {
            CreateDustCloud(sx, sy);
            CreateTrappedAnimal(sx, sy);
            return 1;
        }

        if (!(movestate & 0x40000000)) {
            if (((sprPlayer->hitboxes[1]).index != -1)) {
                if ((((((sx) + s->hitboxes[hbIndex].left) <= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left) && ((((sx)) + (s->hitboxes[hbIndex]).left) + ((s->hitboxes[hbIndex]).right - (s->hitboxes[hbIndex]).left)) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left)) || (((sx) + s->hitboxes[hbIndex].left) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left) && ((((((int)((player->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1]).left) + ((sprPlayer->hitboxes[1]).right - (sprPlayer->hitboxes[1]).left)) >= ((sx) + s->hitboxes[hbIndex].left))) && (((((sy)) + s->hitboxes[hbIndex].top) <= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) && ((((sy)) + s->hitboxes[hbIndex].top) + ((s->hitboxes[hbIndex]).bottom - (s->hitboxes[hbIndex]).top)) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top)) || ((((sy)) + s->hitboxes[hbIndex].top) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) && ((((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) + ((sprPlayer->hitboxes[1]).bottom - (sprPlayer->hitboxes[1]).top)) >= (((sy)) + s->hitboxes[hbIndex].top))))) {
            ...
            if (((sprPlayer->hitboxes[0]).index != -1)
                && ((((((sx) + s->hitboxes[hbIndex].left) <= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left) && ((((sx)) + (s->hitboxes[hbIndex]).left) + ((s->hitboxes[hbIndex]).right - (s->hitboxes[hbIndex]).left)) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left)) || (((sx) + s->hitboxes[hbIndex].left) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left) && ((((((int)((player->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0]).left) + ((sprPlayer->hitboxes[0]).right - (sprPlayer->hitboxes[0]).left)) >= ((sx) + s->hitboxes[hbIndex].left))) && (((((sy)) + s->hitboxes[hbIndex].top) <= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) && ((((sy)) + s->hitboxes[hbIndex].top) + ((s->hitboxes[hbIndex]).bottom - (s->hitboxes[hbIndex]).top)) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top)) || ((((sy)) + s->hitboxes[hbIndex].top) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) && ((((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) + ((sprPlayer->hitboxes[0]).bottom - (sprPlayer->hitboxes[0]).top)) >= (((sy)) + s->hitboxes[hbIndex].top)))))) {
        ...
        if (gCheese != 
# 237 "src/game/sa1_sa2_shared/collision.c" 3 4
                      ((void *)0)
# 237 "src/game/sa1_sa2_shared/collision.c"
                          ) {
            Cheese *cheese = gCheese;
            if (cheese->s.hitboxes[1].index != -1
                && (((((((sx) + s->hitboxes[hbIndex].left) <= ((((int)((cheese->posX) >> 8))) + cheese->s.hitboxes[1].left) && ((((sx)) + (s->hitboxes[hbIndex]).left) + ((s->hitboxes[hbIndex]).right - (s->hitboxes[hbIndex]).left)) >= ((((int)((cheese->posX) >> 8))) + cheese->s.hitboxes[1].left)) || (((sx) + s->hitboxes[hbIndex].left) >= ((((int)((cheese->posX) >> 8))) + cheese->s.hitboxes[1].left) && ((((((int)((cheese->posX) >> 8)))) + (cheese->s.hitboxes[1]).left) + ((cheese->s.hitboxes[1]).right - (cheese->s.hitboxes[1]).left)) >= ((sx) + s->hitboxes[hbIndex].left))) && (((((sy)) + s->hitboxes[hbIndex].top) <= (((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top) && ((((sy)) + s->hitboxes[hbIndex].top) + ((s->hitboxes[hbIndex]).bottom - (s->hitboxes[hbIndex]).top)) >= (((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top)) || ((((sy)) + s->hitboxes[hbIndex].top) >= (((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top) && ((((((int)((cheese->posY) >> 8)))) + cheese->s.hitboxes[1].top) + ((cheese->s.hitboxes[1]).bottom - (cheese->s.hitboxes[1]).top)) >= (((sy)) + s->hitboxes[hbIndex].top))))))) {
                if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
                    RoomEvent_EnemyDestroy *roomEvent = CreateRoomEvent();
                    roomEvent->type = 3;
                    roomEvent->x = eb->base.regionX;
...
bool32 Coll_Player_Projectile(Sprite *s, s32 sx, s32 sy)
{
    ...
    if (gPlayer.moveState & 0x40000000) {
        return result;
    }
    ...
    if (((s->hitboxes[0]).index != -1)) {
        ...
        if ((!(!(gPlayer.moveState & 0x00000080))) || !((sprPlayer->hitboxes[0]).index != -1)) {
            return result;
        }

        if (((((((sx) + s->hitboxes[0].left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left) && ((((sx)) + (s->hitboxes[0]).left) + ((s->hitboxes[0]).right - (s->hitboxes[0]).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left)) || (((sx) + s->hitboxes[0].left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0]).left) + ((sprPlayer->hitboxes[0]).right - (sprPlayer->hitboxes[0]).left)) >= ((sx) + s->hitboxes[0].left))) && (((((sy)) + s->hitboxes[0].top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) && ((((sy)) + s->hitboxes[0].top) + ((s->hitboxes[0]).bottom - (s->hitboxes[0]).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top)) || ((((sy)) + s->hitboxes[0].top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) + ((sprPlayer->hitboxes[0]).bottom - (sprPlayer->hitboxes[0]).top)) >= (((sy)) + s->hitboxes[0].top)))))) {
            Coll_DamagePlayer(p);
            result = 1;
        }
    }
...
bool32 Coll_Player_ItemBox(Sprite *s, s32 sx, s32 sy)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080)) && ((sprPlayer->hitboxes[1]).index != -1) && (((s->hitboxes[0]).index != -1))) {
        if ((((((sx) + s->hitboxes[0].left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left) && ((((sx)) + (s->hitboxes[0]).left) + ((s->hitboxes[0]).right - (s->hitboxes[0]).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left)) || (((sx) + s->hitboxes[0].left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1]).left) + ((sprPlayer->hitboxes[1]).right - (sprPlayer->hitboxes[1]).left)) >= ((sx) + s->hitboxes[0].left))) && (((((sy)) + s->hitboxes[0].top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) && ((((sy)) + s->hitboxes[0].top) + ((s->hitboxes[0]).bottom - (s->hitboxes[0]).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top)) || ((((sy)) + s->hitboxes[0].top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].top) + ((sprPlayer->hitboxes[1]).bottom - (sprPlayer->hitboxes[1]).top)) >= (((sy)) + s->hitboxes[0].top))))) {
            result = 1;
        }
    }
...
bool32 Coll_Player_Enemy(Sprite *s, s32 sx, s32 sy, s16 hbIndex, Player *p)
{
    ...
    if ((!(p->moveState & 0x00000080)) && (((s->hitboxes[hbIndex]).index != -1) && ((sprPlayer->hitboxes[0]).index != -1))) {
        if ((((((sx) + s->hitboxes[hbIndex].left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left) && ((((sx)) + (s->hitboxes[hbIndex]).left) + ((s->hitboxes[hbIndex]).right - (s->hitboxes[hbIndex]).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left)) || (((sx) + s->hitboxes[hbIndex].left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0]).left) + ((sprPlayer->hitboxes[0]).right - (sprPlayer->hitboxes[0]).left)) >= ((sx) + s->hitboxes[hbIndex].left))) && (((((sy)) + s->hitboxes[hbIndex].top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) && ((((sy)) + s->hitboxes[hbIndex].top) + ((s->hitboxes[hbIndex]).bottom - (s->hitboxes[hbIndex]).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top)) || ((((sy)) + s->hitboxes[hbIndex].top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].top) + ((sprPlayer->hitboxes[0]).bottom - (sprPlayer->hitboxes[0]).top)) >= (((sy)) + s->hitboxes[hbIndex].top))))) {
            Coll_DamagePlayer(p);
            return 1;
        }
    }
...
void Coll_Player_Enemy_AdjustSpeed(Player *p)
{
    if (p->moveState & 0x02000000) {
        ...
        p->qSpeedAirX = speedX - ((s32)((gCamera.dx)*256));
    } else if (p->qSpeedAirY > 0) {

        p->qSpeedAirY = -p->qSpeedAirY;
    }

    gPlayer.moveState |= 0x00004000;
}
...
u32 Coll_Player_Platform(Sprite *s, s32 sx, s32 sy, Player *p)
{
    ...
    if (mask != 0) {
        if (mask & 0x00010000) {
            ...
            if (!stoodOnSprite && s == 
# 445 "src/game/sa1_sa2_shared/collision.c" 3 4
                                      ((void *)0)
# 445 "src/game/sa1_sa2_shared/collision.c"
                                          ) {
        ...
        if (!(p->moveState & 0x00000008)) {
            ...
            p->moveState |= 0x00000002;
            p->stoodObj = 
# 453 "src/game/sa1_sa2_shared/collision.c" 3 4
                         ((void *)0)
# 453 "src/game/sa1_sa2_shared/collision.c"
                             ;

            if (((((gCurrentLevel) & ((3 + 1) - 1)) == 2) || (((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && !gFinalBossActive) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
                p->qSpeedGround -= ((s32)((gCamera.dx)*256));
            }
...
u32 Coll_Player_Interactable(Sprite *s, s32 sx, s32 sy, Player *p)
{
    ...
    if (mask & 0x00010000) {
        ...
        p->stoodObj = 
# 497 "src/game/sa1_sa2_shared/collision.c" 3 4
                     ((void *)0)
# 497 "src/game/sa1_sa2_shared/collision.c"
                         ;
...
u32 sub_800CE94(Sprite *s, s32 sx, s32 sy, Rect8 *inRect, Player *p)
{
    ...
    if ((((((sx) + ((Rect8 *)&s->hitboxes[0].left)->left) <= ((px) + (inRect)->left) && (((sx) + ((Rect8 *)&s->hitboxes[0].left)->left) + (((Rect8 *)&s->hitboxes[0].left)->right - ((Rect8 *)&s->hitboxes[0].left)->left)) >= ((px) + (inRect)->left)) || (((sx) + ((Rect8 *)&s->hitboxes[0].left)->left) >= ((px) + (inRect)->left) && (((px) + (inRect)->left) + ((inRect)->right - (inRect)->left)) >= ((sx) + ((Rect8 *)&s->hitboxes[0].left)->left))) && (((((sy)) + ((Rect8 *)&s->hitboxes[0].left)->top) <= (((py)) + (inRect)->top) && ((((sy)) + ((Rect8 *)&s->hitboxes[0].left)->top) + (((Rect8 *)&s->hitboxes[0].left)->bottom - ((Rect8 *)&s->hitboxes[0].left)->top)) >= (((py)) + (inRect)->top)) || ((((sy)) + ((Rect8 *)&s->hitboxes[0].left)->top) >= (((py)) + (inRect)->top) && ((((py)) + (inRect)->top) + ((inRect)->bottom - (inRect)->top)) >= (((sy)) + ((Rect8 *)&s->hitboxes[0].left)->top))))) {
        ...
        if (((r6) >= 0 ? (r6) : -(r6)) < (((r1) >= 0 ? (r1) : -(r1)))) {
            result &= (0x00040000 | 0x00080000);
            goto temp_lbl;
        } else {
            result &= (0x00010000 | 0x00020000);
    ...
    temp_lbl:
        ...
        if (!(result & (0x00010000 | 0x00020000))) {
            result &= ~0xFF;
        }
    }
...
u32 sub_800DA4C(Sprite *opponent, s16 oppX, s16 oppY, __attribute__((unused)) s32 param3, __attribute__((unused)) s32 param4, u8 layer)
{
    ...
    if ((p->qSpeedAirX == 0 && p->qSpeedAirY == 0) && ((opponent->hitboxes[1]).index != -1)) {
        if ((((((oppX) + opponent->hitboxes[1].left) <= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].left) && ((((oppX)) + (opponent->hitboxes[1]).left) + ((opponent->hitboxes[1]).right - (opponent->hitboxes[1]).left)) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].left)) || (((oppX) + opponent->hitboxes[1].left) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].left) && ((((mpp->pos.x)) + (mpPlayerSprite->hitboxes[0]).left) + ((mpPlayerSprite->hitboxes[0]).right - (mpPlayerSprite->hitboxes[0]).left)) >= ((oppX) + opponent->hitboxes[1].left))) && (((((oppY)) + opponent->hitboxes[1].top) <= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top) && ((((oppY)) + opponent->hitboxes[1].top) + ((opponent->hitboxes[1]).bottom - (opponent->hitboxes[1]).top)) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top)) || ((((oppY)) + opponent->hitboxes[1].top) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top) && ((((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top) + ((mpPlayerSprite->hitboxes[0]).bottom - (mpPlayerSprite->hitboxes[0]).top)) >= (((oppY)) + opponent->hitboxes[1].top))))) {
    ...
    if (((mpPlayerSprite->hitboxes[1]).index != -1) && ((opponent->hitboxes[0]).index != -1)
        && (((((oppX) + opponent->hitboxes[0].left) <= ((mpp->pos.x) + mpPlayerSprite->hitboxes[1].left) && ((((oppX)) + (opponent->hitboxes[0]).left) + ((opponent->hitboxes[0]).right - (opponent->hitboxes[0]).left)) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[1].left)) || (((oppX) + opponent->hitboxes[0].left) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[1].left) && ((((mpp->pos.x)) + (mpPlayerSprite->hitboxes[1]).left) + ((mpPlayerSprite->hitboxes[1]).right - (mpPlayerSprite->hitboxes[1]).left)) >= ((oppX) + opponent->hitboxes[0].left))) && (((((oppY)) + opponent->hitboxes[0].top) <= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].top) && ((((oppY)) + opponent->hitboxes[0].top) + ((opponent->hitboxes[0]).bottom - (opponent->hitboxes[0]).top)) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].top)) || ((((oppY)) + opponent->hitboxes[0].top) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].top) && ((((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].top) + ((mpPlayerSprite->hitboxes[1]).bottom - (mpPlayerSprite->hitboxes[1]).top)) >= (((oppY)) + opponent->hitboxes[0].top))))) {
        ...
        result |= 0x00000001;
               ...
               && (((((oppX) + opponent->hitboxes[1].left) <= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].left) && ((((oppX)) + (opponent->hitboxes[1]).left) + ((opponent->hitboxes[1]).right - (opponent->hitboxes[1]).left)) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].left)) || (((oppX) + opponent->hitboxes[1].left) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].left) && ((((mpp->pos.x)) + (mpPlayerSprite->hitboxes[0]).left) + ((mpPlayerSprite->hitboxes[0]).right - (mpPlayerSprite->hitboxes[0]).left)) >= ((oppX) + opponent->hitboxes[1].left))) && (((((oppY)) + opponent->hitboxes[1].top) <= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top) && ((((oppY)) + opponent->hitboxes[1].top) + ((opponent->hitboxes[1]).bottom - (opponent->hitboxes[1]).top)) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top)) || ((((oppY)) + opponent->hitboxes[1].top) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top) && ((((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].top) + ((mpPlayerSprite->hitboxes[0]).bottom - (mpPlayerSprite->hitboxes[0]).top)) >= (((oppY)) + opponent->hitboxes[1].top))))) {
        result |= 0x00000002;
    }
