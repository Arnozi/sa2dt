# 0 "src/game/sa1_sa2_shared/interactables/slidy_ice.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/slidy_ice.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 2
# 1 "include/task.h" 1
...
# 3 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 2
...
# 5 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 2
...
# 6 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 2
...
# 7 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 2
...
# 8 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 2
...
{
    Sprite_SlidyIce *ice = (void *)((gCurTask)->data);
    ...
    if (!(gPlayer.moveState & 0x00000080)) {
        s32 posX = (screenX + me->offsetX * 8);

        if ((posX <= ((int)((gPlayer.qWorldX) >> 8))) && ((posX + me->width * 8) >= ((int)((gPlayer.qWorldX) >> 8)))) {
            s32 posY = screenY + me->offsetY * 8;

            if ((posY <= ((int)((gPlayer.qWorldY) >> 8))) && ((posY + me->height * 8) >= ((int)((gPlayer.qWorldY) >> 8)))) {
                gPlayer.moveState |= 0x00000800;
            }
        }
    }
...
{
    struct Task *t = TaskCreate(Task_SlidyIce, sizeof(Sprite_SlidyIce), 0x2010, 0, 
# 61 "src/game/sa1_sa2_shared/interactables/slidy_ice.c" 3 4
                                                                                  ((void *)0)
# 61 "src/game/sa1_sa2_shared/interactables/slidy_ice.c"
                                                                                      );

    Sprite_SlidyIce *ice = (void *)((t)->data);
