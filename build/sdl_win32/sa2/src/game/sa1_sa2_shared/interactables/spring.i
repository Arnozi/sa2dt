...
void CreateEntity_Spring(u8 springType, MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Spring *spring = (void *)((t)->data);
    Sprite *s = &spring->s;
    ...
    if (((s16)springKind != 1) || ((springType / 2) != 0)) {
        ...
        s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2980);
    }
...
static void Task_Spring_Idle(void)
{
    Sprite_Spring *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
    ...
    if (CheckSpringPlayerCollisions(s, me, spring, &gPlayer) != 0) {
        ...
        if ((((gCurrentLevel) >> 2) == 2 && (spring->dir / 2) == 0))
            s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2B00);
