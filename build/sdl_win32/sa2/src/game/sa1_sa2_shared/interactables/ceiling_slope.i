# 0 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
# 1 "include/task.h" 1
# 5 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
...
# 7 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
...
# 8 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2



# 1 "include/constants/player_transitions.h" 1
# 12 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
# 1 "include/constants/interactables.h" 1
# 13 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 2
...
{
    Sprite_CeilingSlope *ceilingSlope = (void *)((gCurTask)->data);
    ...
    screenX = ((spriteX)*8 + (regionX)*256);
    screenY = ((me->y)*8 + (regionY)*256);

    left = (screenX + me->d.sData[0] * 8);
    playerX = ((int)((gPlayer.qWorldX) >> 8));

    if ((left <= playerX) && (((screenX + me->d.sData[0] * 8)) + me->d.uData[2] * 8) >= playerX) {
        top = (screenY + me->d.sData[1] * 8);
        playerY = ((int)((gPlayer.qWorldY) >> 8));

        if ((top <= playerY) && (((screenY + me->d.sData[1] * 8)) + me->d.uData[3] * 8) >= playerY) {
            u32 moveState = gPlayer.moveState;
            if (((moveState & (0x00040000 | 0x00000002)) == 0x00000002) && (gPlayer.qSpeedAirY < 0)) {
                if (moveState & 0x10000000) {
                    base->id = 1;
                }

                if ((!(moveState & 0x10000000) || !(gPlayer.moveState & 0x10000000)) && base->id == 0) {
                    gPlayer.transition = 23;
                    gPlayer.unk6E = 0;
    ...
    if ((((u32)(screenX + (256 / 2)) > 426 + 256) || (screenY + (256 / 2) < 0) || (screenY > 240 + (256 / 2)))) {
        me->x = spriteX;
...
{
    struct Task *t = TaskCreate(Task_Interactable_CeilingSlope, sizeof(Sprite_CeilingSlope), 0x2010, 0, 
# 86 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c" 3 4
                                                                                                       ((void *)0)
# 86 "src/game/sa1_sa2_shared/interactables/ceiling_slope.c"
                                                                                                           );
    Sprite_CeilingSlope *ceilingSlope = (void *)((t)->data);
