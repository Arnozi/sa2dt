...
void CreateEntity_PlatformThin(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_CommonThinPlatform *platform = (void *)((t)->data);
    Sprite *s = &platform->s;
...
static void Task_PlatformThinMain(void)
{
    ...
    if ((((u32)(x - gCamera.x + (256 / 2)) > 426 + 256) || (y - gCamera.y + (256 / 2) < 0) || (y - gCamera.y > 240 + (256 / 2)))) {
...
static void CreatePlatformBreakParticles(s16 x, s16 y)
{
    ...
    PlatformBreakParticles *particles = (void *)((t)->data);
    ...
    { void *p1 = s; void *p2 = ++s; DmaSet(3, p1, p2, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*s))/(16/8)))); };

    { void *p1 = transform; void *p2 = ++transform; DmaSet(3, p1, p2, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*transform))/(16/8)))); };
...
{
    s16 x, y;
    PlatformBreakParticles *particles = (void *)((gCurTask)->data);
    Sprite *s;
    s16 width;
    SpriteTransform *transform;
...
{
    PlatformBreakParticles *platform = (void *)((t)->data);
