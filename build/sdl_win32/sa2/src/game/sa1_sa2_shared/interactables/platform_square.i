# 0 "src/game/sa1_sa2_shared/interactables/platform_square.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/platform_square.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
...
# 4 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
# 1 "include/task.h" 1
# 6 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
# 1 "include/trig.h" 1
...
# 7 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
# 1 "include/malloc_vram.h" 1
# 8 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
...
# 10 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
...
# 6 "include/game/sa1_sa2_shared/interactables/platform_square.h" 2

void CreateEntity_Platform_Square(MapEntity *, u16, u16, u8);
# 11 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
...
# 16 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
# 1 "include/constants/interactables.h" 1
# 17 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
# 1 "include/constants/player_transitions.h" 1
# 18 "src/game/sa1_sa2_shared/interactables/platform_square.c" 2
...
static const u16 sAnimsPlatformSquare[9][3] = {
    { 36, 613, 0 }, { 36, 613, 0 }, { 36, 574, 1 },
    { 36, 581, 2 }, { 36, 594, 0 }, { 36, 597, 2 },
    { 36, 613, 0 }, { 36, 613, 0 }, { 36, 613, 0 },
};
...
void CreateEntity_Platform_Square(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_PlatformSquare *platform = (void *)((t)->data);
    Sprite *s = &platform->s;
...

    {
        ...
        for (i = 0; i < (sizeof(platform->prevOffset) / sizeof((platform->prevOffset)[0])); i++) {
        ...
        tileCount = sAnimsPlatformSquare[((gCurrentLevel) >> 2)][0];
        s->graphics.dest = VramMalloc(tileCount);

        anim = sAnimsPlatformSquare[((gCurrentLevel) >> 2)][1];
        s->graphics.anim = anim;

        variant = sAnimsPlatformSquare[((gCurrentLevel) >> 2)][2];
        s->variant = variant;
...
static void Task_Platform_Square(void)
{
    ...
    Sprite_PlatformSquare *platform = (void *)((gCurTask)->data);
    Sprite *s = &platform->s;
    me = platform->base.me;
    ...
    if (platform->velocityX != 0) {
        ...
        platform->offsetX = ((gSineTable[((platform->velocityX * ((gStageTime + platform->timer) & 0xFF)) & (1024 - 1))]) * meUdata2) >> 14;
    ...
    if (platform->velocityY != 0) {
        ...
        platform->offsetY = ((gSineTable[(((platform->velocityY * ((gStageTime + platform->timer) & 0xFF))) & (1024 - 1))]) * meUdata3) >> 14;
    ...
    posX = ((platform->base.meX)*8 + (platform->base.regionX)*256);
    posY = ((me->y)*8 + (platform->base.regionY)*256);

    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        s->x = posX - gCamera.x + ((int)((platform->prevOffset[1][0]) >> 8));
        s->y = posY - gCamera.y + ((int)((platform->prevOffset[1][1]) >> 8));
    } else {
        s->x = posX - gCamera.x + ((int)((platform->offsetX) >> 8));
        s->y = posY - gCamera.y + ((int)((platform->offsetY) >> 8));
    }
    ...
    if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
        ...
        if (!(gStageFlags & 0x0080)) {
            p->qWorldY += deltaY + ((s32)((1.0)*256));
        } else {
            p->qWorldY += deltaY - ((s32)((2.0)*256));
        }

        res = sub_801F100(((int)((gPlayer.qWorldY) >> 8)) + gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)) + gPlayer.spriteOffsetX, gPlayer.layer, +8,
                          sub_801EC3C);
        if (res < 0) {
            ...
            p->stoodObj = 
# 183 "src/game/sa1_sa2_shared/interactables/platform_square.c" 3 4
                         ((void *)0)
# 183 "src/game/sa1_sa2_shared/interactables/platform_square.c"
                             ;
        }

        temp = ((int)((p->qWorldX) >> 8)) + 2;
        res = sub_801F100(temp + p->spriteOffsetX, ((int)((p->qWorldY) >> 8)), p->layer, +8, sub_801EB44);

        if (res < 0) {
            p->qWorldX += ((s32)((res)*256));
        }

        temp2 = ((int)((p->qWorldX) >> 8)) - 2;
        res = sub_801F100(temp2 - p->spriteOffsetX, ((int)((p->qWorldY) >> 8)), p->layer, -8, sub_801EB44);

        if (res < 0) {
            p->qWorldX -= ((s32)((res)*256));
        }

        res = sub_801F100(((int)((p->qWorldY) >> 8)) + p->spriteOffsetY, ((int)((p->qWorldX) >> 8)) - p->spriteOffsetX, p->layer, +8, sub_801EC3C);
        ...
        if (res < 0) {
            ...
            p->moveState |= 0x00000002;
            p->stoodObj = 
# 207 "src/game/sa1_sa2_shared/interactables/platform_square.c" 3 4
                         ((void *)0)
# 207 "src/game/sa1_sa2_shared/interactables/platform_square.c"
                             ;
        }
    }
    ...
    if (!(p->moveState & 0x00400000)) {
        ...
        s->hitboxes[0].top -= 3;
        x = (posX + ((int)((platform->offsetX) >> 8)));
        y = (posY + ((int)((platform->offsetY) >> 8)));
        ...
        if (result & 0x30000) {
            ...
            if (result & 0x20000) {
                ...
                res = sub_801F100(((int)((p->qWorldY) >> 8)) + p->spriteOffsetY, ((int)((p->qWorldX) >> 8)), p->layer, 8, sub_801EC3C);
            ...
            if (result & 0x10000) {
                if ((gStageFlags & 0x0080)) {
                    ...
                    otherRes = Coll_Player_Platform(s, posX + ((int)((platform->offsetX) >> 8)), posY + ((int)((platform->offsetY) >> 8)), p);
                    ...
                    if (otherRes & 0x10000) {
                        s32 newRes = sub_801F100(((int)((p->qWorldY) >> 8)) - p->spriteOffsetY, ((int)((p->qWorldX) >> 8)), p->layer, -8, sub_801EC3C);
                    ...
                    s32 newRes;
                    p->qSpeedAirY = 0;
                    newRes = sub_801F100(((int)((p->qWorldY) >> 8)) - p->spriteOffsetY, ((int)((p->qWorldX) >> 8)), p->layer, -8, sub_801EC3C);
        ...
        if ((result & 0xC0000) && !(p->moveState & 0x00000008) && !(p->stoodObj == s)) {
            ...
            if (result & 0x40000) {
                s32 tempXVal = ((int)((p->qWorldX) >> 8)) + 2;
                if (sub_801F100(tempXVal + p->spriteOffsetX, ((int)((p->qWorldY) >> 8)), p->layer, -8, sub_801EB44) < 0) {
                    Platform_Square_KillPlayer();
                }
            }
    ...
    if ((((u32)(posX - gCamera.x + (256 / 2)) > 426 + 256) || (posY - gCamera.y + (256 / 2) < 0) || (posY - gCamera.y > 240 + (256 / 2)))) {
...
static u32 __attribute__((unused)) HandleSquarePlatformCollision(Sprite *s, s32 x, s32 y, Player *p)
{
    u32 result;
