# 0 "src/game/sa1_sa2_shared/interactables/ramp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/ramp.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/sa1_sa2_shared/interactables/ramp.c" 2

# 1 "include/task.h" 1
# 6 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "include/malloc_vram.h" 1
# 7 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 9 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 10 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 11 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 12 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 13 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
# 15 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/sa1_sa2_shared/interactables/ramp.c" 2
...
static void Task_Ramp(void)
{
    ...
    Sprite_Ramp *ramp = (void *)((gCurTask)->data);
    Sprite *s = &ramp->s;
        ...
        if (r1 != 0) {
            ...
            if (var) {
                if (((ramp->unk3C & 2) != 0 && ((int)((player->qWorldX) >> 8)) < s->x) || ((ramp->unk3C & 2) == 0 && ((int)((player->qWorldX) >> 8)) > s->x)) {
                    ...
                    player->moveState &= ~0x00000008;
                    player->stoodObj = 
# 172 "src/game/sa1_sa2_shared/interactables/ramp.c" 3 4
                                      ((void *)0)
# 172 "src/game/sa1_sa2_shared/interactables/ramp.c"
                                          ;
                }
            }
        }
    ...
    if ((((u32)(screenX - gCamera.x + (256 / 2)) > 426 + 256) || (screenY - gCamera.y + (256 / 2) < 0) || (screenY - gCamera.y > 240 + (256 / 2)))) {
        me->x = ramp->base.meX;
