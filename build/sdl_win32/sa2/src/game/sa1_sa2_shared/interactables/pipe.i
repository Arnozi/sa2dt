# 0 "src/game/sa1_sa2_shared/interactables/pipe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/pipe.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/pipe.c" 2
...
# 4 "src/game/sa1_sa2_shared/interactables/pipe.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/sa1_sa2_shared/interactables/pipe.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "src/game/sa1_sa2_shared/interactables/pipe.c" 2
...
# 8 "src/game/sa1_sa2_shared/interactables/pipe.c" 2
...
# 9 "src/game/sa1_sa2_shared/interactables/pipe.c" 2



# 1 "include/constants/player_transitions.h" 1
# 13 "src/game/sa1_sa2_shared/interactables/pipe.c" 2
...
{
    Sprite_ClearPipe *pipe = (void *)((gCurTask)->data);
    ...
    if (!(gPlayer.moveState & 0x00000080) && (screenX <= ((int)((gPlayer.qWorldX) >> 8))) && ((screenX + 24) >= ((int)((gPlayer.qWorldX) >> 8)))
        && (screenY <= ((int)((gPlayer.qWorldY) >> 8))) && ((screenY + 24) >= ((int)((gPlayer.qWorldY) >> 8))) && (!(gPlayer.moveState & 0x00080000))) {
        u8 flag;

        gPlayer.transition = 25;

        flag = (me->unk3 & 0x03) << 4;
        flag |= me->unk4 & 0x0F;
        gPlayer.unk6E = flag;

        gPlayer.qWorldX = ((s32)((screenX + 12)*256));
        gPlayer.qWorldY = ((s32)((screenY + 12)*256));
...
static void Task_Pipe_End(void)
{
    ...
    if (!(gPlayer.moveState & 0x00000080) && (screenX <= ((int)((gPlayer.qWorldX) >> 8))) && ((screenX + 24) >= ((int)((gPlayer.qWorldX) >> 8)))
        && (screenY <= ((int)((gPlayer.qWorldY) >> 8))) && ((screenY + 24) >= ((int)((gPlayer.qWorldY) >> 8))) && (gPlayer.moveState & 0x00080000)) {
        gPlayer.moveState &= ~(0x00080000 | 0x00000200 | 0x00000002);
...
{
    struct Task *t = TaskCreate(Task_Pipe_Start, sizeof(Sprite_ClearPipe), 0x2010, 0, 
# 127 "src/game/sa1_sa2_shared/interactables/pipe.c" 3 4
                                                                                     ((void *)0)
# 127 "src/game/sa1_sa2_shared/interactables/pipe.c"
                                                                                         );

    Sprite_ClearPipe *pipe = (void *)((t)->data);
...
{
    struct Task *t = TaskCreate(Task_Pipe_End, sizeof(Sprite_ClearPipe), 0x2010, 0, 
# 139 "src/game/sa1_sa2_shared/interactables/pipe.c" 3 4
                                                                                   ((void *)0)
# 139 "src/game/sa1_sa2_shared/interactables/pipe.c"
                                                                                       );
