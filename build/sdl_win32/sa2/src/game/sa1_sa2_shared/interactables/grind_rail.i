# 0 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 5 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 6 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 7 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 11 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2

# 1 "include/constants/songs.h" 1
# 13 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
# 1 "include/constants/player_transitions.h" 1
# 14 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 2
...
# 31 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...

{
    ...
    s32 r7 = (gStageFlags & 0x0080) ? ((int)((p->qWorldY) >> 8)) - p->spriteOffsetY : ((int)((p->qWorldY) >> 8)) + p->spriteOffsetY;
    ...
    Sprite_GrindRail *rail = (void *)((gCurTask)->data);
    ...
    x = ((stackSpriteX)*8 + (regionX)*256);
    y = ((me->y)*8 + (regionY)*256);

    if (!(p->moveState & 0x00000080)) {

        if (((x + (me->d.sData[0] * 8)) <= ((int)((p->qWorldX) >> 8))
             && ((x + (me->d.sData[0] * 8)) + (me->d.uData[2] * 8) >= ((int)((p->qWorldX) >> 8))))
            && (y + (me->d.sData[1] * 8) <= r7 && y + (me->d.sData[1] * 8) + (me->d.uData[3] * 8) >= r7)) {
            bool32 r6 = 0;
            ...
            if ((p->qSpeedAirY >= 0) && r6 && !(kind & 0x80)) {
                if ((p->moveState & 0x01000000)) {
                    if ((!(kind & 0x1) && (p->moveState & 0x00000001)
                         && (((int)((p->qWorldX) >> 8)) < x + (me->d.sData[0] * 8) + ((me->d.uData[2] * (8 / 2)))
                             || ((p->heldInput & gPlayerControls.jump) && (kind & 0x2))))) {
                        if ((kind & 0x2)) {
                            p->transition = 13;
                        ...
                        *(u8 *)((void *)((gCurTask)->data) + 
# 93 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                     __builtin_offsetof (
# 93 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                                     Sprite_GrindRail
# 93 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                     , 
# 93 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...
# 93 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                    ...
                    } else if ((kind & 0x1) && !(p->moveState & 0x00000001)
                               && (((int)((p->qWorldX) >> 8)) > x + (me->d.sData[0] * 8) + ((me->d.uData[2] * (8 / 2)))
                                   || ((p->heldInput & gPlayerControls.jump) && (kind & 0x2)))) {
                        if ((kind & 0x2)) {
                            p->transition = 13;
                        ...
                        *(u8 *)((void *)((gCurTask)->data) + 
# 102 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                     __builtin_offsetof (
# 102 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                                     Sprite_GrindRail
# 102 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                     , 
# 102 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...
# 102 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                           ...
                           || (!(kind & 0x1)
                               && ((int)((p->qWorldX) >> 8))
                                   > (x + (me->d.sData[0] * 8)) + ((me->d.uData[2] * (8 / 2))))) {
                    p->transition = 11;
                    p->unk6E = 0;
            ...
            *(u8 *)((void *)((gCurTask)->data) + 
# 117 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                         __builtin_offsetof (
# 117 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                         Sprite_GrindRail
# 117 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                         , 
# 117 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...
# 117 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
            ...
            *(u8 *)((void *)((gCurTask)->data) + 
# 119 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                         __builtin_offsetof (
# 119 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                         Sprite_GrindRail
# 119 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                         , 
# 119 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...
# 119 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
    ...
    if ((((u16)(x + (256 / 2)) > 426 + 256) || (y + (256 / 2) < 0) || (y > 240 + (256 / 2)))) {
        me->x = stackSpriteX;
...
static void Task_GrindRail_Air(void)
{
    ...
    if (!(p->moveState & 0x00000080)) {
        if ((x + (me->d.sData[0] * 8) <= ((int)((p->qWorldX) >> 8))
             && (x + (me->d.sData[0] * 8) + (me->d.uData[2] * 8) >= ((int)((p->qWorldX) >> 8))))
            && (y + (me->d.sData[1] * 8) <= ((int)((p->qWorldY) >> 8))
                && y + (me->d.sData[1] * 8) + (me->d.uData[3] * 8) >= ((int)((p->qWorldY) >> 8)))) {

            if ((p->moveState & 0x01000000)) {
                if (((kind & 0x1) && (p->moveState & 0x00000001)
                     && (((int)((p->qWorldX) >> 8)) < x + (me->d.sData[0] * 8) + ((me->d.uData[2] * 8) >> 1)
                         || ((p->heldInput & gPlayerControls.jump) && (kind & 0x2))))) {
                    if ((kind & 0x2)) {
                        p->transition = 13;
...
static void CreateEntity_GrindRail(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u8 railType)
{
    ...
    struct Task *t = TaskCreate(Task_GrindRail, sizeof(Sprite_GrindRail), 0x2010, 0, 
# 195 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                                                    ((void *)0)
# 195 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                                                                        );
    Sprite_GrindRail *rail = (void *)((t)->data);
    rail->kind = railType;
    rail->regionX = spriteRegionX;
    rail->regionY = spriteRegionY;
    rail->me = me;
    rail->spriteX = me->x;
# 232 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
...
static void CreateEntity_GrindRail_Air(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u8 railType)
{
    ...
    struct Task *t = TaskCreate(Task_GrindRail_Air, sizeof(Sprite_GrindRail), 0x2010, 0, 
# 238 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                                                        ((void *)0)
# 238 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                                                                            );
    Sprite_GrindRail *rail = (void *)((t)->data);
    rail->kind = railType;
    rail->regionX = spriteRegionX;
    ...
    rail->me = me;
    rail->spriteX = me->x;
# 275 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
    { s32 negativeTwo; s16 forMatching; negativeTwo = (-2); forMatching = negativeTwo; me->x = forMatching; };
}


__attribute__((unused)) static void CreateGrindrailAudioTask(void)
{
    struct Task *t = TaskCreate(GrindRailAudioDelay, sizeof(u16), 0x2010, 0, 
# 281 "src/game/sa1_sa2_shared/interactables/grind_rail.c" 3 4
                                                                            ((void *)0)
# 281 "src/game/sa1_sa2_shared/interactables/grind_rail.c"
                                                                                );
    u16 *audioTimer = (void *)((t)->data);
    *audioTimer = 0;
}

static void GrindRailAudioDelay(void)
{
    u16 *audioTimer = (void *)((gCurTask)->data);
    if (++(*audioTimer) > 60) {
        m4aSongNumStart(114);
        TaskDestroy(gCurTask);
    }
...
void CreateEntity_GrindRail_StartAir(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail(me, spriteRegionX, spriteRegionY, spriteY, 2); }

void CreateEntity_GrindRail_End_ForcedJump(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail(me, spriteRegionX, spriteRegionY, spriteY, 3); }

void CreateEntity_GrindRail_Start(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail(me, spriteRegionX, spriteRegionY, spriteY, 0); }

void CreateEntity_GrindRail_EndGround(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail(me, spriteRegionX, spriteRegionY, spriteY, 1); }

void CreateEntity_GrindRail_EndAir(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail_Air(me, spriteRegionX, spriteRegionY, spriteY, 2); }

void CreateEntity_GrindRail_EndAir_Left(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail_Air(me, spriteRegionX, spriteRegionY, spriteY, 3); }


void CreateEntity_GrindRail_EndAlternate(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail_Air(me, spriteRegionX, spriteRegionY, spriteY, 0); }

void CreateEntity_GrindRail_EndGround_Left(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY) { CreateEntity_GrindRail_Air(me, spriteRegionX, spriteRegionY, spriteY, 1); }
