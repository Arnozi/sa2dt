...
# 16 "src/game/sa1_sa2_shared/input_buffer.c"
...
const u8 *unk_8C87198[3] = { pat1, gUnknown_080D5262, ((void *)((intptr_t)-1)) };
...
void InputBuffer_NewFrameInput(u16 frameInputs1, u16 frameInputs2)
{
    ...
    r5 &= frameInputs1;
# 184 "src/game/sa1_sa2_shared/input_buffer.c"
...
void InitNewInputCounters(void)
{
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gNewInputCounters, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gNewInputCounters) - 4)/(32/8)))); };
}
