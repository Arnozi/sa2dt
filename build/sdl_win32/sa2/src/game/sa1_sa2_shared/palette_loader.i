# 0 "src/game/sa1_sa2_shared/palette_loader.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/palette_loader.c"
...
# 2 "src/game/sa1_sa2_shared/palette_loader.c" 2
# 1 "include/task.h" 1
...
# 3 "src/game/sa1_sa2_shared/palette_loader.c" 2
...
# 4 "src/game/sa1_sa2_shared/palette_loader.c" 2
...
# 6 "src/game/sa1_sa2_shared/palette_loader.c" 2
...
struct Task *CreatePaletteLoaderTask(u16 priority, AnimId anim, u8 variant, TaskDestructor dtor)
{
    ...
    s->y = 0;
    s->graphics.dest = 
# 22 "src/game/sa1_sa2_shared/palette_loader.c" 3 4
                      ((void *)0)
# 22 "src/game/sa1_sa2_shared/palette_loader.c"
                          ;
    s->oamFlags = ((0) << 6);
    s->graphics.size = 0;
