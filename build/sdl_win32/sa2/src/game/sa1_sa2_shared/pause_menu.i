...
void Task_PauseMenuUpdate(void)
{
    ...
    if (pm->cursor != 0) {
        DmaSet(3, pm->pal6A, &(((u16 *)((u16*)&PLTT[0x200/sizeof(uint16_t)]))[249]), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8))));
        DmaSet(3, pm->pal64, &(((u16 *)((u16*)&PLTT[0x200/sizeof(uint16_t)]))[252]), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8))));

        if (gWater.isActive == 1) {
            u16 *somePalette = (void *)((gWater.t)->data);

            DmaSet(3, pm->pal6A, &somePalette[249], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8))));
            DmaSet(3, pm->pal64, &somePalette[252], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8))));
        }
    } else {
        DmaSet(3, pm->pal6A, &(((u16 *)((u16*)&PLTT[0x200/sizeof(uint16_t)]))[252]), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8))));
        DmaSet(3, pm->pal64, &(((u16 *)((u16*)&PLTT[0x200/sizeof(uint16_t)]))[249]), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8))));

        if (gWater.isActive == 1) {
            u16 *somePalette = (void *)((gWater.t)->data);

            DmaSet(3, pm->pal6A, &somePalette[252], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8))));
            DmaSet(3, pm->pal64, &somePalette[249], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8))));
        }
    }
...
void Task_PauseMenuInit(void)
{
    ...
    gFlags |= 0x400;
    DmaSet(3, &gObjPalette[(15)*16u + (+9)], pm->pal64, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8))));
    DmaSet(3, &gObjPalette[(15)*16u + (+12)], pm->pal6A, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8))));
...
{
    DmaSet(3, &Tileset_zone_1_act_1_fg[(4 * 16 * 32) / sizeof(u16)], (void *)(&VRAM[0x14000] + 0x3EC0), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x140)/(16/8))));
