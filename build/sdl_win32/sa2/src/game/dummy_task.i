# 0 "src/game/dummy_task.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/dummy_task.c"
# 1 "include/core.h" 1
...
# 2 "src/game/dummy_task.c" 2
# 1 "include/task.h" 1
# 3 "src/game/dummy_task.c" 2
...
# 1 "include/global.h" 1
# 5 "include/game/dummy_task.h" 2

void CreateDummyTask(void);


extern struct Task *gDummyTask;
# 5 "src/game/dummy_task.c" 2
...
# 6 "src/game/dummy_task.c" 2

struct Task *gDummyTask = 
# 7 "src/game/dummy_task.c" 3 4
                         ((void *)0)
# 7 "src/game/dummy_task.c"
                             ;
...
__attribute__((unused)) static void DestroyDummyTask(void)
{
    ...
    gDummyTask = 
# 17 "src/game/dummy_task.c" 3 4
                ((void *)0)
# 17 "src/game/dummy_task.c"
                    ;
}

static void Task_DummyFunc(void) { }

__attribute__((unused)) static void DummyTaskOnDestroy(struct Task *task) { gDummyTask = 
# 22 "src/game/dummy_task.c" 3 4
                                                                       ((void *)0)
# 22 "src/game/dummy_task.c"
                                                                           ; }
