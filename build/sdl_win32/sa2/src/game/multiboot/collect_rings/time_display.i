# 0 "src/game/multiboot/collect_rings/time_display.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiboot/collect_rings/time_display.c"
# 1 "include/core.h" 1
...
# 2 "src/game/multiboot/collect_rings/time_display.c" 2
# 1 "include/malloc_vram.h" 1
# 3 "src/game/multiboot/collect_rings/time_display.c" 2
# 1 "include/flags.h" 1
# 4 "src/game/multiboot/collect_rings/time_display.c" 2
...
# 6 "src/game/multiboot/collect_rings/time_display.c" 2
...
# 7 "src/game/multiboot/collect_rings/time_display.c" 2
...
# 9 "src/game/multiboot/collect_rings/time_display.c" 2
...
void sub_8082E9C(TimeDisplay *timeDisplay)
{
    ...
    temp = ({((60) != 0) ? ((s32)(gCourseTime) / (s32)(60)) : 0;});
    index = gCourseTime - (temp * 60);
    temp *= 0x10000;
    temp /= 0x10000;
    digit1 = gUnknown_080E0234[index];

    temp2 = ({((60) != 0) ? ((s32)(temp) / (s32)(60)) : 0;});
    temp -= (temp2 * 60);
    temp *= 0x10000;
    while (0)
        ;
...
void sub_8083104(TimeDisplay *timeDisplay)
{
    ...
    temp = ({((60) != 0) ? ((s32)(gCollectRingsLastLapTime) / (s32)(60)) : 0;});
...
void sub_808328C(void)
{
    if (!(gStageFlags & 0x0400)) {
        TimeDisplay *timeDisplay = (void *)((gCurTask)->data);
...
{
    TimeDisplay *timeDisplay = (void *)((t)->data);
