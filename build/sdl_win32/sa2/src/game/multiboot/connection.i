# 0 "src/game/multiboot/connection.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiboot/connection.c"
...
# 2 "src/game/multiboot/connection.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiboot/connection.c" 2
# 1 "include/flags.h" 1
# 4 "src/game/multiboot/connection.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/multiboot/connection.c" 2
# 1 "include/task.h" 1
# 6 "src/game/multiboot/connection.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/multiboot/connection.c" 2
# 1 "include/mb_programs.h" 1
...
# 8 "src/game/multiboot/connection.c" 2
...
# 9 "src/game/multiboot/connection.c" 2
...
# 10 "src/game/multiboot/connection.c" 2
...
# 11 "src/game/multiboot/connection.c" 2
...
# 12 "src/game/multiboot/connection.c" 2
...
# 13 "src/game/multiboot/connection.c" 2
...
# 14 "src/game/multiboot/connection.c" 2
...
# 15 "src/game/multiboot/connection.c" 2
...
# 16 "src/game/multiboot/connection.c" 2
...
# 17 "src/game/multiboot/connection.c" 2
...
# 18 "src/game/multiboot/connection.c" 2
...
# 20 "src/game/multiboot/connection.c" 2
...
# 21 "src/game/multiboot/connection.c" 2
...
# 22 "src/game/multiboot/connection.c" 2
...
# 23 "src/game/multiboot/connection.c" 2
...
# 24 "src/game/multiboot/connection.c" 2
# 1 "include/game/dummy_task.h" 1
...
# 25 "src/game/multiboot/connection.c" 2
...
# 27 "src/game/multiboot/connection.c" 2
...
# 29 "src/game/multiboot/connection.c" 2
# 1 "include/constants/songs.h" 1
# 30 "src/game/multiboot/connection.c" 2
# 1 "include/constants/text.h" 1
# 31 "src/game/multiboot/connection.c" 2
# 1 "include/constants/tilemaps.h" 1
# 32 "src/game/multiboot/connection.c" 2
...
# 63 "src/game/multiboot/connection.c"
...
void *const gCollectRingsSegments[9] = {
    ...
    (void *)gCollectRingsRom_Compressed + 0x8000 * 0,
    (void *)gCollectRingsRom_Compressed + 0x8000 * 1,
    (void *)gCollectRingsRom_Compressed + 0x8000 * 2,
    ...
    (void *)gCollectRingsTilemaps + (0x8000 * 1),


    (void *)gCollectRingsTilemaps + (0x8000 * 0),
};
...
void *const gUnknown_080E01E0[7][2] = {
    { 
# 130 "src/game/multiboot/connection.c" 3 4
     ((void *)0)
# 130 "src/game/multiboot/connection.c"
         , 
# 130 "src/game/multiboot/connection.c" 3 4
           ((void *)0) 
# 130 "src/game/multiboot/connection.c"
...
# 239 "src/game/multiboot/connection.c"
void sub_8081200(void)
{
    u8 i;
    ...
    gRingsScatterTask = 
# 245 "src/game/multiboot/connection.c" 3 4
                       ((void *)0)
# 245 "src/game/multiboot/connection.c"
                           ;
    gDummyTask = 
# 246 "src/game/multiboot/connection.c" 3 4
                ((void *)0)
# 246 "src/game/multiboot/connection.c"
                    ;
    gGameStageTask = 
# 247 "src/game/multiboot/connection.c" 3 4
                    ((void *)0)
# 247 "src/game/multiboot/connection.c"
                        ;
    gPlayer.spriteTask = 
# 248 "src/game/multiboot/connection.c" 3 4
                        ((void *)0)
# 248 "src/game/multiboot/connection.c"
                            ;



    gCamera.movementTask = 
# 252 "src/game/multiboot/connection.c" 3 4
                          ((void *)0)
# 252 "src/game/multiboot/connection.c"
                              ;
    gUnknown_0300543C = 0;
...
# 257 "src/game/multiboot/connection.c" 3 4
                          ((void *)0)
# 257 "src/game/multiboot/connection.c"
                              ;

    for (i = 0; i < 4; i++) {
        gMultiplayerPlayerTasks[i] = 
# 260 "src/game/multiboot/connection.c" 3 4
                                    ((void *)0)
# 260 "src/game/multiboot/connection.c"
                                        ;
    };
...
void StartSinglePakConnect(void)
{
    ...
    t = TaskCreate(sub_8081604, sizeof(struct SinglePakConnectScreen), 0x2000, 0, 
# 292 "src/game/multiboot/connection.c" 3 4
                                                                                 ((void *)0)
# 292 "src/game/multiboot/connection.c"
                                                                                     );
    connectScreen = (void *)((t)->data);
    connectScreen->unkFA = (gLoadedSaveGame)->language;

    if ((u8)(connectScreen->unkFA - 1) > (6 - 1)) {
...
void sub_8081604(void)
{
    struct SinglePakConnectScreen *connectScreen = (void *)((gCurTask)->data);
    s8 result;
    s32 multiBootFlags;
    ...
    if (connectScreen->unkF0 == 0 && gPressedKeys & 0x0002) {
        m4aSongNumStop(61);
        m4aSongNumStart(107);
    ...
    if (multiBootFlags == 0x50 || multiBootFlags == 0x60
        || multiBootFlags == 0x70 || multiBootFlags == 0x71) {
        TasksDestroyInPriorityRange(0, 0xFFFF);
        gBackgroundsCopyQueueCursor = gBackgroundsCopyQueueIndex;;
        gBgSpritesCount = 0;
        gVramGraphicsCopyCursor = gVramGraphicsCopyQueueIndex;;
...
void sub_80818B8(void)
{
    ...
    u32 temp;
    struct SinglePakConnectScreen *connectScreen = (void *)((gCurTask)->data);
    if (gMultiSioStatusFlags & 0x0020 && connectScreen->unkF9 < (sizeof(gCollectRingsSegments) / sizeof((gCollectRingsSegments)[0]))) {
    ...
    temp = ((gMultiSioStatusFlags & (0x0100 | 0x0200 | 0x0400 | 0x0800))
            >> 8);
...
void sub_8081AD4(struct SinglePakConnectScreen *connectScreen)
{
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, &gBgPalette[(1)*16u + (1)], 0x00000000 | 0x01000000 | (((((0) << 10) | ((0) << 5) | (30)))/(16/8) & 0x1FFFFF)); };

    gDispCnt |= (0x0200 | 0x2000);
    temp = ((31) << 8) | (1);
    gBgScrollRegs[1][0] = 0;
    gBgScrollRegs[1][1] = 0;
    gWinRegs[0] = (((40) << 16) | (40));
    gWinRegs[2] = (((136) << 16) | (144));
    gWinRegs[4] = 2;
    gWinRegs[5] = 1;
    gBgCntRegs[1] = temp;

    { vu16 tmp = (vu16)(0xF3FF); CpuSet((void *)&tmp, (void *)(((u8*)&VRAM[0]) + (0x800 * (31))), 0x00000000 | 0x01000000 | ((2049)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(0xFFFF); CpuSet((void *)&tmp, (void *)VRAM + 1023 * 32, 0x00000000 | 0x01000000 | ((32)/(16/8) & 0x1FFFFF)); };

    gBgPalette[(15)*16u + (15)] = (((31) | ((0) << 5) | ((0) << 10)));;
    gFlags |= 0x1;
}
...
void sub_8081D04(void)
{
    ...
    Sio32MultiLoadInit(gMultiSioStatusFlags & 0x0080, gCollectRingsSegments[connectScreen->unkF9]);
...
s8 sub_8081D70(__attribute__((unused)) struct SinglePakConnectScreen *connectScreen)
{
    u8 i;
    s8 result;

    for (result = 1, i = 1; i < 4; i++) {
        if ((((gMultiBootParam.response_bit) >> (i)) & 1) && (((gMultiBootParam.client_bit) >> (i)) & 1)) {
            result++;
        }
    }
...
void sub_8081DF0(struct SinglePakConnectScreen *connectScreen, u8 a)
{
    ...
    connectScreen->unk6C.graphics.anim = 1074;
    connectScreen->unk6C.variant = a + 6;
...
{
    if ((0x0001 << (id + 8)) & gMultiSioStatusFlags) {
        if (!((0x0001 << (id)) & gMultiSioStatusFlags)) {
...
{
    u8 val = (connectScreen->unkE4 * 240) / 0x12000;
