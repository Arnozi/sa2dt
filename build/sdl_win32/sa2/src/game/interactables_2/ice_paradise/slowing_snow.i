...
void CreateEntity_SlowingSnow(MapEntity *in_ia, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_SlowingSnow *snow = (void *)((t)->data);
    MapEntity *me = in_ia;
...
{
    Sprite_SlowingSnow *snow = (void *)((gCurTask)->data);
...
static bool32 ShouldDespawn(Sprite_SlowingSnow *snow)
{
    ...
    if ((screenX + snow->right < -(256 / 2)) || (screenX + snow->left > 426 + (256 / 2))
        || (screenY + snow->bottom < -(256 / 2)) || (screenY + snow->top > ((240) + ((256) / 2))))
        return 1;
