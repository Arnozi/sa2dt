...
static void CreateEntity_HalfPipe(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, s32 direction)
{
    ...
    Sprite_IceParadiseHalfPipe *halfPipe = (void *)((t)->data);
...
{
    Sprite_IceParadiseHalfPipe *halfPipe = (void *)((gCurTask)->data);
...
static bool32 ShouldDespawn(Sprite_IceParadiseHalfPipe *halfPipe)
{
    ...
    if (x + halfPipe->width < -128 || x + halfPipe->offsetX > (426 + 128) || y + halfPipe->height < -128
        || y + halfPipe->offsetY > (240 + 128)) {
        return 1;
    }
    return 0;
}
