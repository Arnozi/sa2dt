...
bool32 sub_8079624(Sprite_IA69 *ia69)
{
    ...
    temp2 = temp1;
    temp3 = temp;
    if ((temp2 + ia69->unk1B0) < -128 || (temp2 + ia69->unk1AC) > (426 + 128) || (temp3 + ia69->unk1B2) < -128
        || (temp3 + ia69->unk1AE) > (240 + 128)) {
        return 1;
    }
...
void Task_Interactable069(void)
{
    Sprite_IA69 *ia69 = (void *)((gCurTask)->data);
    sub_80791B4(ia69);
