...
void CreateEntity_WindUpStick(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_WindUpStick *windUpStick = (void *)((t)->data);
    windUpStick->unk11 = 0;
...
{
    Sprite_WindUpStick *windUpStick = (void *)((gCurTask)->data);
...
bool32 sub_8072A5C(Sprite_WindUpStick *windUpStick)
{
    ...
    if (x + windUpStick->unkC < -128 || x + windUpStick->unk8 > (426 + 128) || y + windUpStick->unkE < -128
        || y + windUpStick->unkA > (240 + 128)) {
        return 1;
    }
    return 0;
}
