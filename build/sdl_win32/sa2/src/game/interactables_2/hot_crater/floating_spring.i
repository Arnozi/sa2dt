# 0 "src/game/interactables_2/hot_crater/floating_spring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/hot_crater/floating_spring.c"
...
# 2 "src/game/interactables_2/hot_crater/floating_spring.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/hot_crater/floating_spring.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/hot_crater/floating_spring.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/interactables_2/hot_crater/floating_spring.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/hot_crater/floating_spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/hot_crater/floating_spring.c" 2
...
# 8 "src/game/interactables_2/hot_crater/floating_spring.c" 2
...
# 11 "src/game/interactables_2/hot_crater/floating_spring.c" 2
...
# 13 "src/game/interactables_2/hot_crater/floating_spring.c" 2
# 1 "include/constants/player_transitions.h" 1
# 14 "src/game/interactables_2/hot_crater/floating_spring.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/interactables_2/hot_crater/floating_spring.c" 2
...
void CreateEntity_FloatingSpring_Up(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_FloatingSpring *floatingSpring = (void *)((t)->data);
...
static void sub_8074E44(Sprite_FloatingSpring *floatingSpring)
{
    ...
    if (floatingSpring->unk52 != 0) {
        ...
        floatingSpring->unk44 = ((gSineTable[((floatingSpring->unk52 * ((gStageTime + floatingSpring->unk56) & 255)) & (1024 - 1))]) * temp) >> 15;
    }

    if (floatingSpring->unk54 != 0) {
        s32 temp = me->d.uData[3] * 2048;
        floatingSpring->unk48 = ((gSineTable[((floatingSpring->unk54 * ((gStageTime + floatingSpring->unk56) & 255)) & (1024 - 1))]) * temp) >> 15;
    }

    floatingSpring->unk3C = ((floatingSpring->base.meX)*8 + (floatingSpring->base.regionX)*256) + ((int)((floatingSpring->unk44) >> 8));
    floatingSpring->unk40 = ((me->y)*8 + (floatingSpring->base.regionY)*256) + ((int)((floatingSpring->unk48) >> 8));
}
...
static u32 sub_8074EF4(Sprite_FloatingSpring *floatingSpring)
{
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if (temp != 0) {
            if (((int)((gPlayer.qWorldY) >> 8)) < floatingSpring->unk40) {
                gPlayer.qWorldY += ((s32)((floatingSpring->s.hitboxes[0].top)*256));
...
static void sub_8074FD8(Sprite_FloatingSpring *floatingSpring)
{
    ...
    if (floatingSpring->unk50) {
        ...
        if (((gCurrentLevel) >> 2) == 2) {
            floatingSpring->s.graphics.anim = 571;
            floatingSpring->s.variant = 0;
        } else {
            floatingSpring->s.graphics.anim = 568;
            floatingSpring->s.variant = 0;
        }
    } else {
        if (((gCurrentLevel) >> 2) == 2) {
...
static void sub_80750A8(void)
{
    Sprite_FloatingSpring *floatingSpring = (void *)((gCurTask)->data);
...
bool32 sub_80751CC(Sprite_FloatingSpring *floatingSpring)
{
    ...
    if (x < -((me->d.uData[2] * 8) + (256 / 2))
        || x > (me->d.uData[2] * 8) + (426 + (256 / 2)) || y < -((me->d.uData[3] * 8) + 128)
        || y > (me->d.uData[3] * 8) + (240 + 384)) {
        return 1;
    }
...
bool32 sub_8075228(Sprite_FloatingSpring *floatingSpring)
{
    ...
    if (((x < -((me->d.uData[2] * 8) + (256 / 2))) || (x > 426 + ((me->d.uData[2] * 8) + (256 / 2))) || (y < -((me->d.uData[3] * 8) + (256 / 2))) || (y > 240 + ((me->d.uData[3] * 8) + (256 / 2))))
                                                                                 ) {
        return 1;
    }
...
static void sub_80752BC(Sprite_FloatingSpring *floatingSpring)
{
    if (floatingSpring->unk4C) {
        ...
        floatingSpring->s.graphics.dest = 
# 327 "src/game/interactables_2/hot_crater/floating_spring.c" 3 4
                                         ((void *)0)
# 327 "src/game/interactables_2/hot_crater/floating_spring.c"
                                             ;
        floatingSpring->unk4C = 0;
    }
}
