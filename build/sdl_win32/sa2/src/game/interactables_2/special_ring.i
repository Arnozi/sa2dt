# 0 "src/game/interactables_2/special_ring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/special_ring.c"
...
# 2 "src/game/interactables_2/special_ring.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_2/special_ring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_2/special_ring.c" 2
...
# 5 "include/game/player_callbacks.h" 2
...
# 6 "include/game/player_callbacks.h" 2
...
# 6 "src/game/interactables_2/special_ring.c" 2
...
# 7 "src/game/interactables_2/special_ring.c" 2
...
# 8 "src/game/interactables_2/special_ring.c" 2
...
# 9 "src/game/interactables_2/special_ring.c" 2
# 1 "include/task.h" 1
# 10 "src/game/interactables_2/special_ring.c" 2


# 1 "include/flags.h" 1
# 13 "src/game/interactables_2/special_ring.c" 2
...
# 14 "src/game/interactables_2/special_ring.c" 2
...
# 17 "src/game/interactables_2/special_ring.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_2/special_ring.c" 2
...
void CreateEntity_SpecialRing(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
        ...
        Sprite_SpecialRing *ring = (void *)((t)->data);
        Sprite *s;

        ring->worldX = ((me->x)*8 + (spriteRegionX)*256);
        ring->worldY = ((me->y)*8 + (spriteRegionY)*256);
...
static bool32 IsTouchingPlayer(Sprite_SpecialRing *ring)
{
    ...
    if (!(gPlayer.moveState & 0x00000080)) {
        ...
        if (flags & 0xF0000) {
            ...
            if (cheese != 
# 79 "src/game/interactables_2/special_ring.c" 3 4
                         ((void *)0)
# 79 "src/game/interactables_2/special_ring.c"
                             )

            {
                s32 somePosX, somePosY;
                u16 posX, posY;
                somePosX = ((int)((cheese->posX) >> 8)) + 16;
                somePosX -= ring->worldX;

                somePosY = ((int)((cheese->posY) >> 8)) + 32;
...
static void Task_SpecialRingVisible(void)
{
    Sprite_SpecialRing *ring = (void *)((gCurTask)->data);

    if (gPlayer.character == CHARACTER_CREAM) {
        Player_UpdateHomingPosition(((s32)((ring->worldX)*256)), ((s32)((ring->worldY)*256)));
    }
...
static void CollectRing(Sprite_SpecialRing *ring)
{
    ...
    ring->displayed.graphics.anim = 730;
    ring->displayed.variant = 1;
    m4aSongNumStart(298);
...
static bool32 ShouldDespawn(Sprite_SpecialRing *ring)
{
    ...
    u16 posX, posY;
    screenPosX = (ring->worldX + (256 / 2));
    screenPosX -= gCamera.x;

    screenPosY = (ring->worldY + (256 / 2));
...
static void Task_SpecialRingCollected(void)
{
    ...
    if ((s->frameFlags & ((1) << (14))) || ShouldDespawn(ring)) {
        Despawn(ring, 0);
    } else {
        Render(ring);
    }
