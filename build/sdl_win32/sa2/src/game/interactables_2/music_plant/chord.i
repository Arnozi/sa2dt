...
void CreateEntity_Chord(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Chord *chord = (void *)((t)->data);
    Sprite *s = &chord->s;
    u16 i;
    ...
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x3700);
    s->graphics.anim = 575;
    s->variant = 15;
...
{
    u8 r7 = 0;
    Sprite_Chord *chord = (void *)((gCurTask)->data);
    u8 i;
...
static bool32 ShouldDespawn(Sprite_Chord *chord)
{
    ...
    if (((otherX < -((256 + ((6 * 8) / 2)) / 2)) || (otherX > 426 + ((256 + ((6 * 8) / 2)) / 2)) || (otherY < -(256 / 2)) || (otherY > 240 + (256 / 2)))) {
        return 1;
    }
