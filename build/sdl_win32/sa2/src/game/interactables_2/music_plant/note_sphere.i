...
void CreateEntity_NoteSphere(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_NoteSphere *note = (void *)((t)->data);
    Sprite *s = &note->disp;
    note->unk44 = 0;
    note->unk46 = 0;
    ...
    s->graphics.dest = &((u8 *)&VRAM[0x10000])[sNoteSphereAnimInfo[note->kind][2] * 32];
...
{
    Sprite_NoteSphere *note = (void *)((gCurTask)->data);
