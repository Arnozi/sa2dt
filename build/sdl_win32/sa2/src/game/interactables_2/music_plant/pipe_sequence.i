# 0 "src/game/interactables_2/music_plant/pipe_sequence.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/music_plant/pipe_sequence.c"
...
# 2 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
# 1 "include/trig.h" 1
...
# 4 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
...
# 5 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
...
# 7 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
...
# 10 "src/game/interactables_2/music_plant/pipe_sequence.c" 2

# 1 "include/data/handlers_ia_pipe_horn_sequences.h" 1
...
# 6 "include/data/handlers_ia_pipe_horn_sequences.h" 2

extern const PipeSegment *gUnknown_08C8793C[9];
extern const PipeSegment *gUnknown_08C87960[3];
# 12 "src/game/interactables_2/music_plant/pipe_sequence.c" 2

# 1 "include/constants/char_states.h" 1
# 14 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
# 1 "include/constants/player_transitions.h" 1
# 15 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/game/interactables_2/music_plant/pipe_sequence.c" 2
...
static const PipeHandler sHandlers[16] = {
    [0] = PipeSegmentHandler_Translate,
...
# 43 "src/game/interactables_2/music_plant/pipe_sequence.c" 3 4
   ((void *)0)
# 43 "src/game/interactables_2/music_plant/pipe_sequence.c"
       ,
    
# 44 "src/game/interactables_2/music_plant/pipe_sequence.c" 3 4
   ((void *)0)
# 44 "src/game/interactables_2/music_plant/pipe_sequence.c"
       ,
    
# 45 "src/game/interactables_2/music_plant/pipe_sequence.c" 3 4
   ((void *)0)
# 45 "src/game/interactables_2/music_plant/pipe_sequence.c"
       ,
    
# 46 "src/game/interactables_2/music_plant/pipe_sequence.c" 3 4
   ((void *)0)
# 46 "src/game/interactables_2/music_plant/pipe_sequence.c"
       ,
    
# 47 "src/game/interactables_2/music_plant/pipe_sequence.c" 3 4
   ((void *)0)
# 47 "src/game/interactables_2/music_plant/pipe_sequence.c"
       ,
};
...
static void PipeSegmentHandler_Translate(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        u32 nextType;
        pipeSequence->accumulator -= 1024;
...
static void Handler_MusicPlant_Pipe_1(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    u16 sinIndex = (((int)((((double)(90)) / 360.0) * 1024)) - index) & (1024 - 1);

    cos = ((int)(((gSineTable[(sinIndex) + 256])) >> 6));
    pipeSequence->currentX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX;

    sin = ((int)(((gSineTable[(sinIndex)])) >> 6));
    pipeSequence->currentY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY - r5;
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        ...
        cos = ((int)((gSineTable[((int)((((double)(0)) / 360.0) * 1024)) + 256]) >> 6));
        pipeSequence->segmentBaseX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX;

        sin = ((int)((gSineTable[((int)((((double)(0)) / 360.0) * 1024))]) >> 6));
        pipeSequence->segmentBaseY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY - r5;
...
static void Handler_MusicPlant_Pipe_2(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    s32 r5 = data[pipeSequence->index].d._32;
    u32 index = ((u16)pipeSequence->accumulator >> 2);
    u16 sinIndex = (((int)((((double)(270)) / 360.0) * 1024)) + index) & (1024 - 1);
...
static void Handler_MusicPlant_Pipe_3(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    s32 r5 = data[pipeSequence->index].d._32;
    u32 index = ((u16)pipeSequence->accumulator >> 2);
    u16 sinIndex = (index)&(1024 - 1);

    cos = ((int)(((gSineTable[(sinIndex) + 256])) >> 6));
    pipeSequence->currentX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX - r5;

    sin = ((int)(((gSineTable[(sinIndex)])) >> 6));
    pipeSequence->currentY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY;
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        ...
        cos = ((int)((gSineTable[((int)((((double)(90)) / 360.0) * 1024)) + 256]) >> 6));
        pipeSequence->segmentBaseX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX - r5;

        sin = ((int)((gSineTable[((int)((((double)(90)) / 360.0) * 1024))]) >> 6));
        pipeSequence->segmentBaseY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY;
...
static void Handler_MusicPlant_Pipe_4(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    s32 r5 = data[pipeSequence->index].d._32;
    u32 index = ((u16)pipeSequence->accumulator >> 2);
    u16 sinIndex = (((int)((((double)(180)) / 360.0) * 1024)) - index) & (1024 - 1);
...
static void Handler_MusicPlant_Pipe_5(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    s32 r5 = data[pipeSequence->index].d._32;
    u32 index = ((u16)pipeSequence->accumulator >> 2);
    u16 sinIndex = (index + ((int)((((double)(90)) / 360.0) * 1024))) & (1024 - 1);
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        ...
        cos = ((int)((gSineTable[((int)((((double)(180)) / 360.0) * 1024)) + 256]) >> 6));
        pipeSequence->segmentBaseX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX;

        sin = ((int)((gSineTable[((int)((((double)(180)) / 360.0) * 1024))]) >> 6));
        pipeSequence->segmentBaseY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY - r5;
...
static void Handler_MusicPlant_Pipe_7(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    s32 r5 = data[pipeSequence->index].d._32;
    u32 index = ((u16)pipeSequence->accumulator >> 2);
    u16 sinIndex = (((int)((((double)(360)) / 360.0) * 1024)) - index) & (1024 - 1);
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        ...
        cos = ((int)((gSineTable[((int)((((double)(270)) / 360.0) * 1024)) + 256]) >> 6));
        pipeSequence->segmentBaseX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX - r5;

        sin = ((int)((gSineTable[((int)((((double)(270)) / 360.0) * 1024))]) >> 6));
        pipeSequence->segmentBaseY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY;
...
static void Handler_MusicPlant_Pipe_8(PipeSequence *pipeSequence, const PipeSegment data[])
{
    s16 sin, cos;
    s32 r5 = data[pipeSequence->index].d._32;
    u16 sinIndex = (((u16)pipeSequence->accumulator >> 2) + 512) & (1024 - 1);
...
static void Handler_MusicPlant_Pipe_9(PipeSequence *pipeSequence, const PipeSegment data[])
{
    ...
    u16 sinIndex = (((u16)pipeSequence->accumulator >> 3) + ((int)((((double)(315)) / 360.0) * 1024))) & (1024 - 1);

    cos = ((int)(((gSineTable[(sinIndex) + 256])) >> 6));
    r8 = r7 * cos;

    sin = ((int)((gSineTable[((int)((((double)(135)) / 360.0) * 1024))]) >> 6));
    r9 = r7 * sin;
    pipeSequence->currentX = ((int)((r8 - r9) >> 8)) + pipeSequence->segmentBaseX;

    sin2 = (((int)(((gSineTable[(sinIndex)])) >> 6)) + ((int)((gSineTable[((int)((((double)(45)) / 360.0) * 1024))]) >> 6)));
    pipeSequence->currentY = ((int)((sin2 * r7) >> 8)) + pipeSequence->segmentBaseY;
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        ...
        cos = ((int)((gSineTable[((int)((((double)(90)) / 360.0) * 1024))]) >> 6)) * r7;
        pipeSequence->segmentBaseX = ((int)((cos - r9) >> 8)) + pipeSequence->segmentBaseX;

        pipeSequence->segmentBaseY = ((int)(((((int)((gSineTable[((int)((((double)(0)) / 360.0) * 1024))]) >> 6)) + ((int)((gSineTable[((int)((((double)(45)) / 360.0) * 1024))]) >> 6))) * r7) >> 8)) + pipeSequence->segmentBaseY;
...
static void Handler_MusicPlant_Pipe_10(PipeSequence *pipeSequence, const PipeSegment data[])
{
    s16 sin, cos;
    s32 r5 = data[pipeSequence->index].d._32;
    u16 sinIndex = (((u16)pipeSequence->accumulator >> 3) + 512) & (1024 - 1);
    ...
    if (pipeSequence->accumulator >= (unsigned)1024) {
        ...
        cos = ((int)((gSineTable[((int)((((double)(225)) / 360.0) * 1024)) + 256]) >> 6));
        pipeSequence->segmentBaseX = ((int)((cos * r5) >> 8)) + pipeSequence->segmentBaseX + r5;

        sin = ((int)((gSineTable[((int)((((double)(225)) / 360.0) * 1024))]) >> 6));
        pipeSequence->segmentBaseY = ((int)((sin * r5) >> 8)) + pipeSequence->segmentBaseY;
