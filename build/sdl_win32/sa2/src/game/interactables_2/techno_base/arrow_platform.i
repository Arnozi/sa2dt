...
{
    u8 someBool = 0;
    Sprite_IA75 *ia75 = (void *)((gCurTask)->data);
...
static bool32 sub_807A920(Sprite_IA75 *ia75)
{
    ...
    if ((x + ia75->offsetX + 24) < -128 || (x + ia75->width - 24) > (426 + 128) || (y + ia75->offsetY + 24) < -128
        || (y + ia75->height - 24) > (240 + 128)) {
        return 1;
    }
    return 0;
}
