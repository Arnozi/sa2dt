# 0 "src/game/interactables_2/techno_base/bounce_block.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/techno_base/bounce_block.c"
...
# 2 "src/game/interactables_2/techno_base/bounce_block.c" 2
...
# 6 "include/game/interactables_2/music_plant/note_block.h" 2

void CreateEntity_NoteBlock(MapEntity *, u16, u16, u8);
# 3 "src/game/interactables_2/techno_base/bounce_block.c" 2
# 1 "include/trig.h" 1
...
# 4 "src/game/interactables_2/techno_base/bounce_block.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/techno_base/bounce_block.c" 2
...
# 9 "src/game/interactables_2/techno_base/bounce_block.c" 2
# 1 "include/constants/char_states.h" 1
# 10 "src/game/interactables_2/techno_base/bounce_block.c" 2
# 1 "include/constants/player_transitions.h" 1
# 11 "src/game/interactables_2/techno_base/bounce_block.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/game/interactables_2/techno_base/bounce_block.c" 2
...
static const u16 gUnknown_080E001A[][4] = {
    { ((s16)((6)*256)), ((s16)((250)*256)), ((s16)((250)*256)), ((s16)((6)*256)) },
    { ((s16)((7)*256)), ((s16)((249)*256)), ((s16)((249)*256)), ((s16)((7)*256)) },
    { ((s16)((8)*256)), ((s16)((248)*256)), ((s16)((248)*256)), ((s16)((8)*256)) },
};
...
void CreateEntity_BounceBlock(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_TecBaseNoteBlock *noteBlock = (void *)((t)->data);
    ...
    s->frameFlags = 0x2000;
    s->graphics.dest = (void *)&VRAM[0x10000] + sNoteBlockAssets[noteBlock->unk4C][2] * 0x20;
    s->graphics.anim = sNoteBlockAssets[noteBlock->unk4C][0];
    s->variant = sNoteBlockAssets[noteBlock->unk4C][1];

    noteBlock->unk3C = ((me->x)*8 + (spriteRegionX)*256);
    noteBlock->unk40 = ((me->y)*8 + (spriteRegionY)*256);
...
{
    Sprite_TecBaseNoteBlock *noteBlock = (void *)((gCurTask)->data);

    switch (noteBlock->unk4E++) {
        case 0:
            noteBlock->unk44 = ((int)(((gSineTable[(noteBlock->unk4D * 4) + 256])) >> 6)) * 8;
            noteBlock->unk48 = ((int)(((gSineTable[(noteBlock->unk4D * 4)])) >> 6)) * 8;
            break;
        case 4:
            noteBlock->unk44 = ((int)(((gSineTable[(noteBlock->unk4D * 4) + 256])) >> 6)) * -2;
            noteBlock->unk48 = ((int)(((gSineTable[(noteBlock->unk4D * 4)])) >> 6)) * -2;
            break;
        case 6:
            noteBlock->unk44 = 0;
            noteBlock->unk48 = 0;
...
static bool32 sub_8079AC4(Sprite_TecBaseNoteBlock *noteBlock)
{
    ...
    if (!(gPlayer.moveState & 0x00000080)) {
        temp1 = ((int)((gPlayer.qWorldX) >> 8));
        temp1 += 24;
        temp1 -= noteBlock->unk3C;

        temp2 = ((int)((gPlayer.qWorldY) >> 8));
        temp2 += 16;
        ...
        if (temp3 < 49 && temp4 < 33) {
            ...
            if (gPlayer.stoodObj == &noteBlock->s) {
                gPlayer.stoodObj = 
# 172 "src/game/interactables_2/techno_base/bounce_block.c" 3 4
                                  ((void *)0)
# 172 "src/game/interactables_2/techno_base/bounce_block.c"
                                      ;
...
static void sub_8079D00(Sprite_TecBaseNoteBlock *noteBlock)
{
    ...
    s->x = noteBlock->unk3C - gCamera.x + ((int)((noteBlock->unk44) >> 8));
    s->y = noteBlock->unk40 - gCamera.y + ((int)((noteBlock->unk48) >> 8));
}
...
static bool32 sub_8079D60(Sprite_TecBaseNoteBlock *noteBlock)
{
    ...
    if (temp3 > (128 + (426 + 128)) || temp4 > (128 + (240 + 128))) {
        return 1;
    }
    return 0;
}
