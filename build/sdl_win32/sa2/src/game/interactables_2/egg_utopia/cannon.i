...
void CreateEntity_Cannon(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Cannon *cannon = (void *)((t)->data);
    ...
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x2C80;
    s->graphics.anim = 616;
    s->variant = 1;
...
{
    Sprite_Cannon *cannon = (void *)((gCurTask)->data);
...
static bool32 ShouldDespawn(Sprite_Cannon *cannon)
{
    ...
    if (((x < -((256 / 2))) || (x > 426 + ((256 / 2))) || (y < -((256 / 2))) || (y > 240 + ((256 / 2))))) {
        return 1;
    }
