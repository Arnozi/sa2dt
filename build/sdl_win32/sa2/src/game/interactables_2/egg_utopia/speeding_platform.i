# 0 "src/game/interactables_2/egg_utopia/speeding_platform.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/egg_utopia/speeding_platform.c"
...
# 2 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
# 1 "include/task.h" 1
# 5 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
...
# 9 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
...
# 10 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
...
# 15 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
...
# 17 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
# 1 "include/constants/player_transitions.h" 1
# 18 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
# 1 "include/constants/songs.h" 1
# 19 "src/game/interactables_2/egg_utopia/speeding_platform.c" 2
...
void CreateEntity_SpeedingPlatform(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_SpeedingPlatform *platform = (void *)((t)->data);
    Sprite *s;
    platform->unk54 = 0;
    platform->unk58 = 0;
    platform->unk5A = 0;
    ...
    platform->x = ((me->x)*8 + (spriteRegionX)*256);
    platform->y = ((me->y)*8 + (spriteRegionY)*256);

    platform->unk44 = ((s32)((32)*256));
    platform->unk48 = ((s32)((18)*256));
...
{
    Sprite_SpeedingPlatform *platform = (void *)((gCurTask)->data);
    ...
    if (platform->unk4C && platform->unk5A > -1) {
        s32 res = sub_801F100(platform->y + ((int)((platform->unk48) >> 8)), platform->x + ((int)((platform->unk44) >> 8)), 1, 8, sub_801EC3C);
        if (res < 0) {
            platform->unk4C = 0;
...
{
    platform->unk44 = ((s32)((814)*256));
    platform->unk48 = ((s32)((576)*256));

    platform->unk5E = 224;
    platform->unk5C = ((s32)((8)*256));
    platform->unk58 = ((int)(((gSineTable[(platform->unk5E * 4) + 256])) >> 6)) * 8;
    platform->unk5A = ((int)((platform->unk5C * ((int)(((gSineTable[(platform->unk5E * 4)])) >> 6))) >> 8));
    platform->unk54 = 1;
    m4aSongNumStop(288);
...
{
    if (platform->unk54 == 0) {
        platform->unk5C = platform->unk5C > ((s32)((15)*256)) ? ((s32)((15)*256)) : platform->unk5C;
        platform->unk58 = ((int)((platform->unk5C * ((int)(((gSineTable[(platform->unk5E * 4) + 256])) >> 6))) >> 8));
        platform->unk5A = ((int)((platform->unk5C * ((int)(((gSineTable[(platform->unk5E * 4)])) >> 6))) >> 8));
    } else {
        platform->unk5A += ((s32)((0.1640625)*256));
        platform->unk5A = platform->unk5A > ((s32)((8)*256)) ? ((s32)((8)*256)) : platform->unk5A;
    }

    platform->unk44 += platform->unk58;
    platform->unk48 += platform->unk5A;

    if ((!(gPlayer.moveState & 0x00000080)) && platform->unk4C) {
        gPlayer.qWorldX = platform->unk50 + (((s32)((platform->x)*256)) + platform->unk44);
        gPlayer.qWorldY = platform->unk52 + (((s32)((platform->y)*256)) + platform->unk48) - ((s32)((gPlayer.spriteOffsetY)*256));
...
static void RenderPlatform(Sprite_SpeedingPlatform *platform)
{
    Sprite *s = &platform->s;
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        s->x = platform->x + ((int)((platform->unk60[1][0]) >> 8)) - gCamera.x;
        s->y = platform->y + ((int)((platform->unk60[1][1]) >> 8)) - gCamera.y;
    } else {
        s->x = platform->x + ((int)((platform->unk44) >> 8)) - gCamera.x;
        s->y = platform->y + ((int)((platform->unk48) >> 8)) - gCamera.y;
    }
...
static bool32 sub_807FC9C(Sprite_SpeedingPlatform *platform)
{
    ...
    if (gPlayer.moveState & (0x01000000 | 0x00400000 | 0x00000002 | 0x00000080)) {
        gPlayer.moveState &= ~0x00000008;
        gPlayer.stoodObj = 
# 188 "src/game/interactables_2/egg_utopia/speeding_platform.c" 3 4
                          ((void *)0)
# 188 "src/game/interactables_2/egg_utopia/speeding_platform.c"
                              ;
        return 0;
    }

    if (sub_807FD0C(platform) != 2) {
        s16 x = platform->x + ((int)((platform->unk44) >> 8)) - gCamera.x - 27;
...
static u32 sub_807FD0C(Sprite_SpeedingPlatform *platform)
{
    if ((!(gPlayer.moveState & 0x00000080))) {
        u32 temp = Coll_Player_Platform(&platform->s, platform->x + ((int)((platform->unk44) >> 8)), platform->y + ((int)((platform->unk48) >> 8)), &gPlayer);

        if (temp != 0) {
            if (temp & 0x10000) {
                gPlayer.qWorldY += ((s16)((temp)*256));
...
{
    platform->unk50 = gPlayer.qWorldX - (((s32)((platform->x)*256)) + platform->unk44);
    platform->unk52 = gPlayer.qWorldY - (((s32)((platform->y)*256)) + platform->unk48) + ((s32)((gPlayer.spriteOffsetY)*256));
    platform->unk4C = 1;
    m4aSongNumStart(288);
...
{
    s16 x = platform->x + ((int)((platform->unk44) >> 8)) - gCamera.x;
    s16 y = platform->y + ((int)((platform->unk48) >> 8)) - gCamera.y;

    if (x < -((256 / 2) + 64) || x > (426 + ((256 / 2) + 64)) || y + 32 < -(256 / 2)
        || y - 32 > (240 + (256 / 2))) {
        return 1;
    }
...
{
    { platform->base.me->x = platform->base.meX; };
...
static void sub_807FF20(void)
{
    ...
    platform->unk5C += ((s32)((0.125)*256));
    sub_807FB1C(platform);

    if (platform->unk44 >= ((s32)((590)*256))) {
