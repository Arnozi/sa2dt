...
static void Task_807EA8C(void)
{
    Sprite_Pole *pole = (void *)((gCurTask)->data);
...
static bool32 PoleIsOffScreen(Sprite_Pole *pole)
{
    ...
    if (screenX + pole->right < -((256) / 2) || screenX + pole->left > (426 + ((256) / 2))
        || screenY + pole->bottom < -((256) / 2) || screenY + pole->top > (240 + ((256) / 2))) {
        return 1;
    }
