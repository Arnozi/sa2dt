# 0 "src/game/interactables_2/sky_canyon/whirlwind.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/sky_canyon/whirlwind.c"
...
# 2 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
...
# 3 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
...
# 4 "src/game/interactables_2/sky_canyon/whirlwind.c" 2

# 1 "include/task.h" 1
# 6 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
...
# 10 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
# 1 "include/malloc_vram.h" 1
# 11 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
# 1 "include/trig.h" 1
...
# 12 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
...
# 14 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
# 1 "include/constants/char_states.h" 1
# 15 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/interactables_2/sky_canyon/whirlwind.c" 2
...
void CreateEntity_Whirlwind(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u32 kind)
{
    ...
    Sprite_IA86 *ia086 = (void *)((t)->data);
    s32 someX, someY;
    s32 value;
    u32 width;
    ia086->unk228.posX = ((me->x)*8 + (spriteRegionX)*256);
    ia086->unk228.posY = ((me->y)*8 + (spriteRegionY)*256);
    ia086->unk228.kind = kind;
    ia086->unk228.left = me->d.sData[0] * 8;
    ia086->unk228.top = me->d.sData[1] * 8;
    ia086->unk228.right = ia086->unk228.left + me->d.uData[2] * 8;
    ia086->unk228.bottom = ia086->unk228.top + me->d.uData[3] * 8;
...

    {
        ...
        u8 *vram;
        Unk_IA86 *unkPtr;
        for (i = 0; i < (sizeof(ia086->unk0) / sizeof((ia086->unk0)[0])); i++) {
            ia086->unk0[i].s = 
# 129 "src/game/interactables_2/sky_canyon/whirlwind.c" 3 4
                              ((void *)0)
# 129 "src/game/interactables_2/sky_canyon/whirlwind.c"
                                  ;
        }
        ia086->unk228.vramMem = VramMalloc(4);
        vram = ia086->unk228.vramMem;

        for (i = 0; i < (sizeof(ia086->sprites) / sizeof((ia086->sprites)[0])); i++) {
...
void sub_807C9C0(Sprite_IA86 *ia086)
{
    ...
    ia086->unk182 = 64;
    ia086->unk184 = ((s32)((0.5)*256));
    ia086->unk186 = gPlayer.qSpeedAirY;
    ia086->unk180 = 0;
    ia086->unk188 = ((s32)((ia086->unk228.centerX)*256)) - gPlayer.qWorldX;
    ia086->unk18C = ((s32)((ia086->unk228.centerY)*256)) - gPlayer.qWorldY;
    ia086->unk190 = 0;
    ia086->unk194 = 0;

    gCurTask->main = Task_807D0C4;
}
# 214 "src/game/interactables_2/sky_canyon/whirlwind.c"
bool32 sub_807CA64(Sprite_IA86 *ia086)
{
    u8 returnState = 0;

    s32 someY = ((s32)((ia086->unk228.centerY - 2 * 8)*256));
    ...
    if (ia086->unk186 <= 0) {
        ...
        ia086->unk186 = (((ia086->unk186) > (-((s32)((3.0)*256)))) ? (ia086->unk186) : (-((s32)((3.0)*256))));
    } else {
        ia086->unk186 = (((ia086->unk186) < (+((s32)((6.0)*256)))) ? (ia086->unk186) : (+((s32)((6.0)*256))));
        ia086->unk186 += ((((-ia086->unk186 >> 4)) < (-((s32)((0.25)*256)))) ? ((-ia086->unk186 >> 4)) : (-((s32)((0.25)*256))));
    }

    gPlayer.qWorldY += ia086->unk186;
    gPlayer.qWorldY = (((gPlayer.qWorldY) < (someY)) ? (gPlayer.qWorldY) : (someY));

    ia086->unk184 += ((s32)((0.25)*256));
    ia086->unk184 = (((ia086->unk184) < (+((s32)((3.0)*256)))) ? (ia086->unk184) : (+((s32)((3.0)*256))));
    ...
    gPlayer.qWorldX = ((s32)((ia086->unk228.centerX)*256)) + ia086->unk188 + ia086->unk190;
...
bool32 sub_807CB78(Sprite_IA86 *ia086)
{
    ...
    if (gPlayer.qWorldY > ((s32)((ia086->unk228.posY + ia086->unk228.top)*256))) {
        ia086->unk186 -= 0x10;
...

    {
        ...
        x = ((s32)((ia086->unk228.centerX)*256));
        x += ia086->unk188;
        x += ia086->unk190;
        p->qWorldX = x;

        y = ((s32)((ia086->unk228.centerY)*256));
        y += ia086->unk18C;
        y += ia086->unk194;
        p->qWorldY = y;
    }
...
void sub_807CC28(Sprite_IA86 *ia086)
{
    ...
    u32 temp;
    u32 unk180;
    s32 cosVal = (procRes * ((int)(((gSineTable[(ia086->unk182 * 4) + 256])) >> 6)));

    *target = ((int)((cosVal * 192) >> 8));
...
void sub_807CCBC(Sprite_IA86 *ia086)
{
    ...
    for (i = 0; i < (sizeof(ia086->unk0) / sizeof((ia086->unk0)[0])); i++) {
        ...
        if (unk086->s == 
# 348 "src/game/interactables_2/sky_canyon/whirlwind.c" 3 4
                        ((void *)0)
# 348 "src/game/interactables_2/sky_canyon/whirlwind.c"
                            ) {
            u32 spriteIndex;
            s32 unkC;
            u16 rnd;
        ...
        {
            s16 r2 = ((unk086->unkC) >= 0 ? (unk086->unkC) : -(unk086->unkC)) >> 4;
            r0 = ({ s16 clamped; if ((r2) >= (64)) { clamped = (r2) > (0x200) ? (0x200) : (r2); } else { clamped = (64); } clamped; });
        }
        ...
        if (unk086->unkC > 0) {
...

            {
                s32 sinIndex;
                s32 addend;
                unk086->unk10 = newR1 * ((int)(((gSineTable[(unk086->unk4 * 4) + 256])) >> 6));

                r2 = (u16)((32 - ((int)((unk086->unkC) >> 8))) >> 2);
            ...
            if (-((int)((unk086->unkC) >> 8)) < ia086->unk228.height) {
                s32 r4, r5;
                s32 divRes;
                s16 divRes2;
                s32 temp2;
                unk086->unk14 = ((int)(((gSineTable[(unk086->unk4 * 4)])) >> 6)) * 4;
                ...
                unk086->unk10 = divRes2 * ((int)(((gSineTable[(unk086->unk4 * 4)])) >> 6));
                unk086->unk4 += 8;
            } else {
                unk086->s = 
# 434 "src/game/interactables_2/sky_canyon/whirlwind.c" 3 4
                           ((void *)0)
# 434 "src/game/interactables_2/sky_canyon/whirlwind.c"
                               ;
            }
        }
    }
...
void sub_807CE94(Sprite_IA86 *ia086)
{
    ...
    for (i = 0; i < (sizeof(ia086->unk0) / sizeof((ia086->unk0)[0])); i++) {
        ...
        if (unk086->s != 
# 446 "src/game/interactables_2/sky_canyon/whirlwind.c" 3 4
                        ((void *)0)
# 446 "src/game/interactables_2/sky_canyon/whirlwind.c"
                            ) {
            s32 someX, someY;
            Sprite *s2;
            someX = ia086->unk228.centerX;
            someX += ((int)((unk086->unk8 + unk086->unk10) >> 8));
            someX -= gCamera.x;
            unk086->s->x = someX;

            s2 = unk086->s;
            someY = ia086->unk228.centerY;
            someY += ((int)((unk086->unkC + unk086->unk14) >> 8));
            someY -= gCamera.y;
            s2->y = someY;

            if (unk086->unk4 < 124) {
                unk086->s->oamFlags = ((6) << 6);
            } else {
                unk086->s->oamFlags = ((18) << 6);
            }

            if (unk086->unkC > -((s32)((16)*256)))
                unk086->s->frameFlags = ((3) << (12));
            else
                unk086->s->frameFlags = ((2) << (12));
...
bool32 sub_807CF2C(Sprite_IA86 *ia086)
{
    ...
    if (((screenX + ia086->unk228.right) < -128) || ((screenX + ia086->unk228.left) > (426 + 128))
        || ((screenY + ia086->unk228.bottom) < -128) || ((screenY + ia086->unk228.top) > (240 + 128))) {
...
bool32 sub_807CFB4(Sprite_IA86 *ia086)
{
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        s16 px = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x;
        s16 py = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y;
        s32 r5, r4;
        u16 r3;
        ...
        if ((r2 <= py) && (r2 + ia086->unk228.height >= py)) {
            ...
            r3 = sub_80855C0(r5, r4, (((s32)((y - py)*256)) / ia086->unk228.height), 8);
...
{
    Sprite_IA86 *ia086 = (void *)((gCurTask)->data);
...
{
    ia086->unk188 = 0;
    ia086->unk18C = gPlayer.qWorldY - ((s32)((ia086->unk228.centerY)*256));
...
void Task_807D268(void)
{
    Sprite_IA86 *sprite = (void *)((gCurTask)->data);
...
{
    gPlayer.moveState &= ~0x00400000;
    gPlayer.transition = 7;
    gPlayer.qSpeedAirX = 0;
    gPlayer.qSpeedAirY = -((s32)((8.0)*256));
