...
static void Task_IA_Fan_UpdateRegular(void)
{
    Sprite_Fan *prop = (void *)((gCurTask)->data);
...
static s16 ClampPlayerSpeed(s16 speed)
{
    if (gPlayer.isBoosting) {
        ...
        ({ if ((speed) > (+((s32)((9.0)*256)))) { speed = (+((s32)((9.0)*256))); } else if ((speed) < (-((s32)((9.0)*256)))) { speed = (-((s32)((9.0)*256))); } });
...
static bool32 IsPropellerOffScreen(Sprite_Fan *prop)
{
    ...
    if (((posX + prop->right) < -128) || ((posX + prop->left) > 426 + 128) || ((posY + prop->bottom) < -128)
        || ((posY + prop->top) > 240 + 128))
        return 1;
