...
{
    Sprite_Propeller *propeller = (void *)((gCurTask)->data);
...
Sprite_OnInit_SkyCanyon *sub_807BA54(void)
{
    EntitiesManager *em = (void *)(((struct Task *)((gCurTask)->parent))->data);
    return (void *)((em->preInit)->data);
}

static void sub_807BA70(void)
{
    EntitiesManager *em = (void *)(((struct Task *)((gCurTask)->parent))->data);
    Sprite_OnInit_SkyCanyon *level = (void *)((em->preInit)->data);
...
void CreateEntity_Propeller(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Propeller *propeller = (void *)((t)->data);
