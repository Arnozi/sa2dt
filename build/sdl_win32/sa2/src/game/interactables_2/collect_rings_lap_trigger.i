# 0 "src/game/interactables_2/collect_rings_lap_trigger.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/collect_rings_lap_trigger.c"
...
# 2 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
# 5 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
# 6 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
# 8 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
# 9 "src/game/interactables_2/collect_rings_lap_trigger.c" 2


# 1 "include/task.h" 1
# 12 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
# 14 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/interactables_2/collect_rings_lap_trigger.c" 2
...
{
    struct Task *t = TaskCreate(Task_LapTriggerInactive, sizeof(Sprite_LapTrigger), 0x2010, 0, 
# 51 "src/game/interactables_2/collect_rings_lap_trigger.c" 3 4
                                                                                              ((void *)0)
# 51 "src/game/interactables_2/collect_rings_lap_trigger.c"
                                                                                                  );
    Sprite_LapTrigger *trigger = (void *)((t)->data);
    ...
    if ((trigger->lastPlayerX < ((s32)((trigger->posX + trigger->left)*256))) && (gPlayer.qWorldX > ((s32)((trigger->posX + trigger->right)*256)))) {
        if (trigger->passedLap) {
            ...
            if (trigger->highestLap < trigger->lap) {
                ...
                if (!((gCurrentLevel) == ((7)*(3 + 1)) + (1)) && (({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}) != ({((100) != 0) ? ((s32)(prevRingCount) / (s32)(100)) : 0;}))
                    && (gGameMode == 0)) {

                    u32 lives = gNumLives + 1;
                    ({ if (lives > 255) { gNumLives = 255; } else { gNumLives = lives; } });
...
static void CreateSprite_Notif_RingBonus(void)
{
    ...
    Sprite_Notif_RingBonus *notif = (void *)((t)->data);
    Sprite *s = &notif->s;
...
static void Task_LapTriggerInactive(void)
{
    Sprite_LapTrigger *trigger = (void *)((gCurTask)->data);
...
static void Task_NotifRingBonus(void)
{
    Sprite_Notif_RingBonus *notif = (void *)((gCurTask)->data);
...
static void TaskDestructor_NotifRingBonus(struct Task *t)
{
    Sprite_Notif_RingBonus *trigger = (void *)((t)->data);
