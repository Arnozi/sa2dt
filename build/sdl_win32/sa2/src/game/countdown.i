...
void sub_8036168(void)
{
    CourseStartCountdown *countdown = (void *)((gCurTask)->data);
    Sprite *s;
    ...
    if (countdown->timer < (60 * 3)) {
        s = &countdown->sprCountdownDigits;
        s->variant = 2 - ({((60) != 0) ? ((s32)(countdown->timer) / (s32)(60)) : 0;});
        s->prevVariant = -1;
        s->x = (426 / 2);
    ...
    if (countdown->timer >= (int)((1 + 1. / 6.) * 60) && countdown->timer < 3 * 60) {
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
            gPlayer.spriteInfoBody->s.palId = (((volatile struct SioMultiCnt *)(REG_BASE + 0x128)))->id;
        } else {
...
void CreateRaceStartMessage(void)
{
    ...
    RaceStartMessage *startMessage = (void *)((t)->data);
    Sprite *s;
...
void Task_RaceStartMessageMain(void)
{
    RaceStartMessage *startMessage = (void *)((gCurTask)->data);
    Sprite *s, *element2;
    SpriteTransform *transform;
    s16 timer;
    startMessage->timer--;
...
{
    CourseStartCountdown *countdown = (void *)((t)->data);
