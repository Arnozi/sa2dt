# 0 "src/game/time_attack/results.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/time_attack/results.c"
...
# 5 "include/game/time_attack/results.h" 2

u32 CreateTimeAttackResults(u32 finishTime);
# 2 "src/game/time_attack/results.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/time_attack/results.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/time_attack/results.c" 2
...
# 5 "src/game/time_attack/results.c" 2
...
# 6 "src/game/time_attack/results.c" 2
...
# 7 "src/game/time_attack/results.c" 2
...
# 8 "src/game/time_attack/results.c" 2
# 1 "include/malloc_vram.h" 1
# 9 "src/game/time_attack/results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/time_attack/results.c" 2
# 1 "include/trig.h" 1
...
# 11 "src/game/time_attack/results.c" 2
# 1 "include/task.h" 1
# 12 "src/game/time_attack/results.c" 2
...
# 13 "src/game/time_attack/results.c" 2
...
# 14 "src/game/time_attack/results.c" 2
...
# 16 "src/game/time_attack/results.c" 2
# 1 "include/constants/char_states.h" 1
# 17 "src/game/time_attack/results.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/time_attack/results.c" 2
...
u32 CreateTimeAttackResults(u32 finishTime)
{
    ...
    ScreenFade *fade;
    Sprite *s = 
# 51 "src/game/time_attack/results.c" 3 4
               ((void *)0)
# 51 "src/game/time_attack/results.c"
                   ;
    ...
    resultsCutScene = (void *)((t)->data);
    fade = &resultsCutScene->base.fade;

    resultsCutScene->base.counter = 0;
    resultsCutScene->medalSpinSpeed = ((s32)((8)*256));
    resultsCutScene->medalSpin = ((s32)((64)*256));
    ...
    resultsCutScene->unk171 = ((minutes) % 10);
    resultsCutScene->unk172 = ((seconds) / 10);
    resultsCutScene->unk173 = ((seconds) % 10);
    resultsCutScene->unk174 = ((millis) / 10);
    resultsCutScene->unk175 = ((millis) % 10);
    ...
    isBossLevel = ((gCurrentLevel) & ((3 + 1) - 1)) >> 1;
    ...
    if (resultsCutScene->rank != 0) {
        s->variant = resultsCutScene->rank + 13;
    } else {
        s->variant = 14;
    }
    s->oamFlags = ((4) << 6);
    ...
    resultsCutScene->transform.qScaleY = +((s32)((1)*256));
    resultsCutScene->transform.x = (426 / 2);
    resultsCutScene->transform.y = (240 / 2) + 40;
    ...
    if ((gCurrentLevel & 2) && !(gCurrentLevel & 1)) {
...
{
    TimeAttackResultsCutScene *resultsCutScene = (void *)((gCurTask)->data);
    Sprite *s;
    ...
    if (frame > 28) {
        s32 numElements = ((gCurrentLevel & 2) && !(gCurrentLevel & 1)) ? 2 : 3;
    ...
    if (frame >= 120) {
        ...
        if (dFrames > 16) {
            if (resultsCutScene->rank > 0) {
                ...
                s = &resultsCutScene->base.sprScores[1];
                resultsCutScene->transform.qScaleX = ((int)(((gSineTable[(((int)(((u16)resultsCutScene->medalSpin) >> 8)) * 4) + 256])) >> 6));
                resultsCutScene->medalSpin += resultsCutScene->medalSpinSpeed;

                if (resultsCutScene->medalSpin == 0) {
                    if (resultsCutScene->medalSpinSpeed == ((s32)((8)*256))) {
                        resultsCutScene->medalSpinSpeed = ((s32)((4)*256));
                    } else {
                ...
                if (resultsCutScene->transform.qScaleX == 0) {
                    resultsCutScene->transform.qScaleX = ((s32)((0.0625)*256));
                }
        ...
        for (i = 0; i < 7; i++) {
            ...
            s = &resultsCutScene->digits[i];
            if (index < (sizeof(sTimeResultDigitAnim) / sizeof((sTimeResultDigitAnim)[0]))) {
...
static u8 StoreRecord(u32 finishTime)
{
    ...
    u8 act = currentLevel - (currentLevel / (3 + 1)) * (3 + 1);
    u8 rank = 0;
...
static void Task_AnimateResults(void)
{
    ...
    if (((frame > 160) && (gPressedKeys & (0x0001 | 0x0008))) || (frame > 600)) {
...
{
    TimeAttackResultsCutScene *resultsCutScene = (void *)((gCurTask)->data);
    if (UpdateScreenFade(&resultsCutScene->base.fade) == 1) {
        WriteSaveGame();
...
{
    u32 i;
    TimeAttackResultsCutScene *resultsCutScene = (void *)((t)->data);
