# 0 "src/game/time_attack/mode_select.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/time_attack/mode_select.c"
# 1 "include/core.h" 1
...
# 2 "src/game/time_attack/mode_select.c" 2
# 1 "include/malloc_vram.h" 1
# 3 "src/game/time_attack/mode_select.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/time_attack/mode_select.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/time_attack/mode_select.c" 2
# 1 "include/task.h" 1
# 6 "src/game/time_attack/mode_select.c" 2
# 1 "include/flags.h" 1
# 7 "src/game/time_attack/mode_select.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/time_attack/mode_select.c" 2
# 1 "include/game/character_select.h" 1



# 1 "include/global.h" 1
# 5 "include/game/character_select.h" 2


void CreateCharacterSelectionScreen(u8 selectedCharacter, bool8 allUnlocked);
# 9 "src/game/time_attack/mode_select.c" 2
...
# 10 "src/game/time_attack/mode_select.c" 2
...
# 11 "src/game/time_attack/mode_select.c" 2
...
# 12 "src/game/time_attack/mode_select.c" 2
...
# 13 "src/game/time_attack/mode_select.c" 2
...
# 14 "src/game/time_attack/mode_select.c" 2
...
# 15 "src/game/time_attack/mode_select.c" 2
...
# 17 "src/game/time_attack/mode_select.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/time_attack/mode_select.c" 2
# 1 "include/constants/text.h" 1
# 19 "src/game/time_attack/mode_select.c" 2
# 1 "include/constants/tilemaps.h" 1
# 20 "src/game/time_attack/mode_select.c" 2
...
const TileInfo gUnknown_080E0384[] = {
    { .numTiles = (12), .anim = (1057), .variant = (1) },
    { .numTiles = (8), .anim = (1057), .variant = (2) },
    { .numTiles = (168), .anim = (1057), .variant = ((3 + 0)) },
    { .numTiles = (168), .anim = (1057), .variant = ((3 + 1)) },
    { .numTiles = (168), .anim = (1057), .variant = ((3 + 2)) },

    { .numTiles = (12), .anim = (1058), .variant = (3) },
    { .numTiles = (12), .anim = (1058), .variant = (4) },
    { .numTiles = (168), .anim = (1058), .variant = (0) },
    { .numTiles = (168), .anim = (1058), .variant = (1) },
    { .numTiles = (168), .anim = (1058), .variant = (2) },

    { .numTiles = (12), .anim = (1058), .variant = (3) },
    { .numTiles = (12), .anim = (1058), .variant = (4) },
    { .numTiles = (168), .anim = (1059), .variant = (0) },
    { .numTiles = (168), .anim = (1059), .variant = (1) },
    { .numTiles = (168), .anim = (1059), .variant = (2) },

    { .numTiles = (12), .anim = (1058), .variant = (3) },
    { .numTiles = (12), .anim = (1058), .variant = (4) },
    { .numTiles = (168), .anim = (1060), .variant = (0) },
    { .numTiles = (168), .anim = (1060), .variant = (1) },
    { .numTiles = (168), .anim = (1060), .variant = (2) },

    { .numTiles = (12), .anim = (1058), .variant = (3) },
    { .numTiles = (12), .anim = (1058), .variant = (4) },
    { .numTiles = (168), .anim = (1061), .variant = (0) },
    { .numTiles = (168), .anim = (1061), .variant = (1) },
    { .numTiles = (168), .anim = (1061), .variant = (2) },

    { .numTiles = (12), .anim = (1058), .variant = (3) },
    { .numTiles = (12), .anim = (1058), .variant = (4) },
    { .numTiles = (168), .anim = (1062), .variant = (0) },
    { .numTiles = (168), .anim = (1062), .variant = (1) },
    { .numTiles = (168), .anim = (1062), .variant = (2) },
};
...
void CreateTimeAttackModeSelectionScreen(void)
{
    ...
    s->graphics.dest = VramMalloc(gUnknown_080E0384[(0 + ((lang) * (5)))].numTiles);
    s->graphics.anim = gUnknown_080E0384[(0 + ((lang) * (5)))].anim;
    s->variant = gUnknown_080E0384[(0 + ((lang) * (5)))].variant;
    s->prevVariant = -1;
    s->x = 0;
    s->y = 0;
    s->oamFlags = ((4) << 6);
    ...
    s->graphics.dest = VramMalloc(gUnknown_080E0384[(1 + ((lang) * (5)))].numTiles);
    s->graphics.anim = gUnknown_080E0384[(1 + ((lang) * (5)))].anim;
    s->variant = gUnknown_080E0384[(1 + ((lang) * (5)))].variant;
    s->prevVariant = -1;
    s->x = 0;
    s->y = 0;
    s->oamFlags = ((4) << 6);
    ...
    s->graphics.dest = VramMalloc(gUnknown_080E0384[(2 + ((lang) * (5)))].numTiles);
    s->graphics.anim = gUnknown_080E0384[(2 + ((lang) * (5)))].anim;
    s->variant = gUnknown_080E0384[(2 + ((lang) * (5)))].variant;
    s->prevVariant = -1;
    s->x = 426 / 2 - 112;
    s->y = 240 - 57;
    s->oamFlags = ((4) << 6);
...
{
    struct TimeAttackModeSelectionScreen *modeScreen = (void *)((gCurTask)->data);
    ...
    ScreenMask_Right_OriginBottom(((s32)((100)*256)), modeScreen->animFrame * ((int)((((double)(7.03125)) / 360.0) * 1024)) + ((int)((((double)(246.09375)) / 360.0) * 1024)));
...
static void Task_IntroUIAnim(void)
{
    ...
    gFlags |= 0x4;
    InitHBlankBgOffsets(426);
    ScreenMask_Right_OriginBottom(((s32)((100)*256)), ((int)((((double)(246.09375)) / 360.0) * 1024)));
...
static void Task_ScreenMain(void)
{
    ...
    if (modeScreen->unk14D) {
        ...
        if (gLoadedSaveGame->bossTimeAttackUnlocked) {
            s->graphics.anim = gUnknown_080E0384[(3 + ((lang) * (5)))].anim;
            s->variant = gUnknown_080E0384[(3 + ((lang) * (5)))].variant;
        } else {
            s->graphics.anim = gUnknown_080E0384[(4 + ((lang) * (5)))].anim;
            s->variant = gUnknown_080E0384[(4 + ((lang) * (5)))].variant;
        }
        s->prevVariant = -1;
    } else {
        lang = gLoadedSaveGame->language - 1;
...
{
    struct TimeAttackModeSelectionScreen *modeScreen = (void *)((t)->data);
