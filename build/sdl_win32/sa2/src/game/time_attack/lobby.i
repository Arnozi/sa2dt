# 0 "src/game/time_attack/lobby.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/time_attack/lobby.c"
...
# 5 "include/game/time_attack/lobby.h" 2

void CreateTimeAttackLobbyScreen(void);
# 2 "src/game/time_attack/lobby.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/time_attack/lobby.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/time_attack/lobby.c" 2
...
# 5 "src/game/time_attack/lobby.c" 2
...
# 6 "src/game/time_attack/lobby.c" 2
...
# 7 "src/game/time_attack/lobby.c" 2
# 1 "include/malloc_vram.h" 1
# 8 "src/game/time_attack/lobby.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/time_attack/lobby.c" 2
...
# 10 "src/game/time_attack/lobby.c" 2
...
# 11 "src/game/time_attack/lobby.c" 2
...
# 12 "src/game/time_attack/lobby.c" 2
...
# 13 "src/game/time_attack/lobby.c" 2

# 1 "include/task.h" 1
# 15 "src/game/time_attack/lobby.c" 2
...
# 17 "src/game/time_attack/lobby.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/time_attack/lobby.c" 2
# 1 "include/constants/tilemaps.h" 1
# 19 "src/game/time_attack/lobby.c" 2
...
const TileInfo gUnknown_080E0474[] = {
    { .numTiles = (20), .anim = (0), .variant = (0) }, { .numTiles = (16), .anim = (91), .variant = (0) }, { .numTiles = (30), .anim = (182), .variant = (0) }, { .numTiles = (20), .anim = (273), .variant = (0) },
    { .numTiles = (20), .anim = (364), .variant = (0) }, { .numTiles = (64), .anim = (9), .variant = (3) }, { .numTiles = (64), .anim = (100), .variant = (3) }, { .numTiles = (64), .anim = (191), .variant = (3) },
    { .numTiles = (64), .anim = (282), .variant = (3) }, { .numTiles = (64), .anim = (373), .variant = (3) },
};

const TileInfo gUnknown_080E04C4[] = {
    { .numTiles = (9), .anim = (455), .variant = (0) },
    { .numTiles = (9), .anim = (456), .variant = (0) },
};

const TileInfo gUnknown_080E04D4[] = {
    { .numTiles = (22), .anim = (1051), .variant = (0) }, { .numTiles = (32), .anim = (1051), .variant = (1) }, { .numTiles = (22), .anim = (1051), .variant = (2) }, { .numTiles = (22), .anim = (1051), .variant = (3) },
    { .numTiles = (10), .anim = (1051), .variant = (4) }, { .numTiles = (24), .anim = (1052), .variant = (0) }, { .numTiles = (42), .anim = (1052), .variant = (1) }, { .numTiles = (36), .anim = (1052), .variant = (2) },
    { .numTiles = (30), .anim = (1052), .variant = (3) }, { .numTiles = (8), .anim = (1052), .variant = (4) }, { .numTiles = (24), .anim = (1053), .variant = (0) }, { .numTiles = (36), .anim = (1053), .variant = (1) },
    { .numTiles = (42), .anim = (1053), .variant = (2) }, { .numTiles = (36), .anim = (1053), .variant = (3) }, { .numTiles = (20), .anim = (1053), .variant = (4) }, { .numTiles = (24), .anim = (1054), .variant = (0) },
    { .numTiles = (48), .anim = (1054), .variant = (1) }, { .numTiles = (36), .anim = (1054), .variant = (2) }, { .numTiles = (32), .anim = (1054), .variant = (3) }, { .numTiles = (8), .anim = (1054), .variant = (4) },
    { .numTiles = (44), .anim = (1055), .variant = (0) }, { .numTiles = (44), .anim = (1055), .variant = (1) }, { .numTiles = (38), .anim = (1055), .variant = (2) }, { .numTiles = (32), .anim = (1055), .variant = (3) },
    { .numTiles = (8), .anim = (1055), .variant = (4) }, { .numTiles = (20), .anim = (1056), .variant = (0) }, { .numTiles = (44), .anim = (1056), .variant = (1) }, { .numTiles = (40), .anim = (1056), .variant = (2) },
    { .numTiles = (28), .anim = (1056), .variant = (3) }, { .numTiles = (12), .anim = (1056), .variant = (4) },
};
...
void sub_8088944(struct TimeAttackLobbyScreen *lobbyScreen)
{
    ...
    s = &lobbyScreen->unk80;
    s->graphics.dest = 
# 117 "src/game/time_attack/lobby.c" 3 4
                      ((void *)0)
# 117 "src/game/time_attack/lobby.c"
                          ;
    s->graphics.anim = 1051;
    s->variant = 5;
    s->prevVariant = -1;
    s->x = 0;
    s->y = 0;
    ...
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (29)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 150;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (7)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 151;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
...
{
    struct TimeAttackLobbyScreen *lobbyScreen = (void *)((gCurTask)->data);
    Sprite *s;
    u32 i;
    ...
    if (UpdateScreenFade(&lobbyScreen->unk1A0) == 1) {
    ...
    if (UpdateScreenFade(&lobbyScreen->unk1A0) == 1) {
...

        {
            case 0:
                ...
                break;
            case 1:
                CreateCharacterSelectionScreen(gSelectedCharacter, gLoadedSaveGame->unlockedCharacters & (1 << (CHARACTER_AMY)));
                gCurrentLevel = ((0)*(3 + 1)) + (0);
                break;
            case 2:
                CreateTimeAttackLevelSelectScreen(((gGameMode / 2) % 2), gSelectedCharacter, gCurrentLevel);
                break;
            case 3:
...
void sub_8088EB4(void)
{
    ...
    if (gRepeatedKeys & (0x0040) && lobbyScreen->cursor != 0) {
        lobbyScreen->cursor--;
        m4aSongNumStart(108);
    } else if (gRepeatedKeys & 0x0080 && lobbyScreen->cursor != 3) {
        lobbyScreen->cursor++;
        m4aSongNumStart(108);
    }
...
void CreateTimeAttackLobbyScreen()
{
    ...
    struct TimeAttackLobbyScreen *lobbyScreen = (void *)((t)->data);
