# 0 "src/game/interactables_1/incline_ramp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/incline_ramp.c"
...
# 2 "src/game/interactables_1/incline_ramp.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_1/incline_ramp.c" 2
...
# 6 "src/game/interactables_1/incline_ramp.c" 2
...
# 7 "src/game/interactables_1/incline_ramp.c" 2
...
# 8 "src/game/interactables_1/incline_ramp.c" 2

# 1 "include/task.h" 1
# 10 "src/game/interactables_1/incline_ramp.c" 2

# 1 "include/constants/char_states.h" 1
# 12 "src/game/interactables_1/incline_ramp.c" 2
# 1 "include/constants/player_transitions.h" 1
# 13 "src/game/interactables_1/incline_ramp.c" 2
# 1 "include/constants/songs.h" 1
# 14 "src/game/interactables_1/incline_ramp.c" 2
...
{
    Sprite_InclineRamp *ramp = (void *)((gCurTask)->data);
    MapEntity *me = ramp->base.me;
    u32 moveState;
    s16 screenX, screenY;

    screenX = ((ramp->base.meX)*8 + (ramp->base.regionY)*256);


    screenY = ((me->y)*8 + (ramp->base.regionX)*256);

    moveState = gPlayer.moveState;
    if (!(moveState & 0x00000080) && (screenX <= ((int)((gPlayer.qWorldX) >> 8))) && ((screenX + me->d.uData[2] * 8) >= ((int)((gPlayer.qWorldX) >> 8)))
        && (screenY <= ((int)((gPlayer.qWorldY) >> 8))) && ((screenY + me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8)))
        && (!(moveState & 0x00000002))) {

        if (((s8)ramp->base.id) == 0) {
            if (gPlayer.qSpeedAirX > ((s32)((4)*256))) {
                moveState &= ~0x00000008;
                moveState |= 0x00000002;
                moveState &= ~0x00000100;
                moveState &= ~0x00000004;
                gPlayer.moveState = moveState;

                { Player_HandleSpriteYOffsetChange(&gPlayer, 14); { (&gPlayer)->spriteOffsetX = 6; (&gPlayer)->spriteOffsetY = 14; } };
                gPlayer.qSpeedAirY = ((s16)((-3)*256));
                gPlayer.qSpeedGround = ((s16)((17)*256));
                gPlayer.qSpeedAirX += ((s16)((17)*256));
            ...
            if (gPlayer.qSpeedAirX < ((s16)((-4)*256))) {
                moveState &= ~0x00000008;
                moveState |= 0x00000002;
                moveState &= ~0x00000100;
                moveState &= ~0x00000004;
...
{
    struct Task *t = TaskCreate(Task_InclineRamp, sizeof(Sprite_InclineRamp), 0x2000, 0, 
# 94 "src/game/interactables_1/incline_ramp.c" 3 4
                                                                                        ((void *)0)
# 94 "src/game/interactables_1/incline_ramp.c"
                                                                                            );
    Sprite_InclineRamp *ramp = (void *)((t)->data);
