# 0 "src/game/interactables_1/corkscrew_3d.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/corkscrew_3d.c"
...
# 2 "src/game/interactables_1/corkscrew_3d.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_1/corkscrew_3d.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_1/corkscrew_3d.c" 2
...
# 6 "src/game/interactables_1/corkscrew_3d.c" 2
...
# 7 "src/game/interactables_1/corkscrew_3d.c" 2
...
# 8 "src/game/interactables_1/corkscrew_3d.c" 2
# 1 "include/task.h" 1
# 9 "src/game/interactables_1/corkscrew_3d.c" 2

# 1 "include/sprite.h" 1
# 11 "src/game/interactables_1/corkscrew_3d.c" 2
# 1 "include/trig.h" 1
...
# 12 "src/game/interactables_1/corkscrew_3d.c" 2
...
# 13 "src/game/interactables_1/corkscrew_3d.c" 2
...
# 15 "src/game/interactables_1/corkscrew_3d.c" 2
# 1 "include/constants/char_states.h" 1
# 16 "src/game/interactables_1/corkscrew_3d.c" 2
# 1 "include/constants/player_transitions.h" 1
# 17 "src/game/interactables_1/corkscrew_3d.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_1/corkscrew_3d.c" 2
...
void Task_8061914(void)
{
    Sprite_Corkscrew3D *corkscrew = (void *)((gCurTask)->data);
    MapEntity *me = corkscrew->base.me;

    u16 regionX = corkscrew->base.regionX;
    u16 regionY = corkscrew->base.regionY;
    s32 x = ((corkscrew->base.meX)*8 + (regionX)*256);
    s32 y = ((corkscrew->base.me->y)*8 + (regionY)*256);

    if ((!(gPlayer.moveState & 0x00000080))) {
        if ((x + (me->d.sData[0] * 8) <= ((int)((gPlayer.qWorldX) >> 8))
             && (x + (me->d.sData[0] * 8) + (me->d.uData[2] * 8) >= ((int)((gPlayer.qWorldX) >> 8))))
            && (y + (me->d.sData[1] * 8) <= ((int)((gPlayer.qWorldY) >> 8))
                && y + (me->d.sData[1] * 8) + (me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8)))) {
            if (x < ((int)((gPlayer.qWorldX) >> 8)) && (corkscrew->base.id & 1)) {
                s32 idx;
                s32 y24_8;
                gPlayer.transition = 27;

                idx = ((((((int)((gPlayer.qWorldX) >> 8)) - x) * 930) >> 8) + 256) & (1024 - 1);
                gPlayer.qWorldX += gPlayer.qSpeedGround;
                y24_8 = ((s32)((y)*256));
                gPlayer.qWorldY = ((int)(((gSineTable[(idx)])) >> 6)) * 24 + y24_8 - ((s32)((28)*256));

                gPlayer.qSpeedAirY = 0;
                gCurTask->main = sub_8061AB0;
            } else if ((x >= ((int)((gPlayer.qWorldX) >> 8))) && gPlayer.qSpeedGround > ((s16)((4)*256)) && !(gPlayer.moveState & 0x00000002)
...
void sub_8061AB0(void)
{
    ...
    idx = ((int)(((((int)((player->qWorldX) >> 8)) - x) * 930) >> 8));
    idx = (idx + 256) & (1024 - 1);

    player->qWorldX += player->qSpeedGround;
    y24_8 = ((s32)((y)*256));
    player->qWorldY = ((int)(((gSineTable[(idx)])) >> 6)) * 24 + y24_8 - ((s32)((28)*256));
    player->qSpeedAirY = 0;

    if ((((int)((player->qWorldX) >> 8)) - x) > 0x8C) {
        player->qWorldX = ((s32)((x + 0x8C)*256));

        if (!(player->moveState & 0x00000004)) {
            player->charState = 48;
        }
        ...
        if (player->qSpeedGround < corkscrew->unkC) {
            ...
            player->charState = 50;
            player->qSpeedAirX = player->qSpeedGround;
            player->qSpeedAirY = -((s32)((4.875)*256));
            player->transition = 5;
            gCurTask->main = Task_8061914;
        } else if (!(player->moveState & 0x00000004) && player->frameInput & 0x0080) {
            player->charState = 4;
            { Player_HandleSpriteYOffsetChange(player, 9); { (player)->spriteOffsetX = 6; (player)->spriteOffsetY = 9; } };
            player->moveState |= 0x00000004;
            m4aSongNumStart(109);
        } else if (!(player->moveState & 0x00000004)) {
            player->anim = gPlayerCharacterIdleAnims[player->character] + 68;
            player->variant = ({((94) != 0) ? ((s32)((idx - 282) & (1024 - 1)) / (s32)(94)) : 0;});
        }
    }
}
...
void Task_8061C70(void)
{
    ...
    player->qWorldX = x = ((s32)((x + 0x8C)*256));
    player->qWorldY += player->qSpeedGround;
    player->qSpeedAirY = 0;

    if ((((int)((player->qWorldY) >> 8)) - y) > 0xBE) {
        player->qWorldY = ((s32)((y + 0xBE)*256));
...
void Task_8061DA4(void)
{
    ...
    if (((int)((player->qWorldX) >> 8)) - x > 0x1A8) {
        if (player->moveState & 0x00000004) {
            player->transition = 2;
        } else {
            player->transition = 1;
...
void Task_8062100(void)
{
    ...
    if (!(!(gPlayer.moveState & 0x00000080))) {
        ...
        if ((((int)((player->qWorldX) >> 8)) - x) < -288) {
            player->qWorldX = ((s32)((x + -288)*256));
...
void Task_80622C8(void)
{
    ...
    if (!(!(gPlayer.moveState & 0x00000080))) {
        ...
        if ((((int)((player->qWorldY) >> 8)) - y) < -255) {
            player->qWorldY = ((s32)((y - 255)*256));
...
{
    struct Task *t = TaskCreate(Task_8061914, sizeof(Sprite_Corkscrew3D), 0x2000, 0, 
# 468 "src/game/interactables_1/corkscrew_3d.c" 3 4
                                                                                    ((void *)0)
# 468 "src/game/interactables_1/corkscrew_3d.c"
                                                                                        );
    Sprite_Corkscrew3D *corkscrew = (void *)((t)->data);
    ...
    corkscrew->base.id = 0;
    corkscrew->unkC = +((s32)((4)*256));
}

void CreateEntity_Corkscrew3D_End(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    struct Task *t = TaskCreate(Task_8061F60, sizeof(Sprite_Corkscrew3D), 0x2000, 0, 
# 483 "src/game/interactables_1/corkscrew_3d.c" 3 4
                                                                                    ((void *)0)
# 483 "src/game/interactables_1/corkscrew_3d.c"
                                                                                        );
    Sprite_Corkscrew3D *corkscrew = (void *)((t)->data);
    corkscrew->base.regionX = spriteRegionX;
    corkscrew->base.regionY = spriteRegionY;
...
s32 sub_806267C(s32 x, s32 y, s16 p2)
{
    ...
    s32 px = ((((int)((p->qWorldX) >> 8)) - x) * 930) >> 8;
    ...
    py = ((s32)((y)*256));
    p->qWorldY = ((int)(((gSineTable[(px)])) >> 6)) * 24 + py - ((s32)((28)*256));
