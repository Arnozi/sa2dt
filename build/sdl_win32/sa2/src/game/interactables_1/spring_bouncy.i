# 0 "src/game/interactables_1/spring_bouncy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/spring_bouncy.c"
...
# 2 "src/game/interactables_1/spring_bouncy.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/interactables_1/spring_bouncy.c" 2
...
void VramFree(void *);
# 6 "src/game/interactables_1/spring_bouncy.c" 2
...
# 8 "src/game/interactables_1/spring_bouncy.c" 2
...
# 9 "src/game/interactables_1/spring_bouncy.c" 2
...
# 10 "src/game/interactables_1/spring_bouncy.c" 2


# 1 "include/task.h" 1
# 13 "src/game/interactables_1/spring_bouncy.c" 2
...
# 15 "src/game/interactables_1/spring_bouncy.c" 2
# 1 "include/constants/char_states.h" 1
# 16 "src/game/interactables_1/spring_bouncy.c" 2
# 1 "include/constants/player_transitions.h" 1
# 17 "src/game/interactables_1/spring_bouncy.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_1/spring_bouncy.c" 2
...
void CreateEntity_BouncySpring(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_BouncySpring *spring = (void *)((t)->data);
    Sprite *s = &spring->s;
    u32 variant = 0;
...
{
    Sprite_BouncySpring *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
    MapEntity *me = spring->base.me;
    s32 screenX, screenY;
    s16 airSpeed;

    screenX = ((spring->base.meX)*8 + (spring->base.regionX)*256);
    screenY = ((me->y)*8 + (spring->base.regionY)*256);

    s->x = screenX - gCamera.x;
    s->y = screenY - gCamera.y;
    if (!(gPlayer.moveState & (0x00400000 | 0x00000080))) {
        airSpeed = gPlayer.qSpeedAirY;
        if ((Coll_Player_Platform(s, screenX, screenY, &gPlayer) != 0)) {
            u8 index;

            index = ({((400) != 0) ? ((s32)(airSpeed) / (s32)(400)) : 0;});
            if (index > ((sizeof(gUnknown_080D948C) / sizeof((gUnknown_080D948C)[0])) - 1))
                index = ((sizeof(gUnknown_080D948C) / sizeof((gUnknown_080D948C)[0])) - 1);

            gPlayer.qSpeedAirY = -(airSpeed + (airSpeed >> 3));

            if (gPlayer.qSpeedAirY > ((s16)((-7.5)*256)))
                gPlayer.qSpeedAirY = ((s16)((-7.5)*256));

            if (gPlayer.qSpeedAirY < ((s16)((-12)*256)))
                gPlayer.qSpeedAirY = ((s16)((-12)*256));
