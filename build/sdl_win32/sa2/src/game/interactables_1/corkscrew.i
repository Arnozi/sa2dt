# 0 "src/game/interactables_1/corkscrew.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/corkscrew.c"
...
# 2 "src/game/interactables_1/corkscrew.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_1/corkscrew.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_1/corkscrew.c" 2
...
# 6 "src/game/interactables_1/corkscrew.c" 2
# 1 "include/core.h" 1
...
# 7 "src/game/interactables_1/corkscrew.c" 2
# 1 "include/sprite.h" 1
# 8 "src/game/interactables_1/corkscrew.c" 2
# 1 "include/trig.h" 1
...
# 9 "src/game/interactables_1/corkscrew.c" 2
...
# 10 "src/game/interactables_1/corkscrew.c" 2
...
# 11 "src/game/interactables_1/corkscrew.c" 2
...
# 12 "src/game/interactables_1/corkscrew.c" 2
...
# 13 "src/game/interactables_1/corkscrew.c" 2
...
# 15 "src/game/interactables_1/corkscrew.c" 2
# 1 "include/constants/char_states.h" 1
# 16 "src/game/interactables_1/corkscrew.c" 2
# 1 "include/constants/player_transitions.h" 1
# 17 "src/game/interactables_1/corkscrew.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_1/corkscrew.c" 2
...
{
    Sprite_Corkscrew *corkscrew = (void *)((gCurTask)->data);
...
void sub_8060ED0(void)
{
    ...
    if (((int)((player->qWorldX) >> 8)) - x > 0x230) {
...
{
    struct Task *t = TaskCreate(Task_8060D34, sizeof(Sprite_Corkscrew), 0x2000, 0, 
# 243 "src/game/interactables_1/corkscrew.c" 3 4
                                                                                  ((void *)0)
# 243 "src/game/interactables_1/corkscrew.c"
                                                                                      );
    Sprite_Corkscrew *corkscrew = (void *)((t)->data);
    ...
    corkscrew->base.id = 0;
    corkscrew->unk10 = ((s32)((4)*256));
}

void CreateEntity_Corkscrew_End(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    struct Task *t = TaskCreate(sub_8061088, sizeof(Sprite_Corkscrew), 0x2000, 0, 
# 258 "src/game/interactables_1/corkscrew.c" 3 4
                                                                                 ((void *)0)
# 258 "src/game/interactables_1/corkscrew.c"
                                                                                     );
    Sprite_Corkscrew *corkscrew = (void *)((t)->data);
    corkscrew->base.regionX = spriteRegionX;
    corkscrew->base.regionY = spriteRegionY;
...
__attribute__((unused)) s32 sub_806148C(s32 x, s32 y)
{
    s32 y24_8;
    s32 idx = ((((((int)((gPlayer.qWorldX) >> 8)) - x) * 930) >> 8) + 256) & (1024 - 1);
