# 0 "src/game/interactables_1/gapped_loop.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/gapped_loop.c"
...
# 2 "src/game/interactables_1/gapped_loop.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_1/gapped_loop.c" 2
# 1 "include/task.h" 1
# 4 "src/game/interactables_1/gapped_loop.c" 2
...
# 5 "src/game/interactables_1/gapped_loop.c" 2
...
# 8 "src/game/interactables_1/gapped_loop.c" 2
...
# 10 "src/game/interactables_1/gapped_loop.c" 2
...
{
    Sprite_GappedLoop *gappedLoop = (void *)((gCurTask)->data);
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        if (x <= ((int)((gPlayer.qWorldX) >> 8)) && (x + me->d.uData[2] * 8) >= ((int)((gPlayer.qWorldX) >> 8))) {
            if (y <= ((int)((gPlayer.qWorldY) >> 8)) && (y + me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8))) {
                if (y <= ((int)((gPlayer.qWorldY) >> 8)) && (y + me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8))) {
                    if (gPlayer.qSpeedGround > ((s32)((3)*256)) && !(gPlayer.moveState & (0x00000001 | 0x00000002))) {
                        gCurTask->main = Task_JumpSequenceForwards;
                        gPlayer.moveState |= 0x00400000;
                        gappedLoop->playerAngle
                            = sub_8004418(((int)((gPlayer.qWorldY - gappedLoop->unk10) >> 8)), ((int)((gPlayer.qWorldX - gappedLoop->unkC) >> 8)));
    ...
    x -= gCamera.x;
    y -= gCamera.y;
    if (((x < -((256 / 2))) || (x > 426 + ((256 / 2))) || ((y) + ((256 / 2)) < 0) || (y > 240 + ((256 / 2))))) {
        me->x = spriteX;
...
static void Task_JumpSequenceForwards(void)
{
    ...
    x = ((spriteX)*8 + (regionX)*256);
    y = ((me->y)*8 + (regionY)*256);
    gappedLoop->playerAngle = (gappedLoop->playerAngle + gappedLoop->spinSpeed) & (1024 - 1);
    gPlayer.rotation += gappedLoop->spinSpeed;

    r3 = ((((s32)((3)*256)) - gappedLoop->playerAngle) >= 0 ? (((s32)((3)*256)) - gappedLoop->playerAngle) : -(((s32)((3)*256)) - gappedLoop->playerAngle)) >> 4;
    gPlayer.qWorldY = gappedLoop->unk10 + ((int)(((gSineTable[(gappedLoop->playerAngle)]) * (r3 + 135)) >> 6));
    gPlayer.qWorldX = gappedLoop->unkC + ((int)(((gSineTable[(gappedLoop->playerAngle) + 256]) * 135) >> 6));
...
static void Task_GappedLoopReverseMain(void)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if (base <= ((int)((gPlayer.qWorldX) >> 8)) && (base + me->d.uData[2] * 8) >= ((int)((gPlayer.qWorldX) >> 8))) {
            if (y <= ((int)((gPlayer.qWorldY) >> 8)) && (y + me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8))) {
                if (y <= ((int)((gPlayer.qWorldY) >> 8)) && (y + me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8))) {
                    if (gPlayer.qSpeedGround < -((s32)((3)*256)) && (gPlayer.moveState & 0x00000001)
...
{
    struct Task *t = TaskCreate(Task_GappedLoopForwardsMain, sizeof(Sprite_GappedLoop), 0x2000, 0, 
# 170 "src/game/interactables_1/gapped_loop.c" 3 4
                                                                                                  ((void *)0)
# 170 "src/game/interactables_1/gapped_loop.c"
                                                                                                      );
    Sprite_GappedLoop *gappedLoop = (void *)((t)->data);
    ...
    gappedLoop->unkC = ((s32)((((gappedLoop->base.meX)*8 + (spriteRegionX)*256) - 96)*256));
    gappedLoop->unk10 = ((s32)((((me->y)*8 + (spriteRegionY)*256) + 96)*256));
}

void CreateEntity_GappedLoop_End(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    struct Task *t = TaskCreate(Task_GappedLoopReverseMain, sizeof(Sprite_GappedLoop), 0x2000, 0, 
# 184 "src/game/interactables_1/gapped_loop.c" 3 4
                                                                                                 ((void *)0)
# 184 "src/game/interactables_1/gapped_loop.c"
                                                                                                     );
    Sprite_GappedLoop *gappedLoop = (void *)((t)->data);
    gappedLoop->base.regionX = spriteRegionX;
    gappedLoop->base.regionY = spriteRegionY;
