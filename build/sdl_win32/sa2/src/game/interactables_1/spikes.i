# 0 "src/game/interactables_1/spikes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/spikes.c"
...
# 2 "src/game/interactables_1/spikes.c" 2
...
# 4 "src/game/interactables_1/spikes.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/interactables_1/spikes.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "src/game/interactables_1/spikes.c" 2
# 1 "include/malloc_vram.h" 1
# 24 "include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 7 "src/game/interactables_1/spikes.c" 2
...
# 9 "src/game/interactables_1/spikes.c" 2
...
# 10 "src/game/interactables_1/spikes.c" 2
...
# 12 "src/game/interactables_1/spikes.c" 2
...
# 16 "src/game/interactables_1/spikes.c" 2
# 1 "include/constants/interactables.h" 1
# 17 "src/game/interactables_1/spikes.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_1/spikes.c" 2
# 26 "src/game/interactables_1/spikes.c"
typedef struct {
               SpriteBase base;
               Sprite s;
               u32 playerMoveState[2];
} Sprite_Spikes;
...
const u16 sSpikesOfZone[7 + 1] = {
    [0] = 542,
    [1] = 542, [2] = 580, [3] = 542, [4] = 542,
    [5] = 607, [6] = 542, [7] = 0,
};
...
{
    struct Task *t = TaskCreate(Task_SpikesUpMain, sizeof(Sprite_Spikes), 0x2000, 0, 
# 57 "src/game/interactables_1/spikes.c" 3 4
                                                                                    ((void *)0)
# 57 "src/game/interactables_1/spikes.c"
                                                                                        );
    Sprite_Spikes *spikes = (void *)((t)->data);
    Sprite *s = &spikes->s;
    ...
    s->graphics.dest = (void *)(&VRAM[0x10000] + 204 * 32);;
    ...
    if (gGameMode != 5) {
        s->graphics.anim = sSpikesOfZone[((gCurrentLevel) >> 2)];
    } else
...
{
    struct Task *t = TaskCreate(Task_SpikesDownMain, sizeof(Sprite_Spikes), 0x2000, 0, 
# 100 "src/game/interactables_1/spikes.c" 3 4
                                                                                      ((void *)0)
# 100 "src/game/interactables_1/spikes.c"
                                                                                          );
    Sprite_Spikes *spikes = (void *)((t)->data);
    Sprite *s = &spikes->s;
...
static void Task_SpikesUpMain(void)
{
    Sprite_Spikes *spikes = (void *)((gCurTask)->data);
    Sprite *s = &spikes->s;
    MapEntity *me = spikes->base.me;
    s16 screenX, screenY;

    screenX = ((spikes->base.meX)*8 + (spikes->base.regionX)*256);
    screenY = ((me->y)*8 + (spikes->base.regionY)*256);
    ...
    if ((gGameMode == 5) && (me->d.sData[0] == 0) && (gSpikesUnknownTimer == 0)) {
        if (spikes->playerMoveState[0] & (0x00040000 | 0x00080000)) {
            gPlayer.moveState &= ~0x00000020;
        }

        if (spikes->playerMoveState[0] & 0x00010000) {
...
static void Task_SpikesDownMain(void)
{
    ...
    if ((gGameMode == 5) && (me->d.sData[0] == 0) && (gSpikesUnknownTimer == 0)) {
        if (spikes->playerMoveState[0] & 0x00000020) {
            gPlayer.moveState &= ~0x00000020;
        }

        if (spikes->playerMoveState[0] & 0x00000008) {
            gPlayer.moveState &= ~0x00000008;
        }
    }
...
static void Task_SpikesLeftRightMain(void)
{
    ...
    if (gGameMode != 5 || me->d.sData[0] != 0 || gSpikesUnknownTimer != 0) {
        ...
        gravityInverted = (gStageFlags & 0x0080);
        if (gravityInverted) {
            if (r4 & 0x10000) {
            ...
            if (r4 & 0x10000) {
                if (HandleSpikePlayerCollision(s, screenX, screenY, &gPlayer) & 0x10000) {
                    gPlayer.qWorldY += (r4 << 24) >> 16;
                    gPlayer.qSpeedAirY = gravityInverted;
                }
            }

            if (r4 & 0x20000) {
                gPlayer.qWorldY += (r4 << 24) >> 16;
                gPlayer.qSpeedAirY = ((s16)((0)*256));
            }
        }
...
static bool32 HandleSpikeMovementUp(Sprite *s, MapEntity *me, Sprite_Spikes *spikes, Player *player)
{
    ...
    if ((gGameMode == 5) && (me->d.sData[0] == 0) && (gSpikesUnknownTimer == 30)) {
        ...
        if (flags) {
            ...
            if (flags & 0xC0000) {
                player->moveState |= 0x00000020;
            }

            if (!(gStageFlags & 0x0080)) {
                player->qWorldY = ((s32)((screenY + s->hitboxes[0].top - sp00[3])*256));
            } else {
                player->qWorldY = ((s32)((screenY + s->hitboxes[0].bottom + sp00[3])*256));
            }
...

    {
        ...
        r7 = (player->moveState >> 3) & (0x00000008 >> 3);
        r8 = (player->moveState >> 1) & (0x00000002 >> 1);
        ...
        if (flags) {
            if (flags & 0x30000) {
                ...
                u32 gravityInverted = (gStageFlags & 0x0080);
# 593 "src/game/interactables_1/spikes.c"
                if (gravityInverted) {
                    if (flags & 0x20000) {
                        player->qSpeedAirY = 0;
                        player->qWorldY = ((s32)((screenY + s->hitboxes[0].bottom + player->spriteOffsetY)*256));
                        player->moveState |= 0x00000008;
                        player->moveState &= ~0x00000002;
                        player->stoodObj = s;
...
static bool32 HandleSpikeMovementDown(Sprite *s, MapEntity *me, Sprite_Spikes *spikes, Player *player)
{
    ...
    if (!(player->moveState & 0x00400000)) {
        u32 flags = Coll_Player_Platform(s, screenX, screenY, player);
        if (flags) {
            if ((flags & 0x20000) && !(gStageFlags & 0x0080)) {
                player->qWorldY = ((s32)(((screenY + s->hitboxes[0].bottom) + player->spriteOffsetY + 1)*256));
                player->qSpeedAirY = 0;
                player->qSpeedGround = 0;
            ...
            } else if ((flags & 0x10000) && (gStageFlags & 0x0080)) {

                player->qWorldY = ((s32)(((screenY + s->hitboxes[0].top) - player->spriteOffsetY - 1)*256));
                player->qSpeedAirY = 0;
                player->qSpeedGround = 0;
...
static bool32 HandleSpikeMovementHidingUp(Sprite *s, MapEntity *me, Sprite_Spikes *spikes, Player *player, u32 *param4)
{
    ...
    if (stageTimer[0] < 60) {
        if ((player->moveState & 0x00000008) && (player->stoodObj == s)) {
            player->moveState &= ~0x00000008;
            player->moveState |= 0x00000002;
        }


        if (spikes->playerMoveState[playerID] & 0x00000020) {
            player->moveState &= ~0x00000020;
        ...
        if ((s->variant != 0) || ((player->playerID != 0) && (*param4 != 0))) {
            ...
            u32 flags = Coll_Player_Platform(s, screenX, screenY, player);
            if (flags) {
                if ((flags & 0x10000) && !(gStageFlags & 0x0080)) {
                    flags = HandleSpikePlayerCollision(s, screenX, screenY, player);
                ...
                } else if ((flags & 0x20000) && (gStageFlags & 0x0080)) {
                    player->qWorldY = ((s32)((screenY + s->hitboxes[0].bottom + player->spriteOffsetY)*256));
                    player->moveState |= 0x00000008;
                    player->moveState &= ~0x00000002;
                    player->stoodObj = s;
    ...
    if (stageTimer[0] < 60) {
        ...
        if ((s->variant != 0) || ((player->playerID != 0) && (*param4 != 0))) {
            ...
            if ((Coll_Player_Entity_Intersection(s, screenX, screenY, player) == 0x80000)
                ...
                if (!(gStageFlags & 0x0080)) {
                    player->qWorldY = ((s32)((s->hitboxes[0].bottom + screenY - sp00[1])*256));
                } else {
                    player->qWorldY = ((s32)((s->hitboxes[0].top + screenY + sp00[1])*256));
                }
                if (!Coll_DamagePlayer(player)) {
                    return 1;
                }
            ...
            if (!(spikes->playerMoveState[playerID] & 0x00020000) || !Coll_DamagePlayer(player)) {
                return 1;
            }
        }
