...
void CreateEntity_RotatingHandle(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if (me->d.sData[0] >= 0) {
        ...
        Sprite_RotatingHandle *rotatingHandle = (void *)((t)->data);
...
static void Task_Idle(void)
{
    Sprite_RotatingHandle *rotatingHandle = (void *)((gCurTask)->data);
    Sprite *s = &rotatingHandle->s;
...
void Task_Rotating()
{
    ...
    rotatingHandle = (void *)((gCurTask)->data);
    ...
    if (gPlayer.frameInput & gPlayerControls.jump) {
        ...
        gPlayer.qSpeedAirX = ({((0x11) != 0) ? ((s32)((gSineTable[(r4) + 256]) << 1) / (s32)(0x11)) : 0;});
        gPlayer.qSpeedAirY = ({((0x11) != 0) ? ((s32)((gSineTable[(r4)]) << 1) / (s32)(0x11)) : 0;});
        gPlayer.charState = 50;
        gPlayer.unk6C = 1;
    } else {
        u8 r2;
        if (gPlayer.charState == 45) {
            r2 = ({((0x56) != 0) ? ((s32)(temp) / (s32)(0x56)) : 0;});
            if (r2 > 0xB) {
                r2 = 0xB;
            }
    ...
    if ((((u16)(sprite->x + (256 / 2)) > 426 + 256) || (sprite->y + (256 / 2) < 0) || (sprite->y > 240 + (256 / 2)))) {
...
static void Task_AfterJump(void)
{
    ...
    temp3 = ({((85) != 0) ? ((s32)(rotatingHandle->rot >> 4) / (s32)(85)) : 0;});
    if (temp3 > 0xB) {
        temp3 = 0xB;
    }
