# 0 "src/game/interactables_1/checkpoint.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/checkpoint.c"
...
# 2 "src/game/interactables_1/checkpoint.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_1/checkpoint.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_1/checkpoint.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "src/game/interactables_1/checkpoint.c" 2

# 1 "include/flags.h" 1
# 7 "src/game/interactables_1/checkpoint.c" 2
# 1 "include/sprite.h" 1
# 8 "src/game/interactables_1/checkpoint.c" 2
# 1 "include/task.h" 1
# 9 "src/game/interactables_1/checkpoint.c" 2
...
# 11 "src/game/interactables_1/checkpoint.c" 2
...
# 12 "src/game/interactables_1/checkpoint.c" 2
...
# 14 "src/game/interactables_1/checkpoint.c" 2
...
# 15 "src/game/interactables_1/checkpoint.c" 2
...
# 19 "src/game/interactables_1/checkpoint.c" 2
...
# 21 "src/game/interactables_1/checkpoint.c" 2
# 1 "include/constants/anim_commands.h" 1
# 22 "src/game/interactables_1/checkpoint.c" 2
# 1 "include/constants/songs.h" 1
# 23 "src/game/interactables_1/checkpoint.c" 2
...
static const u16 sAnimIdsCheckpoint[7 + 1][2] = {
    [0] = { 898, 0 }, [1] = { 899, 0 }, [2] = { 903, 0 }, [3] = { 902, 0 },
    [4] = { 904, 0 }, [5] = { 947, 0 }, [6] = { 905, 0 }, [7] = { 899, 0 },
};
...
{
    Sprite_Checkpoint *chkPt = (void *)((gCurTask)->data);
    Sprite *s = &chkPt->s;
    MapEntity *me = chkPt->base.me;
    s32 posX, posY;
    posX = ((chkPt->base.meX)*8 + (chkPt->base.regionX)*256);
    posY = ((me->y)*8 + (chkPt->base.regionY)*256);
    ...
    if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        ...
        if (!(gPlayer.moveState & (0x00400000 | 0x00000080)) && posX <= ((int)((gPlayer.qWorldX) >> 8))) {
...
{
    Sprite_Checkpoint *chkPt = (void *)((t)->data);
...
void TaskDestructor_PaletteLoader_Checkpoint(struct Task *unused)
{
    ...
    if (*cmd++ == -2) {
        ...
        DmaSet(3, &gRefSpriteTables->palettes[palId * 16], &gBgPalette[offset], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((numColors * sizeof(u16))/(32/8))));
...
static void Task_Interactable_Toggle_Checkpoint(void)
{
    Sprite_Toggle_Checkpoint *toggle = (void *)((gCurTask)->data);
    MapEntity *me = toggle->base.me;
    s32 posX, posY;
    s16 screenX, screenY;

    posX = ((toggle->base.meX)*8 + (toggle->base.regionX)*256);
    posY = ((me->y)*8 + (toggle->base.regionY)*256);

    screenX = posX - gCamera.x;
    screenY = posY - gCamera.y;

    if ((((u16)(screenX + (256 / 2)) > 426 + 256) || (screenY + (256 / 2) < 0) || (screenY > 240 + (256 / 2)))) {
        me->x = toggle->base.meX;
        TaskDestroy(gCurTask);
    } else if (!(gPlayer.moveState & (0x00400000 | 0x00000080)) && posX <= ((int)((gPlayer.qWorldX) >> 8))) {
        gPlayer.checkPointX = gCheckpointPositions[gCurrentLevel].x;
        gPlayer.checkPointY = gCheckpointPositions[gCurrentLevel].y;
        gPlayer.checkpointTime = gCheckpointTime;
...
{
    if (gBossIndex == 0) {
        struct Task *t = TaskCreate(Task_Interactable_Toggle_Checkpoint, sizeof(Sprite_Toggle_Checkpoint), 0x2010, 0, 
# 250 "src/game/interactables_1/checkpoint.c" 3 4
                                                                                                                     ((void *)0)
# 250 "src/game/interactables_1/checkpoint.c"
                                                                                                                         );

        Sprite_Toggle_Checkpoint *toggle = (void *)((t)->data);
    ...
    { s32 negativeTwo; s16 forMatching; negativeTwo = (-2); forMatching = negativeTwo; in_ia->x = forMatching; };
}
