# 0 "src/game/race_progress.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/race_progress.c"
# 1 "include/core.h" 1
...
# 2 "src/game/race_progress.c" 2
# 1 "include/task.h" 1
# 3 "src/game/race_progress.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/race_progress.c" 2
# 1 "include/malloc_vram.h" 1
# 5 "src/game/race_progress.c" 2
...
# 7 "src/game/race_progress.c" 2
# 1 "include/game/race_progress.h" 1



# 1 "include/global.h" 1
# 5 "include/game/race_progress.h" 2

void CreateRaceProgressIndicator(void);
# 8 "src/game/race_progress.c" 2
...
static const u16 sCourseStepSizes[] = {
    [(((((((0)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((0)*(3 + 1)) + (0))&1)))] = 816, [(((((((0)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((0)*(3 + 1)) + (1))&1)))] = 845,

    [(((((((1)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((1)*(3 + 1)) + (0))&1)))] = 560, [(((((((1)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((1)*(3 + 1)) + (1))&1)))] = 637,

    [(((((((2)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((2)*(3 + 1)) + (0))&1)))] = 618, [(((((((2)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((2)*(3 + 1)) + (1))&1)))] = 578,

    [(((((((3)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((3)*(3 + 1)) + (0))&1)))] = 557, [(((((((3)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((3)*(3 + 1)) + (1))&1)))] = 748,

    [(((((((4)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((4)*(3 + 1)) + (0))&1)))] = 1024, [(((((((4)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((4)*(3 + 1)) + (1))&1)))] = 800,

    [(((((((5)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((5)*(3 + 1)) + (0))&1)))] = 512, [(((((((5)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((5)*(3 + 1)) + (1))&1)))] = 744,

    [(((((((6)*(3 + 1)) + (0)) / (3 + 1)) << 0x19 >> 0x18) | ((((6)*(3 + 1)) + (0))&1)))] = 448, [(((((((6)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((6)*(3 + 1)) + (1))&1)))] = 464,
};
...
void CreateRaceProgressIndicator(void)
{
    ...
    struct RaceProgressIndicator *progressIndicator = (void *)((t)->data);

    progressIndicator->course = (((gCurrentLevel) >> 1) + ((gCurrentLevel)&1));

    for (i = 0; i < 4; i++) {
        if (gMultiplayerPlayerTasks[i] == 
# 66 "src/game/race_progress.c" 3 4
                                         ((void *)0)
# 66 "src/game/race_progress.c"
                                             ) {
            break;
        }
    }
...
static void Task_UpdateAvatarPositions(void)
{
    ...
    struct RaceProgressIndicator *progressIndicator = (void *)((gCurTask)->data);
...
static void RenderUI(struct RaceProgressIndicator *progressIndicator)
{
    ...
    if (gPlayer.moveState & 0x00100000) {
        return;
    }
    ...
    for (i = 0; i < (sizeof(progressIndicator->flags) / sizeof((progressIndicator->flags)[0])); i++) {
