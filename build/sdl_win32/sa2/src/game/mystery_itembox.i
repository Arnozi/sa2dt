# 0 "src/game/mystery_itembox.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/mystery_itembox.c"
# 1 "include/core.h" 1
...
# 2 "src/game/mystery_itembox.c" 2
# 1 "include/malloc_vram.h" 1
# 3 "src/game/mystery_itembox.c" 2
...
# 4 "src/game/mystery_itembox.c" 2
...
# 6 "src/game/mystery_itembox.c" 2
...
# 7 "src/game/mystery_itembox.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "src/game/mystery_itembox.c" 2
...
# 14 "src/game/mystery_itembox.c" 2
# 1 "include/constants/char_states.h" 1
# 15 "src/game/mystery_itembox.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/mystery_itembox.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/mystery_itembox.c" 2
...
static const u16 gUnknown_080E02AA[][3] = { { 725, 9, 4 },
                                            { 725, 12, 4 } };
...
{
    Sprite_MysteryItemBox *itemBox = (void *)((gCurTask)->data);
    SpriteTransform *transform;
    Sprite *identifier;
    ...
    switch (itemBox->unk82) {
        case 0: {
            ...
            if (!((gCurrentLevel) == ((7)*(3 + 1)) + (1))) {
                if (({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}) != ({((100) != 0) ? ((s32)(prevRingCount) / (s32)(100)) : 0;}) && gGameMode == 0) {

                    gNumLives = (((gNumLives + 1) < (255u)) ? (gNumLives + 1) : (255u));
...
{
    Sprite_MysteryItemBox *itemBox = (void *)((t)->data);
