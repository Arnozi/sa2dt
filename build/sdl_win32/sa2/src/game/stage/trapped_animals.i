# 0 "src/game/stage/trapped_animals.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/trapped_animals.c"
...
# 2 "src/game/stage/trapped_animals.c" 2
# 1 "include/trig.h" 1
...
# 3 "src/game/stage/trapped_animals.c" 2
...
# 5 "src/game/stage/trapped_animals.c" 2
...
# 7 "src/game/stage/trapped_animals.c" 2
...
# 8 "src/game/stage/trapped_animals.c" 2
...
# 9 "src/game/stage/trapped_animals.c" 2
...
# 10 "src/game/stage/trapped_animals.c" 2
...
# 12 "src/game/stage/trapped_animals.c" 2
...
# 67 "src/game/stage/trapped_animals.c"
...
static const TrappedAnimalData sAnimsTrappedAnimals[][3] = {
    {
        { 192, 523, 0, 0 },
        { 196, 528, 0, 0 },
        { 200, 527, 0, 2 },
...
{
    struct Task *t = TaskCreate(Task_FlyingAnimal, sizeof(FlyingAnimal), 0x2000, 0, 
# 125 "src/game/stage/trapped_animals.c" 3 4
                                                                                   ((void *)0)
# 125 "src/game/stage/trapped_animals.c"
                                                                                       );
...
static void Task_FlyingAnimal(void)
{
    ...
    x += ({((20) != 0) ? ((s32)((gSineTable[(animal->unk38 & (1024 - 1)) + 256])) / (s32)(20)) : 0;}) >> 3;
    y += ({((20) != 0) ? ((s32)((gSineTable[(animal->unk38 & (1024 - 1))])) / (s32)(20)) : 0;}) >> 1;
    ...
    if (((s->x < -(32)) || (s->x > 426 + (32)) || ((s->y) + (32) < 0) || (s->y > 240 + (32)))) {
...
{
    struct Task *t = TaskCreate(Task_BouncingAnimal, sizeof(BouncingAnimal), 0x2000, 0, 
# 190 "src/game/stage/trapped_animals.c" 3 4
                                                                                       ((void *)0)
# 190 "src/game/stage/trapped_animals.c"
                                                                                           );
...
static void Task_BouncingAnimal(void)
{
    ...
    if (animal->inAirTimer > 0) {
        ...
        s32 clampedY = y + ((s32)((sub_801F07C(((int)((animal->y) >> 8)), ((int)((animal->x) >> 8)), 1, 8, 
# 230 "src/game/stage/trapped_animals.c" 3 4
                          ((void *)0)
# 230 "src/game/stage/trapped_animals.c"
                          , sub_801EE64))*256));
...
{
    struct Task *t = TaskCreate(Task_StaticAnimalMain, sizeof(StaticAnimal), 0x2000, 0, 
# 257 "src/game/stage/trapped_animals.c" 3 4
                                                                                       ((void *)0)
# 257 "src/game/stage/trapped_animals.c"
                                                                                           );
...
static void Task_StaticAnimalMain(void)
{
    ...
    if (animal->inAirTimer > 0) {
        ...
        s32 clampedY = y + ((s32)((sub_801F07C(((int)((animal->y) >> 8)), ((int)((animal->x) >> 8)), 1, 8, 
# 298 "src/game/stage/trapped_animals.c" 3 4
                          ((void *)0)
# 298 "src/game/stage/trapped_animals.c"
                          , sub_801EE64))*256));
