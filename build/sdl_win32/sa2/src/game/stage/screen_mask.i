...
void ScreenMask_Lower_OriginLeft(int_vcount y, u16 angle)
{
    ...
    if (bgOffsets == 
# 21 "src/game/stage/screen_mask.c" 3 4
                    ((void *)0)
# 21 "src/game/stage/screen_mask.c"
                        ) {
        return;
    }
...
static void sub_802E278(s16 *p0, u8 pairCount)
{
    ...
    for (i = 0; i < pairCount - 1; i++) {
        ...
        if (v != 0) {
            r4 = ({((pairs[i][1] - pairs[i + 1][1]) != 0) ? ((s32)(((s32)((xVal - pairs[i + 1][0])*256))) / (s32)(pairs[i][1] - pairs[i + 1][1])) : 0;});
        } else {
...
static void sub_802E384(s16 *p0, u16 pairCount)
{
    ...
    for (j = 0; j < pairCount - 1; j++) {
        ...
        if (yVal != 0) {
            r4 = ({((yVal) != 0) ? ((s32)(((s32)((xVal - sp[j + 1][0])*256))) / (s32)(yVal)) : 0;});
        } else {
...
static void sub_802E49C(s16 *input, u8 pairCount)
{
    ...
    if (temp != 0) {
        temp3 = ({((another_pair_2[1] - another_pair_1[1]) != 0) ? ((s32)(((s32)((another_pair_2[0] - another_pair_1[0])*256)) + ((s32)((0.5)*256))) / (s32)(another_pair_2[1] - another_pair_1[1])) : 0;});
    } else {
...
void ScreenMask_CreateShape(u16 angle, u16 width, u16 c, s16 x, s16 y, u8 d)
{
    ...
    gHBlankCopyTarget = (void *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0));
    gFlags |= 0x4;



    if (x > 0 && x < 426 && y < 240 && x > 0) {
        u16 i;



        if (gBgOffsetsHBlankPrimary == gBgOffsetsBuffer) {
            { u16 tmp = (u16)(0); DmaSet(3, &tmp, &gBgOffsetsBuffer[0], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[0]))/(16/8)))); };
        } else {
            { u16 tmp = (u16)(0); DmaSet(3, &tmp, &gBgOffsetsBuffer[1], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[1]))/(16/8)))); };
        }
        ...
        if (angle > ((int)((((double)(90)) / 360.0) * 1024)) && angle < ((int)((((double)(270)) / 360.0) * 1024)) && x >= 426) {
            r7 = ((int)(((gSineTable[(angle)]) * (x - 426)) >> 14));
            r7 += y;
            ...
            if (r7 > 0 && r7 < 240) {
                ...
                r3 = 426 + 1;
                if (gBgOffsetsHBlankPrimary == gBgOffsetsBuffer) {
                    { u16 tmp = (u16)(r3); DmaSet(3, &tmp, &gBgOffsetsBuffer[0], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[0]))/(16/8)))); };
                } else {
                    { u16 tmp = (u16)(r3); DmaSet(3, &tmp, &gBgOffsetsBuffer[1], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[1]))/(16/8)))); };
                }
        ...
        if (angle > ((int)((((double)(180)) / 360.0) * 1024))) {
            if (y >= 240) {
                s16 r3, r4;
                r6 = ((int)(((gSineTable[(angle) + 256]) * (y - 240)) >> 14));
                r6 += x;
