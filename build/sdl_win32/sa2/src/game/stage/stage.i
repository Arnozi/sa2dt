# 0 "src/game/stage/stage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/stage.c"
...
# 3 "src/game/stage/stage.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/stage/stage.c" 2
...
# 7 "src/game/stage/stage.c" 2
# 1 "include/game/sa1_sa2_shared/palette_loader.h" 1
...
# 8 "src/game/stage/stage.c" 2
# 1 "include/game/sa1_sa2_shared/pause_menu.h" 1



void CreatePauseMenu(void);
# 9 "src/game/stage/stage.c" 2
...
# 15 "src/game/stage/stage.c" 2
# 1 "include/game/race_progress.h" 1
...
# 21 "src/game/stage/stage.c" 2



# 1 "include/game/multiplayer/finish.h" 1
...
# 25 "src/game/stage/stage.c" 2
# 1 "include/game/multiplayer/indicators.h" 1
...
# 26 "src/game/stage/stage.c" 2
# 1 "include/game/multiboot/collect_rings/time_display.h" 1
...
# 32 "src/game/stage/stage.c" 2

# 1 "include/constants/songs.h" 1
# 34 "src/game/stage/stage.c" 2
...
# 37 "src/game/stage/stage.c" 2



struct Task *gGameStageTask = 
# 40 "src/game/stage/stage.c" 3 4
                             ((void *)0)
# 40 "src/game/stage/stage.c"
                                 ;
...
const VoidFn sStageInitProcs[34] = { StageInit_Zone1Act1,
                                                StageInit_Zone1Act2,
...
void ApplyGameStageSettings(void)
{
    ...
    if ((gStageFlags & 0x0040)) {
        SetPlayerControls(0x0001, 0x0002, 0x0100);
    } else {
...
void GameStageStart(void)
{
    ...
    if (gCurrentLevel != ((7)*(3 + 1)) + (1)) {
        ...
        gCheese = 
# 164 "src/game/stage/stage.c" 3 4
                 ((void *)0)
# 164 "src/game/stage/stage.c"
                     ;
    }
...
void CreateGameStage(void)
{
    ...
    if (((((gCurrentLevel) & ((3 + 1) - 1)) == 2) || (((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && !gFinalBossActive) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
        gBossCameraClampYLower = gBossCameraYClamps[((gCurrentLevel) >> 2)][0];
        gBossCameraClampYUpper = gBossCameraYClamps[((gCurrentLevel) >> 2)][1];
...

    {
        ...
        gPlayer.moveState &= ~(0x00400000 | 0x00200000);
        gStageFlags &= ~0x0001;
    }
    ...
    gCheese = 
# 300 "src/game/stage/stage.c" 3 4
             ((void *)0)
# 300 "src/game/stage/stage.c"
                 ;
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && gGameMode != 5) {
...
# 332 "src/game/stage/stage.c"
...

    {
        ...
        if (!(((gMultiplayerConnections) >> (gCamera.spectatorTarget)) & 1)) {
            gCamera.spectatorTarget = sioId;
        }
    ...
    if (gStageFlags & 0x0004) {
        ...
        if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            ...
            if ((gLoadedSaveGame)->timeLimitDisabled && (gGameMode == 0 || (!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))))) {
                return;
            }
...
void StageInit_Zone1Act1(void)
{
    ...
    CreatePaletteLoaderTask(0x2000, 897, 0, 
# 589 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 589 "src/game/stage/stage.c"
                                               );
...
void StageInit_Zone3Act1(void)
{
    CreatePaletteLoaderTask(0x2000, 900, 0, 
# 596 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 596 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 900, 1, 
# 597 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 597 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 900, 2, 
# 598 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 598 "src/game/stage/stage.c"
                                               );
...
{
    CreatePaletteLoaderTask(0x2000, 900, 0, 
# 605 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 605 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 900, 1, 
# 606 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 606 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 900, 2, 
# 607 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 607 "src/game/stage/stage.c"
                                               );
...
void StageInit_Zone4Act1(void)
{
    CreatePaletteLoaderTask(0x2000, 906, 2, 
# 614 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 614 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 906, 0, 
# 615 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 615 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 906, 1, 
# 616 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 616 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 901, 0, 
# 617 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 617 "src/game/stage/stage.c"
                                               );
...
{
    CreatePaletteLoaderTask(0x2000, 906, 2, 
# 624 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 624 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 906, 0, 
# 625 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 625 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 906, 1, 
# 626 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 626 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 901, 0, 
# 627 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 627 "src/game/stage/stage.c"
                                               );
...
void StageInit_Zone6Act1(void)
{
    CreatePaletteLoaderTask(0x2000, 940, 0, 
# 634 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 634 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 1, 
# 635 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 635 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 2, 
# 636 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 636 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 3, 
# 637 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 637 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 4, 
# 638 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 638 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 5, 
# 639 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 639 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 6, 
# 640 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 640 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 7, 
# 641 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 641 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 8, 
# 642 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 642 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 9, 
# 643 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 643 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 11, 
# 644 "src/game/stage/stage.c" 3 4
                                            ((void *)0)
# 644 "src/game/stage/stage.c"
                                                );
...
{
    CreatePaletteLoaderTask(0x2000, 940, 0, 
# 651 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 651 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 1, 
# 652 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 652 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 2, 
# 653 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 653 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 3, 
# 654 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 654 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 4, 
# 655 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 655 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 5, 
# 656 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 656 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 6, 
# 657 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 657 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 7, 
# 658 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 658 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 8, 
# 659 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 659 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 9, 
# 660 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 660 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 940, 11, 
# 661 "src/game/stage/stage.c" 3 4
                                            ((void *)0)
# 661 "src/game/stage/stage.c"
                                                );
...
void StageInit_Zone7Act1(void)
{
    CreatePaletteLoaderTask(0x2000, 941, 0, 
# 668 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 668 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 942, 0, 
# 669 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 669 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 943, 0, 
# 670 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 670 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 944, 0, 
# 671 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 671 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 945, 0, 
# 672 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 672 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 946, 0, 
# 673 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 673 "src/game/stage/stage.c"
                                               );
...
{
    CreatePaletteLoaderTask(0x2000, 941, 0, 
# 680 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 680 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 942, 0, 
# 681 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 681 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 943, 0, 
# 682 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 682 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 944, 0, 
# 683 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 683 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 945, 0, 
# 684 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 684 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 946, 0, 
# 685 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 685 "src/game/stage/stage.c"
                                               );
...
{
    CreatePaletteLoaderTask(0x2000, 941, 0, 
# 692 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 692 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 942, 0, 
# 693 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 693 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 943, 0, 
# 694 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 694 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 944, 0, 
# 695 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 695 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 945, 0, 
# 696 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 696 "src/game/stage/stage.c"
                                               );
    CreatePaletteLoaderTask(0x2000, 946, 0, 
# 697 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 697 "src/game/stage/stage.c"
                                               );
...
void DestroyStageTasks(void)
{
    ...
    gGameStageTask = 
# 706 "src/game/stage/stage.c" 3 4
                    ((void *)0)
# 706 "src/game/stage/stage.c"
                        ;
...
void GoToNextLevel(void)
{
    ...
    gBgSpritesCount = 0;
    gVramGraphicsCopyCursor = gVramGraphicsCopyQueueIndex;;
# 775 "src/game/stage/stage.c"
    WriteSaveGame();
# 793 "src/game/stage/stage.c"
    if (gGameMode == 0)
...
void TaskDestructor_GameStage(struct Task *t)
{
    ...
    gGameStageTask = 
# 816 "src/game/stage/stage.c" 3 4
                    ((void *)0)
# 816 "src/game/stage/stage.c"
                        ;
...
{
    CreatePaletteLoaderTask(0x2000, 897, 0, 
# 825 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 825 "src/game/stage/stage.c"
                                               );
...
void StageInit_Zone5ActBoss(void)
{
    CreatePaletteLoaderTask(0x2000, 686, 0, 
# 848 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 848 "src/game/stage/stage.c"
                                               );
...
{
    CreatePaletteLoaderTask(0x2000, 686, 0, 
# 857 "src/game/stage/stage.c" 3 4
                                           ((void *)0)
# 857 "src/game/stage/stage.c"
                                               );
