...
u16 CreateStageResults(u32 courseTime, u16 ringCount, u8 spRingCount)
{
    ...
    if (outro->base.spRingBonusScore > outro->base.ringBonusScore) {
        if (outro->base.spRingBonusScore > outro->base.timeBonusScore) {
            outro->base.unk16C = ({((100) != 0) ? ((s32)(outro->base.spRingBonusScore) / (s32)(100)) : 0;});
        } else {
            outro->base.unk16C = ({((100) != 0) ? ((s32)(outro->base.timeBonusScore) / (s32)(100)) : 0;});
        }
    } else {
        if (outro->base.ringBonusScore > outro->base.timeBonusScore) {
            outro->base.unk16C = ({((100) != 0) ? ((s32)(outro->base.ringBonusScore) / (s32)(100)) : 0;});
        } else {
            outro->base.unk16C = ({((100) != 0) ? ((s32)(outro->base.timeBonusScore) / (s32)(100)) : 0;});
        }
    }
...
static void Task_UpdateStageResults(void)
{
    StageResults *outro = (void *)((gCurTask)->data);
    ...
    if (counter >= 150) {
        ...
        if (!((((gCurrentLevel) == ((7)*(3 + 1)) + (0))) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
            if (gPressedKeys & 0x0001) {
                { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += outro->base.ringBonusScore; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (0) gMusicManagerState.unk3 = 0x10 | 0x0; } };
                { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += outro->base.spRingBonusScore; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (0) gMusicManagerState.unk3 = 0x10 | 0x0; } };
                { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += outro->base.timeBonusScore; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (0) gMusicManagerState.unk3 = 0x10 | 0x0; } };
...
static void AnimateResults(u16 frame)
{
    ...
    if (counter >= 39) {
...

        {
            s16 r4_2 = r4;
            s16 pp = frame;
            StageUI_PrintIntegerAt(outro->base.timeBonusScore, r4_2 + 144 - pp, (240 / 2) + 10, 0);
        }
    }
    ...
    if (counter >= 49) {
...

        {
            s16 r4_2 = r4;
            s16 pp = frame;
            StageUI_PrintIntegerAt(outro->base.ringBonusScore, r4_2 + 144 - pp, (240 / 2) + 30, 0);
        }
    }
    ...
    if ((((gCurrentLevel) & ((3 + 1) - 1)) != 2) && (gCurrentLevel < ((7)*(3 + 1)) + (0)) && (counter >= 59)) {
...

        {
            s16 r4_2 = r4;
            s16 pp = frame;
            StageUI_PrintIntegerAt(outro->base.spRingBonusScore, r4_2 + 144 - pp, (240 / 2) + 50, 0);
        }
    }
}
...
{
    StageResults *outro = (void *)((t)->data);
    if (outro->base.separator.graphics.dest != 
# 642 "src/game/stage/results.c" 3 4
                                              ((void *)0)
# 642 "src/game/stage/results.c"
                                                  ) {
...
static void DestroyStageResultsGfx(void)
{
    StageResults *outro = (void *)((gCurTask)->data);
    if (outro->base.separator.graphics.dest != 
# 656 "src/game/stage/results.c" 3 4
                                              ((void *)0)
# 656 "src/game/stage/results.c"
                                                  ) {
        VramFree(outro->base.separator.graphics.dest);
        VramFree(outro->base.title[0].graphics.dest);
        VramFree(outro->base.title[1].graphics.dest);
        ...
        outro->base.separator.graphics.dest = 
# 665 "src/game/stage/results.c" 3 4
                                             ((void *)0)
# 665 "src/game/stage/results.c"
                                                 ;
    }
}
