...
{
    StageResultsInit *sri = (void *)((gCurTask)->data);
...
void Task_802EE78(void)
{
    ...
    if (++sri->unk10 > 8) {
        ...
        if (((gCurrentLevel) == ((7)*(3 + 1)) + (0))) {
            ...
            if (gCheese != 
# 116 "src/game/stage/boss_results_transition.c" 3 4
                          ((void *)0)
# 116 "src/game/stage/boss_results_transition.c"
                              ) {
...
{
    struct Task *t = TaskCreate(Task_802EE78, sizeof(StageResultsInit), 0x6080, 0, 
# 130 "src/game/stage/boss_results_transition.c" 3 4
                                                                                  ((void *)0)
# 130 "src/game/stage/boss_results_transition.c"
                                                                                      );
    StageResultsInit *sri = (void *)((t)->data);
    ScreenFade *ts = &sri->ts;
...
void InitHBlankBgOffsets(u16 xOffset)
{
    if (gBgOffsetsHBlankPrimary == &gBgOffsetsBuffer) {
        ...
        { u32 tmp = (u32)(xOffset); DmaSet(3, &tmp, &gBgOffsetsBuffer[0][0], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[0]))/(32/8)))); };



    } else {

        { u32 tmp = (u32)(xOffset); DmaSet(3, &tmp, &gBgOffsetsBuffer[1][0], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[1]))/(32/8)))); };
