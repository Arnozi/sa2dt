# 0 "src/game/stage/debug_text_printer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/debug_text_printer.c"
...
# 2 "src/game/stage/debug_text_printer.c" 2
...
void VramFree(void *);
# 3 "src/game/stage/debug_text_printer.c" 2
...
# 4 "src/game/stage/debug_text_printer.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/stage/debug_text_printer.c" 2
...
# 8 "src/game/stage/debug_text_printer.c" 2

typedef struct {
    Sprite chars[94];
} DebugTextPrinter;

static struct Task *sDebugUITask = 
# 13 "src/game/stage/debug_text_printer.c" 3 4
                                  ((void *)0)
# 13 "src/game/stage/debug_text_printer.c"
                                      ;
...
struct Task *Debug_CreateAsciiTask(s16 x, s16 y)
{
    ...
    DebugTextPrinter *printer = (void *)((t)->data);
    u32 i;
    ...
    for (i = 0; i < 94; i++) {
        ...
        if (i == 0) {
            s->graphics.dest = VramMalloc((2 * 94));
        } else {
            s->graphics.dest = (printer->chars[0].graphics.dest + (i * (2 * 32)));
        }
...
{
    Sprite *digits = (Sprite *)&(((DebugTextPrinter *)(void *)((sDebugUITask)->data))->chars[('0') - '!']);
    s32 base = 10;
    u32 remaining = 1;
    u32 numDigits;
    u32 digitX;
...
void Debug_PrintTextAt(char *text, s16 x, s16 y)
{
    ...
    Sprite *baseChar = (Sprite *)&(((DebugTextPrinter *)(void *)((sDebugUITask)->data))->chars[('\000') - '!']);
    u8 i;
...
void TaskDestructor_802D4B8(struct Task *t)
{
    ...
    sDebugUITask = 
# 142 "src/game/stage/debug_text_printer.c" 3 4
                  ((void *)0)
# 142 "src/game/stage/debug_text_printer.c"
                      ;
...
{
    if (sDebugUITask != 
# 149 "src/game/stage/debug_text_printer.c" 3 4
                       ((void *)0)
# 149 "src/game/stage/debug_text_printer.c"
                           )
