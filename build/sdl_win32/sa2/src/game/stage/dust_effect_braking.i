# 0 "src/game/stage/dust_effect_braking.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/dust_effect_braking.c"
...
# 2 "src/game/stage/dust_effect_braking.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/stage/dust_effect_braking.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/stage/dust_effect_braking.c" 2
...
# 5 "src/game/stage/dust_effect_braking.c" 2
...
# 6 "src/game/stage/dust_effect_braking.c" 2
...
# 7 "src/game/stage/dust_effect_braking.c" 2
...
# 9 "src/game/stage/dust_effect_braking.c" 2
...
# 26 "src/game/stage/dust_effect_braking.c"
struct Task *CreateBrakingDustEffect(s32 x, s32 y)
{
    if (gDustEffectBrakingTask.t == 
# 28 "src/game/stage/dust_effect_braking.c" 3 4
                                   ((void *)0) 
# 28 "src/game/stage/dust_effect_braking.c"
                                        || gDustEffectBrakingTask.unk0 == 0) {
        return 
# 29 "src/game/stage/dust_effect_braking.c" 3 4
              ((void *)0)
# 29 "src/game/stage/dust_effect_braking.c"
                  ;
    } else {
        struct Task *t;
        BrakeDustEffect *bde;
        ...
        t = TaskCreate(Task_BrakingDustEffect, sizeof(BrakeDustEffect), 0x4001, 0, TaskDestructor_BrakingDustEffect);
        ...
        if (p->moveState & 0x08000000) {
            ...
            s->graphics.dest = ((void *)&VRAM[0x10000] + 0x2300);
            s->graphics.anim = 848;
            s->variant = 0;
            s->frameFlags = ((2) << (12));
...
{
    if (gDustEffectBrakingTask.t == 
# 97 "src/game/stage/dust_effect_braking.c" 3 4
                                   ((void *)0)
# 97 "src/game/stage/dust_effect_braking.c"
                                       ) {
...
{
    if (gDustEffectBrakingTask.t != 
# 106 "src/game/stage/dust_effect_braking.c" 3 4
                                   ((void *)0)
# 106 "src/game/stage/dust_effect_braking.c"
                                       ) {
        TaskDestroy(gDustEffectBrakingTask.t);
        gDustEffectBrakingTask.t = 
# 108 "src/game/stage/dust_effect_braking.c" 3 4
                                  ((void *)0)
# 108 "src/game/stage/dust_effect_braking.c"
                                      ;
    }
}

void TaskDestructor_BrakingDustEffectRelated(struct Task *t) { gDustEffectBrakingTask.t = 
# 112 "src/game/stage/dust_effect_braking.c" 3 4
                                                                                         ((void *)0)
# 112 "src/game/stage/dust_effect_braking.c"
                                                                                             ; }
...
{
    BrakeDustEffect *bde = (void *)((t)->data);
    Sprite *s = &bde->s;

    if (s->graphics.anim == 872) {
