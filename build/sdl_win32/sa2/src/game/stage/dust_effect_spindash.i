# 0 "src/game/stage/dust_effect_spindash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/dust_effect_spindash.c"
...
# 2 "src/game/stage/dust_effect_spindash.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/stage/dust_effect_spindash.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/stage/dust_effect_spindash.c" 2
# 1 "include/task.h" 1
# 5 "src/game/stage/dust_effect_spindash.c" 2
...
# 7 "src/game/stage/dust_effect_spindash.c" 2
...
# 9 "src/game/stage/dust_effect_spindash.c" 2
...
# 10 "src/game/stage/dust_effect_spindash.c" 2
...
# 11 "src/game/stage/dust_effect_spindash.c" 2
...
# 13 "src/game/stage/dust_effect_spindash.c" 2
...
void Task_SpindashDustEffect(void)
{
    ...
    if (p->spriteTask == 
# 52 "src/game/stage/dust_effect_spindash.c" 3 4
                        ((void *)0) 
# 52 "src/game/stage/dust_effect_spindash.c"
                             || (p->moveState & (0x00000400 | 0x00000080)) != 0x00000400) {
        ...
        if (p->spindashAccel > ((s32)((2.0)*256))) {
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
            struct Task *t = gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id];
...
void Task_SpindashDustEffectBig(void)
{
    ...
    if (p->spriteTask == 
# 113 "src/game/stage/dust_effect_spindash.c" 3 4
                        ((void *)0) 
# 113 "src/game/stage/dust_effect_spindash.c"
                             || (p->moveState & (0x00000400 | 0x00000080)) != 0x00000400) {
        TaskDestroy(gCurTask);
        return;
    } else {
