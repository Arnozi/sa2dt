# 0 "src/game/stage/player_super_sonic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/player_super_sonic.c"
...
# 2 "src/game/stage/player_super_sonic.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/stage/player_super_sonic.c" 2
# 1 "include/trig.h" 1
...
# 4 "src/game/stage/player_super_sonic.c" 2
...
# 5 "src/game/stage/player_super_sonic.c" 2
...
# 7 "src/game/stage/player_super_sonic.c" 2
...
# 8 "src/game/stage/player_super_sonic.c" 2
...
# 9 "src/game/stage/player_super_sonic.c" 2
...
# 1 "include/sprite.h" 1
# 6 "include/game/bosses/boss_9.h" 2
...
# 11 "src/game/stage/player_super_sonic.c" 2
...
# 12 "src/game/stage/player_super_sonic.c" 2
...
# 13 "src/game/stage/player_super_sonic.c" 2
...
# 14 "src/game/stage/player_super_sonic.c" 2
...
# 15 "src/game/stage/player_super_sonic.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 17 "src/game/stage/player_super_sonic.c" 2
...
# 19 "src/game/stage/player_super_sonic.c" 2
# 1 "include/constants/char_states.h" 1
# 20 "src/game/stage/player_super_sonic.c" 2


# 1 "include/constants/songs.h" 1
# 23 "src/game/stage/player_super_sonic.c" 2
...
struct Task *sSuperSonicTask = 
# 43 "src/game/stage/player_super_sonic.c" 3 4
                              ((void *)0)
# 43 "src/game/stage/player_super_sonic.c"
                                  ;
...
const TileInfo gAnims_SuperSonic_080D69C8[23] = {
    ...
    { 0, 475, 14 }, { 0, 475, 15 },
    { 0, 475, 18 }, { 0, 475, 19 },
    { 0, 476, 0 }, { 0, ((29) + CHARACTER_SONIC * (91)), 0 },
    { 0, 475, 2 },
};
...
static void SuperSonicInitPlayer(void)
{
    ...
    p->layer = 0;
    p->stoodObj = 
# 87 "src/game/stage/player_super_sonic.c" 3 4
                 ((void *)0)
# 87 "src/game/stage/player_super_sonic.c"
                     ;
    p->maxSpeed = 0;
    p->topSpeed = 0;
    p->acceleration = 0;
...
void SuperSonicInit()
{
    ...
    gPlayer.qSpeedAirX = ((s32)((2.0)*256));
    gPlayer.qSpeedGround = ((s32)((2.0)*256));

    gCourseTime = 0;

    t = TaskCreate(Task_802BC10, sizeof(struct SuperSonic), 0x4040, 0, 
# 146 "src/game/stage/player_super_sonic.c" 3 4
                                                                      ((void *)0)
# 146 "src/game/stage/player_super_sonic.c"
                                                                          );
    sSuperSonicTask = t;
    sonic = (void *)((t)->data);

    sonic->flags = 0x20;
    sonic->worldX = ((s32)((600)*256));
    sonic->worldY = ((s32)((288)*256));
    sonic->unk10 = 0;
    sonic->unk14 = 0;
    sonic->unk1A = 0;
    sonic->rotation = 0;
    ...
    sonic->shouldDestroy = 0;

    spr = &sonic->spr;
    spr->graphics.dest = (void *)(&VRAM[0x10000]);
...
void sub_802B81C(void)
{
    ...
    sonic = (void *)((sSuperSonicTask)->data);
    sSuperSonicTask->main = Task_802C7E8;
    sonic->func24 = sub_802C8A0;

    { sonic->tileInfoId = 2; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[2].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[2].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
}
...
static s32 sub_802B8A8(struct SuperSonic *sonic)
{
    ...
    if (!(sonic->flags & 0x10) && !(gStageFlags & 0x0100)) {
        if (gCourseTime >= ((int)(((10 * 60.) + 0) * 60)) && !gLoadedSaveGame->timeLimitDisabled) {
            ...
            { sonic->tileInfoId = 21; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[21].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[21].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
        } else if (!(sonic->flags & 0x200)) {
            if (({((60) != 0) ? ((s32)(gStageTime) % (s32)(60)) : 0;}) == 0) {
                if (gRingCount == 0) {
                    u32 flags;
                    gPlayer.moveState = 0x00000080;
            ...
            if (ExtraBossIsDead() == 1) {
                gStageFlags |= (0x0001 | 0x0002);
                sonic->func24 = sub_802C8A0;
...
{
    struct SuperSonic *sonic = (void *)((sSuperSonicTask)->data);
    ...
    { sonic->tileInfoId = 3; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[3].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[3].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
...
void sub_802BB54(void)
{
    ...
    { sonic->tileInfoId = 20; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[20].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[20].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
...
static void Task_802BC10(void)
{
    struct SuperSonic *sonic = (void *)((gCurTask)->data);
    sub_802BCCC(sonic);
    sonic->func24(sonic);
    sub_802C9B0(sonic);
    sub_802B8A8(sonic);
...
void sub_802BCCC(struct SuperSonic *sonic)
{
    ...
    ssx2 = ((s32)((gUnknown_080D650C[gCurrentLevel].x)*256));
    id = &sonic->unk128;
    ...
    if (ssx >= ssx2) {
        ...
        ssx += ((s32)((someX)*256));
        TrueArea53BossMove(((s32)((someX)*256)), ((s32)((someY)*256)));

        for (i = 0; i < (sizeof(sonic->unk28) / sizeof((sonic->unk28)[0])); i++) {
            sonic->unk28[i].x += ((s32)((someX)*256));
            sonic->unk28[i].y += ((s32)((someY)*256));
        }
    ...
    if (sonic->func24 != sub_802C8A0) {
        if (ssx < (((s32)((gCamera.unk10)*256)) + ((s32)((8)*256)))) {
            ssx = ((s32)((gCamera.unk10)*256)) + ((s32)((8)*256));
        } else if (ssx > (((s32)((gCamera.unk10)*256)) + ((s32)((312)*256)))) {
            ssx = ((s32)((gCamera.unk10)*256)) + ((s32)((312)*256));
        }
    }
    sonic->worldX = ssx;
    ...
    *id = (id2 + 1) % (sizeof(sonic->unk28) / sizeof((sonic->unk28)[0]));
}
...
static void sub_802BE1C(struct SuperSonic *sonic)
{
    ...
    if (((sonic->flags & (0x80 | 0x2)) == 0x80) && (gStageTime & 0x4)) {
        return;
    }
    if ((sonic->flags & 0x4) && ((gStageTime & 0x4) != 0)) {
        return;
    }
    ...
    spr->x = ((int)((sonic->worldX) >> 8)) - gCamera.x + ((int)((sonic->unk10) >> 8));
    spr->y = ((int)((sonic->worldY) >> 8)) - gCamera.y + ((int)((sonic->unk14) >> 8));

    prio = (sonic->flags & 0x200) ? 3 : 0;

    if (sonic->flags & 0x4) {
        spr->frameFlags
            = ((prio) << (12)) | gOamMatrixIndex++ | ((1) << (6)) | ((1) << (5));
    } else {
        spr->frameFlags = ((prio) << (12)) | ((1) << (10));
    }
    UpdateSpriteAnimation(spr);

    if (sonic->flags & 0x4) {
        transform->rotation = ((gSineTable[((sonic->unkC * 20) & (1024 - 1)) + 256]) >> 4) & (1024 - 1);
        ...
        if (((sonic->flags & (0x80 | 0x2)) == 0x80)) {
            return;
        }

        if (sonic->flags & (0x200 | 0x10 | 0x8)) {
            return;
        }
        ...
        unk128 = &sonic->unk128;
        for (; i < 3; i++) {
            if (({((i + 2) != 0) ? ((s32)(gStageTime) % (s32)(i + 2)) : 0;}) == 0) {
                s32 ii = (i + 1) * 3;

                u32 r2 = (*unk128 - ii) % 32u;
                spr->x = ((int)((sonic->unk28[r2].x) >> 8)) - gCamera.x;
                spr->y = ((int)((sonic->unk28[r2].y) >> 8)) - gCamera.y;
                DisplaySprite(spr);
            }
        }
    }
...
static u8 SuperSonicHandleDirectionalInput(struct SuperSonic *sonic)
{
    ...
    if (sonic->rawKeys & 0x0020) {
        if (sonic->rawKeys & 0x0040) {
            sonic->rotation = ((s32)((2.5)*256));
            return 16;
        } else if (sonic->rawKeys & 0x0080) {
            sonic->rotation = ((s32)((1.5)*256));
            return 12;
        } else {
            sonic->rotation = ((s32)((2.0)*256));
            return 6;
        }
    } else if (sonic->rawKeys & 0x0010) {
        if (sonic->rawKeys & 0x0040) {
            sonic->rotation = ((s32)((3.5)*256));
            return 18;
        } else if (sonic->rawKeys & 0x0080) {
            sonic->rotation = ((s32)((0.5)*256));
            return 14;
        } else {
            sonic->rotation = ((s32)((0.0)*256));
            return 4;
        }
    } else if (sonic->rawKeys & 0x0040) {
        sonic->rotation = ((s32)((3.0)*256));
        return 8;
    } else if (!(sonic->rawKeys & 0x0080)) {
        return 0;
    } else {
...
static void sub_802C058(struct SuperSonic *sonic)
{
    ...
    if (dir) {
        sonic->unk1A = ((sonic->unk1A) >= 0 ? (sonic->unk1A) : -(sonic->unk1A));
        sonic->unk1A += 0x40;

        if (sonic->unk1A > ((s32)((2.5)*256))) {
            sonic->unk1A = ((s32)((2.5)*256));
        }

        if (sonic->rawKeys & 0x0040) {
            if (sonic->spr.variant != 1) {
                { sonic->tileInfoId = 1; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[1].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[1].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
            }
        } else if (sonic->rawKeys & 0x0080) {
            ...
            if (sonic->spr.variant != 2) {
                { sonic->tileInfoId = 0; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[0].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[0].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
            }
        }
    } else {
        if (sonic->unk1A < 0) {
        ...
        sonic->worldX -= ((s32)((0.5)*256));
    }

    if (sonic->pressedKeys & (0x0001 | 0x0002)) {
        sonic->func24 = sub_802C358;
        sonic->unkC = 20;
        sonic->flags &= ~0x1;
        sonic->flags |= (0x80 | 0x2);
        m4aSongNumStart(112);

        if (dir != 0) {
            { sonic->tileInfoId = dir; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[dir].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[dir].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
        } else {
            sonic->rotation = 0;

            { sonic->tileInfoId = 4; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[4].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[4].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
        }
    }

    sonic->worldX += ((gSineTable[(sonic->rotation) + 256]) * sonic->unk1A) >> 14;
    sonic->worldY += ((gSineTable[(sonic->rotation)]) * sonic->unk1A) >> 14;
}
...
static void sub_802C358(struct SuperSonic *sonic)
{
    ...
    sonic->unk1A = ((gSineTable[(sonic->unkC * 12)]) * 3) >> 5;
    sonic->worldX += ((gSineTable[(sonic->rotation) + 256]) * sonic->unk1A) >> 14;
    sonic->worldY += ((gSineTable[(sonic->rotation)]) * sonic->unk1A) >> 14;
}
...
static void sub_802C480(struct SuperSonic *sonic)
{
    ...
    sonic->unk1A = ((gSineTable[(sonic->unkC * 5)]) * 3) >> 5;
    sonic->worldX += ((gSineTable[(sonic->rotation) + 256]) * sonic->unk1A) >> 14;
    sonic->worldY += ((gSineTable[(sonic->rotation)]) * sonic->unk1A) >> 14;
}
...
static void sub_802C55C(struct SuperSonic *sonic)
{
    ...
    if (--sonic->unkC == 0) {
        ...
        { sonic->tileInfoId = 0; sonic->spr.graphics.anim = gAnims_SuperSonic_080D69C8[0].anim; sonic->spr.variant = gAnims_SuperSonic_080D69C8[0].variant; sonic->spr.prevVariant = -1; sonic->spr.graphics.size = 0; sonic->spr.animCursor = 0; sonic->spr.qAnimDelay = 0; sonic->unk10 = 0; sonic->unk14 = 0; sonic->unk22 = 0; };
    } else if (sonic->pressedKeys & (0x00F0 | 0x0001 | 0x0002)) {
        if (sonic->unkC <= 4) {
            sonic->unkC = 1;
        } else {
            sonic->unkC -= 4;
        ...
        if (++sonic->unk22 > 4) {
            sonic->unk22 = 0;
            sonic->unk10 = (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % 0x1000u) - (0x800 - 1);
            sonic->unk14 = (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % 0x1000u) - (0x800 - 1);
        }
    }
}
...
void sub_802C704(u8 index, s32 *outX, s32 *outY)
{
    if (sSuperSonicTask) {
        ...
        s32 posIndex = (sonic->unk128 - index) % (sizeof(sonic->unk28) / sizeof((sonic->unk28)[0]));
...
{
    Sprite *spr = 
# 721 "src/game/stage/player_super_sonic.c" 3 4
                 ((void *)0)
# 721 "src/game/stage/player_super_sonic.c"
                     ;
...
void sub_802C798(void)
{
    ...
    if ((ExtraBossIsDead() != 1) && !(sonic->flags & 0x10)) {
...
static void sub_802C828(struct SuperSonic *sonic)
{
    ...
    if (!(gStageFlags & 0x0100)) {
        ...
        x = ((s32)((gCamera.x + 80)*256));
        y = ((s32)((gCamera.y + 90)*256));

        sonic->worldX += ({((100) != 0) ? ((s32)(((x - sonic->worldX) * 3)) / (s32)(100)) : 0;});
        sonic->worldY += ({((100) != 0) ? ((s32)(((y - sonic->worldY) * 3)) / (s32)(100)) : 0;});
    }
}
...
static void sub_802C8A0(struct SuperSonic *sonic)
{
    ...
    x = ((s32)((gCamera.x + (426 + 76))*256));
    y = ((s32)((gCamera.y + (240 / 2))*256));

    sonic->worldX += ({((100) != 0) ? ((s32)((x - sonic->worldX)) / (s32)(100)) : 0;});
    sonic->worldY += ({((100) != 0) ? ((s32)((y - sonic->worldY)) / (s32)(100)) : 0;});
}
...
static void sub_802C8EC(struct SuperSonic *sonic)
{
    ...
    sonic->unk1A += ((s32)((0.125)*256));
    sonic->worldY += sonic->unk1A;

    if ((((int)((sonic->worldY) >> 8)) - gCamera.y) > 240) {
        sonic->shouldDestroy = 1;
    }
}
...
static void sub_802C92C(struct SuperSonic *sonic)
{
    ...
    sonic->unk1A = ((s32)((1.0)*256));
    sonic->worldX += ((int)(((gSineTable[(sonic->rotation) + 256]) * 4) >> 8));
    sonic->worldY += ((int)(((gSineTable[(sonic->rotation)]) * 4) >> 8));
}
...
static void sub_802C9B0(struct SuperSonic *sonic)
{
    if (!(sonic->flags & (0x20 | 0x10))) {



        ({ if ((sonic->worldY) < (((s32)((50)*256)))) { sonic->worldY = (((s32)((50)*256))); } else if ((sonic->worldY) > (((s32)((254)*256)))) { sonic->worldY = (((s32)((254)*256))); } });

    }
}

bool32 sub_802C9E0(void) { return 0; }
