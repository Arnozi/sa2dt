...
struct Task *CreateMultiplayerSpriteTask(s16 x, s16 y, u8 param2, s8 param3, TaskMain main, TaskDestructor dtor)
{
    ...
    s->graphics.dest = 
# 43 "src/game/stage/mp_sprite_task.c" 3 4
                      ((void *)0)
# 43 "src/game/stage/mp_sprite_task.c"
                          ;
    s->graphics.size = 0;
    s->graphics.anim = 0;
    s->variant = 0;
            ...
            switch (ts->unk14 & 0x30) {
                case 0x20: {
                    ...
                    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
                        ...
                        s8 id = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
...
struct Task *CreateStageGoalBonusPointsAnim(s32 x, s32 y, u16 score)
{
    if ((score != 100) && (score != 200) && (score != 300) && (score != 500) && (score != 800)) {
        return 
# 196 "src/game/stage/mp_sprite_task.c" 3 4
              ((void *)0)
# 196 "src/game/stage/mp_sprite_task.c"
                  ;
    } else {
        struct Task *t;
