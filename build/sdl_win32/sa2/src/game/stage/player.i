...
void SetStageSpawnPos(u32 character, u32 level, u32 playerID, Player *p)
{
    ...
    if (gGameMode != 5) {
        ...
        p->checkPointX = 360 - (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id * 20);
        p->checkPointY = 177;
        p->qWorldX = -1;
        p->qWorldY = -1;
    }
...
void InitializePlayer(Player *p)
{
    ...
    p->confusionTimer = 0;
    p->stoodObj = 
# 864 "src/game/stage/player.c" 3 4
                 ((void *)0)
# 864 "src/game/stage/player.c"
                     ;
    p->itemEffect = 0x00;
    p->unk2A = 0;
...
# 964 "src/game/stage/player.c" 3 4
                          ((void *)0)
# 964 "src/game/stage/player.c"
                              ;
...
s32 sub_802195C(Player *p, u8 *rot, s32 *out)
{
    ...
    if (rot == 
# 1027 "src/game/stage/player.c" 3 4
              ((void *)0)
# 1027 "src/game/stage/player.c"
                  )
        rot = &dummy;
    if (out == 
# 1029 "src/game/stage/player.c" 3 4
              ((void *)0)
# 1029 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
s32 sub_8021A34(Player *p, u8 *rot, s32 *out)
{
    ...
    if (rot == 
# 1077 "src/game/stage/player.c" 3 4
              ((void *)0)
# 1077 "src/game/stage/player.c"
                  )
        rot = &dummy;
    if (out == 
# 1079 "src/game/stage/player.c" 3 4
              ((void *)0)
# 1079 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
s32 sub_8021B08(Player *p, u8 *rot, s32 *out)
{
    ...
    if (rot == 
# 1127 "src/game/stage/player.c" 3 4
              ((void *)0)
# 1127 "src/game/stage/player.c"
                  )
        rot = &dummy;
    if (out == 
# 1129 "src/game/stage/player.c" 3 4
              ((void *)0)
# 1129 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
void sub_8021EE4(Player *p)
{
    ...
    if (gravity) {
        playerX = ((int)((p->qWorldX) >> 8)) - (3 + p->spriteOffsetX);
        playerY = ((int)((p->qWorldY) >> 8));
        result = sub_801E4E4(playerX, playerY, mask2, -8, 
# 1386 "src/game/stage/player.c" 3 4
                                                         ((void *)0)
# 1386 "src/game/stage/player.c"
                                                             , sub_801ED24);
    } else

    {
        ...
        result = sub_801E4E4(playerX2, playerY2, mask, -8, 
# 1397 "src/game/stage/player.c" 3 4
                                                          ((void *)0)
# 1397 "src/game/stage/player.c"
                                                              , sub_801ED24);
    }
...
void sub_802203C(Player *p)
{
    ...
    if (gravity) {
        ...
        playerY = ((int)((p->qWorldY) >> 8));
        result = sub_801E4E4(playerX, playerY, mask2, +8, 
# 1473 "src/game/stage/player.c" 3 4
                                                         ((void *)0)
# 1473 "src/game/stage/player.c"
                                                             , sub_801ED24);
    } else

    {
        ...
        result = sub_801E4E4(playerX2, playerY2, mask, +8, 
# 1484 "src/game/stage/player.c" 3 4
                                                          ((void *)0)
# 1484 "src/game/stage/player.c"
                                                              , sub_801ED24);
    }
...
void sub_80223BC(Player *p)
{
    ...
    result = sub_801E4E4(playerX, playerY, mask, -8, 
# 1750 "src/game/stage/player.c" 3 4
                                                    ((void *)0)
# 1750 "src/game/stage/player.c"
                                                        , sub_801ED24);
    ...
    result = sub_801E4E4(playerX2, playerY2, mask, +8, 
# 1766 "src/game/stage/player.c" 3 4
                                                      ((void *)0)
# 1766 "src/game/stage/player.c"
                                                          , sub_801ED24);
...
void sub_80224DC(Player *p)
{
    ...
    result = sub_801E4E4(playerX, playerY, mask, -8, 
# 1815 "src/game/stage/player.c" 3 4
                                                    ((void *)0)
# 1815 "src/game/stage/player.c"
                                                        , sub_801ED24);
    ...
    result = sub_801E4E4(playerX2, playerY2, mask, +8, 
# 1831 "src/game/stage/player.c" 3 4
                                                      ((void *)0)
# 1831 "src/game/stage/player.c"
                                                          , sub_801ED24);
...
void sub_80225E8(Player *p)
{
    ...
    result = sub_801E4E4(playerX, playerY, mask, -8, 
# 1876 "src/game/stage/player.c" 3 4
                                                    ((void *)0)
# 1876 "src/game/stage/player.c"
                                                        , sub_801ED24);
...
void sub_8022710(Player *p)
{
    ...
    result = sub_801E4E4(playerX, playerY, mask, +8, 
# 1944 "src/game/stage/player.c" 3 4
                                                    ((void *)0)
# 1944 "src/game/stage/player.c"
                                                        , sub_801ED24);
...
s32 sub_802302C(u8 param0, Player *p)
{
    ...
    switch (param0 >> 6) {
        case 0: {
            s32 y = py + 2;
            result = sub_801E4E4(y + p->spriteOffsetX, px, p->layer, +8, 
# 2743 "src/game/stage/player.c" 3 4
                                                                        ((void *)0)
# 2743 "src/game/stage/player.c"
                                                                            , sub_801EE64);
        } break;
        ...
        case 2: {
            s32 y = py - 2;
            result = sub_801E4E4(y - p->spriteOffsetX, px, p->layer, -8, 
# 2748 "src/game/stage/player.c" 3 4
                                                                        ((void *)0)
# 2748 "src/game/stage/player.c"
                                                                            , sub_801EE64);
        } break;

        case 1: {
            s32 x = (px - 2);
            result = sub_801E4E4(x - p->spriteOffsetX, py, p->layer, -8, 
# 2753 "src/game/stage/player.c" 3 4
                                                                        ((void *)0)
# 2753 "src/game/stage/player.c"
                                                                            , sub_801ED24);
        } break;
        ...
        case 3: {
            s32 x = (px + 2);
            result = sub_801E4E4(x + p->spriteOffsetX, py, p->layer, +8, 
# 2758 "src/game/stage/player.c" 3 4
                                                                        ((void *)0)
# 2758 "src/game/stage/player.c"
                                                                            , sub_801ED24);
        } break;
        ...
        if (((((gCurrentLevel) & ((3 + 1) - 1)) == 2) || (((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && !gFinalBossActive) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
            if (gCurrentLevel & 0x2) {
                ...
                if ((ox >= 0) && (qPX >= ((s32)((ox)*256)))) {
                    ...
                    if (gCheese != 
# 2931 "src/game/stage/player.c" 3 4
                                  ((void *)0)
# 2931 "src/game/stage/player.c"
                                      ) {
            ...
            if ((ox >= 0) && (qPX >= ((s32)((ox)*256))) && (cam->unk8 != 0)) {
                if (!(cam->unk50 & 0x1)) {
                    ...
                    if (gCheese != 
# 2963 "src/game/stage/player.c" 3 4
                                  ((void *)0)
# 2963 "src/game/stage/player.c"
                                      ) {
                        gCheese->posX += ((s32)((ix)*256));
                    }
                }
            ...
            if ((oy >= 0) && (qPY >= ((s32)((oy)*256))) && (cam->unkC != 0)) {
                if (!(cam->unk50 & 0x2)) {
                    ...
                    if (gCheese != 
# 2979 "src/game/stage/player.c" 3 4
                                  ((void *)0)
# 2979 "src/game/stage/player.c"
                                      ) {
...
void Task_PlayerHandleDeath(void)
{
    ...
    if (val == 0) {
...

        {
            ...
            gCamera.x = ((int)((gPlayer.qWorldX) >> 8)) + gCamera.shiftX - (426 / 2);
            ...
            if (gPlayer.character == CHARACTER_CREAM && gCheese != 
# 3513 "src/game/stage/player.c" 3 4
                                                                  ((void *)0)
# 3513 "src/game/stage/player.c"
                                                                      ) {
...
void Task_PlayerMain(void)
{
    ...
    gCheeseTarget.task = 
# 3625 "src/game/stage/player.c" 3 4
                        ((void *)0)
# 3625 "src/game/stage/player.c"
                            ;
    ...
    if (p->moveState & 0x00000080) {
        ...
        p->stoodObj = 
# 3644 "src/game/stage/player.c" 3 4
                     ((void *)0)
# 3644 "src/game/stage/player.c"
                         ;
        cam->unk50 |= 3;
...
void Player_HandleInputs(Player *p)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id != gCamera.spectatorTarget)) {
        p->heldInput = 0;
        input = 0;
    } else {
        input = p->heldInput;
    ...
    if ((charState == 10) || (charState == 11)) {
        if (p->variant == 0 && (s->frameFlags & ((1) << (14))) && (((u16)anim - 10) == 0 || ((u16)anim - 10) == 1)) {
            ...
            if ((p->qSpeedAirY > 0) && (p->variant == 1) && ((((u16)anim - 10) == 0) || (((u16)anim - 10) == 1))) {
                s32 newY = sub_801E6D4(((int)((p->qWorldY) >> 8)) + p->spriteOffsetY, ((int)((p->qWorldX) >> 8)), p->layer, 8, 
# 3934 "src/game/stage/player.c" 3 4
                                                                                                    ((void *)0)
# 3934 "src/game/stage/player.c"
                                                                                                        , sub_801EE64);
...
# 4065 "src/game/stage/player.c"
        ...
        case 52 - 9: {
            ...
            s->animSpeed = ((int)((((p->qSpeedAirY) >= 0 ? (p->qSpeedAirY) : -(p->qSpeedAirY))) >> 8)) * 3 + 8;
        ...
        case 54 - 9: {
            ...
            s->animSpeed = ((int)((((p->qSpeedGround) >= 0 ? (p->qSpeedGround) : -(p->qSpeedGround))) >> 8)) * 3 + 8;
...
# 4275 "src/game/stage/player.c" 3 4
                                                 ((void *)0)
# 4275 "src/game/stage/player.c"
                                                     ) {
                    break;
                }
...
void InitPlayerGrindGraphics(Player *p)
{
    ...
    if ((gStageFlags & 0x0080)) {
        newY = sub_801E6D4(((int)((p->qWorldY) >> 8)) - p->spriteOffsetY, ((int)((p->qWorldX) >> 8)), p->layer, -8, 
# 5165 "src/game/stage/player.c" 3 4
                                                                                         ((void *)0)
# 5165 "src/game/stage/player.c"
                                                                                             , sub_801EE64);
    ...
    {
        newY = sub_801E6D4(((int)((p->qWorldY) >> 8)) + p->spriteOffsetY, ((int)((p->qWorldX) >> 8)), p->layer, 8, 
# 5171 "src/game/stage/player.c" 3 4
                                                                                        ((void *)0)
# 5171 "src/game/stage/player.c"
                                                                                            , sub_801EE64);
    ...
    if (cAnim == 31) {
        ...
        if ((p->variant == 1) && (p->qSpeedGround <= 0)) {
            ...
            if (gStageGoalX != 0) {
                ...
                if (r8 != 0) {
                    { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += r8; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
...
void Player_80279F8(Player *p)
{
    ...
    if (p->unk72 < 
# 5872 "src/game/stage/player.c" 3 4
                  32767
# 5872 "src/game/stage/player.c"
                           )
        p->unk72++;
...
{
    u16 rank = gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id];
...
void sub_8028204(Player *p)
{
    ...
    { s16 speed = (p->moveState & 0x00000040) ? ((s16)((12.0 / 256.0)*256)) : ((s16)((42.0 / 256.0)*256)); if (p->qSpeedAirY < 0) { speed /= 2; } p->qSpeedAirY += speed; };
...
void DoTrickIfButtonPressed(Player *p)
{
    if ((gGameMode != 5) && (p->disableTrickTimer == 0) && (p->frameInput & gPlayerControls.trick)) {
        ...
        if (p->heldInput & 0x0040) {
            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += sTrickPoints[0]; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
            p->trickDir = 0;
            gPlayer.callback = Player_InitDefaultTrick;;
        } else if (p->heldInput & 0x0080) {
            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += sTrickPoints[3]; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
            ...
            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += sTrickPoints[2]; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
            p->trickDir = 2;

            gPlayer.callback = Player_InitDefaultTrick;;
        } else {
            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += sTrickPoints[1]; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
            p->trickDir = 3;
...
void DestroyPlayerTasks(Player *p)
{
    ...
    p->spriteTask = 
# 6962 "src/game/stage/player.c" 3 4
                   ((void *)0)
# 6962 "src/game/stage/player.c"
                       ;
...
s32 sub_8029A28(Player *p, u8 *rot, s32 *out)
{
    ...
    if (rot == 
# 6989 "src/game/stage/player.c" 3 4
              ((void *)0)
# 6989 "src/game/stage/player.c"
                  )
        rot = &dummy;
    if (out == 
# 6991 "src/game/stage/player.c" 3 4
              ((void *)0)
# 6991 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
s32 sub_8029A74(Player *p, u8 *rot, s32 *out)
{
    ...
    if (rot == 
# 7020 "src/game/stage/player.c" 3 4
              ((void *)0)
# 7020 "src/game/stage/player.c"
                  )
        rot = &dummy;
    if (out == 
# 7022 "src/game/stage/player.c" 3 4
              ((void *)0)
# 7022 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
s32 sub_8029AC0(Player *p, u8 *rot, s32 *out)
{
    ...
    if (rot == 
# 7052 "src/game/stage/player.c" 3 4
              ((void *)0)
# 7052 "src/game/stage/player.c"
                  )
        rot = &dummy;
    if (out == 
# 7054 "src/game/stage/player.c" 3 4
              ((void *)0)
# 7054 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
s32 sub_8029B0C(Player *p, u8 *ret_rotation, s32 *out)
{
    ...
    if (ret_rotation == 
# 7084 "src/game/stage/player.c" 3 4
                       ((void *)0)
# 7084 "src/game/stage/player.c"
                           )
        ret_rotation = &dummy;
    if (out == 
# 7086 "src/game/stage/player.c" 3 4
              ((void *)0)
# 7086 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
s32 sub_8029BB8(Player *p, u8 *rotation, s32 *out)
{
    ...
    if (rotation == 
# 7148 "src/game/stage/player.c" 3 4
                   ((void *)0)
# 7148 "src/game/stage/player.c"
                       )
        rotation = &dummy;
    if (out == 
# 7150 "src/game/stage/player.c" 3 4
              ((void *)0)
# 7150 "src/game/stage/player.c"
                  )
        out = &dummyInt;
...
{
    gPlayer.spriteTask = 
# 7379 "src/game/stage/player.c" 3 4
                        ((void *)0)
# 7379 "src/game/stage/player.c"
                            ;
...
void sub_802A558(Player *p) { { s16 speed = (p->moveState & 0x00000040) ? ((s16)((12.0 / 256.0)*256)) : ((s16)((42.0 / 256.0)*256)); if (p->qSpeedAirY < 0) { speed /= 2; } p->qSpeedAirY += speed; }; }
