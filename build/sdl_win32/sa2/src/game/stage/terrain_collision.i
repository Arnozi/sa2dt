# 0 "src/game/stage/terrain_collision.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/terrain_collision.c"
...
# 2 "src/game/stage/terrain_collision.c" 2
...
# 3 "src/game/stage/terrain_collision.c" 2
...
# 4 "src/game/stage/terrain_collision.c" 2
...
# 5 "src/game/stage/terrain_collision.c" 2
...
# 6 "src/game/stage/terrain_collision.c" 2



const Collision *gRefCollision = 
# 9 "src/game/stage/terrain_collision.c" 3 4
                                ((void *)0)
# 9 "src/game/stage/terrain_collision.c"
                                    ;
...
# 102 "src/game/stage/terrain_collision.c"
...
s32 sub_801E4E4(s32 p0, s32 p1, s32 p2, s32 p3, u8 *data, Func801F07C func)
{
    ...
    if (data == 
# 153 "src/game/stage/terrain_collision.c" 3 4
               ((void *)0)
# 153 "src/game/stage/terrain_collision.c"
                   )
        data = dummy;
...
s32 sub_801E6D4(s32 p0, s32 p1, s32 p2, s32 p3, u8 *data, Func801F07C func)
{
    ...
    if (data == 
# 247 "src/game/stage/terrain_collision.c" 3 4
               ((void *)0)
# 247 "src/game/stage/terrain_collision.c"
                   )
        data = dummy;
...
s32 sub_801EE64(s32 p0in, s32 p1in, s32 p2in, u8 *p3in)
{
    ...
    typedef u32 r0r1_t;
# 692 "src/game/stage/terrain_collision.c"
    r0r1_t r0;
    r0r1_t r1;
    s32 r3;
    s32 p0 = p0in;
...
{
    s32 r0;
# 826 "src/game/stage/terrain_collision.c"
    s32 r1;
    s32 r3;
    s32 r4;
    s32 r5;
...
s32 sub_801F07C(s32 p0, s32 p1, s32 p2, s32 p3, u8 *data, Func801F07C func)
{
    ...
    if (data == 
# 911 "src/game/stage/terrain_collision.c" 3 4
               ((void *)0)
# 911 "src/game/stage/terrain_collision.c"
                   )
        data = dummy;
