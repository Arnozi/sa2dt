# 0 "src/game/stage/screen_fade.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/screen_fade.c"
# 1 "include/core.h" 1
...
# 2 "src/game/stage/screen_fade.c" 2
# 1 "include/game/stage/screen_fade.h" 1



# 1 "include/global.h" 1
# 5 "include/game/stage/screen_fade.h" 2
...
# 3 "src/game/stage/screen_fade.c" 2
...
static inline void ScreenFadeUpdateValues_inline(ScreenFade *fade)
{
    if (fade->window != 0) {
        ...
        gWinRegs[5] |= ((1 << 4) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)));
    } else {
        gDispCnt |= 0x2000;
        gWinRegs[0] = (((0) << 16) | (426));
        gWinRegs[2] = (((0) << 16) | (240));
    ...
    if (fade->flags & (1 << 0)) {
        gBldRegs.bldY = ((int)((fade->brightness) >> 8));
    } else {
        gBldRegs.bldY = 32 - ((int)((fade->brightness) >> 8));
    }
...
u8 UpdateScreenFade(ScreenFade *fade)
{
    ...
    if (fade->brightness >= ((s16)((32)*256))) {
        fade->brightness = ((s16)((32)*256));
        return 1;
    } else {
        return 0;
    }
