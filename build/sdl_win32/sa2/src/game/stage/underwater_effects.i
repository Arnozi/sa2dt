# 0 "src/game/stage/underwater_effects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/underwater_effects.c"
...
# 2 "src/game/stage/underwater_effects.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/stage/underwater_effects.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/stage/underwater_effects.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/stage/underwater_effects.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/stage/underwater_effects.c" 2
...
# 8 "src/game/stage/underwater_effects.c" 2
...
# 9 "src/game/stage/underwater_effects.c" 2
...
# 10 "src/game/stage/underwater_effects.c" 2
...
# 11 "src/game/stage/underwater_effects.c" 2
...
# 12 "src/game/stage/underwater_effects.c" 2
...
# 13 "src/game/stage/underwater_effects.c" 2
...
# 15 "src/game/stage/underwater_effects.c" 2
...
static void Task_DrowningCountdown(void)
{
    ...
    if ((transform->x < -32 || transform->x > 426 + 32) || (transform->y < -32 || transform->y > 240 + 32)
        || (ts->unk10 > 0x80)) {
...
struct Task *SpawnAirBubbles(s32 p0, s32 p1, s32 p2, s32 p3)
{
    if ((s8)gSmallAirBubbleCount > 11) {
        return 
# 108 "src/game/stage/underwater_effects.c" 3 4
              ((void *)0)
# 108 "src/game/stage/underwater_effects.c"
                  ;
    } else {
        struct Task *t;
        ...
        if (p3 == 0) {
            s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2A40);
            s->graphics.anim = 853;
            s->variant = 0;
        } else {
            s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2AC0);
            s->graphics.anim = 854;
            s->variant = 0;
...
static void Task_SpawnAirBubbles(void)
{
    ...
    if ((transform->x < -32 || transform->x > 426 + 32) || (transform->y < -32 || transform->y > 240 + 32)
        || (gWater.isActive != 1) || (gWater.currentWaterLevel < 0) || (((int)((r4) >> 8)) - 3 < gWater.currentWaterLevel) || (ts->unk10 > 0x1E0)) {
        TaskDestroy(gCurTask);
        return;
    } else {
        ts->x += ts->unk8;
...
struct Task *SpawnBubblesAfterDrowning(Player *p)
{
    struct Task *t = TaskCreate(Task_SpawnBubblesAfterDrowning, sizeof(Player **), 0x4001, 0, 
# 259 "src/game/stage/underwater_effects.c" 3 4
                                                                                             ((void *)0)
# 259 "src/game/stage/underwater_effects.c"
                                                                                                 );
