# 0 "src/game/bosses/explosion_parts.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/bosses/explosion_parts.c"
...
# 2 "src/game/bosses/explosion_parts.c" 2
...
# 3 "src/game/bosses/explosion_parts.c" 2
# 1 "include/task.h" 1
...
# 4 "src/game/bosses/explosion_parts.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/bosses/explosion_parts.c" 2
...
# 6 "src/game/bosses/explosion_parts.c" 2
...
# 7 "src/game/bosses/explosion_parts.c" 2
...
# 8 "src/game/bosses/explosion_parts.c" 2
...
# 9 "src/game/bosses/explosion_parts.c" 2
# 1 "include/game/bosses/boss_2.h" 1



extern void CreateEggBomberTank(void);
extern void EggBomberTankMove(s32, s32);
# 10 "src/game/bosses/explosion_parts.c" 2
...
# 11 "src/game/bosses/explosion_parts.c" 2
# 1 "include/game/bosses/boss_4.h" 1



extern void CreateAeroEgg(void);
extern void AeroEggMove(s32, s32);
# 12 "src/game/bosses/explosion_parts.c" 2
# 1 "include/game/bosses/boss_5.h" 1



extern void CreateEggSaucer(void);
extern void EggSaucerMove(s32, s32);
# 13 "src/game/bosses/explosion_parts.c" 2
...
# 14 "src/game/bosses/explosion_parts.c" 2
...
# 15 "src/game/bosses/explosion_parts.c" 2
# 1 "include/game/bosses/boss_8.h" 1



extern void CreateSuperEggRoboZ(void);
# 16 "src/game/bosses/explosion_parts.c" 2
...
# 17 "src/game/bosses/explosion_parts.c" 2
...
# 19 "src/game/bosses/explosion_parts.c" 2
...
void CreateBossParticleWithExplosionUpdate(ExplosionPartsInfo *info, u8 *numCreatedParts)
{
    if (!(info->unk4 & 1) || *numCreatedParts < 16) {
        struct Task *t = TaskCreate(Task_BossParticleWithExplosionUpdate, sizeof(Sprite_ExplosionParts), 0x5432, 0, 
# 30 "src/game/bosses/explosion_parts.c" 3 4
                                                                                                                   ((void *)0)
# 30 "src/game/bosses/explosion_parts.c"
                                                                                                                       );
        Sprite_ExplosionParts *parts = (void *)((t)->data);
        Sprite *s = &parts->s;
        s32 cos, sin;

        parts->posX = ((s32)((info->spawnX)*256));
        parts->posY = ((s32)((info->spawnY)*256));

        cos = (gSineTable[(info->rotation & (1024 - 1)) + 256]) * info->speed;
        parts->accelX = cos >> 14;

        sin = (gSineTable[(info->rotation & (1024 - 1))]) * info->speed;
        parts->accelY = sin >> 14;
...
void Task_BossParticleWithExplosionUpdate(void)
{
    Sprite_ExplosionParts *parts = (void *)((gCurTask)->data);
    Sprite *s = &parts->s;

    if (s->graphics.anim == 619) {
        parts->accelX -= ((s32)((1.0)*256));
    }
    ...
    s->x = ((int)((parts->posX) >> 8));
    s->y = ((int)((parts->posY) >> 8));

    if (((s->x < -32) && (parts->accelX < 0)) || ((s->x > (426 + 32)) && (parts->accelX > 0))
        || ((s->y < -32) && (parts->accelY < 0))
        || ((s->y > (240 + 32)) && (parts->accelY > 0))) {
...
{
    if (!(info->unk4 & 1) || *numCreatedParts < 16) {
        struct Task *t = TaskCreate(Task_BossParticleStatic, sizeof(Sprite_ExplosionParts), 0x5432, 0, 
# 97 "src/game/bosses/explosion_parts.c" 3 4
                                                                                                      ((void *)0)
# 97 "src/game/bosses/explosion_parts.c"
                                                                                                          );
        Sprite_ExplosionParts *parts = (void *)((t)->data);
        Sprite *s = &parts->s;
        s32 cos, sin;
...
void Task_BossParticleStatic(void)
{
    ...
    s->x = ((int)((parts->posX) >> 8)) - gCamera.x;
    s->y = ((int)((parts->posY) >> 8)) - gCamera.y;
