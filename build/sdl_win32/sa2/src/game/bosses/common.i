# 0 "src/game/bosses/common.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/bosses/common.c"
...
# 21 "src/game/bosses/common.c" 2
# 1 "include/constants/player_transitions.h" 1
# 22 "src/game/bosses/common.c" 2


struct Task *gActiveBossTask = 
# 24 "src/game/bosses/common.c" 3 4
                              ((void *)0)
# 24 "src/game/bosses/common.c"
                                  ;
...
void CreateZoneBoss(u8 boss)
{
    if (boss < (sizeof(sBossCreationFuncs) / sizeof((sBossCreationFuncs)[0]))) {
...
void sub_8039F14(s32 p0, s32 p1)
{
    if ((gCurrentLevel != ((7)*(3 + 1)) + (0)) && (gActiveBossTask != 
# 63 "src/game/bosses/common.c" 3 4
                                                                                            ((void *)0)
# 63 "src/game/bosses/common.c"
                                                                                                )) {
        MoveBossPositionFuncs[((gCurrentLevel) >> 2)](p0, p1);
    }
}

void sub_8039F50(s32 p0, u8 p1)
{
    if ((p1 < 7) && (gActiveBossTask != 
# 70 "src/game/bosses/common.c" 3 4
                                                ((void *)0)
# 70 "src/game/bosses/common.c"
                                                    )) {
