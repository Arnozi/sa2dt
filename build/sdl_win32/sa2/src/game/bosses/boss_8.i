...
void CreateBossRunManager(u8 bossIndex)
{
    ...
    BossRunManager *manager = (void *)((t)->data);
    ...
    if (bossIndex != 0) {
        ...
        cheese = gCheese;
        if (cheese != 
# 230 "src/game/bosses/boss_8.c" 3 4
                     ((void *)0)
# 230 "src/game/bosses/boss_8.c"
                         ) {
...
static void Task_BossRunManagerMain(void)
{
    BossRunManager *manager = (void *)((gCurTask)->data);
    ...
    if (manager->bossIndex <= 6) {
        if (manager->bossIndex == 6) {
            ...
            if (gPlayer.qWorldX < ((s32)((42960)*256)) && gPlayer.qWorldX > ((s32)((gUnknown_080D8808[6][0] + 30)*256))) {
                ...
                if (gActiveBossTask == 
# 278 "src/game/bosses/boss_8.c" 3 4
                                      ((void *)0) 
# 278 "src/game/bosses/boss_8.c"
                                           && !(gStageFlags & 0x0100)) {
                ...
                if (r5 > ((s32)((42960)*256))) {
                    ...
                    manager->bossIndex++;
                    manager->unk6 = 1;
                } else if (gActiveBossTask != 
# 291 "src/game/bosses/boss_8.c" 3 4
                                             ((void *)0) 
# 291 "src/game/bosses/boss_8.c"
                                                  && r5 < ((s32)((42300)*256))) {
                    ...
                    if (r1 >= 0) {
                        ...
                        if (r5 >= r0) {
                            ...
                            gCamera.unk10 += r4;
                            if (gCheese != 
# 306 "src/game/bosses/boss_8.c" 3 4
                                          ((void *)0)
# 306 "src/game/bosses/boss_8.c"
                                              ) {
                                gCheese->posX += r6;
                            }
                        }
            ...
            if (gUnknown_080D8808[manager->bossIndex][0] >= 0 && gActiveBossTask != 
# 322 "src/game/bosses/boss_8.c" 3 4
                                                                                   ((void *)0)
                
# 323 "src/game/bosses/boss_8.c"
               && gPlayer.qWorldX >= ((s32)((gUnknown_080D8808[manager->bossIndex][0])*256))) {
                ...
                gCamera.unk10 += r4;
                if (gCheese != 
# 333 "src/game/bosses/boss_8.c" 3 4
                              ((void *)0)
# 333 "src/game/bosses/boss_8.c"
                                  ) {
                    gCheese->posX += r5;
                }
            }
...
static void CreateSuperEggRoboZTowers(void *vram, SuperEggRoboZ *boss)
{
    ...
    SuperEggRoboZTowers *towers = (void *)((t)->data);
    void *vrams[2];
    Sprite *s;
...
{
    u8 i;
    SuperEggRoboZTowers *towers = (void *)((gCurTask)->data);
    if (gActiveBossTask == 
# 413 "src/game/bosses/boss_8.c" 3 4
                          ((void *)0)
# 413 "src/game/bosses/boss_8.c"
                              ) {
...
void CreateSuperEggRoboZ(void)
{
    ...
    body = &boss->body;
    body->graphics.dest = (void *)(((u8*)&VRAM[0]) + (0x4000 * (3)));
    body->graphics.anim = 0;
    body->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (20)));
    body->unk18 = 0;
    body->unk1A = 0;
    body->tilemapId = 368;
    body->unk1E = 0;
...
{
    SuperEggRoboZ *boss = (void *)((gCurTask)->data);
    ...
    if (boss->unk14 > 60) {
        ...
        if (({((30) != 0) ? ((s32)(boss->unk14) % (s32)(30)) : 0;}) == 0) {
            s8 v;
            gPlayer.moveState = 0;
...
static u8 sub_804B0EC(SuperEggRoboZ *boss, u8 arm)
{
    ...
    if ((r5 + r4) < 200) {
        ...
        if ((gCheese != 
# 1276 "src/game/bosses/boss_8.c" 3 4
                       ((void *)0)
# 1276 "src/game/bosses/boss_8.c"
                           ) && ((gCheese->reserved).index != -1)) {
            r6 -= gCheese->posX;
            r6 = (r6) >> 8;
            r7 -= gCheese->posY;
            r7 = (r7) >> 8;
...
# 1314 "src/game/bosses/boss_8.c"
    ...
    if ((gCheese != 
# 1344 "src/game/bosses/boss_8.c" 3 4
                   ((void *)0)
# 1344 "src/game/bosses/boss_8.c"
                       ) && ((gCheese->reserved).index != -1)) {
        x -= gCheese->posX;
        x = (x) >> 8;
        y -= gCheese->posY;
...
static void sub_804C080(SuperEggRoboZ *boss)
{
    ...
    if (((gStageTime + 3) & 0x7) == 0) {
        ...
        info.vram = (&VRAM[0x10000] + (gTileInfoBossScrews[r4][0] * 32));
...
{
    SuperEggRoboZ *boss = (void *)((t)->data);
    ...
    gActiveBossTask = 
# 2102 "src/game/bosses/boss_8.c" 3 4
                     ((void *)0)
# 2102 "src/game/bosses/boss_8.c"
                         ;
}
