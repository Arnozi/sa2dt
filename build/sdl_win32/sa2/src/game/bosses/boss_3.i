...
void CreateEggTotem(void)
{
    ...
    gPlayer.stoodObj = 
# 204 "src/game/bosses/boss_3.c" 3 4
                      ((void *)0)
# 204 "src/game/bosses/boss_3.c"
                          ;
    ...
    for (i = 0; i < (sizeof(totem->sprBulletLauncher) / sizeof((totem->sprBulletLauncher)[0])); i++) {
        ...
        s->x = 0;
        s->y = 0;
# 361 "src/game/bosses/boss_3.c"
        s->graphics.dest = VramMalloc(sTileInfoBulletLauncher[i].numTiles); s->graphics.anim = sTileInfoBulletLauncher[i].anim; s->variant = sTileInfoBulletLauncher[i].variant; s->oamFlags = ((21) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    ...
    s->x = 0;
    s->y = 0;
# 383 "src/game/bosses/boss_3.c"
    s->graphics.dest = VramMalloc(12); s->graphics.anim = 629; s->variant = 0; s->oamFlags = ((22) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    ...
    if (!((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && gSelectedCharacter == CHARACTER_SONIC
        ...
        s->x = 0;
        s->y = 0;
# 408 "src/game/bosses/boss_3.c"
        s->graphics.dest = VramMalloc(5 * 6); s->graphics.anim = 222; s->variant = 0; s->oamFlags = ((20) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;


        s = &totem->sprTailsHook;
        s->x = 0;
        s->y = 0;
# 429 "src/game/bosses/boss_3.c"
        s->graphics.dest = VramMalloc(4 * 5); s->graphics.anim = 656; s->variant = 0; s->oamFlags = ((21) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;


    } else {
        totem->sprTails.graphics.dest = 
# 433 "src/game/bosses/boss_3.c" 3 4
                                       ((void *)0)
# 433 "src/game/bosses/boss_3.c"
                                           ;
        totem->sprTailsHook.graphics.dest = 
# 434 "src/game/bosses/boss_3.c" 3 4
                                           ((void *)0)
# 434 "src/game/bosses/boss_3.c"
                                               ;
    }
...
{
    EggTotem *totem = (void *)((gCurTask)->data);
    ...
    if (totem->lives == 0) {
        ...
        if (gPlayer.stoodObj != 
# 464 "src/game/bosses/boss_3.c" 3 4
                               ((void *)0) 
# 464 "src/game/bosses/boss_3.c"
                                    || gPlayer.moveState & 0x00000008) {
            gPlayer.stoodObj = 
# 465 "src/game/bosses/boss_3.c" 3 4
                              ((void *)0)
# 465 "src/game/bosses/boss_3.c"
                                  ;
...
void sub_803F4B8(EggTotem *totem)
{
    ...
    if (totem->sprTails.graphics.dest != 
# 525 "src/game/bosses/boss_3.c" 3 4
                                        ((void *)0)
# 525 "src/game/bosses/boss_3.c"
                                            ) {
...
void sub_803F698(EggTotem *totem)
{
    ...
    if (totem->sprTails.graphics.dest != 
# 621 "src/game/bosses/boss_3.c" 3 4
                                        ((void *)0)
# 621 "src/game/bosses/boss_3.c"
                                            ) {
        s = &totem->sprTailsHook;
...
bool32 sub_803F878(EggTotem *totem)
{
    ...
    if (totem->sprTails.graphics.dest != 
# 706 "src/game/bosses/boss_3.c" 3 4
                                        ((void *)0)
# 706 "src/game/bosses/boss_3.c"
                                            ) {
        s = &totem->sprTails;
...
{
    EggTotem *totem = (void *)((gActiveBossTask)->data);
    u8 i;
...
void sub_803FB88(EggTotem *totem)
{
    ...
    res = ({((3) != 0) ? ((s32)(discY) / (s32)(3)) : 0;}) - ((s32)((2.0)*256));
...
void sub_803FC14(EggTotem *totem)
{
    ...
    if (({((14) != 0) ? ((s32)(gStageTime) % (s32)(14)) : 0;}) == 0) {
        ...
        info.vram = (void *)(&VRAM[0x10000] + 0x2980);
        info.anim = 619;
        info.variant = 0;
        info.unk4 = 0;
    ...
    for (i = 0; i < 3; i++) {
        ...
        if (divRes < 0) {
            ...
            v = t3c->qUnkA * 35;
            t3c->qUnkA = ({((100) != 0) ? ((s32)(-(v * 2)) / (s32)(100)) : 0;});
    ...
    if (totem->unk38 == 0) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (res < 0) {
                ...
                totem->unk24[i][1] = ({((100) != 0) ? ((s32)(-(totem->unk24[i][1] * 80)) / (s32)(100)) : 0;});
        ...
        if (res < 0) {
            ...
            totem->qUnkA6 = ({((100) != 0) ? ((s32)(-(totem->qUnkA6 * 80)) / (s32)(100)) : 0;});
        ...
        if (({((6) != 0) ? ((s32)(gStageTime) % (s32)(6)) : 0;}) == 0) {
        ...
        if (res < 0) {
            ...
            totem->qUnk9A = ({((100) != 0) ? ((s32)(-(totem->qUnk9A * 60)) / (s32)(100)) : 0;});
        }
    ...
    for (i = 0; i < 3; i++) {
        ...
        if (Coll_Player_Enemy(s, ((int)((t3c->qWorldX) >> 8)), ((int)((t3c->qWorldY) >> 8)), 1, &gPlayer) == 0
            ...
            if ((p->moveState & 0x00000008) && (coll & 0x00010000)) {
                ...
                gPlayer.moveState &= ~0x00000008;
                gPlayer.stoodObj = 
# 1285 "src/game/bosses/boss_3.c" 3 4
                                  ((void *)0)
# 1285 "src/game/bosses/boss_3.c"
                                      ;
...
# 1366 "src/game/bosses/boss_3.c"
    ...
    if (Coll_Cheese_Enemy_Attack(s, t3CX, t3CY, 0, &gPlayer) == 1) {
        ...
        if (t3c->unk14 == 0) {
            ...
            info2.vram = (void *)(&VRAM[0x10000] + 0x2980);
            info2.anim = 619;
            info2.variant = 0;
            info2.unk4 = 0;

            CreateBossParticleWithExplosionUpdate(&info2, &t3c->unk16);
# 1421 "src/game/bosses/boss_3.c"
            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += 500; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
...
void TaskDestructor_EggTotemMain(struct Task *t)
{
    ...
    if (totem->sprTailsHook.graphics.dest != 
# 1553 "src/game/bosses/boss_3.c" 3 4
                                            ((void *)0)
# 1553 "src/game/bosses/boss_3.c"
                                                ) {
        VramFree(totem->sprTailsHook.graphics.dest);
    }

    if (totem->sprTails.graphics.dest != 
# 1557 "src/game/bosses/boss_3.c" 3 4
                                        ((void *)0)
# 1557 "src/game/bosses/boss_3.c"
                                            ) {
        VramFree(totem->sprTails.graphics.dest);
    }

    gActiveBossTask = 
# 1561 "src/game/bosses/boss_3.c" 3 4
                     ((void *)0)
# 1561 "src/game/bosses/boss_3.c"
                         ;
}
...
void Task_8041138(void)
{
    ...
    if (totem->sprTails.graphics.dest != 
# 1589 "src/game/bosses/boss_3.c" 3 4
                                        ((void *)0)
# 1589 "src/game/bosses/boss_3.c"
                                            ) {
...
void CreateEggTotemBullet(EggTotem *totem, s32 qX, s32 qY, u16 qSpeed)
{
    ...
    struct Task *t = TaskCreate(Task_EggTotemBullet, sizeof(EggTotemBullet), 0x6100, 0, 
# 1663 "src/game/bosses/boss_3.c" 3 4
                                                                                       ((void *)0)
# 1663 "src/game/bosses/boss_3.c"
                                                                                           );

    EggTotemBullet *bullet = (void *)((t)->data);
...
{
    EggTotem *totem;
    EggTotemBullet *bullet = (void *)((gCurTask)->data);
    Sprite *s = &bullet->s;
    ...
    if ((s->x < -32 && bullet->qDX < 0) || ((s->x > (426 + 32)) && bullet->qDX > 0) || (s->y < -32 && bullet->qDY < 0)
        || ((s->y > (240 + 32)) && bullet->qDY > 0) || (s->x < -((s32)((2)*256))) || s->x > 752) {
