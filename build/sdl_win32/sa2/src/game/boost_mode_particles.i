# 0 "src/game/boost_mode_particles.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/boost_mode_particles.c"
...
# 2 "src/game/boost_mode_particles.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/boost_mode_particles.c" 2
...
# 4 "src/game/boost_mode_particles.c" 2
...
# 5 "src/game/boost_mode_particles.c" 2
# 1 "include/sprite.h" 1
# 6 "src/game/boost_mode_particles.c" 2
# 1 "include/task.h" 1
# 7 "src/game/boost_mode_particles.c" 2
# 1 "include/malloc_vram.h" 1
# 8 "src/game/boost_mode_particles.c" 2
...
# 9 "src/game/boost_mode_particles.c" 2
...
# 10 "src/game/boost_mode_particles.c" 2
# 1 "include/trig.h" 1
...
# 11 "src/game/boost_mode_particles.c" 2
...
# 13 "src/game/boost_mode_particles.c" 2
...
void CreateBoostModeParticles(void)
{
    ...
    struct BoostModeParticles *particles = (void *)((t)->data);
    ...
    for (i = 0; i < 16; i++) {
        u8 temp1;
        s32 rand, var;
        particles->positions[i][1] = (Random() & 0x7FF) + ((s32)((16)*256));
        if (gPlayer.moveState & 0x00000001) {
            ...
            particles->positions[i][0] = ((((int)(((gSineTable[(((gPlayer.rotation + 128) & 0xFF) * 4) + 256])) >> 6)) * particles->positions[i][1]) >> 8);
            particles->positions[i][1] = ((((int)(((gSineTable[(((gPlayer.rotation + 128) & 0xFF) * 4)])) >> 6)) * particles->positions[i][1]) >> 8);

        } else {
            temp1 = gPlayer.rotation + 64;
            particles->positions[i][0] = ((((int)(((gSineTable[(gPlayer.rotation * 4) + 256])) >> 6)) * particles->positions[i][1]) >> 8);
            particles->positions[i][1] = ((((int)(((gSineTable[(gPlayer.rotation * 4)])) >> 6)) * particles->positions[i][1]) >> 8);
        }
# 93 "src/game/boost_mode_particles.c"
        rand = Random();
        particles->accelerations[i][0] = ((((int)(((gSineTable[(temp1 * 4) + 256])) >> 6)) * ((rand & 0x3FF) + 512)) >> 8);
        particles->accelerations[i][1] = ((((int)(((gSineTable[(temp1 * 4)])) >> 6)) * var) >> 8);
...
{
    s32 i;
    struct BoostModeParticles *particles = (void *)((gCurTask)->data);
    Sprite *s;
    ...
    for (i = 0; i < 16 / 2; i++) {
        ...
        particles->accelerations[i][0] = ((particles->accelerations[i][0] * ((s32)((0.78125)*256))) >> 8);
        particles->accelerations[i][1] = ((particles->accelerations[i][1] * ((s32)((0.78125)*256))) >> 8);
        s = &particles->unk0;
        s->x = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x + ((int)((particles->positions[i][0]) >> 8));
        s->y = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y + ((int)((particles->positions[i][1]) >> 8));
        DisplaySprite(s);
    }
    ...
    if (particles->frame++ > 8) {
        ...
        for (i = 0; i < 16; i++) {
            ...
            if (gPlayer.moveState & 0x00000001) {
                temp = Random();
                temp += 64;
                particles->unkE2 = ((int)(((gSineTable[(((gPlayer.rotation + 128) & 0xFF) * 4) + 256])) >> 6)) * 4;
                particles->unkE4 = ((int)(((gSineTable[(((gPlayer.rotation + 128) & 0xFF) * 4)])) >> 6)) * 4;
            } else {
                temp = Random();
                particles->unkE2 = ((int)(((gSineTable[(gPlayer.rotation * 4) + 256])) >> 6)) * 4;
                particles->unkE4 = ((int)(((gSineTable[(gPlayer.rotation * 4)])) >> 6)) * 4;
            }

            rand = (Random() & 0x3FF);
            particles->accelerations[i][0] = ((((int)(((gSineTable[(temp * 4) + 256])) >> 6)) * (rand + ((s32)((6)*256)))) >> 8);
            particles->accelerations[i][1] = ((((int)(((gSineTable[(temp * 4)])) >> 6)) * (rand + ((s32)((6)*256)))) >> 8);
        }
...
void sub_808A0A4(void)
{
    ...
    for (i = 0; i < 16; i++) {
        ...
        particles->unkE2 = ((particles->unkE2 * ((s32)((1.00390625)*256))) >> 8);
        particles->unkE4 = ((particles->unkE4 * ((s32)((1.00390625)*256))) >> 8);
    }
    ...
    for (i = 0; i < (16 / 2); i++) {
        ...
        if (particles->frame & 1) {
            ...
            s->x = (((int)((gPlayer.qWorldX) >> 8)) - gCamera.x) + ((int)((particles->positions[i + (16 / 2)][0]) >> 8));
            s->y = (((int)((gPlayer.qWorldY) >> 8)) - gCamera.y) + ((int)((particles->positions[i + (16 / 2)][1]) >> 8));
        }
        DisplaySprite(s);
    }
}
