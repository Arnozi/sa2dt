# 0 "src/game/character_select.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/character_select.c"
...
# 2 "src/game/character_select.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/character_select.c" 2
...
# 4 "src/game/character_select.c" 2
...
# 5 "src/game/character_select.c" 2
# 1 "include/sprite.h" 1
# 6 "src/game/character_select.c" 2
...
# 7 "src/game/character_select.c" 2
...
# 8 "src/game/character_select.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/character_select.c" 2
# 1 "include/task.h" 1
# 10 "src/game/character_select.c" 2
# 1 "include/malloc_vram.h" 1
# 11 "src/game/character_select.c" 2
# 1 "include/flags.h" 1
# 12 "src/game/character_select.c" 2
# 1 "include/trig.h" 1
...
# 13 "src/game/character_select.c" 2
...
# 14 "src/game/character_select.c" 2
# 1 "include/game/multiplayer/results.h" 1
# 10 "include/game/multiplayer/results.h"
void CreateMultiplayerResultsScreen(u8 mode);
# 15 "src/game/character_select.c" 2
...
# 16 "src/game/character_select.c" 2
...
# 17 "src/game/character_select.c" 2
...
# 18 "src/game/character_select.c" 2
...
# 19 "src/game/character_select.c" 2
...
# 20 "src/game/character_select.c" 2
...
# 22 "src/game/character_select.c" 2
# 1 "include/constants/songs.h" 1
# 23 "src/game/character_select.c" 2
# 1 "include/constants/text.h" 1
# 24 "src/game/character_select.c" 2
# 1 "include/constants/tilemaps.h" 1
# 25 "src/game/character_select.c" 2
...
static __attribute__((aligned(4))) const u16 sCharacterTitleLeftSideAssets[][2] = {
    [CHARACTER_SONIC] = { 739, 0 }, [CHARACTER_CREAM] = { 739, 8 }, [CHARACTER_TAILS] = { 739, 2 },
    [CHARACTER_KNUCKLES] = { 739, 4 }, [CHARACTER_AMY] = { 739, 6 }, [5] = { 739, 10 },
};

static const u16 sCharacteTitleRightSideAssets[][2] = {
    [CHARACTER_SONIC] = { 739, 1 }, [CHARACTER_CREAM] = { 739, 9 }, [CHARACTER_TAILS] = { 739, 3 },
    [CHARACTER_KNUCKLES] = { 739, 5 }, [CHARACTER_AMY] = { 739, 7 }, [5] = { 739, 11 },
};
...
static const u16 sScreenTitleTextAssets[][2] = {
    [(1 - 1)] = { 740, 0 }, [(2 - 1)] = { 743, 0 }, [(3 - 1)] = { 744, 0 },
    [(4 - 1)] = { 748, 0 }, [(5 - 1)] = { 745, 0 }, [(6 - 1)] = { 746, 0 },
};

static const u8 gUnknown_080D7274[] = { 8, 10, 10, 14 };
static const u16 gCharacterAnnouncements[] = {
    [CHARACTER_SONIC] = 202, [CHARACTER_CREAM] = 206,
    [CHARACTER_TAILS] = 203, [CHARACTER_KNUCKLES] = 204,
    [CHARACTER_AMY] = 205,
};
...
static const u8 sCharacterSilhouettes[] = {
    ...
    [CHARACTER_KNUCKLES] = 6, [CHARACTER_AMY] = 5, [5] = 3,
};
# 187 "src/game/character_select.c"
void CreateCharacterSelectionScreen(u8 initialSelection, bool8 allUnlocked)
{
    struct Task *t;

    Sprite *s = 
# 191 "src/game/character_select.c" 3 4
               ((void *)0)
# 191 "src/game/character_select.c"
                   ;
    ScreenFade *fade = 
# 192 "src/game/character_select.c" 3 4
                      ((void *)0)
# 192 "src/game/character_select.c"
                          ;
    Background *background = 
# 193 "src/game/character_select.c" 3 4
                            ((void *)0)
# 193 "src/game/character_select.c"
                                ;
    ...
    characterScreen->selectionComplete = 0;
    characterScreen->multiplayerSelections = 0;
    characterScreen->exiting = 0;
    characterScreen->scrollingDown = 0;

    if (allUnlocked) {
        characterScreen->carouselPosition = ((0x108 - (0x66 * initialSelection)) & 0x3FF) * 0x100 + 2;
        characterScreen->amyUnlocked = 1;
    ...
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (22)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 99;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (20)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 373;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (21)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 374;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
    ...
    s->x = 0;
    s->y = 0;
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x400);
    s->graphics.anim = 736;
    s->variant = ((5)*2 + 0);
    s->oamFlags = ((4) << 6);
    s->graphics.size = 0;
...
static void Task_FadeInAndStartRollInAnim(void)
{
    struct CharacterSelectionScreen *characterScreen = (void *)((gCurTask)->data);
    ...
    ({ gBgScrollRegs[0][1] = (gBgScrollRegs[0][1] - 1) & 0xFF; gBgScrollRegs[2][0] = (gBgScrollRegs[2][0] - 1) & 0xFF; gBgScrollRegs[2][1] = (gBgScrollRegs[2][1] + 1) & 0xFF; });
}
...
static void Task_RollInAnim(void)
{
    ...
    if (animFrame > 60 || ((gPressedKeys & 0x0001) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) {
        ...
        characterScreen->carouselPosition -= ({((3) != 0) ? ((s32)(gSineTable[(((animFrame + 4) << 2) & 0x3FF) + 0x100]) / (s32)(3)) : 0;});
...
static void Task_CharacterSelectMain(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ({ (characterScreen)->multiplayerSelections = 0; for ((i) = 0; (i) < 4; (i)++) { if ((i) != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id && (((gMultiplayerConnections) >> ((i))) & 1)) { (packet) = &gMultiSioRecv[(i)]; if ((packet)->pat0.unk0 > 0x4020) { (characterScreen)->multiplayerSelections |= (1 << (packet->pat0.unk2)); } } } });
    } else if (gPressedKeys & 0x0002 || characterScreen->exiting) {
        fade = &characterScreen->fade;
        fade->window = 0;
        fade->brightness = 0;
        fade->flags = (1 << 0);
    ...
    if (characterScreen->selectionComplete) {
        ...
        if (gInput & (0x0020 | 0x0040)) {
            ...
            characterScreen->animFrame = 0;
            characterScreen->unk3C4 = 0;
            characterScreen->scrollingDown = 1;
...
# 707 "src/game/character_select.c"
            if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))
                && !((gPressedKeys & 0x0001)
                     && (characterScreen->availableCharacters & (1 << (characterScreen->selectedCharacter))))) {
                RenderCarouselScrollAnim(characterScreen);
            } else

            if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))
                || (gPressedKeys & 0x0001
                    && !(characterScreen->multiplayerSelections & (1 << (characterScreen->selectedCharacter))))) {
                s = &characterScreen->characterSprite;
                s->graphics.anim = sCharacterSelectedSpriteAssets[characterScreen->selectedCharacter][0];
                s->variant = sCharacterSelectedSpriteAssets[characterScreen->selectedCharacter][1];
                s->prevVariant = -1;
                ...
                RenderUI(characterScreen);
            } else if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && characterScreen->multiplayerSelections & (1 << (characterScreen->selectedCharacter))) {
...
static void Task_HandleCarouselScrollUp(void)
{
    ...
    characterScreen = (void *)((gCurTask)->data);
    ...
    if ((((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) && (gPressedKeys & 0x0001)
         && (characterScreen->availableCharacters & (1 << (characterScreen->selectedCharacter))))
        || ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && (gPressedKeys & 0x0001)
            && !(characterScreen->multiplayerSelections & (1 << (characterScreen->selectedCharacter))))) {
        characterScreen->selectionComplete = 1;
    } else if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) && (gPressedKeys & 0x0002)) {
        if (!characterScreen->exiting) {
            m4aSongNumStart(107);
        }
        characterScreen->exiting = 1;
    }
...
static void Task_SelectionCompleteFadeOutAndExit(void)
{
    ...
    if ((characterScreen->animFrame >= sCharacterChosenAnimLengths[characterScreen->selectedCharacter])
        ...
        if (gGameMode != 0) {
            CreateTimeAttackLevelSelectScreen((gGameMode & 2) ? 1 : 0, gSelectedCharacter, gCurrentLevel);
            return;
        }


        if (gLoadedSaveGame->unlockedLevels[gSelectedCharacter] <= ((0)*(3 + 1)) + (2)) {
        ...
        if (gLoadedSaveGame->extraZoneStatus == 1 && gSelectedCharacter == CHARACTER_SONIC) {
            CreateCourseSelectionScreen(((0)*(3 + 1)) + (0), gLoadedSaveGame->unlockedLevels[gSelectedCharacter],
                                        2);
            return;
        }
    ...
    if (characterScreen->amyUnlocked) {
        for (i = 0; i < 10; i++) {
            if ((characterScreen->animFrame > (i - characterScreen->initialSelection) * 5)
                ...
                u8 temp = i - ({((5) != 0) ? ((s32)(i) / (s32)(5)) : 0;}) * 5;
                s = &characterScreen->carouselBlobs[temp];

                s->x = ((int)(((gSineTable[(((characterScreen->carouselPosition >> 8) + (i * 0x66)) & 0x3FF) + 256]) * 92) >> 14)) + 10;
                s->y = ((int)(((gSineTable[((((characterScreen->carouselPosition >> 8) + (i * 0x66)) & 0x3FF))]) * 92) >> 14)) + 80;
                DisplaySprite(s);
            }
        }
    } else {
        ...
        for (i = 0; i < 9; i++) {
            if (characterScreen->animFrame > (s8)(i - characterScreen->initialSelection)) {
                ...
                s->x = ((int)(((gSineTable[(temp2) + 256]) * 92) >> 14)) + 10;
                s->y = ((int)(((gSineTable[(temp2)]) * 92) >> 14)) + 80;
                DisplaySprite(s);
            }
        }
...
static void RenderTransitionInUIAnim(struct CharacterSelectionScreen *characterScreen)
{
    ...
    if (characterScreen->amyUnlocked) {
        for (i = 0; i < 10; i++) {
            u8 temp2 = i - ({((5) != 0) ? ((s32)(i) / (s32)(5)) : 0;}) * 5;
    ...
    s->x = 101;
    s->y = 79;
    s->variant = characterScreen->selectedCharacter + (0 + NUM_CHARACTERS);
    s->prevVariant = -1;
    ...
    if (!(characterScreen->availableCharacters & (1 << (characterScreen->selectedCharacter))) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
    ...
    if (characterScreen->selectedCharacter == CHARACTER_CREAM) {
        ...
        if (!(characterScreen->availableCharacters & (1 << (characterScreen->selectedCharacter))) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            ...
            s->frameFlags |= 0x40000;
            s->palId = sCharacterSilhouettes[5];
        } else {
            s->frameFlags &= ~0x40000;
            s->palId = 0;
        }
    ...
    transform->qScaleY = ((s32)((1)*256)) - ((0x10 - characterScreen->animFrame) * 0xF);
    transform->x = s->x;
    transform->y = s->y;
...
static void RenderCarouselScrollAnim(struct CharacterSelectionScreen *characterScreen)
{
    ...
    if (characterScreen->unk3C4 == 0) {
        ...
        if (!(characterScreen->availableCharacters & (1 << (characterScreen->selectedCharacter))) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            s = &characterScreen->characterNameSubText;
            s->graphics.anim = sCharacterNameSubTextAssets[5][0];
            s->variant = sCharacterNameSubTextAssets[5][1];
            s->prevVariant = -1;
            UpdateSpriteAnimation(s);

            s = &characterScreen->characterTitleTextLeft;
            s->graphics.anim = sCharacterTitleLeftSideAssets[5][0];
            s->variant = sCharacterTitleLeftSideAssets[5][1];
            s->prevVariant = -1;

            s = &characterScreen->characterTitleTextRight;
            s->graphics.anim = sCharacteTitleRightSideAssets[5][0];
            s->variant = sCharacteTitleRightSideAssets[5][1];
            s->prevVariant = -1;
        } else {
            s = &characterScreen->characterNameSubText;
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && characterScreen->multiplayerSelections & (1 << (characterScreen->selectedCharacter))) {
        s = &characterScreen->characterUnavailableIndicator;
        s->x = f;
        s->y = 130;
        DisplaySprite(s);
    ...
    s->y = 144;
    DisplaySprite(s);
# 1448 "src/game/character_select.c"
    s = &characterScreen->screenTitleText;
    s->x = 426;
    s->y = 16;
    DisplaySprite(s);
    ...
    if (c < 8) {
        transform->rotation = 0;
        transform->qScaleX = ((s32)((1)*256));
        transform->qScaleY = ((s32)((1)*256)) - ((8 - c) * 0x1E);
        transform->x = s->x;
        transform->y = s->y;
...
# 1580 "src/game/character_select.c"
...
static void Task_MultiplayerWaitForSelections(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ({ (characterScreen)->multiplayerSelections = 0; for ((i) = 0; (i) < 4; (i)++) { if ((i) != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id && (((gMultiplayerConnections) >> ((i))) & 1)) { (recv) = &gMultiSioRecv[(i)]; if ((recv)->pat0.unk0 > 0x4020) { (characterScreen)->multiplayerSelections |= (1 << (recv->pat0.unk2)); } } } });
    }
    ...
    for (i = 0; i < 4; i++) {
        if ((((gMultiplayerConnections) >> (i)) & 1) && i != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
            recv = &gMultiSioRecv[i];

            if (recv->pat0.unk0 == 0x4021 && recv->pat0.unk2 == characterScreen->selectedCharacter && i < ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
                gCurTask->main = Task_CharacterSelectMain;
                m4aSongNumStart(107);
                characterScreen->selectionComplete = 0;
...
static void Task_MultiplayerVerifySelections(void)
{
    ...
    register struct CharacterSelectionScreen *characterScreen = (void *)((gCurTask)->data);
    ({ if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) { u32 i; for (i = 0; i < 4 && (((gMultiplayerConnections) >> (i)) & 1); i++) { if (!(gMultiSioStatusFlags & (0x0001 << (i)))) { if (gMultiplayerMissingHeartbeats[i]++ > 0xB4) { TasksDestroyInPriorityRange(0, 0xFFFF); gBackgroundsCopyQueueCursor = gBackgroundsCopyQueueIndex;; gBgSpritesCount = 0; gVramGraphicsCopyCursor = gVramGraphicsCopyQueueIndex; LinkCommunicationError(); return; } } else { gMultiplayerMissingHeartbeats[i] = 0; } } } });

    for (i = 0, someoneNotConfirmed = 0; i < 4; i++) {
        recv = &gMultiSioRecv[i];
        if ((((gMultiplayerConnections) >> (i)) & 1) && recv->pat0.unk0 < 0x4022) {
            someoneNotConfirmed = 1;
...
{
    u8 i;
    struct CharacterSelectionScreen *characterScreen = (void *)((t)->data);
