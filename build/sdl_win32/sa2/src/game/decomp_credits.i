# 0 "src/game/decomp_credits.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/decomp_credits.c"
...
# 10 "src/game/decomp_credits.c" 2
...
# 11 "src/game/decomp_credits.c" 2
# 1 "include/game/stage/debug_text_printer.h" 1
...
# 12 "src/game/decomp_credits.c" 2
...
# 14 "src/game/decomp_credits.c" 2

# 1 "include/constants/songs.h" 1
# 16 "src/game/decomp_credits.c" 2
...
void CreateDecompCreditsScreen(bool32 hasProfile)
{
    ...
    s->x = -508;
    s->y = (240 / 2) - 16;
    s->graphics.dest = VramMalloc(64); s->graphics.anim = ((9) + CHARACTER_SONIC * (91)); s->variant = 4; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (((1) << (10))));;;
    ...
    s->x = 426 + 64 + 32;
    s->y = 240 - 48;
    s->graphics.dest = VramMalloc(64); s->graphics.anim = ((9) + CHARACTER_TAILS * (91)); s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    s->palId = 1;
    ...
    s->x = (426 / 2) + 24;
    s->y = (240 / 2) - (64 / 2);
    s->graphics.dest = VramMalloc(64); s->graphics.anim = 1133; s->variant = 1; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (((1) << (10))));;;
    s->palId = 2;
    ...
    s->y = cred->sprTails.y;
    s->graphics.dest = VramMalloc(64); s->graphics.anim = 1133; s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    s->palId = 3;
...
void UpdateSprites(DCCredits *cred)
{
    ...
    if (tailsIsCheering && ((cred->frames % 64u) < 32)) {
        Debug_PrintTextAt("Press START to continue", 8, 240);
    }
}
...
void Task_DecompCreditsFirst()
{
    ...
    if (cred->sprLogoJace.x <= ((426 / 2) + 24)) {
    ...
    if ((cred->qSpeedSonic <= 0) && cred->sprSonic.x < (426 / 2) + 16) {
...
void customHBlank(void)
{
    ...
    int_vcount vcount = (*(vu16 *)(REG_BASE + 0x6));
    if ((vcount >= 240 - 16 - 1) && (vcount < 240 - 1)) {

        ((u16 *)((u16*)&PLTT[0]))[0] = ((31) | ((31) << 5) | ((31) << 10));
    } else if ((vcount >= (240 / 2) - 1) && (vcount < 240 - 1)) {

        ((u16 *)((u16*)&PLTT[0]))[0] = ((u16 *)((u16*)&PLTT[0x200/sizeof(uint16_t)]))[3 * 16u];
    } else {

        ((u16 *)((u16*)&PLTT[0]))[0] = ((u16 *)((u16*)&PLTT[0x200/sizeof(uint16_t)]))[2 * 16u];
    }
}
