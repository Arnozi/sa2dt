...
void InitWaterPalettes(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ...
        for (j = 0; j < i; j++) {
            ...
            CopyPalette((u32 *)wd->pal[j], (u32 *)gSpritePalettes[pal], 16u);
...
void CreateRunOnWaterEffect(void)
{
    ...
    RunOnWaterEffect *effect = (void *)((t)->data);
    Sprite *s = &effect->s;
...
static void Task_RunOnWaterEffect(void)
{
    RunOnWaterEffect *effect = (void *)((gCurTask)->data);
    Sprite *s = &effect->s;
    Player *p = &gPlayer;
    u32 newMovestate;
...
static void TaskDestructor_WaterSurface(struct Task *t)
{
    ...
    gIntrTable[3] = gIntrTableTemplate[3];
    water->t = 
# 330 "src/game/water_effects.c" 3 4
              ((void *)0)
# 330 "src/game/water_effects.c"
                  ;
}
...
static void sub_8011A4C(void)
{
...

    {
        ...
        if (!unk2) {
            DmaSet(3, &wd->pal[16], PLTT, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((29 * 16)/(32/8))));
            DmaSet(3, &wd->pal[0], ((u16*)&PLTT[0x200/sizeof(uint16_t)]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((0x200)/(32/8))));
            (*(vu16 *)(REG_BASE + 0x0)) &= ~0x0100;
            gFlags |= (0x2 | 0x1);
        }
    }
}
