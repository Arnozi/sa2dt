...
void CreateEntity_Circus(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Circus *circus = (void *)((t)->data);
    Sprite *s = &circus->s;
...
void Task_CircusMain(void)
{
    Sprite_Circus *circus = (void *)((gCurTask)->data);
    Sprite *s = &circus->s;
    Sprite *s2 = &circus->s2;
    ...
    if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = circus->base.meX; }; TaskDestroy(gCurTask); return; };
