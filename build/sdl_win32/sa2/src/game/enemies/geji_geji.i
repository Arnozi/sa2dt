...
void CreateEntity_GejiGeji(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_GejiGeji *gg = (void *)((t)->data);
...
{
    u8 i;
    Sprite_GejiGeji *gg = (void *)((gCurTask)->data);
    MapEntity *me;
    Vec2_32 pos;
    ...
    if (((((int)((gg->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((gg->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((gg->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((gg->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = gg->base.meX; }; TaskDestroy(gCurTask); return; }; };
