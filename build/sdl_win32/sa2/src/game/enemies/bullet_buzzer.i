...
void CreateEntity_BulletBuzzer(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_BulletBuzzer *bbuzzer = (void *)((t)->data);
    Sprite *s = &bbuzzer->s;
...
void Task_BulletBuzzerMain(void)
{
    Sprite_BulletBuzzer *bbuzzer = (void *)((gCurTask)->data);
    Sprite *s = &bbuzzer->s;
    ...
    if (((((int)((bbuzzer->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((bbuzzer->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((bbuzzer->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((bbuzzer->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = bbuzzer->base.meX; }; TaskDestroy(gCurTask); return; }; };
