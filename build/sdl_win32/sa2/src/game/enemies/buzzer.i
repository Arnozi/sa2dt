# 0 "src/game/enemies/buzzer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/buzzer.c"
...
# 6 "include/game/sa1_sa2_shared/entities_manager.h" 2
# 1 "include/task.h" 1
...
# 11 "src/game/enemies/buzzer.c" 2
...
void CreateEntity_Buzzer(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if ((gGameMode == 1 || gCurrentLevel > 3 || gDifficultyLevel != 1)) {
        ...
        buzzer->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); buzzer->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));; buzzer->offsetX = 0; buzzer->offsetY = 0;;

        buzzer->unk54 = ((s32)((0.0)*256));
        buzzer->unk58 = 0;
        buzzer->unk60 = 0;
        buzzer->unk64 = 0;
        buzzer->unk66 = 0;
        ...
        s->graphics.dest = VramMalloc(20); s->graphics.anim = 482; s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    }
}

static void Task_BuzzerMain(void)
{
    Sprite_Buzzer *buzzer = (void *)((gCurTask)->data);
    Sprite *s = &buzzer->s;
    ...
    pos.x = ((int)((buzzer->spawnX + buzzer->offsetX) >> 8)); pos.y = ((int)((buzzer->spawnY + 0) >> 8)); s->x = pos.x - gCamera.x; s->y = pos.y - gCamera.y;;
    if (Coll_Player_Enemy_Attack(s, pos.x, pos.y, 0)) { TaskDestroy(gCurTask); return; };
    if (((((int)((buzzer->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((buzzer->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((buzzer->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((buzzer->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = buzzer->base.meX; }; TaskDestroy(gCurTask); return; }; };

    if ((buzzer->unk68 == 0 ||
# 91 "src/game/enemies/buzzer.c"
         --buzzer->unk68 == 0

         )
        && !(s->frameFlags & ((1) << (10))) && ((int)((gPlayer.qWorldX) >> 8)) > (pos.x - 0x3C) && ((int)((gPlayer.qWorldX) >> 8)) < pos.x
        && ((int)((gPlayer.qWorldY) >> 8)) > pos.y && ((int)((gPlayer.qWorldY) >> 8)) < (pos.y + 0x50)) {
        gCurTask->main = sub_80534F0;
        s->graphics.anim = 482;
        s->variant = 1;
        s->prevVariant = -1;
        buzzer->unk5C = gPlayer.qWorldY;
        buzzer->unk64 = ({((0x20) != 0) ? ((s32)(gPlayer.qWorldX - ((s32)((pos.x) << 8))) / (s32)(0x20)) : 0;});
        buzzer->unk66 = ({((0x20) != 0) ? ((s32)(gPlayer.qWorldY - ((s32)((pos.y) << 8))) / (s32)(0x20)) : 0;});
    } else if (buzzer->unk68 == 0 && (s->frameFlags & ((1) << (10))) && ((int)((gPlayer.qWorldX) >> 8)) > pos.x
               && ((int)((gPlayer.qWorldX) >> 8)) < (pos.x + 0x3C) && ((int)((gPlayer.qWorldY) >> 8)) > pos.y && ((int)((gPlayer.qWorldY) >> 8)) < (pos.y + 0x50)) {
        gCurTask->main = sub_80534F0;
        s->graphics.anim = 482;
        s->variant = 1;
        s->prevVariant = -1;
        ...
        buzzer->unk64 = ({((0x20) != 0) ? ((s32)(((s32)((pos.x) << 8)) - gPlayer.qWorldX) / (s32)(0x20)) : 0;});
        buzzer->unk64 = ({((0x20) != 0) ? ((s32)(gPlayer.qWorldX - ((s32)((pos.x) << 8))) / (s32)(0x20)) : 0;});
        ...
        if (((((int)((buzzer->offsetX) >> 8)) <= me->d.sData[0] * 8)) && !(s->frameFlags & ((1) << (10)))) {
            gCurTask->main = sub_80533B4;
            s->graphics.anim = 482;
            s->variant = 2;
            s->prevVariant = -1;
        } else if (((((int)((buzzer->offsetX) >> 8)) >= (me->d.sData[0] * 8 + me->d.uData[2] * 8))) && s->frameFlags & ((1) << (10))) {
            gCurTask->main = sub_80533B4;
            s->graphics.anim = 482;
            s->variant = 2;
            s->prevVariant = -1;
...
static void sub_80533B4(void)
{
    ...
    if (UpdateSpriteAnimation(s) == 0) {
        if (s->frameFlags & ((1) << (10))) { (s)->frameFlags &= ~(((1) << (10))); } else { (s)->frameFlags |= (((1) << (10))); };
        s->graphics.anim = 482;
        s->variant = 0;
        s->prevVariant = -1;
...
static void sub_80534F0(void)
{
    ...
    pos.x = ((int)((buzzer->spawnX + buzzer->offsetX + buzzer->unk54) >> 8)); pos.y = ((int)((buzzer->spawnY + buzzer->unk58) >> 8)); s->x = pos.x - gCamera.x; s->y = pos.y - gCamera.y;;

    if (Coll_Player_Enemy_Attack(s, pos.x, pos.y, 0)) { TaskDestroy(gCurTask); return; };
    if (((((int)((buzzer->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((buzzer->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((buzzer->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((buzzer->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = buzzer->base.meX; }; TaskDestroy(gCurTask); return; }; };

    Player_UpdateHomingPosition(((s32)((pos.x) << 8)), ((s32)((pos.y) << 8))); { { if (((s32)((pos.y) << 8)) > buzzer->unk5C) { gCurTask->main = sub_8053620; } } }; UpdateSpriteAnimation(s); DisplaySprite(s);;
...
static void sub_8053620(void)
{
    ...
    Player_UpdateHomingPosition(((s32)((pos.x) << 8)), ((s32)((pos.y) << 8))); { { if (buzzer->unk58 < 1) { buzzer->unk54 = 0; buzzer->unk58 = 0; s->graphics.anim = 482; s->variant = 0; s->prevVariant = -1; buzzer->unk68 = 0x3C; gCurTask->main = Task_BuzzerMain; } } }; UpdateSpriteAnimation(s); DisplaySprite(s);;
# 208 "src/game/enemies/buzzer.c"
      ;
}
