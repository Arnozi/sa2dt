...
void CreateEntity_KuraKura(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_KuraKura *kk = (void *)((t)->data);
    Sprite *s = &kk->s;
    kk->unkB0 = 0;
    kk->unkAC = 0;
...
void Task_8052024(void)
{
    Sprite_KuraKura *kk = (void *)((gCurTask)->data);
    Sprite *s = &kk->s;
    ...
    if (((pos.x) > gCamera.x + (426 + (256 / 2)) || (pos.x) < gCamera.x - (256 / 2) || (pos.y) > gCamera.y + ((240) + ((256) / 2)) || (pos.y) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = kk->base.meX; }; TaskDestroy(gCurTask); return; }; };
