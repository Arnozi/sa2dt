# 0 "src/game/enemies/mon.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/mon.c"
...
void CreateEntity_Mon(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    mon->x = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256));
    mon->y = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));

    mon->y += ((s32)((sub_801F07C(((int)((mon->y) >> 8)), ((int)((mon->x) >> 8)), r2 >> 31, 8, 
# 49 "src/game/enemies/mon.c" 3 4
             ((void *)0)
# 49 "src/game/enemies/mon.c"
             , sub_801EE64))*256));
    ...
    mon->speedY = -((s32)((5.5)*256));
    mon->offsetY = +((s32)((0)*256));
    s->graphics.anim = 478;
    s->variant = 0;
    s->prevVariant = -1;
}
...
static void Task_MonMain(void)
{
    Sprite_Mon *mon = (void *)((gCurTask)->data);
    Sprite *s = &mon->s;
    MapEntity *me = mon->base.me;

    s->x = ((int)((mon->x) >> 8)) - gCamera.x;
    s->y = ((int)((mon->y) >> 8)) - gCamera.y;

    if (Coll_Player_Enemy_Attack(s, ((int)((mon->x) >> 8)), ((int)((mon->y) >> 8)), 0)) {
        ...
        if ((gPlayer.qWorldX > mon->x - ((s32)((426 / 2)*256))) && (gPlayer.qWorldX < mon->x + ((s32)((426 / 2)*256)))
            && (gPlayer.qWorldY > mon->y - ((s32)((50)*256))) && (gPlayer.qWorldY < mon->y + ((s32)((50)*256)))) {
        ...
        if (gPlayer.qWorldX < mon->x) { (s)->frameFlags &= ~(((1) << (10))); } else { (s)->frameFlags |= (((1) << (10))); };

        Player_UpdateHomingPosition(mon->x, mon->y); { {} }; UpdateSpriteAnimation(s); DisplaySprite(s);;
    }
}
...
static void Task_Mon_3(void)
{
    ...
    mon->speedY += ((s32)((52. / 256.)*256));
    mon->offsetY += mon->speedY;

    s->x = ((int)((mon->x) >> 8)) - gCamera.x;
    s->y = ((int)((mon->y + mon->offsetY) >> 8)) - gCamera.y;

    if (Coll_Player_Enemy_Attack(s, ((int)((mon->x) >> 8)), ((int)((mon->y + mon->offsetY) >> 8)), 0)) {
        TaskDestroy(gCurTask);
        return;
    } else if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = mon->base.meX; };
        ...
        Player_UpdateHomingPosition(mon->x, mon->y + mon->offsetY); { {} }; UpdateSpriteAnimation(s); DisplaySprite(s);;
    }
}
