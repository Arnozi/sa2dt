# 0 "src/game/enemies/mouse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/mouse.c"
...
# 7 "src/game/enemies/mouse.c" 2



# 1 "include/malloc_vram.h" 1
# 11 "src/game/enemies/mouse.c" 2
...
void CreateEntity_Mouse(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if (gGameMode == 1 || gDifficultyLevel != 1) {
        ...
        Sprite_Mouse *mouse = (void *)((t)->data);
        Sprite *s = &mouse->s;
        ...
        mouse->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256));
        mouse->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));
        ...
        if (mouse->unk51) {
            mouse->offsetY = ((s32)((sub_801F07C(((int)((mouse->spawnY) >> 8)), ((int)((mouse->spawnX) >> 8)), mouse->unk50, 8, 0, sub_801EE64))*256));
        } else {
            mouse->offsetY = ((s32)((sub_801F07C(((int)((mouse->spawnY) >> 8)), ((int)((mouse->spawnX) >> 8)), mouse->unk50, 8, 0, sub_801EE64))*256));
        }
        mouse->unk4C = 0;
        ...
        s->graphics.dest = VramMalloc(15); s->graphics.anim = 513; s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
...
static void sub_8057348(void)
{
    Sprite_Mouse *mouse = (void *)((gCurTask)->data);
    ...
    if (mouse->unk51) {
        { s32 delta = sub_801F07C(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, -8, 
# 104 "src/game/enemies/mouse.c" 3 4
       ((void *)0)
# 104 "src/game/enemies/mouse.c"
       , sub_801EE64); if (delta < 0) { mouse->offsetY -= ((s32)((delta)*256)); delta = sub_801F100(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, sub_801EC3C);; } if (delta > 0) { mouse->offsetY -= ((s32)((delta)*256)); } };
        pos.x = ((int)((mouse->spawnX + mouse->offsetX) >> 8)) + 8;
        pos.y = ((int)((mouse->spawnY + mouse->offsetY) >> 8)) + 8;

    } else {
        { s32 delta = sub_801F07C(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, 
# 109 "src/game/enemies/mouse.c" 3 4
       ((void *)0)
# 109 "src/game/enemies/mouse.c"
       , sub_801EE64); if (delta < 0) { mouse->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, sub_801EC3C);; } if (delta > 0) { mouse->offsetY += ((s32)((delta)*256)); } };
        pos.x = ((int)((mouse->spawnX + mouse->offsetX) >> 8));
        pos.y = ((int)((mouse->spawnY + mouse->offsetY) >> 8));
    }

    s->x = pos.x - gCamera.x;
    s->y = pos.y - gCamera.y;
    if (Coll_Player_Enemy_Attack(s, pos.x, pos.y, 0)) { TaskDestroy(gCurTask); return; };
    if (((((int)((mouse->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((mouse->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((mouse->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((mouse->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = mouse->base.meX; }; TaskDestroy(gCurTask); return; }; };

    if (s->frameFlags & ((1) << (10))) {
        if (gPlayer.qWorldX > ((s32)((pos.x) << 8)) && gPlayer.qWorldX < ((s32)((pos.x + 100) << 8))) {
            mouse->unk52 = 1;
        }
    } else {
        if (gPlayer.qWorldX < ((s32)((pos.x) << 8)) && gPlayer.qWorldX > ((s32)((pos.x - 100) << 8))) {
    ...
    if (((int)((mouse->offsetX) >> 8)) <= (me->d.sData[0] * 8) && !(s->frameFlags & ((1) << (10)))) {
        gCurTask->main = sub_8057618;
        s->graphics.anim = 513;
        s->variant = 1;
        s->prevVariant = -1;
    } else if ((((int)((mouse->offsetX) >> 8)) >= ((me->d.sData[0] + me->d.uData[2]) * 8) && s->frameFlags & ((1) << (10)))) {
        gCurTask->main = sub_8057618;
        s->graphics.anim = 513;
        s->variant = 1;
        s->prevVariant = -1;
...
static void sub_8057618(void)
{
    ...
    if (mouse->unk51) {
        { s32 delta = sub_801F07C(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, -8, 
# 157 "src/game/enemies/mouse.c" 3 4
       ((void *)0)
# 157 "src/game/enemies/mouse.c"
       , sub_801EE64); if (delta < 0) { mouse->offsetY -= ((s32)((delta)*256)); delta = sub_801F100(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, sub_801EC3C);; } if (delta > 0) { mouse->offsetY -= ((s32)((delta)*256)); } };
        pos.x = ((int)((mouse->spawnX + mouse->offsetX) >> 8)) + 8;
        pos.y = ((int)((mouse->spawnY + mouse->offsetY) >> 8)) + 8;
    } else {
        { s32 delta = sub_801F07C(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, 
# 161 "src/game/enemies/mouse.c" 3 4
       ((void *)0)
# 161 "src/game/enemies/mouse.c"
       , sub_801EE64); if (delta < 0) { mouse->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, sub_801EC3C);; } if (delta > 0) { mouse->offsetY += ((s32)((delta)*256)); } };
        pos.x = ((int)((mouse->spawnX + mouse->offsetX) >> 8));
        pos.y = ((int)((mouse->spawnY + mouse->offsetY) >> 8));
    }
