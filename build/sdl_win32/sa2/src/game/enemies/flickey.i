# 0 "src/game/enemies/flickey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/flickey.c"
...
# 2 "src/game/enemies/flickey.c" 2
...
void VramFree(void *);
# 3 "src/game/enemies/flickey.c" 2
...
# 4 "src/game/enemies/flickey.c" 2
...
# 6 "src/game/enemies/flickey.c" 2
...
# 12 "src/game/enemies/flickey.c" 2
...
void CreateEntity_Flickey(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    if ((gGameMode == 1 || gDifficultyLevel != 1)) {
        ...
        Sprite_Flickey *flickey = (void *)((t)->data);
        Sprite *s = &flickey->s;
        ...
        flickey->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); flickey->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));; flickey->offsetX = 0; flickey->offsetY = 0;;

        flickey->unk9C = -((s32)((1.5)*256));
        flickey->unk9E = -((s32)((4.0)*256));
        flickey->unk2A4 = 0;

        x = ((s32)((flickey->spawnX)*256));
        y = ((s32)((flickey->spawnY)*256));

        for (i = 0; i < (sizeof(flickey->positions) / sizeof((flickey->positions)[0])); i++) {
            flickey->positions[i].x = ((int)((x >> 8) >> 8));
            flickey->positions[i].y = ((int)((y >> 8) >> 8));
        }
        ...
        s->graphics.dest = VramMalloc(20); s->graphics.anim = 507; s->variant = 1; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;

        s = &flickey->s2;
        s->x = ((me->x)*8 + (spriteRegionX)*256);
        s->y = ((me->y)*8 + (spriteRegionY)*256);
        s->graphics.dest = VramMalloc(8); s->graphics.anim = 508; s->variant = 0; s->oamFlags = ((19) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    }
}
...
{
    u8 i;
    Sprite_Flickey *flickey = (void *)((gCurTask)->data);
    Sprite *s = &flickey->s;
    ...
    pos.x = ((int)((flickey->spawnX + flickey->offsetX) >> 8));
    pos.y = ((int)((flickey->spawnY + flickey->offsetY) >> 8));
    ...
    if (Coll_Player_Enemy_Attack(s, pos.x, pos.y, 0)) {
        ...
        for (i = 0; i < 3; i++) {
            u32 temp;
            flickey->positions[i].x = ((s32)((positions[i][0]) << 8));
            flickey->positions[i].y = ((s32)((positions[i][1]) << 8));
            temp = ({((i + 1) != 0) ? ((s32)(flickey->unk9C) / (s32)(i + 1)) : 0;});
            flickey->positions[i + 3].x = temp;
            flickey->positions[i + 3].y = ((s32)((positions[i][2]) << 8));
        }
    ...
    if (someVal < 0) {
        s->y += someVal;
        flickey->offsetY += ((s32)((someVal)*256));
        ...
        if (((((int)((flickey->offsetX) >> 8)) <= me->d.sData[0] * 8)) && flickey->unk9C < 0) {
            s->graphics.anim = 507;
            s->variant = 0;
            s->prevVariant = -1;
            gCurTask->main = sub_8058EDC;
        } else if (((((int)((flickey->offsetX) >> 8)) >= (me->d.sData[0] * 8 + me->d.uData[2] * 8))) && flickey->unk9C > 0) {
            s->graphics.anim = 507;
            s->variant = 0;
            s->prevVariant = -1;
            gCurTask->main = sub_8058EDC;
    ...
    if (((((int)((flickey->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((flickey->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((flickey->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((flickey->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = flickey->base.meX; }; TaskDestroy(gCurTask); return; }; };
...
static void sub_8058EDC(void)
{
    ...
    pos.x = ((int)((flickey->spawnX + flickey->offsetX) >> 8)); pos.y = ((int)((flickey->spawnY + flickey->offsetY) >> 8)); s->x = pos.x - gCamera.x; s->y = pos.y - gCamera.y;;
...
static void sub_80591FC(void)
{
    ...
    for (i = 0; i < 3; i++) {
        ...
        someVal = sub_801F07C(((int)((flickey->positions[i].y) >> 8)), ((int)((flickey->positions[i].x) >> 8)), 1, 8, 0, sub_801EE64);

        if (someVal < 0) {
            flickey->positions[i].y += ((s32)((someVal) << 8));
            flickey->positions[i + 3].y = -flickey->positions[i + 3].y;
        }

        if (flickey->unkA0 > 0x2D || (gStageTime & 2 && flickey->unkA0 < 0x2D)) {
            s->x = ((int)((flickey->positions[i].x) >> 8)) - gCamera.x;
            s->y = ((int)((flickey->positions[i].y) >> 8)) - gCamera.y;
