# 0 "src/game/enemies/pen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/pen.c"
...
# 4 "src/game/enemies/pen.c" 2
# 1 "include/malloc_vram.h" 1
# 5 "src/game/enemies/pen.c" 2
...
void CreateEntity_Pen(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    pen->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); pen->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));; pen->offsetX = 0; pen->offsetY = ((s32)((sub_801F07C(((int)((pen->spawnY) >> 8)), ((int)((pen->spawnX) >> 8)), pen->clampParam, 8, 
# 47 "src/game/enemies/pen.c" 3 4
   ((void *)0)
# 47 "src/game/enemies/pen.c"
   , sub_801EE64))*256));;
    ...
    s->graphics.dest = VramMalloc(12); s->graphics.anim = 500; s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
}

static void Task_PenMove(void)
{
    Sprite_Pen *pen = (void *)((gCurTask)->data);
    Sprite *s = &pen->s;
    ...
    if ((s->frameFlags & ((1) << (10)))) {
        if (pen->boosting) {
            pen->offsetX += ((s32)((2.0)*256));
        } else {
            pen->offsetX += ((s32)((0.5)*256));
        }
    } else {
        if (pen->boosting) {
            pen->offsetX -= ((s32)((2.0)*256));
    ...
    { s32 delta = sub_801F07C(((int)((pen->spawnY + pen->offsetY) >> 8)), ((int)((pen->spawnX + pen->offsetX) >> 8)), pen->clampParam, 8, 
# 81 "src/game/enemies/pen.c" 3 4
   ((void *)0)
# 81 "src/game/enemies/pen.c"
   , sub_801EE64); if (delta < 0) { pen->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((pen->spawnY + pen->offsetY) >> 8)), ((int)((pen->spawnX + pen->offsetX) >> 8)), pen->clampParam, 8, sub_801EC3C);; } if (delta > 0) { pen->offsetY += ((s32)((delta)*256)); } };

    pos.x = ((int)((pen->spawnX + pen->offsetX) >> 8)); pos.y = ((int)((pen->spawnY + pen->offsetY) >> 8)); s->x = pos.x - gCamera.x; s->y = pos.y - gCamera.y;;

    if (Coll_Player_Enemy_Attack(s, pos.x, pos.y, 0)) { TaskDestroy(gCurTask); return; };
    if (((((int)((pen->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((pen->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((pen->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((pen->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = pen->base.meX; }; TaskDestroy(gCurTask); return; }; };

    if (s->frameFlags & ((1) << (10))) {
        s32 playerX = gPlayer.qWorldX;

        posX_24_8 = ((s32)((pos.x)*256));
        if (playerX > posX_24_8 && playerX < ((s32)((pos.x + 100)*256))) {
            if (!pen->boosting) {
                s->graphics.anim = 500;
                s->variant = 1;
                s->prevVariant = -1;
    ...
    if (((((int)((pen->offsetX) >> 8)) <= me->d.sData[0] * 8)) && !(s->frameFlags & ((1) << (10)))) {
        gCurTask->main = Task_PenTurn;
        s->graphics.anim = 500;
        s->variant = 2;
        s->prevVariant = -1;
    } else if (((((int)((pen->offsetX) >> 8)) >= (me->d.sData[0] * 8 + me->d.uData[2] * 8))) && (s->frameFlags & ((1) << (10)))) {
        gCurTask->main = Task_PenTurn;
        s->graphics.anim = 500;
        s->variant = 2;
        s->prevVariant = -1;
    ...
    Player_UpdateHomingPosition(posX_24_8, ((s32)((pos.y)*256))); { {} }; UpdateSpriteAnimation(s); DisplaySprite(s);;
}
...
static void Task_PenTurn(void)
{
    ...
    { s32 delta = sub_801F07C(((int)((pen->spawnY + pen->offsetY) >> 8)), ((int)((pen->spawnX + pen->offsetX) >> 8)), pen->clampParam, 8, 
# 137 "src/game/enemies/pen.c" 3 4
   ((void *)0)
# 137 "src/game/enemies/pen.c"
   , sub_801EE64); if (delta < 0) { pen->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((pen->spawnY + pen->offsetY) >> 8)), ((int)((pen->spawnX + pen->offsetX) >> 8)), pen->clampParam, 8, sub_801EC3C);; } if (delta > 0) { pen->offsetY += ((s32)((delta)*256)); } };
    ...
    Player_UpdateHomingPosition(((s32)((pos.x)*256)), ((s32)((pos.y)*256)));
