# 0 "src/game/enemies/koura.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/koura.c"
...
# 12 "src/game/enemies/koura.c" 2
# 1 "include/constants/songs.h" 1
# 13 "src/game/enemies/koura.c" 2
...
void CreateEntity_Koura(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Koura *koura = (void *)((t)->data);
    Sprite *s = &koura->s;
    ...
    koura->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); koura->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));;
    koura->offsetX = 0;
    if (koura->unk54 < 2) {
        koura->offsetY = ((s32)((sub_801F07C(((int)((koura->spawnY) >> 8)), ((int)((koura->spawnX) >> 8)), koura->unk54, 8, 
# 71 "src/game/enemies/koura.c" 3 4
                        ((void *)0)
# 71 "src/game/enemies/koura.c"
                        , sub_801EE64)) << 8));
    } else {
        koura->offsetY = 0;
    }
    ...
    s->graphics.dest = VramMalloc(30); s->graphics.anim = gUnknown_080D8F38[koura->unk54 & 2][0]; s->variant = gUnknown_080D8F38[koura->unk54 & 2][1]; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
}

static void sub_8054224(void)
{
    Sprite_Koura *koura = (void *)((gCurTask)->data);
    Sprite *s = &koura->s;
    ...
    if (koura->unk54 < 2) {
        { s32 delta = sub_801F07C(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, 
# 96 "src/game/enemies/koura.c" 3 4
       ((void *)0)
# 96 "src/game/enemies/koura.c"
       , sub_801EE64); if (delta < 0) { koura->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, sub_801EC3C);; } if (delta > 0) { koura->offsetY += ((s32)((delta)*256)); } };
    } else if (koura->unk54 == 2) {
        s32 temp = (gSineTable[((gStageTime * 0x14) & (1024 - 1))]);
    ...
    pos.x = ((int)((koura->spawnX + koura->offsetX) >> 8)); pos.y = ((int)((koura->spawnY + koura->offsetY) >> 8)); s->x = pos.x - gCamera.x; s->y = pos.y - gCamera.y;;

    if (gPlayer.qSpeedAirY >= 1 && (gPlayer.moveState & 0x00000002)) {
    ...
    if (((((int)((koura->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((koura->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((koura->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((koura->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = koura->base.meX; }; TaskDestroy(gCurTask); return; }; };

    if (koura->unk54 < 3) {
        if (((((int)((koura->offsetX) >> 8)) <= me->d.sData[0] * 8)) && koura->unk56 < 0) {
            ...
            s->prevVariant = -1;
            koura->unk56 = ({ s32 temp = koura->unk56; koura->unk56 = -temp; });
        } else if (((((int)((koura->offsetX) >> 8)) >= (me->d.sData[0] * 8 + me->d.uData[2] * 8))) && koura->unk56 > 0) {
            gCurTask->main = sub_805462C;
            s->graphics.anim = gUnknown_080D8F38[koura->unk54 == 2 ? 5 : 4][0];
            s->variant = gUnknown_080D8F38[koura->unk54 == 2 ? 5 : 4][1];
        ...
        if ((((((int)((koura->offsetY) >> 8)) <= me->d.sData[1] * 8)) && koura->unk58 < 0)) {
            koura->unk58 = ({ s32 temp = koura->unk58; koura->unk58 = -temp; });
        } else if (((((int)((koura->offsetY) >> 8)) >= (me->d.sData[1] * 8 + me->d.uData[3] * 8))) && koura->unk58 > 0) {
            koura->unk58 = ({ s32 temp = koura->unk58; koura->unk58 = -temp; });
        }

        if (((((s)->frameFlags & (((1) << (10)))) >> ((10))) && gPlayer.qWorldX < ((s32)((pos.x) << 8))) || (!(((s)->frameFlags & (((1) << (10)))) >> ((10))) && gPlayer.qWorldX > ((s32)((pos.x) << 8)))) {
            gCurTask->main = sub_805462C;
...
static void sub_805462C(void)
{
    ...
    if (koura->unk54 < 2) {
        { s32 delta = sub_801F07C(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, 
# 171 "src/game/enemies/koura.c" 3 4
       ((void *)0)
# 171 "src/game/enemies/koura.c"
       , sub_801EE64); if (delta < 0) { koura->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, sub_801EC3C);; } if (delta > 0) { koura->offsetY += ((s32)((delta)*256)); } };
    } else if (koura->unk54 == 2) {
        s32 temp = (gSineTable[((gStageTime * 0x14) & (1024 - 1))]);
        koura->offsetY = temp >> 4;
...
static void sub_8054904(void)
{
    ...
    if (koura->unk54 < 2) {
        { s32 delta = sub_801F07C(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, 
# 226 "src/game/enemies/koura.c" 3 4
       ((void *)0)
# 226 "src/game/enemies/koura.c"
       , sub_801EE64); if (delta < 0) { koura->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, sub_801EC3C);; } if (delta > 0) { koura->offsetY += ((s32)((delta)*256)); } };
    } else if (koura->unk54 == 2) {
        s32 temp = (gSineTable[((gStageTime * 0x14) & (1024 - 1))]);
        koura->offsetY = temp >> 4;
