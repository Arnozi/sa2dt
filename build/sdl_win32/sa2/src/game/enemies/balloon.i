...
void CreateEntity_Balloon(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if ((gGameMode == 1 || gDifficultyLevel != 1)) {
        ...
        Sprite_Balloon *balloon = (void *)((t)->data);
        Sprite *s = &balloon->s;
...
void Task_BalloonMain(void)
{
    Sprite_Balloon *balloon = (void *)((gCurTask)->data);
    Sprite *s = &balloon->s;
    ...
    if (((((int)((balloon->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((balloon->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((balloon->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((balloon->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = balloon->base.meX; }; TaskDestroy(gCurTask); return; }; };
