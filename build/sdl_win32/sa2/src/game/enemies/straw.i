...
void CreateEntity_Straw(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if ((gGameMode == 1 || gDifficultyLevel != 1)) {
        ...
        Sprite_Straw *straw = (void *)((t)->data);
        Sprite *s = &straw->s;
...
{
    Sprite_Straw *straw = (void *)((gCurTask)->data);
    Sprite *s = &straw->s;
    ...
    if (((((int)((straw->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((straw->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((straw->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((straw->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = straw->base.meX; }; TaskDestroy(gCurTask); return; }; };
