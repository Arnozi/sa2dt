...
void CreateEntity_Spinner(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Spinner *spinner = (void *)((t)->data);
    Sprite *s = &spinner->s;
...
void Task_EnemySpinner(void)
{
    ...
    MapEntity *me;
    Sprite_Spinner *spinner = (void *)((gCurTask)->data);
    Sprite *s = &spinner->s;
    ...
    if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = spinner->base.meX; }; TaskDestroy(gCurTask); return; };
