...
void CreateEntity_Kyura(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Kyura *kyura = (void *)((t)->data);
    Sprite *s = &kyura->s;
...
void Task_KyuraMain(void)
{
    Sprite_Kyura *kyura = (void *)((gCurTask)->data);
    Sprite *s = &kyura->s;
    MapEntity *me = kyura->base.me;
    u32 unk54 = kyura->unk54;

    Vec2_32 pos;
# 91 "src/game/enemies/kyura.c"
    u32 r5 = (1024 - 1);
    kyura->offsetX = (((gSineTable[((unk54 * 5) & r5) + 256])) * kyura->unk58) >> 6;
    ...
    if (((((int)((kyura->spawnX) >> 8))) > gCamera.x + (426 + (256 / 2)) || (((int)((kyura->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((kyura->spawnY) >> 8))) > gCamera.y + ((240) + ((256) / 2)) || (((int)((kyura->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 426 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) { { me->x = kyura->base.meX; }; TaskDestroy(gCurTask); return; }; };
