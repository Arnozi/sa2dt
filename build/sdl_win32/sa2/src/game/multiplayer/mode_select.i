# 0 "src/game/multiplayer/mode_select.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/mode_select.c"
...
# 2 "src/game/multiplayer/mode_select.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiplayer/mode_select.c" 2
# 1 "include/flags.h" 1
# 4 "src/game/multiplayer/mode_select.c" 2
# 1 "include/malloc_vram.h" 1
# 5 "src/game/multiplayer/mode_select.c" 2
...
# 6 "src/game/multiplayer/mode_select.c" 2
# 1 "include/sprite.h" 1
# 7 "src/game/multiplayer/mode_select.c" 2
# 1 "include/task.h" 1
# 8 "src/game/multiplayer/mode_select.c" 2
# 1 "include/trig.h" 1
...
# 9 "src/game/multiplayer/mode_select.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/multiplayer/mode_select.c" 2
...
# 11 "src/game/multiplayer/mode_select.c" 2
...
# 12 "src/game/multiplayer/mode_select.c" 2
...
# 13 "src/game/multiplayer/mode_select.c" 2
...
# 14 "src/game/multiplayer/mode_select.c" 2
...
# 15 "src/game/multiplayer/mode_select.c" 2
...
# 16 "src/game/multiplayer/mode_select.c" 2
...
# 17 "src/game/multiplayer/mode_select.c" 2
...
# 18 "src/game/multiplayer/mode_select.c" 2
...
# 20 "src/game/multiplayer/mode_select.c" 2
# 1 "include/constants/songs.h" 1
# 21 "src/game/multiplayer/mode_select.c" 2
# 1 "include/constants/text.h" 1
# 22 "src/game/multiplayer/mode_select.c" 2
# 1 "include/constants/tilemaps.h" 1
# 23 "src/game/multiplayer/mode_select.c" 2
...
static const TileInfo sMultiplayerModeSelectScreenText[] = {
    [(0) * (4) + (1 - 1)] = { .numTiles = (38), .anim = (1073), .variant = (1) }, [(0) * (4) + (2 - 1)] = { .numTiles = (32), .anim = (1073), .variant = (2) },
    [(0) * (4) + (3 - 1)] = { .numTiles = (168), .anim = (1073), .variant = (3) }, [(0) * (4) + (4 - 1)] = { .numTiles = (168), .anim = (1073), .variant = (4) },
    [(1) * (4) + (1 - 1)] = { .numTiles = (38), .anim = (1073), .variant = (1) }, [(1) * (4) + (2 - 1)] = { .numTiles = (32), .anim = (1073), .variant = (2) },
    [(1) * (4) + (3 - 1)] = { .numTiles = (168), .anim = (1073), .variant = (3) }, [(1) * (4) + (4 - 1)] = { .numTiles = (168), .anim = (1073), .variant = (4) },
    [(0 + ((2) * (4)))] = { .numTiles = (36), .anim = (1094), .variant = (0) }, [(1 + ((2) * (4)))] = { .numTiles = (38), .anim = (1094), .variant = (1) },
    [(2 + ((2) * (4)))] = { .numTiles = (168), .anim = (1094), .variant = (2) }, [(3 + ((2) * (4)))] = { .numTiles = (168), .anim = (1094), .variant = (3) },
    [(0 + ((3) * (4)))] = { .numTiles = (34), .anim = (1095), .variant = (0) }, [(1 + ((3) * (4)))] = { .numTiles = (28), .anim = (1095), .variant = (1) },
    [(2 + ((3) * (4)))] = { .numTiles = (168), .anim = (1095), .variant = (2) }, [(3 + ((3) * (4)))] = { .numTiles = (168), .anim = (1095), .variant = (3) },
    [(0 + ((4) * (4)))] = { .numTiles = (36), .anim = (1096), .variant = (0) }, [(1 + ((4) * (4)))] = { .numTiles = (32), .anim = (1096), .variant = (1) },
    [(2 + ((4) * (4)))] = { .numTiles = (168), .anim = (1096), .variant = (2) }, [(3 + ((4) * (4)))] = { .numTiles = (168), .anim = (1096), .variant = (3) },
    [(0 + ((5) * (4)))] = { .numTiles = (36), .anim = (1097), .variant = (0) }, [(1 + ((5) * (4)))] = { .numTiles = (36), .anim = (1097), .variant = (1) },
    [(2 + ((5) * (4)))] = { .numTiles = (168), .anim = (1097), .variant = (2) }, [(3 + ((5) * (4)))] = { .numTiles = (168), .anim = (1097), .variant = (3) },
    [(0 + ((6) * (4)))] = { .numTiles = (36), .anim = (1098), .variant = (0) }, [(1 + ((6) * (4)))] = { .numTiles = (36), .anim = (1098), .variant = (1) },
    [(2 + ((6) * (4)))] = { .numTiles = (168), .anim = (1098), .variant = (2) }, [(3 + ((6) * (4)))] = { .numTiles = (168), .anim = (1098), .variant = (3) },
};
...
void CreateMultiplayerModeSelectScreen(void)
{
    ...
    modeScreen = (void *)((t)->data);
    modeScreen->animFrame = 0;
    modeScreen->pakMode = 0;
    modeScreen->enterAnimDone = 0;

    fade = &modeScreen->fade;
    fade->window = 1;
    fade->brightness = ((s32)((0.0)*256));
    fade->flags = ((1 << 1) | (0 << 0));
...
{
    struct MultiplayerModeSelectScreen *modeScreen = (void *)((gCurTask)->data);
    gHBlankCopySize = 2;
    gHBlankCopyTarget = (void *)(REG_BASE + (0x40 + sizeof(winreg_t) * 1));
    gWinRegs[4] = 0x1300;
    gWinRegs[5] = 0x11;
    gFlags |= 0x4;
    InitHBlankBgOffsets(426);
    ScreenMask_Right_OriginTop(((s32)((100)*256)), (((int)((((double)(5.625)) / 360.0) * 1024)) - modeScreen->animFrame) * ((int)((((double)(7.03125)) / 360.0) * 1024)));
...
static void Task_EnterAnimPart2(void)
{
    ...
    gFlags |= 0x4;
    InitHBlankBgOffsets(426);
    ScreenMask_Right_OriginTop(((s32)((100)*256)), ((int)((((double)(112.5)) / 360.0) * 1024)));
    ...
    if (modeScreen->animFrame < 10) {
        ...
        unk80->x = modeScreen->animFrame * 0x10 - 426;
    } else {
        unk80->x = (426 / 3);
    }
    unk80->y = (240 * (3. / 8.));
...
static void Task_ScreenMain(void)
{
    ...
    if (gPressedKeys & (0x0080 | 0x0040)) {
        m4aSongNumStart(108);
        modeScreen->pakMode ^= 1;
    }

    if (modeScreen->pakMode != 0) {
        Sprite *subText;
        u8 lang = gLoadedSaveGame->language * 4;
...
{
    struct MultiplayerModeSelectScreen *modeScreen = (void *)((gCurTask)->data);
    if (UpdateScreenFade(&modeScreen->fade) == 1) {
        gFlags &= ~0x4;
        gMultiSioEnabled = 1;
...
{
    struct MultiplayerModeSelectScreen *modeScreen = (void *)((t)->data);
