...
# 33 "src/game/multiplayer/multiplayer_event_mgr.c" 3 4
   ((void *)0)
# 33 "src/game/multiplayer/multiplayer_event_mgr.c"
       ,
};
...
void ReceiveRoomEvent_ReachedStageGoal(union MultiSioData *recv, u8 i)
{
    ...
    for (j = 0; j < 4; j++) {
        ...
        if (gMultiplayerPlayerTasks[j] == 
# 194 "src/game/multiplayer/multiplayer_event_mgr.c" 3 4
                                         ((void *)0)
# 194 "src/game/multiplayer/multiplayer_event_mgr.c"
                                             ) {
            break;
        }
        count++;
    ...
    if (gGameMode == 4) {
        for (j = 0; j < 4 && gMultiplayerPlayerTasks[j] != 
# 221 "src/game/multiplayer/multiplayer_event_mgr.c" 3 4
                                                          ((void *)0)
# 221 "src/game/multiplayer/multiplayer_event_mgr.c"
                                                              ; j++) {
    ...
    if ((count3 + 1) >= (u32)(count - 1) || gGameMode == 4) {
        for (j = 0; j < 4; j++) {
            ...
            if (gMultiplayerPlayerTasks[j] == 
# 261 "src/game/multiplayer/multiplayer_event_mgr.c" 3 4
                                             ((void *)0)
# 261 "src/game/multiplayer/multiplayer_event_mgr.c"
                                                 ) {
                break;
            }
...
struct Task *CreateMultiplayerSendEventMgr(void)
{
    struct Task *t = TaskCreate(Task_MultiplayerEventMgr_Send, 0, -2, 0, 
# 295 "src/game/multiplayer/multiplayer_event_mgr.c" 3 4
                                                                        ((void *)0)
# 295 "src/game/multiplayer/multiplayer_event_mgr.c"
                                                                            );
...
struct Task *CreateMultiplayerReceiveEventMgr(void)
{
    struct Task *t = TaskCreate(Task_MultiplayerEventMgr_Receive, 0, 1, 0, 
# 305 "src/game/multiplayer/multiplayer_event_mgr.c" 3 4
                                                                          ((void *)0)
# 305 "src/game/multiplayer/multiplayer_event_mgr.c"
                                                                              );
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gMultiSioSend, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gMultiSioSend))/(32/8)))); };
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gMultiSioRecv, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gMultiSioRecv))/(32/8)))); };
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gRoomEventQueue, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gRoomEventQueue))/(32/8)))); };
