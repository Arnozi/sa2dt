        ...
        if (gMultiSioStatusFlags & (0x0001 << (id)) && recv->pat0.unk0 == 0x5000) {
            ...
            if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id != mpp->unk56) {
                ...
                if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id != mpp->unk64) {
                    MultiplayerPlayer *mpp2 = (void *)((gMultiplayerPlayerTasks[mpp->unk64])->data);
                    if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id == mpp2->unk64) {
                        mpp2->unk64 = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
...
# 739 "src/game/multiplayer/mp_player.c"
    ...
    if (gGameMode == 4 && gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == -1) {
        u32 someBool = 1;
        for (i = 0; i < 4; i++) {
            if (gMultiplayerPlayerTasks[i] == 
# 780 "src/game/multiplayer/mp_player.c" 3 4
                                             ((void *)0)
# 780 "src/game/multiplayer/mp_player.c"
                                                 ) {
                break;
            }

            {
                MultiplayerPlayer *mpp2 = (void *)((gMultiplayerPlayerTasks[i])->data);
    ...
    if (!(gStageFlags & 1) && !(mpp->unk54 & 0x80000004)) {
        ...
        if ((gPlayer.itemEffect & 0x80) || (mpp->unk57 & 0x80) || gPlayer.timerInvincibility == 0
            ...
            if (gGameMode != 5) {
                if (mpp->unk56 == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id && gMultiplayerCharacters[mpp->unk56] == CHARACTER_TAILS
        ...
        if (mpp->unk57 & 0x20
            && (gGameMode != 4
                || ((gMultiplayerConnections & (0x10 << (mpp->unk56))) >> ((mpp->unk56 + 4))
                    != (gMultiplayerConnections & (0x10 << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id))) >> (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id + 4)))
            && mpp->unk60 == 0 && mpp->unk56 != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
            s->frameFlags |= ((2) << (7));
            gDispCnt |= 0x8000;
            gWinRegs[5] = ((1 << 11) | (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5)));
        }

        if ((u16)(s->x + 63) < (426 + 127) && (s->y > -64 && s->y < 240 + 64)) {
            DisplaySprite(s);
        } else if (gGameMode == 5) {
        ...
        if (Player_TryJump(&gPlayer)) {
            ...
            if ((s->graphics.anim != ((22) + CHARACTER_TAILS * (91)) && s->graphics.anim != ((21) + CHARACTER_TAILS * (91)) && s->graphics.anim != ((20) + CHARACTER_TAILS * (91))) || ((int)((gPlayer.qWorldX) >> 8)) <= gCamera.minX || ((int)((gPlayer.qWorldX) >> 8)) >= gCamera.maxX
                ...
                if (gPlayer.moveState & 0x00000008) {
                    ...
                    gPlayer.qWorldY = y;
                    if (mpp->unk5C & 4) {
# 1335 "src/game/multiplayer/mp_player.c"
...
void sub_8018818(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ...
        for (i = 0; i < 4; i++) {
            if (gMultiplayerPlayerTasks[i] == 
# 2121 "src/game/multiplayer/mp_player.c" 3 4
                                             ((void *)0)
# 2121 "src/game/multiplayer/mp_player.c"
                                                 ) {
                break;
            }
...
{
    MultiplayerPlayer *mpp = (void *)((t)->data);
    gMultiplayerPlayerTasks[mpp->unk56] = 
# 2137 "src/game/multiplayer/mp_player.c" 3 4
                                         ((void *)0)
# 2137 "src/game/multiplayer/mp_player.c"
                                             ;
...
{
    struct Task *t = TaskCreate(Task_HandleLaunchPlayer, sizeof(s16), 0x2000, 0, 
# 2144 "src/game/multiplayer/mp_player.c" 3 4
                                                                                ((void *)0)
# 2144 "src/game/multiplayer/mp_player.c"
                                                                                    );
