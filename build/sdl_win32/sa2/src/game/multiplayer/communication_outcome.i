...
void CreateMultipackOutcomeScreen(u8 outcome)
{
    ...
    t = TaskCreate(Task_MultipackOutcomeScreen, sizeof(struct CommunicationOutcomeScreen), 0x2000, 0, 
# 101 "src/game/multiplayer/communication_outcome.c" 3 4
                                                                                                     ((void *)0)
# 101 "src/game/multiplayer/communication_outcome.c"
                                                                                                         );
