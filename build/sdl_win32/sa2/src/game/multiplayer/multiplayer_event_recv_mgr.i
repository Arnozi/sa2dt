# 0 "src/game/multiplayer/multiplayer_event_recv_mgr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/multiplayer_event_recv_mgr.c"
...
# 2 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 4 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 5 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 6 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
# 7 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 2
...
{
    if (gEntitiesManagerTask != 
# 19 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 3 4
                               ((void *)0)
# 19 "src/game/multiplayer/multiplayer_event_recv_mgr.c"
                                   ) {
...
{
    if (gEntitiesManagerTask != 
# 49 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 3 4
                               ((void *)0)
# 49 "src/game/multiplayer/multiplayer_event_recv_mgr.c"
                                   ) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
...
{
    if (gEntitiesManagerTask != 
# 84 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 3 4
                               ((void *)0)
# 84 "src/game/multiplayer/multiplayer_event_recv_mgr.c"
                                   ) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
...
{
    if (gEntitiesManagerTask != 
# 123 "src/game/multiplayer/multiplayer_event_recv_mgr.c" 3 4
                               ((void *)0)
# 123 "src/game/multiplayer/multiplayer_event_recv_mgr.c"
                                   ) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
...
void ReceiveRoomEvent_Unknown(union MultiSioData *msioData, u8 __attribute__((unused)) someId) { (*(vu32 *)(REG_BASE + 0x128)); }
