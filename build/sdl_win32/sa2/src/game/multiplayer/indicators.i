...
void CreateOpponentPositionIndicator(u8 sid)
{
    ...
    spr->graphics.dest = (void *)(&VRAM[0x10000] + 0x2700);
    spr->oamFlags = ((1) << 6);
    spr->graphics.size = 0;
    spr->animCursor = 0;
    spr->qAnimDelay = 0;
...
void CreateSelfPositionIndicator(void)
{
    ...
    t = TaskCreate(Task_SelfPositionIndicator, sizeof(SelfIndicator), 0x2000, 0, 
# 228 "src/game/multiplayer/indicators.c" 3 4
                                                                                ((void *)0)
# 228 "src/game/multiplayer/indicators.c"
                                                                                    );
...
static void Task_801951C(void)
{
    ...
    if (((mpp->pos.x) - (gCamera.x) >= 0) && ((mpp->pos.x) - (gCamera.x) <= 426)) { if ((((mpp->pos.y) - (gCamera.y)) >= 0)) { if ((((mpp->pos.y) - (gCamera.y)) <= 240)) { return; } } };

    opponentX2 = (unsigned)(mpp->pos.x - (426 / 2) - gCamera.x);
    opponentY2 = (unsigned)(mpp->pos.y - (240 / 2) - gCamera.y);

    ({ s32 opponentDistSq; s16 rot, tfx, tfy; s16 r1 = (opponentX2); s16 r4 = (opponentY2); if (((opponentX2) != 0) && ((opponentY2) != 0)) { while ((((r1) >= 0 ? (r1) : -(r1)) >= 128) || (((r4) >= 0 ? (r4) : -(r4)) >= 128)) { r1 = r1 / 2; r4 = r4 / 2; if (((r1) >= 0 ? (r1) : -(r1)) < 2) { break; } if (((r4) >= 0 ? (r4) : -(r4)) < 2) { break; } } } if (((r1) >= 0 ? (r1) : -(r1)) < 2) { if (r4 > 0) { rot = 256; } else { rot = 768; } } else if (((r4) >= 0 ? (r4) : -(r4)) < 2) { rot = 512; if (r1 > 0) { rot = 0; } } else { rot = sub_8004418(r4, r1); } (transform)->rotation = (rot + 256) & (1024 - 1); opponentDistSq = (((opponentX2)) * ((opponentX2))) + (((opponentY2)) * ((opponentY2))); if (opponentDistSq < 0x10000) { (spr)->animSpeed = opponentDistSq < 0x10000 ? ((int)((float)(1.5)*0x10)) : ((int)((float)(1.0)*0x10)); } else { (spr)->animSpeed = ((int)((float)(1.0)*0x10)); } if (opponentDistSq > 0x06000000) { (transform)->qScaleX = ((s32)((0.25)*256)); (transform)->qScaleY = ((s32)((0.25)*256)); } else if (opponentDistSq < ((256) * (256))) { (transform)->qScaleX = ((s32)((1.875)*256)); (transform)->qScaleY = ((s32)((1.875)*256)); } else { s32 dist = (0x06000000 - opponentDistSq) >> 16; s32 scale = ({((((s32)((5.99609375)*256))) != 0) ? ((s32)(dist * ((s32)((1.625)*256))) / (s32)(((s32)((5.99609375)*256)))) : 0;}) + ((s32)((0.25)*256)); (transform)->qScaleX = scale; (transform)->qScaleY = scale; } if (rot == 0) { tfy = (240 / 2); tfx = 426; } else if (rot == 256) { tfy = 240; tfx = (426 / 2); } else if (rot == 512) { tfy = (240 / 2); tfx = 0; } else if (rot == 768) { tfy = 0; tfx = (426 / 2); } else { if ((opponentX2) > 0) { s16 divRes = ({((((int)(((gSineTable[(rot) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(rot)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(rot) + 256])) >> 6)))) : 0;}); tfy = ((divRes * 15) >> 5) + (240 / 2); if ((opponentY2) > 0) { if (tfy >= 240) { s32 sinVal; tfy = 240; sinVal = (256 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = ((divRes * 5) >> 4) + (426 / 2); } else { tfx = 426; } } else { if (tfy < 0) { s32 sinVal; tfy = 0; sinVal = (256 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = (426 / 2) - ((divRes * 5) >> 4); } else { tfx = 426; } } } else { s16 divRes = ({(((((int)(((gSineTable[((rot - (1024 / 2)) & (1024 - 1)) + 256])) >> 6)))) != 0) ? ((s32)((((int)(((gSineTable[((rot - (1024 / 2)) & (1024 - 1))])) >> 6))) * 0x100) / (s32)((((int)(((gSineTable[((rot - (1024 / 2)) & (1024 - 1)) + 256])) >> 6))))) : 0;}); tfy = (240 / 2) - ((divRes * 15) >> 5); if ((opponentY2) > 0) { if (tfy >= 240) { s32 sinVal; tfy = 240; sinVal = (768 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = ((divRes * 5) >> 4) + (426 / 2); } else { tfx = 0; } } else { if (tfy < 0) { s32 sinVal; tfy = 0; sinVal = (768 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = (426 / 2) - ((divRes * 5) >> 4); } else { tfx = 0; } } } } (transform)->x = tfx; (transform)->y = tfy; (spr)->frameFlags &= ~((0x1F) << (0)); (spr)->frameFlags |= gOamMatrixIndex++; UpdateSpriteAnimation((spr)); TransformSprite((spr), (transform)); DisplaySprite((spr)); });
}
...
static void Task_8019898(void)
{
    ...
    opponentX = (unsigned)(mpp->pos.x - (426 / 2) - gCamera.x);
    opponentY = (unsigned)(mpp->pos.y - (240 / 2) - gCamera.y);
    ...
    if (((mpp->pos.x) - (normalizedCamX) >= 0) && ((mpp->pos.x) - (normalizedCamX) <= 426)) { if ((((mpp->pos.y) - (normalizedCamY)) >= 0)) { if ((((mpp->pos.y) - (normalizedCamY)) <= 240)) { return; } } };

    normalizedCamX = ({ mpp->pos.x - (426 / 2); }) - normalizedCamX;
    normalizedCamY = ({ mpp->pos.y - (240 / 2); }) - normalizedCamY;
