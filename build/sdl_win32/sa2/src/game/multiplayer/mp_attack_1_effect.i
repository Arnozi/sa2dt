# 0 "src/game/multiplayer/mp_attack_1_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/mp_attack_1_effect.c"
# 1 "include/core.h" 1
...
# 2 "src/game/multiplayer/mp_attack_1_effect.c" 2
...
# 5 "src/game/multiplayer/mp_attack_1_effect.c" 2
...
# 6 "src/game/multiplayer/mp_attack_1_effect.c" 2
...
# 7 "src/game/multiplayer/mp_attack_1_effect.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/multiplayer/mp_attack_1_effect.c" 2

# 1 "include/constants/songs.h" 1
# 10 "src/game/multiplayer/mp_attack_1_effect.c" 2
...
s32 __attribute__((aligned(8))) gUnused_03005B78 = 0;
u8 gShouldSpawnMPAttackEffect = 0;

void Task_MPAttackEffect(void)
{
    s16 a = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x;
    s16 b = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y;
    struct MPAttack1Effect *effect = (void *)((gCurTask)->data);

    sub_80871C4(a, b, 240 - effect->unk0);
...
static const __attribute__((aligned(4))) s8 gUnknown_080E02DC[8][2] = {
...
void sub_80870E8(void)
{
    ...
    effect->unk0 += 1;
    if (effect->unk0 > 160) {
        if (!(gPlayer.moveState & (0x40000000 | 0x00400000 | 0x00200000))
            && !(gPlayer.itemEffect & (0x02 | 0x80))
...
void CreateMPAttackEffect(void)
{
    ...
    struct MPAttack1Effect *effect = (void *)((t)->data);
    effect->unk0 = 0;
...
void TaskDestructor_MPAttackEffect(__attribute__((unused)) struct Task *t) { gFlags &= ~0x4; }
