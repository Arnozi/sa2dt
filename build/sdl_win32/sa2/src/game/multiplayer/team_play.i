...
# 117 "src/game/multiplayer/team_play.c" 3 4
                                                                                    ((void *)0)
# 117 "src/game/multiplayer/team_play.c"
                                                                                        );
    teamPlayScreen = (void *)((t)->data);
    ...
    for (i = 0, vram = &VRAM[0x10000]; i < 4; i++) {
    ...
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (6)));
    background->unk18 = 0;
    background->unk1A = 0;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (14)));
    background->unk18 = 0;
    background->unk1A = 0;
...
static void sub_805CB34(void)
{
    ...
    teamPlayScreen = (void *)((gCurTask)->data);
    gWinRegs[5] = 0x3F;
    gBldRegs.bldCnt = 0x3F48;
    gBldRegs.bldAlpha = 0x810;
    gWinRegs[2] = 240;

    if (gBgScrollRegs[1][1] < 240) {
        gBgScrollRegs[1][1] += 4;
    } else {
        gBgScrollRegs[1][1] = 240;
...
static void sub_805D5C8(void)
{
    struct MultiplayerTeamPlayScreen *teamPlayScreen = (void *)((gCurTask)->data);
    teamPlayScreen->unk31E = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id & 1;
    teamPlayScreen->unk31F = 0;
