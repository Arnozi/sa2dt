...
void StartMultiPakConnect(void)
{
    ...
    void *vramAddr = (void *)&VRAM[0x10000];
    u8 i;
    ...
    t = TaskCreate(sub_805ADAC, sizeof(struct MultiPakConnectScreen), 0x2000, 0, 
# 87 "src/game/multiplayer/multipak_connection.c" 3 4
                                                                                ((void *)0)
# 87 "src/game/multiplayer/multipak_connection.c"
                                                                                    );
...
static void sub_805ADAC(void)
{
    ...
    bool8 bool2 = 0;
    bool8 bool3 = 1;
    struct MultiPakConnectScreen *connectScreen = (void *)((gCurTask)->data);
    ...
    if (gMultiSioStatusFlags & (0x0080 | 0x0001)) {
        if (!(gMultiSioStatusFlags & (0x0001 << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)))) {
            if (gMultiplayerMissingHeartbeats[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id]++ > 180) {
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id || (gMultiSioStatusFlags & (0x0001 << (i)) && data->unk0 > 0x400F)) {
            connectScreen->unkEE[i] |= 1;
            var1++;
            var3 |= (0x0001 << (i));
            if (bool1) {
...
static void sub_805B4C0(void)
{
    ...
    if (recv->unk0 == 0x4012) {
        if (!(((recv2) >> (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)) & 1)) {
            gMultiSioEnabled = 0;
            MultiSioStop();
            MultiSioInit(0);
            send = &gMultiSioSend.pat0;
