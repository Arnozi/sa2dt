...
void CreateMultiplayerResultsScreen(u8 mode)
{
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, (void *)VRAM + 0x9fe0, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); };
    t = TaskCreate(sub_805C0F0, sizeof(struct MultiplayerResultsScreen), 0x2000, 0, 
# 151 "src/game/multiplayer/results.c" 3 4
                                                                                   ((void *)0)
# 151 "src/game/multiplayer/results.c"
                                                                                       );
    resultsScreen = (void *)((t)->data);
    ...
    for (i = 0; i < 4; i++) {
        ...
        if ((((gMultiplayerConnections) >> (i)) & 1)) {
            ...
            s->x = 200;
            s->y = 0x33 + (0x20 * i);
            s->graphics.dest = (void *)(&VRAM[0x10000] + (i * 0x800));
            s->oamFlags = ((16) << 6);
            s->graphics.size = 0;
            ...
            s->x = 0;
            s->y = 0x1F + (0x20 * i);
            s->graphics.dest = (void *)(&VRAM[0x10000] + temp2);
            s->oamFlags = ((16) << 6);
            s->graphics.size = 0;
...
static void sub_805C0F0(void)
{
    ...
    selectionResultsScreen = (void *)((gCurTask)->data);
...
static void sub_805C30C(void)
{
    struct MultiplayerResultsScreen *selectionResultsScreen = (void *)((gCurTask)->data);
    bool32 somebool = 0;
...
static void sub_805C3D0(void)
{
    struct MultiplayerResultsScreen *resultsScreen = (void *)((gCurTask)->data);
...
static void sub_805C504(void)
{
    ...
    selectionResultsScreen = (void *)((gCurTask)->data);
    gFlags |= 0x4;
    gHBlankCopyTarget = (void *)(REG_BASE + 0x1e);
    gHBlankCopySize = 2;
