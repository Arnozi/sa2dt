# 0 "src/game/multiplayer/mp_attack_2_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/mp_attack_2_effect.c"
...
# 2 "src/game/multiplayer/mp_attack_2_effect.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiplayer/mp_attack_2_effect.c" 2
...
# 5 "src/game/multiplayer/mp_attack_2_effect.c" 2
...
# 7 "src/game/multiplayer/mp_attack_2_effect.c" 2

# 1 "include/constants/zones.h" 1
# 9 "src/game/multiplayer/mp_attack_2_effect.c" 2



MultiPlayerBgCtrlRegs __attribute__((aligned(16))) *gMPAttackEffect2Regs = 
# 12 "src/game/multiplayer/mp_attack_2_effect.c" 3 4
                                                         ((void *)0)
# 12 "src/game/multiplayer/mp_attack_2_effect.c"
                                                             ;
...
void CreateMPAttack2Effect(void)
{
    ...
    if (((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) && !((((gCurrentLevel) & ((3 + 1) - 1)) == 2) || (((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && !gFinalBossActive) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
        if (gMPAttackEffect2Regs != 
# 24 "src/game/multiplayer/mp_attack_2_effect.c" 3 4
                                   ((void *)0)
# 24 "src/game/multiplayer/mp_attack_2_effect.c"
                                       ) {
            ...
            MultiPlayerBgCtrlRegs *regs = (void *)((t)->data);
...
static void Task_MPAttackEffect2(void)
{
    MultiPlayerBgCtrlRegs *regs = (void *)((gCurTask)->data);
    s16 *p;
...
# 90 "src/game/multiplayer/mp_attack_2_effect.c" 3 4
                          ((void *)0)
# 90 "src/game/multiplayer/mp_attack_2_effect.c"
                              ;
