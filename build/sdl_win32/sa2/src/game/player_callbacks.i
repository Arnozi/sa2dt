...
struct Task *CreateSonicAmySkidAttackEffect(s32 x, s32 y, u16 p2)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        return 
# 104 "src/game/player_callbacks.c" 3 4
              ((void *)0)
# 104 "src/game/player_callbacks.c"
                  ;
    }
...
# 323 "src/game/player_callbacks.c"
...
void Task_SonicBoundMotionFrames(void)
{
    TrickBound *bound = (void *)((gCurTask)->data);
    Sprite *s = &bound->s;
    Vec2_32 pos;
...
struct Task *CreateTailsTailSwipeEffect(s32 x, s32 y)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        result = 
# 816 "src/game/player_callbacks.c" 3 4
                ((void *)0)
# 816 "src/game/player_callbacks.c"
                    ;
    } else {
        struct Task *t;
        MultiplayerSpriteTask *ts;
...
struct Task *CreateKnucklesFireEffect(s32 x, s32 y, u16 p2)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        result = 
# 1018 "src/game/player_callbacks.c" 3 4
                ((void *)0)
# 1018 "src/game/player_callbacks.c"
                    ;
    } else {
        MultiplayerSpriteTask *ts;
        Sprite *s;
    ...
    if (!(someFlags & 0x00000002)) {
        ...
        if (temp) {
            ...
            if (p->w.kf.unkAE >= 0) {
                ...
                if (temp <= 0) {
                    p->moveState |= 0x00000001;
                    result = sub_8029A28(p, 
# 1249 "src/game/player_callbacks.c" 3 4
                                           ((void *)0)
# 1249 "src/game/player_callbacks.c"
                                               , &sp08);
                    ...
                    if (result != 0) {
                        ...
                        if (gravInv) {
                            ...
                            if (sub_801E4E4(playerBottomY, playerBottomX, p->layer, -8, 
# 1272 "src/game/player_callbacks.c" 3 4
                                                                                       ((void *)0)
# 1272 "src/game/player_callbacks.c"
                                                                                           , sub_801EE64) < 0) {
                                gPlayer.callback = Player_Knuckles_FallAfterGlide;;
                                p->charState = 93;
                                p->spriteOffsetX = 6;
                            ...
                            if (sub_801E4E4(playerBottomY, playerBottomX, p->layer, +8, 
# 1290 "src/game/player_callbacks.c" 3 4
                                                                                       ((void *)0)
# 1290 "src/game/player_callbacks.c"
                                                                                           , sub_801EE64) < 0) {
                                gPlayer.callback = Player_Knuckles_FallAfterGlide;;
                                p->charState = 93;
                                p->spriteOffsetX = 6;
                    ...
                    if (result != sp08) {
                        ...
                        if (!(gStageFlags & 0x0080)) {
                            ...
                            if (sub_801E4E4(playerBottomY, playerBottomX, p->layer, +8, 
# 1324 "src/game/player_callbacks.c" 3 4
                                                                                       ((void *)0)
# 1324 "src/game/player_callbacks.c"
                                                                                           , sub_801EE64) < 0) {
                                gPlayer.callback = Player_Knuckles_FallAfterGlide;;
                                p->charState = 93;
                                p->spriteOffsetX = 6;
    ...
    if (p->w.tf.unkAE >= 0) {
        ...
        if (p->heldInput & 0x0040) {
            ...
            if (r2 > 2) {
                ...
                p->qWorldY -= offsetY;
                r2 = sub_8029AC0(p, &rot, 
# 1584 "src/game/player_callbacks.c" 3 4
                                         ((void *)0)
# 1584 "src/game/player_callbacks.c"
                                             );
                p->qWorldY += offsetY;
            ...
            if ((gStageFlags & 0x0080)) {
                r2 = sub_8029AC0(p, &rot, 
# 1617 "src/game/player_callbacks.c" 3 4
                                         ((void *)0)
# 1617 "src/game/player_callbacks.c"
                                             );
            } else {
                r2 = sub_8029B0C(p, &rot, 
# 1619 "src/game/player_callbacks.c" 3 4
                                         ((void *)0)
# 1619 "src/game/player_callbacks.c"
                                             );
            }
        ...
        if (!(p->heldInput & (0x0080 | 0x0040))) {
            r2 = sub_8029B0C(p, &rot, 
# 1657 "src/game/player_callbacks.c" 3 4
                                     ((void *)0)
# 1657 "src/game/player_callbacks.c"
                                         );
            if (r2 < 0) {
                p->qWorldY += ((s32)((r2)*256));
                p->rotation = rot;
