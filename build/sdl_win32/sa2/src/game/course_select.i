# 0 "src/game/course_select.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/course_select.c"
...
# 3 "src/game/course_select.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/course_select.c" 2
...
# 11 "src/game/course_select.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/game/course_select.c" 2
# 1 "include/constants/text.h" 1
# 13 "src/game/course_select.c" 2
# 1 "include/task.h" 1
# 14 "src/game/course_select.c" 2
# 1 "include/malloc_vram.h" 1
# 15 "src/game/course_select.c" 2
...
# 20 "src/game/course_select.c" 2
# 1 "include/constants/tilemaps.h" 1
# 21 "src/game/course_select.c" 2
...
static const u16 sZoneMapPathAssets[][3] = {
    [0] = { 6, 749, 1 }, [1] = { 12, 750, 1 }, [2] = { 10, 751, 1 }, [3] = { 6, 752, 1 },
    [4] = { 16, 753, 1 }, [5] = { 21, 754, 1 }, [6] = { 36, 755, 1 }, [7] = { 30, 756, 1 },
};

static const u16 sZoneMapPathAnimatedAssets[][3] = {
    [0] = { 6, 749, 0 }, [1] = { 12, 750, 0 }, [2] = { 10, 751, 0 }, [3] = { 6, 752, 0 },
    [4] = { 16, 753, 0 }, [5] = { 28, 754, 0 }, [6] = { 36, 755, 0 }, [7] = { 30, 756, 0 },
};
...
static const u16 sZoneMapPathPositions[][2] = {
    [0] = { 24, 80 }, [1] = { 56, 80 }, [2] = { 88, 72 }, [3] = { 120, 64 },
    [4] = { 168, 72 }, [5] = { 224, 72 }, [6] = { 304, 72 }, [7] = { 384, 80 },
};
...
void CreateCourseSelectionScreen(u8 currentLevel, u8 maxLevel, u8 cutScenes)
{
    ...
    Sprite *s = 
# 243 "src/game/course_select.c" 3 4
               ((void *)0)
# 243 "src/game/course_select.c"
                   ;
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && maxLevel > ((6)*(3 + 1)) + (2)) {
        maxLevel = ((6)*(3 + 1)) + (2);
    }
    ...
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) && (({((3 + 1) != 0) ? ((s32)(maxLevel) % (s32)(3 + 1)) : 0;}) & 2) != 0) {
        maxLevel &= ~3;
    }

    gDispCnt = 0x1340;

    gBgCntRegs[1] = 0x0000 | ((2) | ((28) << 8) | 0x0000 | ((3) << 2));
    gBgCntRegs[0] = 0x4000 | ((3) | ((16) << 8) | 0x0000 | ((0) << 2));
    ...
    if (cutScenes & (1 | 2) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
    ...
    coursesScreen = (void *)((t)->data);
    coursesScreen->cameraScrollX = 0;

    courseIndex = ((((currentLevel) / (3 + 1)) << 0x19 >> 0x18) | ((currentLevel)&1));
    coursesScreen->avatarTargetX = sZoneMapCameraTargets[courseIndex][0] * 256;
    coursesScreen->avatarTargetY = sZoneMapCameraTargets[courseIndex][1] * 256;
    coursesScreen->currentCourse = courseIndex;
    coursesScreen->zoneNameAnimFrame = 0;
    coursesScreen->levelChosen = 0;

    maxCourseIndex = ((((maxLevel) / (3 + 1)) << 0x19 >> 0x18) | ((maxLevel)&1));
    ...
    if (cutScenes & (1 | 2) && coursesScreen->zonePathsUnlocked != 0) {
    ...
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
        background->tilemapId = 100 + gSelectedCharacter;
    } else {
        background->tilemapId = 100 + gMultiplayerCharacters[0];
    }
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (16)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 105;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
    ...
    for (i = 0; i < (sizeof(coursesScreen->mapPaths) / sizeof((coursesScreen->mapPaths)[0])); i++) {
        s = &coursesScreen->mapPaths[i];
        s->x = 0;
        s->y = 0;
        s->graphics.dest = VramMalloc(sZoneMapPathAssets[i][0]);
        if ((cutScenes & (1 | 2)) && coursesScreen->zonePathsUnlocked == i) {
    ...
    for (i = 0; i < (sizeof(coursesScreen->zoneActUnits) / sizeof((coursesScreen->zoneActUnits)[0])); i++) {
    ...
    for (i = 0; i < (sizeof(coursesScreen->chaosEmeralds) / sizeof((coursesScreen->chaosEmeralds)[0])); i++) {
        s = &coursesScreen->chaosEmeralds[i];
        s->x = 0;
        s->y = 240 - 24;
        s->graphics.dest = (void *)&VRAM[0x10000] + (i * (9 * 32));
...
static void Task_FadeInIntro(void)
{
    struct CourseSelectionScreen *coursesScreen = (void *)((gCurTask)->data);
    ({ (coursesScreen)->cameraScrollX = (coursesScreen->cameraScrollX + (256 * 3)); if ((coursesScreen)->cameraScrollX < 0) { (coursesScreen)->cameraScrollX = 0; } else if ((coursesScreen)->cameraScrollX > (426 * 256)) { (coursesScreen)->cameraScrollX = (426 * 256); } });


    if (UpdateScreenFade(&coursesScreen->fade) == 1) {
        if (coursesScreen->cameraScrollX == (426 * 256)
            || coursesScreen->cameraScrollX >= coursesScreen->avatarTargetX - ((426 * 256) / 2)) {
            coursesScreen->cameraScrollX = coursesScreen->avatarTargetX - ((426 * 256) / 2);

            if ((coursesScreen->cutScenes & 4) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
    ...
    if (coursesScreen->cameraScrollX >= coursesScreen->avatarTargetX - ((426 * 256) / 2)) {
        coursesScreen->cameraScrollX = coursesScreen->avatarTargetX - ((426 * 256) / 2);
    ...
    ({ gBgScrollRegs[0][0] = (((coursesScreen)->cameraScrollX) >> 8); RenderZoneMapPathsAndUI(coursesScreen); });
}
...
static void Task_FadeInIntroAndStartUnlockCutScene(void)
{
    ...
    ({ (zoneName)->x -= 16; if ((zoneName)->x < (426 - 160)) { (zoneName)->x = (426 - 160); } });

    if (UpdateScreenFade(&coursesScreen->fade) == 1) {
        if (coursesScreen->cameraScrollX == (426 * 256)
            || coursesScreen->cameraScrollX
                >= ((sZoneMapCourseXPositions[coursesScreen->unlockedCourse] * 256) - ((426 * 256) / 2))) {
            coursesScreen->cameraScrollX
                = (sZoneMapCourseXPositions[coursesScreen->unlockedCourse] * 256) - ((426 * 256) / 2);
            m4aSongNumStart(214);
    ...
    ({ (coursesScreen)->cameraScrollX = ((sZoneMapCourseXPositions[coursesScreen->unlockedCourse] * 256) - ((426 * 256) / 2)); if ((coursesScreen)->cameraScrollX < 0) { (coursesScreen)->cameraScrollX = 0; } else if ((coursesScreen)->cameraScrollX > (426 * 256)) { (coursesScreen)->cameraScrollX = (426 * 256); } });
    ({ gBgScrollRegs[0][0] = (((coursesScreen)->cameraScrollX) >> 8); RenderZoneMapPathsAndUI(coursesScreen); });
}
...
static void Task_UnlockCutSceneNewPathAnim(void)
{
    ...
    ({ (zoneName)->x -= 16; if ((zoneName)->x < (426 - 160)) { (zoneName)->x = (426 - 160); } });
    gBgScrollRegs[0][0] = ((coursesScreen->cameraScrollX) >> 8);
...
static void Task_UnlockCutSceneScrollAnim(void)
{
    ...
    if (coursesScreen->cameraScrollX == 0
        ...
        if (coursesScreen->cutScenes & 1) {
            ...
            if (coursesScreen->maxCourse == (((((((7)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((7)*(3 + 1)) + (1))&1))) + 1) {
                Sprite *s;

                coursesScreen->maxCourse = (((((((7)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((7)*(3 + 1)) + (1))&1)));
                s = &coursesScreen->mapPaths[7];
                s->graphics.anim = sZoneMapPathAssets[7][1];
                s->variant = sZoneMapPathAssets[7][2];
            }
            gCurTask->main = Task_CourseSelectMain;
        }
...
static void Task_CourseSelectMain(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ...
        if (!(gMultiSioStatusFlags & 0x0080) && recv->pat1.unk0 > 0x404F) {
            coursesScreen->currentCourse = recv->pat1.unk2;
            coursesScreen->avatarTargetX = recv->pat1.unk4 * 256;
            coursesScreen->avatarTargetY = recv->pat1.unk3 * 256;
        }
    }

    ({ (zoneName)->x -= 16; if ((zoneName)->x < (426 - 160)) { (zoneName)->x = (426 - 160); } });

    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) || gMultiSioStatusFlags & 0x0080) {
        if (coursesScreen->levelChosen && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            fade->window = 0;
            fade->brightness = 0;
            fade->flags = (1 << 0);
            fade->speed = 0x180;
        ...
        } else if (gInput & (0x0020) && !coursesScreen->levelChosen) {
            if (coursesScreen->currentCourse > 0) {
                if (((coursesScreen->currentCourse)&1) == 0
                    || coursesScreen->currentCourse > (((((((6)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((6)*(3 + 1)) + (1))&1)))) {
                    zoneName->x = 426;
                }
                coursesScreen->zoneNameAnimFrame = 0;
                coursesScreen->currentCourse--;
        ...
        } else if (gInput & 0x0010 && !coursesScreen->levelChosen) {
            if (coursesScreen->currentCourse < coursesScreen->maxCourse) {
                if (((coursesScreen->currentCourse)&1) == 1
                    || coursesScreen->currentCourse > (((((((6)*(3 + 1)) + (1)) / (3 + 1)) << 0x19 >> 0x18) | ((((6)*(3 + 1)) + (1))&1)))) {
                    zoneName->x = 426;
                }
                coursesScreen->zoneNameAnimFrame = 0;
        ...
        } else if (!(gInput & (0x0010 | 0x0020)) && (gPressedKeys & 0x0001) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            fade->window = 0;
            fade->brightness = 0;
            fade->flags = (1 << 0);
            fade->speed = 0x180;
            ...
            m4aSongNumStart(106);
            gCurTask->main = Task_FadeOutAndExitToSelectedLevel;
        } else if ((gPressedKeys & 0x0002) && ((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            fade->window = 0;
            fade->brightness = 0;
            fade->flags = (1 << 0);
            fade->speed = 0x180;
        ...
        } else if (!(gInput & (0x0010 | 0x0020)) && (gPressedKeys & 0x0001)
                   && (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) || gGameMode == 3)) {
            fade->window = 0;
            fade->brightness = 0;
            fade->flags = (1 << 0);
            fade->speed = 0x180;
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ...
        send->pat1.unk4 = ((coursesScreen->avatarTargetX) >> 8);
        send->pat1.unk3 = ((coursesScreen->avatarTargetY) >> 8);

        if (gMultiSioStatusFlags & 0x0080 && (gPressedKeys & 0x0001 || coursesScreen->levelChosen)
            && !(gRepeatedKeys & (0x0020 | 0x0010))) {
            coursesScreen->levelChosen = 1;
    ...
    ({ (coursesScreen)->cameraScrollX = (coursesScreen->avatarTargetX - ((426 * 256) / 2)); if ((coursesScreen)->cameraScrollX < 0) { (coursesScreen)->cameraScrollX = 0; } else if ((coursesScreen)->cameraScrollX > (426 * 256)) { (coursesScreen)->cameraScrollX = (426 * 256); } });
    ({ gBgScrollRegs[0][0] = (((coursesScreen)->cameraScrollX) >> 8); RenderZoneMapPathsAndUI(coursesScreen); });
}
...
static void Task_ScrollToPreviousLevelAnim(void)
{
    ...
    if (coursesScreen->avatarTargetX < (sZoneMapCameraTargets[coursesScreen->currentCourse][0] * 256)) {
        coursesScreen->avatarTargetX = sZoneMapCameraTargets[coursesScreen->currentCourse][0] * 256;
        coursesScreen->avatarTargetY = sZoneMapCameraTargets[coursesScreen->currentCourse][1] * 256;
        m4aSongNumStart(215);
...
static bool8 AnimateNewZonePath(struct CourseSelectionScreen *coursesScreen)
{
    ...
    for (i = 0; i < coursesScreen->zonePathsUnlocked; i++) {
        s = &coursesScreen->mapPaths[i];
        s->x = sZoneMapPathPositions[i][0] - ((coursesScreen->cameraScrollX) >> 8);
    ...
    s->x = sZoneMapPathPositions[coursesScreen->zonePathsUnlocked][0] - ((coursesScreen->cameraScrollX) >> 8);
...
static void RenderUI(struct CourseSelectionScreen *coursesScreen)
{
    ...
    s = &coursesScreen->playerAvatar;
    s->x = ((coursesScreen->avatarTargetX - coursesScreen->cameraScrollX) >> 8) + 5;
    s->y = ((coursesScreen->avatarTargetY) >> 8) + 6;
    DisplaySprite(s);

    if (coursesScreen->currentCourse < 0xE) {
        s = &coursesScreen->zoneActUnits[0];
        s->graphics.anim = 0x2F6;
        s->variant = ((coursesScreen->currentCourse) >> 1);
        s->prevVariant = -1;
        UpdateSpriteAnimation(s);
        DisplaySprite(s);
    ...
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
        u8 i;
        for (i = 0; i < 7; i++) {
            if (gLoadedSaveGame->chaosEmeralds[gSelectedCharacter] & (1 << (i))) {
...
static void DestroyUI(struct CourseSelectionScreen *coursesScreen)
{
    ...
    if (coursesScreen->playerAvatar.graphics.dest != 
# 992 "src/game/course_select.c" 3 4
                                                    ((void *)0)
# 992 "src/game/course_select.c"
                                                        ) {
        VramFree(coursesScreen->playerAvatar.graphics.dest);
        coursesScreen->playerAvatar.graphics.dest = 
# 994 "src/game/course_select.c" 3 4
                                                   ((void *)0)
# 994 "src/game/course_select.c"
                                                       ;
    }

    for (i = 0; i < 8; i++) {
        if (coursesScreen->mapPaths[i].graphics.dest != 
# 998 "src/game/course_select.c" 3 4
                                                       ((void *)0)
# 998 "src/game/course_select.c"
                                                           ) {
            VramFree(coursesScreen->mapPaths[i].graphics.dest);
            coursesScreen->mapPaths[i].graphics.dest = 
# 1000 "src/game/course_select.c" 3 4
                                                      ((void *)0)
# 1000 "src/game/course_select.c"
                                                          ;
        }
    }

    if (coursesScreen->zoneActUnits[0].graphics.dest != 
# 1004 "src/game/course_select.c" 3 4
                                                       ((void *)0)
# 1004 "src/game/course_select.c"
                                                           ) {
        VramFree(coursesScreen->zoneActUnits[0].graphics.dest);
        coursesScreen->zoneActUnits[0].graphics.dest = 
# 1006 "src/game/course_select.c" 3 4
                                                      ((void *)0)
# 1006 "src/game/course_select.c"
                                                          ;
    }

    if (coursesScreen->zoneActUnits[1].graphics.dest != 
# 1009 "src/game/course_select.c" 3 4
                                                       ((void *)0)
# 1009 "src/game/course_select.c"
                                                           ) {
        VramFree(coursesScreen->zoneActUnits[1].graphics.dest);
        coursesScreen->zoneActUnits[1].graphics.dest = 
# 1011 "src/game/course_select.c" 3 4
                                                      ((void *)0)
# 1011 "src/game/course_select.c"
                                                          ;
    }

    if (coursesScreen->zoneType.graphics.dest != 
# 1014 "src/game/course_select.c" 3 4
                                                ((void *)0)
# 1014 "src/game/course_select.c"
                                                    ) {
        VramFree(coursesScreen->zoneType.graphics.dest);
        coursesScreen->zoneType.graphics.dest = 
# 1016 "src/game/course_select.c" 3 4
                                               ((void *)0)
# 1016 "src/game/course_select.c"
                                                   ;
    }

    if (coursesScreen->zoneName.graphics.dest != 
# 1019 "src/game/course_select.c" 3 4
                                                ((void *)0)
# 1019 "src/game/course_select.c"
                                                    ) {
        VramFree(coursesScreen->zoneName.graphics.dest);
        coursesScreen->zoneName.graphics.dest = 
# 1021 "src/game/course_select.c" 3 4
                                               ((void *)0)
# 1021 "src/game/course_select.c"
                                                   ;
    }

    if (coursesScreen->screenTitle.graphics.dest != 
# 1024 "src/game/course_select.c" 3 4
                                                   ((void *)0)
# 1024 "src/game/course_select.c"
                                                       ) {
        VramFree(coursesScreen->screenTitle.graphics.dest);
        coursesScreen->screenTitle.graphics.dest = 
# 1026 "src/game/course_select.c" 3 4
                                                  ((void *)0)
# 1026 "src/game/course_select.c"
                                                      ;
    }
}
...
static void CourseSelectionScreenOnDestroy(struct Task *t) { DestroyUI((void *)((t)->data)); }
