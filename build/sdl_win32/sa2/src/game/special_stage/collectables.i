# 0 "src/game/special_stage/collectables.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/special_stage/collectables.c"
# 1 "include/core.h" 1
...
# 2 "src/game/special_stage/collectables.c" 2
...
# 3 "src/game/special_stage/collectables.c" 2
...
# 4 "src/game/special_stage/collectables.c" 2
...
# 5 "src/game/special_stage/collectables.c" 2
...
# 6 "src/game/special_stage/collectables.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/special_stage/collectables.c" 2
# 1 "include/trig.h" 1
...
# 10 "src/game/special_stage/collectables.c" 2
...
# 11 "src/game/special_stage/collectables.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/game/special_stage/collectables.c" 2
...
const s16 gUnknown_080DF6CC[7] = {
    [0] = 304, [1] = 296, [2] = 272, [3] = 296, [4] = 323, [5] = 284, [6] = 267,
};
...
{
    struct SpecialStageCollectables *collectables = (void *)((gCurTask)->data);
    s16 i;
    ...
    sub_806CA88(&collectables->unk4, 0, 4, 0x372, 0x3000, 20, 20, 0xe, 1, 0);
    sub_806CA88(&collectables->unk34, 0, 16, 0x372, 0x3000, 20, 20, 0xe, 0, 0);
    sub_806CA88(&collectables->unk64, 0, 4, 0x374, 0x3000, 20, 0x1e, 0xf, 1, 0);
    sub_806CA88(&collectables->unk94, 0, 4, 0x372, 0x3000, 20, 20, 0xe, 6, 0);
    sub_806CA88(&collectables->unkC4, 0, 4, 0x372, 0x3000, 20, 20, 0xe, 5, 0);
    sub_806CA88(&collectables->unkF4[0], 0, 4, 0x37b, 0x3000, 20, 20, 0xe, 0, 0);
    sub_806CA88(&collectables->unkF4[1], 0, 4, 0x37b, 0x3000, 20, 20, 0xe, 1, 0);
    sub_806CA88(&collectables->unkF4[2], 0, 4, 0x37b, 0x3000, 20, 20, 0xe, 2, 0);
    sub_806CA88(&collectables->unkF4[3], 0, 4, 0x37b, 0x3000, 20, 20, 0xe, 3, 0);
...
void sub_806DB48(void)
{
    ...
    if (stage->paused == 0) {
        ...
        if (sub_806DE10() == 0 && stage->state != 7) {
            stage->state = 6;
        }
...
void HandleCollectableCollision(void)
{
    ...
    s32 playerX = ((int)((player->q16WorldX) >> 0x10));
    s32 playerY = ((int)((player->q16WorldY) >> 0x10));
    s32 val3 = player->unkB0 >> 4;
    u32 cell = ((((int)((player->q16WorldX) >> 0x10)) >> 7) * 8) + (((int)((player->q16WorldY) >> 0x10)) >> 7);
...
void sub_806DEA4(void)
{
    ...
    const struct UNK_8C878E8 *unk78E8_val = 
# 257 "src/game/special_stage/collectables.c" 3 4
                                           ((void *)0)
# 257 "src/game/special_stage/collectables.c"
                                               ;
    ...
    stageZoneX = ((int)((player->q16WorldX) >> 0x10)) >> 7;
    stageZoneY = ((int)((player->q16WorldY) >> 0x10)) >> 7;
...
s16 sub_806E038(s16 acc, const struct UNK_8C878E8 *unk78E8, struct UNK_806DEA4 *unkDEA4Arr)
{
    ...
    struct UNK_806DEA4 *found = 
# 330 "src/game/special_stage/collectables.c" 3 4
                               ((void *)0)
# 330 "src/game/special_stage/collectables.c"
                                   ;

    result = acc;
    while (object->id != -1) {
        if (collectables->objStates[object->id] != 0) {
            new_unk874.unk0 = ((s32)((object->x)*0x10000));
            new_unk874.unk4 = ((s32)((object->y)*0x10000));
            new_unk874.unk8 = ((s32)((object->unk6)*0x10000));
            new_unk874.unkC = 8;
            new_unk874.unkE = 8;
            new_unk874.unk10 = 0;
            new_unk874.unk12 = 5;
...
void sub_806E1AC(s16 index, struct UNK_806DEA4 *unkDEA4)
{
    ...
    if (unkDEA4->unk0 > 2) {
        ...
        element1->oamFlags = (unkDEA4->unk4 < (stage->cameraHeight - 15)) ? ((13) << 6) : ((6) << 6);
    } else {
        s16 x, y;
        Sprite *reference;
        if (unkDEA4->unk6 == 0) {
            ...
            element2->oamFlags = (unkDEA4->unk4 < (stage->cameraHeight - 15)) ? ((14) << 6) : ((7) << 6);
...
{
    s16 i, j;
    struct SpecialStageCollectables *collectables = (void *)((stage->collectablesTask)->data);
    struct SpecialStagePlayer *player = (void *)((stage->playerTask)->data);
    ...
    for (i = 0; i < temp; i++) {
        ...
        sin = (gSineTable[(rand1)]) * 4;
        cos = (gSineTable[(rand1) + 256]) * 4;

        temp3 = ((int)((rand2 * sin) >> 0x10));
        temp4 = ((int)((rand2 * cos) >> 0x10));
...
void sub_806E584(s16 index, struct SpecialStageCollectables_UNK874 *unk874)
{
    ...
    if (visible) {
        ...
        *unk7B4 = collectables->unk34;
        ...
        unk7B4->x = screenX;
        unk7B4->y = screenY;
        unk7B4->oamFlags = (new_unkCB84.screenY < (stage->cameraHeight - 15)) ? ((13) << 6) : ((6) << 6);
        sub_806CD68(unk7B4);
...
# 565 "src/game/special_stage/collectables.c" 3 4
                                                                                        ((void *)0)
# 565 "src/game/special_stage/collectables.c"
                                                                                            );
    collectables = (void *)((t)->data);
