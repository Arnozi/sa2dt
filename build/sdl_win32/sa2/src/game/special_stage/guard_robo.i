...
static void GuardRoboInit(struct SpecialStageGuardRobo *guardRobo)
{
    ...
    sub_8071380(&guardRobo->sprite, vramOld, 426 / 2, (240 / 2) - 20, 7, sprites);
...
void Task_GuardRoboMain(void)
{
    ...
    struct SpecialStageGuardRobo *guardRobo = (void *)((gCurTask)->data);
...
{
    struct SpecialStageGuardRobo *guardRobo = (void *)((gCurTask)->data);
    struct SpecialStagePlayer *player = (void *)((guardRobo->stage->playerTask)->data);
...
struct Task *CreateSpecialStageGuardRobo(struct SpecialStage *stage)
{
    ...
    struct SpecialStageGuardRobo *guardRobo = (void *)((t)->data);
