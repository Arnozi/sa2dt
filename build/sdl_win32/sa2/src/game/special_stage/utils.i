# 0 "src/game/special_stage/utils.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/special_stage/utils.c"
# 1 "include/core.h" 1
...
# 2 "src/game/special_stage/utils.c" 2
...
# 3 "src/game/special_stage/utils.c" 2
...
# 4 "src/game/special_stage/utils.c" 2
...
# 5 "src/game/special_stage/utils.c" 2
...
# 8 "src/game/special_stage/utils.c" 2
# 1 "include/trig.h" 1
...
# 9 "src/game/special_stage/utils.c" 2

void *gSpecialStageSubMenuVramPointer = 
# 10 "src/game/special_stage/utils.c" 3 4
                                       ((void *)0)
# 10 "src/game/special_stage/utils.c"
                                           ;
void *gSpecialStageVramPointer = 
# 11 "src/game/special_stage/utils.c" 3 4
                                ((void *)0)
# 11 "src/game/special_stage/utils.c"
                                    ;
...
void sub_806CA88(Sprite *obj, s8 target, u32 size, AnimId anim, u32 frameFlags, s16 xPos, s16 yPos, u16 oamOrder, u8 variant, u8 palId)
{
    ...
    if (obj != 
# 20 "src/game/special_stage/utils.c" 3 4
              ((void *)0)
# 20 "src/game/special_stage/utils.c"
                  ) {
        s = obj;
    }

    if (target != 0) {
        if (gSpecialStageSubMenuVramPointer == 
# 25 "src/game/special_stage/utils.c" 3 4
                                              ((void *)0)
# 25 "src/game/special_stage/utils.c"
                                                  ) {
    ...
    switch (target) {
        case 0:
            gSpecialStageVramPointer += size * 32;

            ({ gSpecialStageSubMenuVramPointer = 
# 53 "src/game/special_stage/utils.c" 3 4
           ((void *)0)
# 53 "src/game/special_stage/utils.c"
           ; });
            break;
        case 1:
            gSpecialStageSubMenuVramPointer += size * 32;
            break;
    }
}
                                            ...
                                            struct SpecialStage *stage)
{
    ...
    if (stage->worldTask == 
# 72 "src/game/special_stage/utils.c" 3 4
                           ((void *)0)
# 72 "src/game/special_stage/utils.c"
                               ) {
        return 0;
    }


    world = (void *)((stage->worldTask)->data);

    {
        u16 deg = -stage->cameraRotX & (1024 - 1);
        s32 r2 = (gSineTable[(deg)]) * 4;
        s32 r5 = (gSineTable[(deg) + 256]) * 4;
        s32 temp_r4 = (-unk874->unk0 + stage->q16CameraX);
        s32 r3 = (-unk874->unk4 + stage->q16CameraY);
        r9 = ((((int)((r2) >> 8)) * ((int)((r3) >> 8))) + (((int)((r5) >> 8)) * ((int)((temp_r4) >> 8)))) >> 2;
        r4 = ((((int)((-r2) >> 8)) * ((int)((temp_r4) >> 8))) + (((int)((r5) >> 8)) * ((int)((r3) >> 8)))) >> 1;
    }

    {
        s32 unk590 = stage->unk94[240 - 1][1];
...

    {
        ...
        a->unkA = val;
        a->screenY = (a->unkA - unk874->unkE) - (((s32)((unk874->unk12)*0x10000)) / world->qPerspectiveTable[val]);
        a->unk8 = ((426 / 2) - ((r9 * ((426 / 2) + 15)) / r8));
        ...
        a->unkC = ((int)((world->qPerspectiveTable[val]) >> 8));
        a->unk12 = a->unkC;
...
void sub_806CD68(Sprite *s)
{
    ...
    for (i = 0; i < numSubframes; i++) {
        ...
        oam = OamMalloc(((((s)->oamFlags) & 0x7C0) >> 6));
        if (oam == iwram_end) {
            return;
        }
        ...
        DmaSet(3, &oamTemplate[(sprDims->oamIndex + i) * (10 / sizeof(short))], oam, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((10)/(16/8))));
# 188 "src/game/special_stage/utils.c"
        x = oam->split.x;
        oam->split.y += sy;
        oam->split.affineMode = 3;
        oam->split.matrixNum = (((s)->frameFlags & (((0x1F) << (0)))) >> ((0)));
        oam->split.x = sx + x;
        oam->split.paletteNum += s->palId;
        oam->split.priority = (((s)->frameFlags & (((3) << (12)))) >> ((12)));
        oam->split.tileNum += (((uintptr_t)((s->graphics.dest)) - (uintptr_t)&VRAM[0x10000]) / (32));
...
void InitSpecialStageScreenVram(void)
{
    gSpecialStageVramPointer = (void *)&VRAM[0x10000];
    gSpecialStageSubMenuVramPointer = 
# 203 "src/game/special_stage/utils.c" 3 4
                                     ((void *)0)
# 203 "src/game/special_stage/utils.c"
                                         ;
