# 0 "src/game/special_stage/tables.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/special_stage/tables.c"
...
# 2 "src/game/special_stage/tables.c" 2
...
# 6 "include/game/special_stage/tables.h" 2
...
# 3 "src/game/special_stage/tables.c" 2
