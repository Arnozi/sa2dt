...
struct Task *CreateSpecialStagePlayer(struct SpecialStage *stage)
{
    ...
    t = TaskCreate(sub_806D2C8, sizeof(struct SpecialStagePlayer), 0x9000, 0, 
# 72 "src/game/special_stage/player.c" 3 4
                                                                             ((void *)0)
# 72 "src/game/special_stage/player.c"
                                                                                 );
    player = (void *)((t)->data);
    player->unk0 = stage;
    player->unk4 = 
# 75 "src/game/special_stage/player.c" 3 4
                  ((void *)0)
# 75 "src/game/special_stage/player.c"
                      ;
...
void sub_806D2C8(void)
{
    ...
    struct SpecialStagePlayer *player = (void *)((gCurTask)->data);
