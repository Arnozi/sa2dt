# 0 "src/game/special_stage/world.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/special_stage/world.c"
# 1 "include/core.h" 1
...
# 2 "src/game/special_stage/world.c" 2
...
# 3 "src/game/special_stage/world.c" 2
...
# 4 "src/game/special_stage/world.c" 2
...
# 5 "src/game/special_stage/world.c" 2
...
# 6 "src/game/special_stage/world.c" 2
...
# 7 "src/game/special_stage/world.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/special_stage/world.c" 2
...
# 11 "src/game/special_stage/world.c" 2
# 1 "include/trig.h" 1
...
# 12 "src/game/special_stage/world.c" 2
# 1 "include/flags.h" 1
# 13 "src/game/special_stage/world.c" 2
...
void EwramFree(void *);
# 14 "src/game/special_stage/world.c" 2

# 1 "include/constants/songs.h" 1
# 16 "src/game/special_stage/world.c" 2
# 1 "include/constants/tilemaps.h" 1
# 17 "src/game/special_stage/world.c" 2
...
struct Task *CreateSpecialStageWorld(struct SpecialStage *stage)
{
    ...
    world->bgTransforms = 
# 97 "src/game/special_stage/world.c" 3 4
                         ((void *)0)
# 97 "src/game/special_stage/world.c"
                             ;
    world->unk8 = 
# 98 "src/game/special_stage/world.c" 3 4
                 ((void *)0)
# 98 "src/game/special_stage/world.c"
                     ;
    world->qPerspectiveTable = 
# 99 "src/game/special_stage/world.c" 3 4
                              ((void *)0)
# 99 "src/game/special_stage/world.c"
                                  ;
...
void sub_806E7C0(struct SpecialStageWorld *world)
{
    ...
    s32 temp = ((s32)((stage->cameraHeight - stage->cameraPitch)*0x10000));
    ...
    world->qPerspectiveTable = EwramMalloc(240 * sizeof(s32));
    for (i = 0, unkC = world->qPerspectiveTable; i < 240; i++, unkC++) {
    ...
    world->unk8 = EwramMalloc(240 * sizeof(s32));
    for (i = 0, unk8 = world->unk8; i < 240; i++, unk8++) {
        s32 temp2 = (i - stage->cameraPitch);
        if (temp == 0) {
            *unk8 = 0;
        } else {
    ...
    for (i = stage->horizonHeight; i < 240; i++) {
        s32 temp2 = ((int)((world->qPerspectiveTable[i] * worldScale) >> 8));
        s32 temp3 = (-stage->cameraOriginX * temp2);
        s32 temp4 = (((i - stage->cameraHeight) * temp2));
        *unk94++ = ((int)((-(temp3 << 1)) >> 8)) * worldScale;
        *unk94++ = ((int)((-(temp4 << 2)) >> 8)) * worldScale;
    }

    world->bgTransforms = EwramMalloc(240 * sizeof(BgAffineReg));
...

    {
        ...
        for (i = 0; i < 240; i++, unk4 += 8) {
            memcpy(unk4, template, sizeof(BgAffineReg));
            ((BgAffineReg *)unk4)->pc = ((s32)((i)*256));
        }
    }
...
void sub_806EA04(void)
{
    struct SpecialStageWorld *world = (void *)((gCurTask)->data);
    struct SpecialStage *stage = world->stage;
    s32 sin, cos;
    s16 worldScale;
    s32 unk5A0;
    ...
    sin = (gSineTable[(unk5A0)]) * 4;
    cos = (gSineTable[(unk5A0) + 256]) * 4;
    ...
    for (; i < 240; i++) {
        ...
        *unk1884++ = (((int)((temp) >> 0x10)) * cos) >> 0x10;
        ...
        *unk1884++ = (((int)((temp) >> 0x10)) * -sin) >> 0x10;
        ...
        *unk1884++ = 0;
        ...
        x = (((int)((temp5) >> 0x10)) * sin) + (((int)((temp4) >> 0x10)) * cos) + stage->q16CameraX;
        y = (((int)((temp4) >> 0x10)) * -sin) + (((int)((temp5) >> 0x10)) * cos) + stage->q16CameraY;
...
{
    struct SpecialStageWorld *world = (void *)((t)->data);

    if (world->unk8 != 
# 294 "src/game/special_stage/world.c" 3 4
                      ((void *)0)
# 294 "src/game/special_stage/world.c"
                          ) {
        EwramFree(world->unk8);
    }

    if (world->qPerspectiveTable != 
# 298 "src/game/special_stage/world.c" 3 4
                                   ((void *)0)
# 298 "src/game/special_stage/world.c"
                                       ) {
        EwramFree(world->qPerspectiveTable);
    }

    if (world->bgTransforms != 
# 302 "src/game/special_stage/world.c" 3 4
                              ((void *)0)
# 302 "src/game/special_stage/world.c"
                                  ) {
