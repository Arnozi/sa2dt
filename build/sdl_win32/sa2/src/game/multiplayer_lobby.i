# 0 "src/game/multiplayer_lobby.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer_lobby.c"
...
# 2 "src/game/multiplayer_lobby.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiplayer_lobby.c" 2
...
# 4 "src/game/multiplayer_lobby.c" 2
# 1 "include/task.h" 1
# 5 "src/game/multiplayer_lobby.c" 2
# 1 "include/sprite.h" 1
# 6 "src/game/multiplayer_lobby.c" 2
...
# 7 "src/game/multiplayer_lobby.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/multiplayer_lobby.c" 2
# 1 "include/constants/songs.h" 1
# 9 "src/game/multiplayer_lobby.c" 2
...
# 10 "src/game/multiplayer_lobby.c" 2
# 1 "include/malloc_vram.h" 1
# 11 "src/game/multiplayer_lobby.c" 2
...
# 12 "src/game/multiplayer_lobby.c" 2
...
# 13 "src/game/multiplayer_lobby.c" 2
...
# 14 "src/game/multiplayer_lobby.c" 2
...
# 16 "src/game/multiplayer_lobby.c" 2
# 1 "include/constants/text.h" 1
# 17 "src/game/multiplayer_lobby.c" 2
# 1 "include/constants/tilemaps.h" 1
# 18 "src/game/multiplayer_lobby.c" 2
...
# 45 "src/game/multiplayer_lobby.c"
static const TileInfo sUiText[] = {
    [(0 + (((1 - 1)) * (3)))]
    = { .numTiles = (57), .anim = (1074), .variant = (2) },
    [(1 + (((1 - 1)) * (3)))]
    = { .numTiles = (12), .anim = (1074), .variant = (17) },
    [(2 + (((1 - 1)) * (3)))]
    = { .numTiles = (18), .anim = (1074), .variant = (18) },

    [(0 + (((2 - 1)) * (3)))]
    = { .numTiles = (48), .anim = (1079), .variant = (2) },
    [(1 + (((2 - 1)) * (3)))]
    = { .numTiles = (10), .anim = (1079), .variant = (6) },
    [(2 + (((2 - 1)) * (3)))]
    = { .numTiles = (10), .anim = (1079), .variant = (7) },

    [(0 + (((3 - 1)) * (3)))] = { .numTiles = (69), .anim = (1080), .variant = (2) },
    [(1 + (((3 - 1)) * (3)))]
    = { .numTiles = (15), .anim = (1080), .variant = (6) },
    [(2 + (((3 - 1)) * (3)))]
    = { .numTiles = (21), .anim = (1080), .variant = (7) },

    [(0 + (((4 - 1)) * (3)))] = { .numTiles = (39), .anim = (1081), .variant = (2) },
    [(1 + (((4 - 1)) * (3)))]
    = { .numTiles = (18), .anim = (1081), .variant = (6) },
    [(2 + (((4 - 1)) * (3)))]
    = { .numTiles = (18), .anim = (1081), .variant = (7) },

    [(0 + (((5 - 1)) * (3)))] = { .numTiles = (69), .anim = (1082), .variant = (2) },
    [(1 + (((5 - 1)) * (3)))]
    = { .numTiles = (9), .anim = (1082), .variant = (6) },
    [(2 + (((5 - 1)) * (3)))]
    = { .numTiles = (15), .anim = (1082), .variant = (7) },

    [(0 + (((6 - 1)) * (3)))] = { .numTiles = (69), .anim = (1083), .variant = (2) },
    [(1 + (((6 - 1)) * (3)))]
    = { .numTiles = (9), .anim = (1083), .variant = (6) },
    [(2 + (((6 - 1)) * (3)))]
    = { .numTiles = (15), .anim = (1083), .variant = (7) },
};
...
void CreateMultiplayerLobbyScreen(void)
{
    ...
    struct MultiplayerLobbyScreen *lobbyScreen = (void *)((t)->data);

    lobbyScreen->fadeInComplete = 0;
...
static void CreateUI(struct MultiplayerLobbyScreen *lobbyScreen)
{
    ...
    for (i = 0; i < (sizeof(lobbyScreen->uiElements) / sizeof((lobbyScreen->uiElements)[0])); i++) {
        s = &lobbyScreen->uiElements[i];
        s->graphics.dest = VramMalloc(sUiText[(((lang) * (3)) + i)].numTiles);
        s->graphics.anim = sUiText[(((lang) * (3)) + i)].anim;
        s->variant = sUiText[(((lang) * (3)) + i)].variant;
        s->prevVariant = -1;
        s->x = (426 / 2);
        s->y = (240 / 4) - 4;
        s->oamFlags = ((4) << 6);
    ...
    lobbyScreen->fade.speed = ((s32)((2.0)*256));
...
{
    u8 i;
    struct MultiplayerLobbyScreen *lobbyScreen = (void *)((gCurTask)->data);
    ...
    if (lobbyScreen->fadeInComplete && gMultiSioStatusFlags & 0x0080) {
        send = &gMultiSioSend;
        send->pat0.unk3 = 0;
    ...
    if (lobbyScreen->idleFrame == 0) {
        if (UpdateScreenFade(&lobbyScreen->fade) == 1) {
            if (lobbyScreen->fadeInComplete) {
                TaskDestroy(gCurTask);
                if (lobbyScreen->cursor != 0) {
                    gMultiSioEnabled = 0;
                    MultiSioStop();
                    MultiSioInit(0);
...
# 234 "src/game/multiplayer_lobby.c" 3 4
                                                    ((void *)0)
# 234 "src/game/multiplayer_lobby.c"
                                                        ;
                    }
                    ...
                    CreateCharacterSelectionScreen(0, gMultiplayerUnlockedCharacters & (1 << (CHARACTER_AMY)));
                }
                return;
            } else {
                gCurTask->main = ScreenMain;
                lobbyScreen->fadeInComplete = 1;
            }
        }
        ...
        if (lobbyScreen->idleFrame > 120) {
            lobbyScreen->idleFrame = 120;
        }
    }
...
static void ScreenMain(void)
{
    ...
    if (!(gMultiSioStatusFlags & 0x0080)
        && (recv->pat0.unk0 == 0x40A0 || recv->pat0.unk0 == 0x40A1)) {
        lobbyScreen->cursor = recv->pat0.unk2;

        if (recv->pat0.unk3 != 0) {
            lobbyScreen->idleFrame = 0;
            lobbyScreen->animFrame = (sizeof(sShakeAnimPositions) / sizeof((sShakeAnimPositions)[0])) - 1;
            m4aSongNumStart(108);

            if (lobbyScreen->cursor != 0) {
                if (chao->variant != 5) {
                    chao->graphics.anim = 1104;
                    chao->variant = 4;
                    chao->prevVariant = -1;
                }
...
static void StartMultiplayerExitAnim(struct MultiplayerLobbyScreen *lobbyScreen)
{
    ...
    lobbyScreen->fade.bldAlpha = 0;
    lobbyScreen->fade.speed = ((s32)((1.0)*256));
    lobbyScreen->idleFrame = 120;
    m4aSongNumStop(64);
    m4aSongNumStart(412);


    chao->graphics.anim = 1103;
    chao->variant = 0;
    chao->prevVariant = -1;
...
static void RenderUI(struct MultiplayerLobbyScreen *lobbyScreen)
{
    ...
    if (!UpdateSpriteAnimation(s)) {
        if (lobbyScreen->cursor != 0 && s->graphics.anim == 1103) {
            s->variant = 1;
        } else {
            if (s->variant == 6) {
                s->variant = 3;
    ...
    s = &lobbyScreen->uiElements[0];
    DisplaySprite(s);

    s = &lobbyScreen->uiElements[1];
    if (lobbyScreen->cursor != 0) {
        s->x = (426 / 6) + 4;
        s->palId = 1;
    } else {
