# 0 "src/game/cutscenes/extra_ending_slides.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/extra_ending_slides.c"
...
# 2 "src/game/cutscenes/extra_ending_slides.c" 2
...
# 3 "src/game/cutscenes/extra_ending_slides.c" 2
# 1 "include/core.h" 1
...
# 4 "src/game/cutscenes/extra_ending_slides.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/cutscenes/extra_ending_slides.c" 2
...
# 6 "src/game/cutscenes/extra_ending_slides.c" 2
# 1 "include/task.h" 1
# 7 "src/game/cutscenes/extra_ending_slides.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/cutscenes/extra_ending_slides.c" 2
...
# 9 "src/game/cutscenes/extra_ending_slides.c" 2
...
# 11 "src/game/cutscenes/extra_ending_slides.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/game/cutscenes/extra_ending_slides.c" 2
# 1 "include/constants/tilemaps.h" 1
# 13 "src/game/cutscenes/extra_ending_slides.c" 2
...
{
    struct Task *t = 
# 25 "src/game/cutscenes/extra_ending_slides.c" 3 4
                    ((void *)0)
# 25 "src/game/cutscenes/extra_ending_slides.c"
                        ;
    struct ExtraEndingCutSceneSlides *scene;
    Background *background;
    ScreenFade *fade = 
# 28 "src/game/cutscenes/extra_ending_slides.c" 3 4
                      ((void *)0)
# 28 "src/game/cutscenes/extra_ending_slides.c"
                          ;
...
void sub_8091590(void)
{
    struct ExtraEndingCutSceneSlides *scene = (void *)((gCurTask)->data);
