...
void CreateStageResultsCutscene(u8 mode)
{
    ...
    scene->unk34.graphics.dest = 
# 207 "src/game/cutscenes/level_endings.c" 3 4
                                ((void *)0)
# 207 "src/game/cutscenes/level_endings.c"
                                    ;
...
static void sub_808DD9C(void)
{
    ResultsCutScene *scene = (void *)((gCurTask)->data);
    Sprite *s = &scene->unk4;
...
{
    struct CharacterUnlockCutScene *scene = (void *)((gCurTask)->data);
...
void CreateCharacterUnlockCutScene(u8 zone)
{
    ...
    struct Task *t = TaskCreate(sub_808E424, sizeof(struct CharacterUnlockCutScene), 0x1000, 0, 
# 618 "src/game/cutscenes/level_endings.c" 3 4
                                                                                               ((void *)0)
# 618 "src/game/cutscenes/level_endings.c"
                                                                                                   );
    struct CharacterUnlockCutScene *scene = (void *)((t)->data);
    scene->unk10C = zone * 4;
    scene->unk10E = zone * 5;
    scene->unk110 = 0;
    scene->unk112 = zone;
...
{
    struct Task *t = TaskCreate(sub_808E424, sizeof(struct CharacterUnlockCutScene), 0x1000, 0, 
# 630 "src/game/cutscenes/level_endings.c" 3 4
                                                                                               ((void *)0)
# 630 "src/game/cutscenes/level_endings.c"
                                                                                                   );
    struct CharacterUnlockCutScene *scene = (void *)((t)->data);
    scene->unk10C = 0;
    scene->unk10E = 0;
...
{
    struct Task *t = TaskCreate(sub_808E424, sizeof(struct CharacterUnlockCutScene), 0x1000, 0, 
# 640 "src/game/cutscenes/level_endings.c" 3 4
                                                                                               ((void *)0)
# 640 "src/game/cutscenes/level_endings.c"
                                                                                                   );
    struct CharacterUnlockCutScene *scene = (void *)((t)->data);
    scene->unk10C = 8;
    scene->unk10E = 10;
...
{
    struct Task *t = TaskCreate(sub_808E424, sizeof(struct CharacterUnlockCutScene), 0x1000, 0, 
# 650 "src/game/cutscenes/level_endings.c" 3 4
                                                                                               ((void *)0)
# 650 "src/game/cutscenes/level_endings.c"
                                                                                                   );
    struct CharacterUnlockCutScene *scene = (void *)((t)->data);
    scene->unk10C = 4;
    scene->unk10E = 5;
...
{
    ResultsCutScene *scene = (void *)((t)->data);
    VramFree(scene->unk4.graphics.dest);

    if (scene->unk34.graphics.dest != 
# 663 "src/game/cutscenes/level_endings.c" 3 4
                                     ((void *)0)
# 663 "src/game/cutscenes/level_endings.c"
                                         ) {
