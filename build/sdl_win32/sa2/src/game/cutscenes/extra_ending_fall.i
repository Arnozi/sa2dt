...
void CreateExtraEndingFallCutScene(void)
{
    u8 j, i;
    struct Task *t;
    struct ExtraEndingCutScene *scene = 
# 129 "src/game/cutscenes/extra_ending_fall.c" 3 4
                                       ((void *)0)
# 129 "src/game/cutscenes/extra_ending_fall.c"
                                           ;
    ScreenFade *fade = 
# 130 "src/game/cutscenes/extra_ending_fall.c" 3 4
                      ((void *)0)
# 130 "src/game/cutscenes/extra_ending_fall.c"
                          ;
...
void sub_8090480(void)
{
    struct ExtraEndingCutScene *scene = (void *)((gCurTask)->data);
...
void sub_8090F6C(struct ExtraEndingCutScene *scene)
{
    if (scene->unk37C < 0xD) {
        ...
        if (scene->unk37F != 0) {
            scene->unk37F--;
            if (scene->unk37E <= 3) {
                DmaSet(3, gUnknown_080E15C8[scene->unk37E], &gObjPalette[(3)*16u + (0)], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gUnknown_080E15C8[0]))/(32/8))));
            } else {
                DmaSet(3, gUnknown_080E15C8[6 - scene->unk37E], &gObjPalette[(3)*16u + (0)], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gUnknown_080E15C8[0]))/(32/8))));
            }
        } else {
            scene->unk37E++;
