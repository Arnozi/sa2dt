...
{
    ScreenFade *fade = 
# 122 "src/game/cutscenes/final_ending_land.c" 3 4
                      ((void *)0)
# 122 "src/game/cutscenes/final_ending_land.c"
                          ;
    SpriteTransform *transform = 
# 123 "src/game/cutscenes/final_ending_land.c" 3 4
                                ((void *)0)
# 123 "src/game/cutscenes/final_ending_land.c"
                                    ;
    struct FinalEndingLandCutScene *scene = 
# 124 "src/game/cutscenes/final_ending_land.c" 3 4
                                           ((void *)0)
# 124 "src/game/cutscenes/final_ending_land.c"
                                               ;
    ...
    u32 value = 0;
    struct Task *t = 
# 130 "src/game/cutscenes/final_ending_land.c" 3 4
                    ((void *)0)
# 130 "src/game/cutscenes/final_ending_land.c"
                        ;
    ...
    if (!(gLoadedSaveGame->chaosEmeralds[gSelectedCharacter] & (1 << (7)))) {
        ...
        DmaSet(3, unk1AF4, &gBgPalette[(2)*16u + (0)], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(unk1AF4))/(32/8))));
    }
}
...
{
    struct FinalEndingLandCutScene *scene = (void *)((gCurTask)->data);
...
void sub_8093868(struct FinalEndingLandCutScene *scene)
{
    ...
    SpriteTransform *transform;
    Sprite *s = 
# 695 "src/game/cutscenes/final_ending_land.c" 3 4
               ((void *)0)
# 695 "src/game/cutscenes/final_ending_land.c"
                   ;
    ...
    if (s != 
# 735 "src/game/cutscenes/final_ending_land.c" 3 4
            ((void *)0)
# 735 "src/game/cutscenes/final_ending_land.c"
                )
