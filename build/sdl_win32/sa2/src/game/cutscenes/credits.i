# 0 "src/game/cutscenes/credits.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/credits.c"
...
# 2 "src/game/cutscenes/credits.c" 2
...
# 3 "src/game/cutscenes/credits.c" 2
...
# 4 "src/game/cutscenes/credits.c" 2
# 1 "include/game/cutscenes/credits_slides.h" 1
...
# 5 "src/game/cutscenes/credits.c" 2
# 1 "include/core.h" 1
...
# 6 "src/game/cutscenes/credits.c" 2
# 1 "include/sprite.h" 1
# 7 "src/game/cutscenes/credits.c" 2
...
# 8 "src/game/cutscenes/credits.c" 2
# 1 "include/task.h" 1
# 9 "src/game/cutscenes/credits.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/cutscenes/credits.c" 2
...
# 11 "src/game/cutscenes/credits.c" 2

# 1 "include/constants/tilemaps.h" 1
# 13 "src/game/cutscenes/credits.c" 2
...
__attribute__((unused)) static const u16 gUnknown_080E124E[] = { 56, 0, 828, 0, 78, 0, 828, 1, 60, 0, 828, 2, 96, 0, 828, 3 };

void CreateCreditsCutScene(u8 creditsVariant, u8 b, u8 c)
{
    struct Task *t;
    struct CreditsCutScene *scene = 
# 56 "src/game/cutscenes/credits.c" 3 4
                                   ((void *)0)
# 56 "src/game/cutscenes/credits.c"
                                       ;
    ...
    if ((scene->variant == 1 && gLoadedSaveGame->completedCharacters[CHARACTER_AMY])) {
        scene->unk4D = 1;
    } else if (scene->variant == 2 && gLoadedSaveGame->extraEndingCreditsPlayed) {
        scene->unk4D = 2;
    } else {
        scene->unk4D = 0;
    }
...
static void sub_808EBC4(void)
{
    struct CreditsCutScene *scene = (void *)((gCurTask)->data);
...
static void TaskDestroy_CreditsCutScene(__attribute__((unused)) struct Task *t) { }
