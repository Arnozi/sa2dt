# 0 "src/game/cutscenes/missing_emeralds.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/missing_emeralds.c"
...
# 2 "src/game/cutscenes/missing_emeralds.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/cutscenes/missing_emeralds.c" 2
...
# 4 "src/game/cutscenes/missing_emeralds.c" 2
...
# 5 "src/game/cutscenes/missing_emeralds.c" 2
# 1 "include/sprite.h" 1
# 6 "src/game/cutscenes/missing_emeralds.c" 2
# 1 "include/task.h" 1
# 7 "src/game/cutscenes/missing_emeralds.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/cutscenes/missing_emeralds.c" 2
...
# 9 "src/game/cutscenes/missing_emeralds.c" 2
...
# 10 "src/game/cutscenes/missing_emeralds.c" 2
...
# 12 "src/game/cutscenes/missing_emeralds.c" 2
# 1 "include/constants/songs.h" 1
# 13 "src/game/cutscenes/missing_emeralds.c" 2
# 1 "include/constants/tilemaps.h" 1
# 14 "src/game/cutscenes/missing_emeralds.c" 2
...
void CreateMissingChaosEmaraldsCutScene(void)
{
    u8 i;
    struct Task *t;
    struct MissingChaosEmaraldsCutScene *scene = 
# 84 "src/game/cutscenes/missing_emeralds.c" 3 4
                                                ((void *)0)
# 84 "src/game/cutscenes/missing_emeralds.c"
                                                    ;
    ScreenFade *fade = 
# 85 "src/game/cutscenes/missing_emeralds.c" 3 4
                      ((void *)0)
# 85 "src/game/cutscenes/missing_emeralds.c"
                          ;
...

    {
        ...
        if (scene->unkBD < 4) {
            scene->unkC4 += gUnknown_080E1CA0[0].numTiles * 32;
...
{
    Background *background = 
# 205 "src/game/cutscenes/missing_emeralds.c" 3 4
                            ((void *)0)
# 205 "src/game/cutscenes/missing_emeralds.c"
                                ;
    struct MissingChaosEmaraldsCutScene *scene = (void *)((gCurTask)->data);
