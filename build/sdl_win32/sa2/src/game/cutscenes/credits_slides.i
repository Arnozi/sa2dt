# 0 "src/game/cutscenes/credits_slides.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/credits_slides.c"
...
# 2 "src/game/cutscenes/credits_slides.c" 2
...
# 3 "src/game/cutscenes/credits_slides.c" 2
...
# 4 "src/game/cutscenes/credits_slides.c" 2
# 1 "include/core.h" 1
...
# 5 "src/game/cutscenes/credits_slides.c" 2
# 1 "include/sprite.h" 1
# 6 "src/game/cutscenes/credits_slides.c" 2
...
# 7 "src/game/cutscenes/credits_slides.c" 2
# 1 "include/task.h" 1
# 8 "src/game/cutscenes/credits_slides.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/cutscenes/credits_slides.c" 2
...
# 10 "src/game/cutscenes/credits_slides.c" 2
...
# 12 "src/game/cutscenes/credits_slides.c" 2
# 1 "include/constants/tilemaps.h" 1
# 13 "src/game/cutscenes/credits_slides.c" 2
...
{
    struct Task *t;
    CreditsSlidesCutScene *scene = 
# 45 "src/game/cutscenes/credits_slides.c" 3 4
                                  ((void *)0)
# 45 "src/game/cutscenes/credits_slides.c"
                                      ;
    Background *background;
    ScreenFade *fade = 
# 47 "src/game/cutscenes/credits_slides.c" 3 4
                      ((void *)0)
# 47 "src/game/cutscenes/credits_slides.c"
                          ;
    u8 i;
    ...
    if (scene->creditsVariant == 1 && gLoadedSaveGame->completedCharacters[CHARACTER_AMY]) {
        scene->unk4D = 1;
    } else if (scene->creditsVariant == 2 && gLoadedSaveGame->extraEndingCreditsPlayed) {
        scene->unk4D = 2;
    } else {
        scene->unk4D = 0;
    }
...
{
    CreditsSlidesCutScene *scene = (void *)((gCurTask)->data);
...
void sub_808F004(void)
{
    ...
    if (scene->unk4D != 0 && (gPressedKeys & 0x0008)) {
...
void sub_808F148(__attribute__((unused)) struct Task *t)
{
