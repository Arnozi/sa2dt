# 0 "src/game/cutscenes/final_ending_fall.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/final_ending_fall.c"
...
# 2 "src/game/cutscenes/final_ending_fall.c" 2
...
# 3 "src/game/cutscenes/final_ending_fall.c" 2
...
# 4 "src/game/cutscenes/final_ending_fall.c" 2
# 1 "include/game/cutscenes/final_ending_land.h" 1



void CreateFinalEndingLandingCutScene(void);
# 5 "src/game/cutscenes/final_ending_fall.c" 2
# 1 "include/core.h" 1
...
# 6 "src/game/cutscenes/final_ending_fall.c" 2
# 1 "include/sprite.h" 1
# 7 "src/game/cutscenes/final_ending_fall.c" 2
...
# 8 "src/game/cutscenes/final_ending_fall.c" 2
# 1 "include/task.h" 1
# 9 "src/game/cutscenes/final_ending_fall.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/cutscenes/final_ending_fall.c" 2
...
# 11 "src/game/cutscenes/final_ending_fall.c" 2
...
# 12 "src/game/cutscenes/final_ending_fall.c" 2
...
# 14 "src/game/cutscenes/final_ending_fall.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/cutscenes/final_ending_fall.c" 2
# 1 "include/constants/tilemaps.h" 1
# 16 "src/game/cutscenes/final_ending_fall.c" 2
...
void CreateFinalEndingFallCutScene(void)
{
    ...
    struct Task *t;
    struct FinalEndingFallCutScene *scene = 
# 126 "src/game/cutscenes/final_ending_fall.c" 3 4
                                           ((void *)0)
# 126 "src/game/cutscenes/final_ending_fall.c"
                                               ;
    ScreenFade *fade = 
# 127 "src/game/cutscenes/final_ending_fall.c" 3 4
                      ((void *)0)
# 127 "src/game/cutscenes/final_ending_fall.c"
                          ;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (24)));
    background->unk18 = 0;
    background->unk1A = 0;
...
{
    struct FinalEndingFallCutScene *scene = (void *)((gCurTask)->data);
    sub_8091F68(scene);
    sub_809205C(scene);
    sub_80920E4(scene);
    sub_8092804(scene);
    ...
    if ((scene->unk35C & 1) == 0 && scene->unk35C < 10) {
        ...
        gWinRegs[5] |= 0x1F;
        gBldRegs.bldCnt = 0x3FBF;
# 455 "src/game/cutscenes/final_ending_fall.c"
        gBldRegs.bldY -= gUnknown_080E1738[scene->unk35C];
...
void sub_80927E8(void)
{
    struct Task __attribute__((unused)) *t = gCurTask;
...
void sub_809289C(__attribute__((unused)) struct FinalEndingFallCutScene *scene)
{
    CpuFastSet((void *)((u16*)&PLTT[0x200/sizeof(uint16_t)]) + 0x100, (void *)PLTT + 0x100, 1);
    CpuFastSet((void *)((u16*)&PLTT[0x200/sizeof(uint16_t)]) + 0x120, (void *)PLTT + 0x120, 1);
}
