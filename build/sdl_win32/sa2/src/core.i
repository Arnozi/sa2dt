...
void *gBgOffsetsHBlankSecondary = 
# 72 "src/core.c" 3 4
                                 ((void *)0)
# 72 "src/core.c"
                                     ;
...
u32 gFlagsPreVBlank = 0;
                 const struct SpriteTables *gRefSpriteTables = 
# 100 "src/core.c" 3 4
                                                              ((void *)0)
# 100 "src/core.c"
                                                                  ;
...
void *gHBlankCopyTarget __attribute__((aligned(4))) = 
# 124 "src/core.c" 3 4
                                    ((void *)0)
# 124 "src/core.c"
                                        ;
...

{
    ...
    (*(vu16 *)(REG_BASE + 0x204)) = (1 << 14) | (1 << 4) | (1 << 2);
    gFlags = 0;
    gFlagsPreVBlank = 0;
    ...
    if (((*(vu16 *)(REG_BASE + 0x134)) & 0xC000) != 0x8000) {
        gFlags = 0x200;
...
# 445 "src/core.c"
    ...
    gVramHeapMaxTileSlots = 140 * ((4 * 32) / 32);
    gVramHeapStartAddr = &VRAM[0x14000] - (48 * 32);
...
# 509 "src/core.c"
    ...
    (*(vu16 *)(REG_BASE + 0x208)) = (1 << 0);
    (*(vu16 *)(REG_BASE + 0x200)) = (1 << 0);
    (*(vu16 *)(REG_BASE + 0x4)) = 0x0010 | 0x0008;
...
void EngineMainLoop(void)
{
...

    {
        ...
        while ((*(vu16 *)(REG_BASE + 0x4)) & 0x0001)
            ;
    };
}
...
{
    u8 i, j = 0;
    (*(vu16 *)(REG_BASE + 0x0)) = gDispCnt;
    DmaSet(3, gBgCntRegs, (void *)(REG_BASE + 0x8), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gBgCntRegs))/(32/8))));

    if (gFlags & 0x1) {
        DmaSet(3, gBgPalette, (void *)((u16*)&PLTT[0]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gBgPalette))/(32/8))));
        gFlags ^= 0x1;
    }

    if (gFlags & 0x2) {
        DmaSet(3, gObjPalette, (void *)((u16*)&PLTT[0x200/sizeof(uint16_t)]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gObjPalette))/(32/8))));
        gFlags ^= 0x2;
    }
    ...
    DmaSet(3, &gMosaicReg, (void *)(REG_BASE + (0x40 + sizeof(winreg_t) * 6)), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(gMosaicReg))/(16/8))));
...
void UpdateScreenCpuSet(void)
{
    ...
    if (gFlags & 0x1) {
        CpuFastSet(gBgPalette, (void *)((u16*)&PLTT[0]), ((sizeof(gBgPalette))/(32/8) & 0x1FFFFF));
        gFlags ^= 0x1;
    }

    if (gFlags & 0x2) {
        CpuFastSet(gObjPalette, (void *)((u16*)&PLTT[0x200/sizeof(uint16_t)]), ((sizeof(gObjPalette))/(32/8) & 0x1FFFFF));
        gFlags ^= 0x2;
    }
    ...
    CpuSet(&gMosaicReg, (void *)(REG_BASE + (0x40 + sizeof(winreg_t) * 6)), 0x00000000 | ((sizeof(gMosaicReg))/(16/8) & 0x1FFFFF));
    ...
    if (gFlags & 0x8) {
        (*(vu16 *)(REG_BASE + 0x200)) |= (1 << 1);
        { volatile uintptr_t tmp = (volatile uintptr_t)(
# 789 "src/core.c" 3 4
       ((void *)0)
# 789 "src/core.c"
       ); CpuFastSet((void *)&tmp, gHBlankIntrs, 0x01000000 | ((sizeof(gHBlankIntrs))/(32/8) & 0x1FFFFF)); };
        if (gNumHBlankCallbacks != 0) {
...
# 809 "src/core.c" 3 4
       ((void *)0)
# 809 "src/core.c"
       ); CpuFastSet((void *)&tmp, gVBlankIntrs, 0x01000000 | ((sizeof(gVBlankIntrs))/(32/8) & 0x1FFFFF)); };
        if (gNumVBlankCallbacks != 0) {
...
# 851 "src/core.c"
    ...
    if (gFlagsPreVBlank & 0x40) {
        (*(vu16 *)(REG_BASE + 0x4)) |= 0x0020;
        (*(vu16 *)(REG_BASE + 0x4)) &= 0xff;
        (*(vu16 *)(REG_BASE + 0x4)) |= gVCountSetting << 8;
        (*(vu16 *)(REG_BASE + 0x4)) &= ~0x0004;
        (*(vu16 *)(REG_BASE + 0x4)) |= 0x0020;
        (*(vu16 *)(REG_BASE + 0x200)) |= (1 << 2);
    } else {
        (*(vu16 *)(REG_BASE + 0x4)) &= ~0x0004;
        (*(vu16 *)(REG_BASE + 0x4)) &= ~0x0020;
        (*(vu16 *)(REG_BASE + 0x200)) &= ~(1 << 2);
...
void GetInput(void)
{
    ...
    gInput = (~(*(vu16 *)(REG_BASE + 0x130)) & 0x03FF);
...
{
    u8 i;
    int_vcount vcount = *(volatile int_vcount *)&(*(vu16 *)(REG_BASE + 0x6));
    ...
    (*(vu16 *)(REG_BASE + 0x202)) = (1 << 1);
}

static void VCountIntr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 2); }
static void Dma0Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 8); }
static void Dma1Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 9); }
static void Dma2Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 10); }
static void Dma3Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 11); }
static void Timer0Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 3); }
static void Timer1Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 4); }
static void Timer2Intr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 5); }



static void KeypadIntr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 12); }
static void GamepakIntr(void) { (*(vu16 *)(REG_BASE + 0x202)) = (1 << 13); }
