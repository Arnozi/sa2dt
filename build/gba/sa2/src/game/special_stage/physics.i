...
{
    struct SpecialStagePhysics *physics = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    PlayerStatePhysicsHandler stateHandlers[] = {
        ((void *)0), sub_806F9CC, sub_806F9CC, sub_806F9CC, sub_806F9CC, sub_806EFB4, sub_806F034,
        sub_806F3C4, sub_806F36C, sub_806F9E4, sub_806F0C4, sub_806F154, sub_806F1E8, PlayerStatePhysics_SlowToStop,
        sub_806FB00, sub_806F300, sub_806F300, ((void *)0),
    };
    ...
    if (player->state < 11) {
        ...
        screenX = ((int)((screenX) >> 0x10)) + (240 / 2) - 8;
...
{
    struct SpecialStagePhysics *physics = (void *)(0x03000000 + ((gCurTask)->data));
    struct SpecialStagePlayer *player = (void *)(0x03000000 + ((physics->stage->playerTask)->data));
...
{
    struct Task *t = TaskCreate(Task_PhysicsMain, sizeof(struct SpecialStagePhysics), 0x4000, 0, ((void *)0));
    struct SpecialStagePhysics *physics = (void *)(0x03000000 + ((t)->data));
