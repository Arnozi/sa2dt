# 0 "src/game/special_stage/guard_robo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/special_stage/guard_robo.c"
# 1 "include/core.h" 1
...
# 2 "src/game/special_stage/guard_robo.c" 2
# 1 "include/sprite.h" 1
# 3 "src/game/special_stage/guard_robo.c" 2
...
# 4 "src/game/special_stage/guard_robo.c" 2
...
# 5 "src/game/special_stage/guard_robo.c" 2
...
# 6 "src/game/special_stage/guard_robo.c" 2
...
# 7 "src/game/special_stage/guard_robo.c" 2
...
# 8 "src/game/special_stage/guard_robo.c" 2
# 1 "include/game/special_stage/collectables.h" 1
# 12 "include/game/special_stage/collectables.h"
...
# 9 "src/game/special_stage/guard_robo.c" 2
...
# 10 "src/game/special_stage/guard_robo.c" 2
...
# 12 "src/game/special_stage/guard_robo.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 13 "src/game/special_stage/guard_robo.c" 2
# 1 "include/constants/songs.h" 1
# 14 "src/game/special_stage/guard_robo.c" 2
...
static const struct UNK_80DF670 gUnknown_080DF914[9] = {
    ...
    { 883, 1, 64, 16, 0 }, { 883, 2, 64, 16, 0 }, { 883, 3, 64, 16, 0 }, { 65535, 65535, 65535, },
};
...
static void GuardRoboInit(struct SpecialStageGuardRobo *guardRobo)
{
    ...
    gSpecialStageVramPointer += maxSize * 32;

    sub_8071380(&guardRobo->sprite, vramOld, 240 / 2, (160 / 2) - 20, 7, sprites);
...
void Task_GuardRoboMain(void)
{
    ...
    struct SpecialStageGuardRobo *guardRobo = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (visible) {
        ...
        *oam = unkCBB4.unk12;
        ...
        angle = ((guardRobo->bearing - stage->cameraRotX) + 64) & (1024 - 1);
...
{
    struct SpecialStageGuardRobo *guardRobo = (void *)(0x03000000 + ((gCurTask)->data));
    struct SpecialStagePlayer *player = (void *)(0x03000000 + ((guardRobo->stage->playerTask)->data));
    ...
    u16 angle = (-guardRobo->bearing & (1024 - 1));
    s32 sin = (gSineTable[(angle)]) * 4;
    s32 cos = (gSineTable[(angle) + 256]);
    ...
    if (bearingToPlayer > 0) {
        guardRobo->bearing = (guardRobo->bearing - guardRobo->rotateSpeed) & (1024 - 1);
    ...
    sin = (gSineTable[(angle)]) * 4;
    sin4 = (gSineTable[(angle) + 256]) * 4;
...
void sub_807120C(struct SpecialStageGuardRobo *guardRobo)
{
    ...
    s16 guardRoboX = ((int)((guardRobo->x) >> 0x10));
    s16 guardRoboY = ((int)((guardRobo->y) >> 0x10));
...
struct Task *CreateSpecialStageGuardRobo(struct SpecialStage *stage)
{
    ...
    struct SpecialStageGuardRobo *guardRobo = (void *)(0x03000000 + ((t)->data));
    guardRobo->stage = stage;
    GuardRoboInit(guardRobo);
    return t;
}

void SpecialStageGuardRoboOnDestroy(__attribute__((unused)) struct Task *t)
{
...
void sub_8071478(void)
{
    ...
    GuardRoboStateHandler stateHandlers[(sizeof(sGuardRoboStateHandlers) / sizeof((sGuardRoboStateHandlers)[0]))];
...
{
    if (guardRobo->x < ((s32)((42)*0x10000))) {
        guardRobo->x = ((s32)((42)*0x10000));
    }

    if (guardRobo->x > ((s32)((982)*0x10000))) {
        guardRobo->x = ((s32)((982)*0x10000));
    }

    if (guardRobo->y < ((s32)((42)*0x10000))) {
        guardRobo->y = ((s32)((42)*0x10000));
    }

    if (guardRobo->y > ((s32)((982)*0x10000))) {
        guardRobo->y = ((s32)((982)*0x10000));
    }
}
