...
{
    struct SpecialStageCollectables *collectables = (void *)(0x03000000 + ((gCurTask)->data));
    s16 i;
...
void sub_806DEA4(void)
{
    ...
    const struct UNK_8C878E8 *unk78E8_val = ((void *)0);
...
s16 sub_806E038(s16 acc, const struct UNK_8C878E8 *unk78E8, struct UNK_806DEA4 *unkDEA4Arr)
{
    ...
    struct UNK_806DEA4 *found = ((void *)0);
...
{
    s16 i, j;
    struct SpecialStageCollectables *collectables = (void *)(0x03000000 + ((stage->collectablesTask)->data));
    struct SpecialStagePlayer *player = (void *)(0x03000000 + ((stage->playerTask)->data));
...
struct Task *CreateSpecialStageCollectables(struct SpecialStage *stage)
{
    ...
    t = TaskCreate(Task_InitObjects, sizeof(struct SpecialStageCollectables), 0xB000, 0, ((void *)0));
    collectables = (void *)(0x03000000 + ((t)->data));
