...
void *gSpecialStageSubMenuVramPointer = ((void *)0);
void *gSpecialStageVramPointer = ((void *)0);
...
void sub_806CA88(Sprite *obj, s8 target, u32 size, AnimId anim, u32 frameFlags, s16 xPos, s16 yPos, u16 oamOrder, u8 variant, u8 palId)
{
    ...
    if (target != 0) {
        if (gSpecialStageSubMenuVramPointer == ((void *)0)) {
                                            ...
                                            struct SpecialStage *stage)
{
    ...
    s32 r4;
    s16 val2, val;
# 77 "src/game/special_stage/utils.c"
    world = (void *)(0x03000000 + ((stage->worldTask)->data));
    ...
    {
        s32 unk590 = stage->unk94[160 - 1][1];
...
void sub_806CD68(Sprite *s)
{
    ...
    for (i = 0; i < numSubframes; i++) {
        ...
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&oamTemplate[(sprDims->oamIndex + i) * (6 / sizeof(short))]); dmaRegs[1] = (vu32)(oam); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((6)/(16/8)))); dmaRegs[2]; };

        x = oam->all.attr1 & 0x1FF;
        oam->all.attr0 = (sy + (oam->all.attr0 & 0xff)) & 0xff;
        oam->all.attr0 |= (3 << 8);
        oam->all.attr1 &= 0xfe00;
        oam->all.attr1 |= ((((s)->frameFlags & (((0x1F) << (0)))) >> ((0))) << 9);
        oam->all.attr1 |= ((sx + x) & 0x1ff);
        oam->all.attr2 += s->palId << 12;
        oam->all.attr2 |= ((((s)->frameFlags & (((3) << (12)))) >> ((12))) << 10);
        oam->all.attr2 += (((uintptr_t)((s->graphics.dest)) - (uintptr_t)(u8*)(0x6000000 + 0x10000)) / (32));
# 197 "src/game/special_stage/utils.c"
    }
}

void InitSpecialStageScreenVram(void)
{
    gSpecialStageVramPointer = (void *)(u8*)(0x6000000 + 0x10000);
    gSpecialStageSubMenuVramPointer = ((void *)0);
