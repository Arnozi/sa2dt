...
{
    struct Task *t = TaskCreate(Task_SpikesUpMain, sizeof(Sprite_Spikes), 0x2000, 0, ((void *)0));
    Sprite_Spikes *spikes = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &spikes->s;
    ...
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 204 * 32);;
...
{
    struct Task *t = TaskCreate(Task_SpikesDownMain, sizeof(Sprite_Spikes), 0x2000, 0, ((void *)0));
    Sprite_Spikes *spikes = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &spikes->s;
...
static void Task_SpikesUpMain(void)
{
    Sprite_Spikes *spikes = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &spikes->s;
...
static void Task_SpikesLeftRightMain(void)
{
    ...
    spikes = (void *)(0x03000000 + ((gCurTask)->data));
    s = &spikes->s;
    me = spikes->base.me;
