...
void Task_8061914(void)
{
    Sprite_Corkscrew3D *corkscrew = (void *)(0x03000000 + ((gCurTask)->data));
...
void sub_8061AB0(void)
{
    ...
    if ((((int)((player->qWorldX) >> 8)) - x) > 0x8C) {
        ...
        if (player->qSpeedGround < corkscrew->unkC) {
            ...
            player->variant = Div((idx - 282) & (1024 - 1), 94);
        }
    }
}
...
{
    struct Task *t = TaskCreate(Task_8061914, sizeof(Sprite_Corkscrew3D), 0x2000, 0, ((void *)0));
    Sprite_Corkscrew3D *corkscrew = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(Task_8061F60, sizeof(Sprite_Corkscrew3D), 0x2000, 0, ((void *)0));
    Sprite_Corkscrew3D *corkscrew = (void *)(0x03000000 + ((t)->data));
    corkscrew->base.regionX = spriteRegionX;
    corkscrew->base.regionY = spriteRegionY;
    corkscrew->base.me = me;
...
s32 sub_806267C(s32 x, s32 y, s16 p2)
{
    ...
    register s32 px asm("r0") = ((((int)((p->qWorldX) >> 8)) - x) * 930) >> 8;
