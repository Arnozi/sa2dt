...
{
    Sprite_InclineRamp *ramp = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct Task *t = TaskCreate(Task_InclineRamp, sizeof(Sprite_InclineRamp), 0x2000, 0, ((void *)0));
    Sprite_InclineRamp *ramp = (void *)(0x03000000 + ((t)->data));
