...
{
    Sprite_Checkpoint *chkPt = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &chkPt->s;
...
{
    Sprite_Checkpoint *chkPt = (void *)(0x03000000 + ((t)->data));
...
void TaskDestructor_PaletteLoader_Checkpoint(struct Task *unused)
{
    ...
    if (*cmd++ == -2) {
        ...
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gRefSpriteTables->palettes[palId * 16]); dmaRegs[1] = (vu32)(&gBgPalette[offset]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((numColors * sizeof(u16))/(32/8)))); dmaRegs[2]; };
...
static void Task_Interactable_Toggle_Checkpoint(void)
{
    Sprite_Toggle_Checkpoint *toggle = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if ((((u16)(screenX + (256 / 2)) > 240 + 256) || (screenY + (256 / 2) < 0) || (screenY > 160 + (256 / 2)))) {
...
{
    if (gBossIndex == 0) {
        struct Task *t = TaskCreate(Task_Interactable_Toggle_Checkpoint, sizeof(Sprite_Toggle_Checkpoint), 0x2010, 0, ((void *)0));

        Sprite_Toggle_Checkpoint *toggle = (void *)(0x03000000 + ((t)->data));
