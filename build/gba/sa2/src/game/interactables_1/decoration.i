# 0 "src/game/interactables_1/decoration.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/decoration.c"
...
# 2 "src/game/interactables_1/decoration.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_1/decoration.c" 2
...
# 4 "src/game/interactables_1/decoration.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/interactables_1/decoration.c" 2
...
# 7 "src/game/interactables_1/decoration.c" 2
...
# 8 "src/game/interactables_1/decoration.c" 2
...
# 9 "src/game/interactables_1/decoration.c" 2
...
# 11 "src/game/interactables_1/decoration.c" 2
...
void CreateEntity_Decoration(MapEntity *me, u16 regionX, u16 regionY, u8 spriteY)
{
    ...
    if (me->d.sData[0] >= 0) {
        ...
        s->graphics.dest = VramMalloc(sDecoTileAnimInfo[me->d.sData[0]].numTiles);
        s->graphics.anim = sDecoTileAnimInfo[me->d.sData[0]].anim;
        s->variant = sDecoTileAnimInfo[me->d.sData[0]].variant;
...
void Task_Decoration(void)
{
    Sprite_Decoration *base = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    screenX = (base->base.meX) * 8;
    screenX += (base->base.regionX) * 256;
    screenY = (me->y) * 8;
    screenY += (base->base.regionY) * 256;
    ...
    if ((((u16)(screenX + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) {
        me->x = base->base.meX;
...
{
    Sprite_Decoration *s = (void *)(0x03000000 + ((t)->data));
