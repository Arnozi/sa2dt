# 0 "src/game/interactables_1/bouncy_bar.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/bouncy_bar.c"
# 1 "include/core.h" 1
...
# 2 "src/game/interactables_1/bouncy_bar.c" 2
...
# 4 "src/game/interactables_1/bouncy_bar.c" 2
...
# 8 "src/game/interactables_1/bouncy_bar.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/interactables_1/bouncy_bar.c" 2
...
# 12 "src/game/interactables_1/bouncy_bar.c" 2
# 1 "include/constants/char_states.h" 1
# 13 "src/game/interactables_1/bouncy_bar.c" 2
# 1 "include/constants/player_transitions.h" 1
# 14 "src/game/interactables_1/bouncy_bar.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/interactables_1/bouncy_bar.c" 2
...
static const s16 sBaseLaunchSpeed[] = { -((s32)((1.5)*256)), -((s32)((1.5)*256)), -((s32)((1.5)*256)) };
...
void CreateEntity_BouncyBar(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    BouncyBar *bar = (void *)(0x03000000 + ((t)->data));
    ...
    s->graphics.dest = VramMalloc(24); s->graphics.anim = 538; s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
...
static void Task_BouncyBarIdle(void)
{
    BouncyBar *bar = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &bar->s;
    MapEntity *me = bar->base.me;

    s32 screenX, screenY;

    screenX = ((bar->base.meX)*8 + (bar->base.regionX)*256);
    screenY = ((me->y)*8 + (bar->base.regionY)*256);
    s->x = screenX - gCamera.x;
    s->y = screenY - gCamera.y;

    if (!(gPlayer.moveState & 0x00000080) && (Coll_Player_Entity_HitboxN(s, screenX, screenY, 0, &gPlayer, 0) == 1)
        && (gPlayer.qSpeedAirY > 0) && (((int)((gPlayer.qWorldY) >> 8)) + 4) < screenY) {
        gPlayer.charState = 50;
        gPlayer.transition = 5;

        bar->landingSpeed = ((int)((gPlayer.qSpeedAirY) >> 8)) >> 2;
        ...
        bar->landingPosition = ((screenX - ((int)((gPlayer.qWorldX) >> 8))) >= 0 ? (screenX - ((int)((gPlayer.qWorldX) >> 8))) : -(screenX - ((int)((gPlayer.qWorldX) >> 8))));
        ...
        bar->landingSpeed = 2 - bar->landingSpeed;
        m4aSongNumStart(279);
    } else if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) {
        me->x = bar->base.meX;
