...
void CreateEntity_PlatformCrumbling(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_019 *platform = (void *)(0x03000000 + ((t)->data));
...
{
    Sprite_019 *platform = (void *)(0x03000000 + ((gCurTask)->data));
    SpriteBase *base = &platform->base;
    Sprite *s = &platform->s;
    ...
    if ((screenX > gCamera.x + 240 + (256 / 2) || (screenX < gCamera.x - (256 / 2))
         || (screenY > gCamera.y + 160 + (256 / 2)) || (screenY < gCamera.y - (256 / 2)))
...
void Task_805E480(void)
{
    ...
    otherPos = (gCamera.y - screenY) + 160;
    ...
    oam = &oam_ptr[s->dimensions->oamIndex * (6 / sizeof(short))];
    ...
    for (y = 0; y < 4; y++) {
        for (x = 0; x < 8; r6++, x++) {
            ...
            oamAllocated->all.attr0 = ((s16)(r4 + ((y * 8) + s->y))) & 0xFF;

            if (s->frameFlags & ((1) << (10))) {
                oamAllocated->all.attr1 = ((s->x - x * 8 - 8) & 0x1FF) | 0x1000;
            } else {
                oamAllocated->all.attr1 = (s->x + x * 8) & 0x1FF;
            }

            oamAllocated->all.attr2
                = (((oam[2] + s->palId) & ~0xFFF) | ((((s)->frameFlags & (((3) << (12)))) >> ((12))) << 10) | (u16)((((uintptr_t)((s->graphics.dest)) - (uintptr_t)(u8*)(0x6000000 + 0x10000)) / (32)) + r6));
# 253 "src/game/interactables_1/platform_crumbling.c"
        }
    }
}
...
void Task_805E6A4(void)
{
    ...
    for (y = 0; y < 4; y++) {
        for (x = 0; x < 8; r6++, x++) {
            ...
            (oamAllocated)->all.attr0 = ((r4 + ((y * 8) + s->y))) & 0xFF;

            if (s->frameFlags & ((1) << (10))) {
                (oamAllocated)->all.attr1 = ((((s->x - x * 8 - 8)) & 0x1FF) | ((1) ? 0x1000 : 0));;
            } else {
                (oamAllocated)->all.attr1 = ((((s->x + x * 8 + 0)) & 0x1FF) | ((0) ? 0x1000 : 0));;
            }


            oamAllocated->all.attr2
                = (((oam[2] + s->palId) & 0xF000) | ((((s)->frameFlags & (((3) << (12)))) >> ((12))) << 10) | (((((uintptr_t)((s->graphics.dest)) - (uintptr_t)(u8*)(0x6000000 + 0x10000)) / (32)) + r6)));
