# 0 "src/game/interactables_1/booster.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_1/booster.c"
...
# 2 "src/game/interactables_1/booster.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_1/booster.c" 2
...
# 4 "src/game/interactables_1/booster.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/interactables_1/booster.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "src/game/interactables_1/booster.c" 2
...
# 8 "src/game/interactables_1/booster.c" 2
...
# 9 "src/game/interactables_1/booster.c" 2
...
# 15 "src/game/interactables_1/booster.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/game/interactables_1/booster.c" 2
...
# 58 "src/game/interactables_1/booster.c"
void CreateEntity_Booster(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Booster *booster = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &booster->s;
    u32 value;
...
{
    Sprite_Booster *booster = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &booster->s;
    MapEntity *me = booster->base.me;

    s16 screenX, screenY;

    screenX = ((booster->base.meX)*8 + (booster->base.regionX)*256);
    screenY = ((me->y)*8 + (booster->base.regionY)*256);
    s->x = screenX - gCamera.x;
    s->y = screenY - gCamera.y;

    if (!(gPlayer.moveState & (0x00000080 | 0x00000002))
        ...
        if ((gStageFlags & 0x0080)) {
            if ((s->frameFlags & 0x800) == 0) {
                if ((s->frameFlags & 0x400) == 0) {
                    (gPlayer).moveState |= 0x00000001; if (gPlayer.qSpeedGround > -3072) gPlayer.qSpeedGround = -3072;;
                } else {
                    (gPlayer).moveState &= ~0x00000001; if (gPlayer.qSpeedGround < 3072) gPlayer.qSpeedGround = 3072;;
                }
            } else {
