...
{
    Sprite_GappedLoop *gappedLoop = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    x -= gCamera.x;
    y -= gCamera.y;
    if (((x < -((256 / 2))) || (x > 240 + ((256 / 2))) || ((y) + ((256 / 2)) < 0) || (y > 160 + ((256 / 2))))) {
        me->x = spriteX;
...
{
    struct Task *t = TaskCreate(Task_GappedLoopForwardsMain, sizeof(Sprite_GappedLoop), 0x2000, 0, ((void *)0));
    Sprite_GappedLoop *gappedLoop = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(Task_GappedLoopReverseMain, sizeof(Sprite_GappedLoop), 0x2000, 0, ((void *)0));
    Sprite_GappedLoop *gappedLoop = (void *)(0x03000000 + ((t)->data));
    gappedLoop->base.regionX = spriteRegionX;
    gappedLoop->base.regionY = spriteRegionY;
    gappedLoop->base.me = me;
