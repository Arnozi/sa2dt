...
{
    Sprite_Corkscrew *corkscrew = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct Task *t = TaskCreate(Task_8060D34, sizeof(Sprite_Corkscrew), 0x2000, 0, ((void *)0));
    Sprite_Corkscrew *corkscrew = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(sub_8061088, sizeof(Sprite_Corkscrew), 0x2000, 0, ((void *)0));
    Sprite_Corkscrew *corkscrew = (void *)(0x03000000 + ((t)->data));
    corkscrew->base.regionX = spriteRegionX;
    corkscrew->base.regionY = spriteRegionY;
    corkscrew->base.me = me;
