...
void CreateCharacterSelectionScreen(u8 initialSelection, bool8 allUnlocked)
{
    ...
    characterScreen = (void *)(0x03000000 + ((t)->data));
    ...
    background->layoutVram = (void *)(0x6000000 + (0x800 * (22)));
    background->unk18 = 0;
    background->unk1A = 0;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(0x6000000 + (0x800 * (21)));
    background->unk18 = 0;
    background->unk1A = 0;
    ...
    s->x = 0;
    s->y = 0;
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x400);
    s->graphics.anim = 736;
    s->variant = ((5)*2 + 0);
    s->oamFlags = ((4) << 6);
    s->graphics.size = 0;
    ...
    s->x = 0;
    s->y = 0;
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2580);
    s->graphics.anim = 742;
    s->variant = 0;
    s->oamFlags = ((1) << 6);
    s->graphics.size = 0;
    ...
    s->x = 0;
    s->y = 0;
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x1000);
...
static void Task_FadeInAndStartRollInAnim(void)
{
    struct CharacterSelectionScreen *characterScreen = (void *)(0x03000000 + ((gCurTask)->data));
...
static void Task_CharacterSelectMain(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ({ (characterScreen)->multiplayerSelections = 0; for ((i) = 0; (i) < 4; (i)++) { if ((i) != ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id && (((gMultiplayerConnections) >> ((i))) & 1)) { (packet) = &gMultiSioRecv[(i)]; if ((packet)->pat0.unk0 > 0x4020) { (characterScreen)->multiplayerSelections |= (1 << (packet->pat0.unk2)); } } } });
...
static void Task_HandleCarouselScrollUp(void)
{
    ...
    characterScreen = (void *)(0x03000000 + ((gCurTask)->data));
...
static void Task_MultiplayerWaitForSelections(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        ({ (characterScreen)->multiplayerSelections = 0; for ((i) = 0; (i) < 4; (i)++) { if ((i) != ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id && (((gMultiplayerConnections) >> ((i))) & 1)) { (recv) = &gMultiSioRecv[(i)]; if ((recv)->pat0.unk0 > 0x4020) { (characterScreen)->multiplayerSelections |= (1 << (recv->pat0.unk2)); } } } });
    }
    ...
    for (i = 0; i < 4; i++) {
        if ((((gMultiplayerConnections) >> (i)) & 1) && i != ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id) {
            recv = &gMultiSioRecv[i];

            if (recv->pat0.unk0 == 0x4021 && recv->pat0.unk2 == characterScreen->selectedCharacter && i < ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id) {
                gCurTask->main = Task_CharacterSelectMain;
                m4aSongNumStart(107);
                characterScreen->selectionComplete = 0;
...
static void Task_MultiplayerVerifySelections(void)
{
    ...
    register struct CharacterSelectionScreen *characterScreen = (void *)(0x03000000 + ((gCurTask)->data));
    ({ if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) { u32 i; for (i = 0; i < 4 && (((gMultiplayerConnections) >> (i)) & 1); i++) { if (!(gMultiSioStatusFlags & (0x0001 << (i)))) { if (gMultiplayerMissingHeartbeats[i]++ > 0xB4) { TasksDestroyInPriorityRange(0, 0xFFFF); gBackgroundsCopyQueueCursor = gBackgroundsCopyQueueIndex;; gBgSpritesCount = 0; gVramGraphicsCopyCursor = gVramGraphicsCopyQueueIndex; LinkCommunicationError(); return; } } else { gMultiplayerMissingHeartbeats[i] = 0; } } } });
...
{
    u8 i;
    struct CharacterSelectionScreen *characterScreen = (void *)(0x03000000 + ((t)->data));
