...
void RingsScatterSingleplayer_FlippedGravity(void)
{
    ...
    for (i = 0; i < (signed)(sizeof(rs->rings) / sizeof((rs->rings)[0])); ring++, i++) {
        ...
        if ((screenX + 8) > 0 && screenX + 8 < (240 + (8 * 2)) && screenY > -8
            && screenY < (160 + 8)) {
...
__attribute__((naked)) void RingsScatterMultipak_FlippedGravity(void) { asm(".include " "\"asm/non_matching/game/stage/rings_scatter/RingsScatterMultipak_FlippedGravity.inc\""); if (0)
...
__attribute__((naked)) void RingsScatterMultipak_NormalGravity(void) { asm(".include " "\"asm/non_matching/game/stage/rings_scatter/RingsScatterMultipak_NormalGravity.inc\""); if (0)
{
    RingsScatter *rs = (void *)(0x03000000 + ((gCurTask)->data));
    ScatterRing *ring = &rs->rings[0];
    Sprite *s = &rs->sprRing;
...
__attribute__((naked)) void RingsScatterSinglepakMain(void) { asm(".include " "\"asm/non_matching/game/stage/rings_scatter/RingsScatterSinglepakMain.inc\""); if (0)
