...
static void Task_DrowningCountdown(void)
{
    MultiplayerSpriteTask *ts = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &ts->s;
    ...
    if ((transform->x < -32 || transform->x > 240 + 32) || (transform->y < -32 || transform->y > 160 + 32)
        || (ts->unk10 > 0x80)) {
...
struct Task *SpawnAirBubbles(s32 p0, s32 p1, s32 p2, s32 p3)
{
    if ((s8)gSmallAirBubbleCount > 11) {
        ...
        if (p3 == 0) {
            s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2A40);
            s->graphics.anim = 853;
            s->variant = 0;
        } else {
            s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2AC0);
            s->graphics.anim = 854;
            s->variant = 0;
...
{
    DrownBubbles *db = (void *)(0x03000000 + ((gCurTask)->data));
    Player *p = db->p;
...
struct Task *SpawnBubblesAfterDrowning(Player *p)
{
    ...
    DrownBubbles *db = (void *)(0x03000000 + ((t)->data));
    db->p = p;
