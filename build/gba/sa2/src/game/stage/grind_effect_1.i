# 0 "src/game/stage/grind_effect_1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/grind_effect_1.c"
...
# 2 "src/game/stage/grind_effect_1.c" 2
...
# 3 "src/game/stage/grind_effect_1.c" 2
...
# 4 "src/game/stage/grind_effect_1.c" 2

# 1 "include/malloc_vram.h" 1
# 6 "src/game/stage/grind_effect_1.c" 2
# 1 "include/task.h" 1
# 7 "src/game/stage/grind_effect_1.c" 2
...
# 9 "src/game/stage/grind_effect_1.c" 2
# 1 "include/constants/anim_sizes.h" 1
# 10 "src/game/stage/grind_effect_1.c" 2
...
struct Task *CreateGrindEffect()
{
    ...
    GrindEffect *spark = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &spark->s;
...
void Task_GrindEffect(void)
{
    ...
    } else if ((p->anim == 55) && (p->variant == 0)) {

        GrindEffect *spark = (void *)(0x03000000 + ((gCurTask)->data));
        Sprite *s = &spark->s;
