...
struct Task *sSuperSonicTask = ((void *)0);
...
void SuperSonicInit()
{
    ...
    t = TaskCreate(Task_802BC10, sizeof(struct SuperSonic), 0x4040, 0, ((void *)0));
    sSuperSonicTask = t;
    sonic = (void *)(0x03000000 + ((t)->data));
    ...
    spr = &sonic->spr;
    spr->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000));
...
void sub_802B81C(void)
{
    ...
    sonic = (void *)(0x03000000 + ((sSuperSonicTask)->data));
...
{
    struct SuperSonic *sonic = (void *)(0x03000000 + ((sSuperSonicTask)->data));
...
static void Task_802BC10(void)
{
    struct SuperSonic *sonic = (void *)(0x03000000 + ((gCurTask)->data));
    sub_802BCCC(sonic);
    sonic->func24(sonic);
    sub_802C9B0(sonic);
    sub_802B8A8(sonic);
...
__attribute__((naked)) void sub_802BCCC(struct SuperSonic *sonic) { asm(".include " "\"asm/non_matching/game/super_sonic__sub_802BCCC.inc\""); if (0)
{
    s32 ssx, ssx2;
    u8 i;
    u8 *id;
...
static void sub_802C8A0(struct SuperSonic *sonic)
{
    ...
    x = ((s32)((gCamera.x + (240 + 76))*256));
    y = ((s32)((gCamera.y + (160 / 2))*256));
...
static void sub_802C8EC(struct SuperSonic *sonic)
{
    ...
    if ((((int)((sonic->worldY) >> 8)) - gCamera.y) > 160) {
...
static void sub_802C9B0(struct SuperSonic *sonic)
{
    if (!(sonic->flags & (0x20 | 0x10))) {
        ...
        ({ if ((sonic->worldY) < (((s32)((50)*256)))) { sonic->worldY = (((s32)((50)*256))); } if ((sonic->worldY) > (((s32)((254)*256)))) { sonic->worldY = (((s32)((254)*256))); } });
