...
static struct Task *sDebugUITask = ((void *)0);
...
struct Task *Debug_CreateAsciiTask(s16 x, s16 y)
{
    ...
    DebugTextPrinter *printer = (void *)(0x03000000 + ((t)->data));
    u32 i;
...
{
    Sprite *digits = (Sprite *)&(((DebugTextPrinter *)(void *)(0x03000000 + ((sDebugUITask)->data)))->chars[('0') - '!']);
    s32 base = 10;
    u32 remaining = 1;
    u32 numDigits;
    u32 digitX;
...
void Debug_PrintTextAt(char *text, s16 x, s16 y)
{
    ...
    Sprite *baseChar = (Sprite *)&(((DebugTextPrinter *)(void *)(0x03000000 + ((sDebugUITask)->data)))->chars[('\000') - '!']);
    u8 i;
