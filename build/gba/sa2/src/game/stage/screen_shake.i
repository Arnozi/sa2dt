# 0 "src/game/stage/screen_shake.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/screen_shake.c"
...
# 2 "src/game/stage/screen_shake.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/stage/screen_shake.c" 2
# 1 "include/trig.h" 1
...
# 4 "src/game/stage/screen_shake.c" 2
...
# 6 "src/game/stage/screen_shake.c" 2
...
# 8 "src/game/stage/screen_shake.c" 2
...
# 9 "src/game/stage/screen_shake.c" 2
...
# 10 "src/game/stage/screen_shake.c" 2
...
void Task_ScreenShake(void)
{
    ScreenShake *shake = (void *)(0x03000000 + ((gCurTask)->data));
...
struct Task *CreateScreenShake(u32 p0, u32 p1, u32 p2, u32 p3, u32 flags)
{
    ...
    ScreenShake *shake = (void *)(0x03000000 + ((t)->data));
    shake->p0 = p0;
    shake->p1 = p1;
    shake->p2 = p2;
    shake->unk14 = 0;
