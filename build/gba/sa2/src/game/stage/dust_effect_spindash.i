...
struct Task *CreateSpindashDustEffect()
{
    ...
    DustEffect *sde = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &sde->s;
...
void Task_SpindashDustEffect(void)
{
    ...
    if (p->spriteTask == ((void *)0) || (p->moveState & (0x00000400 | 0x00000080)) != 0x00000400) {
        ...
        DustEffect *sde = (void *)(0x03000000 + ((gCurTask)->data));
        Sprite *s = &sde->s;
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
            struct Task *t = gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id];
