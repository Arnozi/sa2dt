# 0 "src/game/stage/item_tasks.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/item_tasks.c"
...
# 2 "src/game/stage/item_tasks.c" 2
...
void VramFree(void *);
# 3 "src/game/stage/item_tasks.c" 2
...
# 4 "src/game/stage/item_tasks.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/stage/item_tasks.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "src/game/stage/item_tasks.c" 2
...
# 8 "src/game/stage/item_tasks.c" 2
...
# 10 "src/game/stage/item_tasks.c" 2
...
# 11 "src/game/stage/item_tasks.c" 2
...
# 12 "src/game/stage/item_tasks.c" 2
...
# 13 "src/game/stage/item_tasks.c" 2
...
# 15 "src/game/stage/item_tasks.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/game/stage/item_tasks.c" 2
...
struct Task *CreateItemTask_Shield_Normal(s8 p0)
{
    ...
    ItemTask *item = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &item->s;
...
struct Task *CreateItemTask_Shield_Magnetic(s8 p0)
{
    ...
    ItemTask *item = (ItemTask *)(void *)(0x03000000 + ((t)->data));

    item->unk30 = p0;

    {
        ItemTask *item2 = (ItemTask *)(void *)(0x03000000 + ((t)->data));
        Sprite *s = &item2->s;
...
void Task_Item_Shield_Normal(void)
{
    s8 param = ({ ItemTask *it = (void *)(0x03000000 + ((gCurTask)->data)); it->unk30; });

    ItemTask *item = (void *)(0x03000000 + ((gCurTask)->data));
    struct Camera *cam = &gCamera;

    u32 itemEffect = (gPlayer.itemEffect & (0x02 | 0x01));
    if (itemEffect != 0x01) {
    ...
    if (!(gPlayer.itemEffect & 0x02)) {
        ...
        screenX = ((int)((gPlayer.qWorldX) >> 8)) - cam->x;
        item->s.x = screenX + gPlayer.unk7C;

        screenY = ((int)((gPlayer.qWorldY) >> 8)) - cam->y;
        item->s.y = screenY;

        item->s.frameFlags &= ~((3) << (12));
        item->s.frameFlags |= gPlayer.spriteInfoBody->s.frameFlags & ((3) << (12));
        ...
        asm("" : "=r"(itemEffect));
# 195 "src/game/stage/item_tasks.c"
...
# 217 "src/game/stage/item_tasks.c"
void Task_Item_Shield_Magnetic(void)
{
    s8 param = ({ ItemTask *it = (void *)(0x03000000 + ((gCurTask)->data)); it->unk30; });
    ...
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
        u32 itemEffect = (gPlayer.itemEffect & (0x08 | 0x02));
...
__attribute__((unused)) void Task_802ABC8(void)
{
    ...
    if (s->frameFlags & ((1) << (14))) {
        ...
        if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))) {
            screenX = ((int)((gPlayer.qWorldX) >> 8)) + gPlayer.unk7C;

            screenY = ((int)((gPlayer.qWorldY) >> 8));

            r2 = gPlayer.spriteInfoBody->s.frameFlags & ((3) << (12));
        }
...
void Task_Item_Invincibility(void)
{
    s32 param = ({ ItemTask *it = (void *)(0x03000000 + ((gCurTask)->data)); it->unk30; });
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        MultiplayerPlayer *mpp = (void *)(0x03000000 + ((gMultiplayerPlayerTasks[(s8)param])->data));
    ...
    } else if ((gPlayer.itemEffect & 0x02) == 0) {
        TaskDestroy(gCurTask);
        return;
    } else {

        x = ((int)((gPlayer.qWorldX) >> 8)) + gPlayer.unk7C;
...
void Task_Item_Confusion(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        MultiplayerPlayer *mpp = (void *)(0x03000000 + ((gMultiplayerPlayerTasks[param])->data));
