# 0 "src/game/stage/mp_sprite_task.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/mp_sprite_task.c"
...
# 2 "src/game/stage/mp_sprite_task.c" 2
...
void VramFree(void *);
# 3 "src/game/stage/mp_sprite_task.c" 2
...
# 4 "src/game/stage/mp_sprite_task.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/stage/mp_sprite_task.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/stage/mp_sprite_task.c" 2
...
# 8 "src/game/stage/mp_sprite_task.c" 2
...
# 9 "src/game/stage/mp_sprite_task.c" 2
...
# 10 "src/game/stage/mp_sprite_task.c" 2
...
# 11 "src/game/stage/mp_sprite_task.c" 2
...
# 12 "src/game/stage/mp_sprite_task.c" 2
...
# 13 "src/game/stage/mp_sprite_task.c" 2
...
# 14 "src/game/stage/mp_sprite_task.c" 2
...
# 16 "src/game/stage/mp_sprite_task.c" 2


const u16 sAnimData_StageGoalScoreBonus[][3] = {
    { 36, 871, 1 }, { 36, 871, 2 }, { 36, 871, 3 },
    { 36, 871, 4 }, { 36, 871, 5 },
};
...
struct Task *CreateMultiplayerSpriteTask(s16 x, s16 y, u8 param2, s8 param3, TaskMain main, TaskDestructor dtor)
{
    ...
    MultiplayerSpriteTask *strc = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &strc->s;
            ...
            switch (ts->unk14 & 0x30) {
                case 0x20: {
                    ...
                    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
                        ...
                        s8 id = ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id;

                        struct Task *tmpp = gMultiplayerPlayerTasks[id];
                        MultiplayerPlayer *mpp = (void *)(0x03000000 + ((tmpp)->data));
...
# 193 "src/game/stage/mp_sprite_task.c"
...
void CreateGrindEffect2(void)
{
    ...
    if ((gStageTime & 0x7) == 0) {
        ...
        x = ((int)((yInverted * ((int)(((gSineTable[(p->rotation * 4)])) >> 6))) >> 8));
        y = ((int)((yInverted * ((int)(((gSineTable[(p->rotation * 4) + 256])) >> 6))) >> 8));
