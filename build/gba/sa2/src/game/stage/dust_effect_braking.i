...
struct Task *CreateBrakingDustEffect(s32 x, s32 y)
{
    if (gDustEffectBrakingTask.t == ((void *)0) || gDustEffectBrakingTask.unk0 == 0) {
        ...
        if (p->moveState & 0x08000000) {
            ...
            s->graphics.dest = ((void *)(u8*)(0x6000000 + 0x10000) + 0x2300);
            s->graphics.anim = 848;
            s->variant = 0;
            s->frameFlags = ((2) << (12));
...
void Task_BrakingDustEffect(void)
{
    ...
    BrakeDustEffect *bde = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &bde->s;
...
{
    BrakeDustEffect *bde = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &bde->s;
