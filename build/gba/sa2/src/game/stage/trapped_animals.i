...
static void CreateFlyingAnimal(SpawnOptions *init)
{
    ...
    FlyingAnimal *animal = (void *)(0x03000000 + ((t)->data));
    Sprite *s;
    ...
    s->x = init->x;
    s->y = init->y;
    s->graphics.dest = (void *)(u8*)(0x6000000 + 0x10000) + (init->vramOffset * 32);
    s->oamFlags = ((17) << 6);
    s->graphics.size = 0;
...
static void Task_FlyingAnimal(void)
{
    FlyingAnimal *animal = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &animal->s;
    ...
    x += Div((gSineTable[(animal->unk38 & (1024 - 1)) + 256]), 20) >> 3;
    y += Div((gSineTable[(animal->unk38 & (1024 - 1))]), 20) >> 1;
    ...
    if (((s->x < -(32)) || (s->x > 240 + (32)) || ((s->y) + (32) < 0) || (s->y > 160 + (32)))) {
...
static void CreateBouncingAnimal(SpawnOptions *init)
{
    ...
    BouncingAnimal *animal = (void *)(0x03000000 + ((t)->data));
    Sprite *s;
    animal->x = ((s32)((init->x)*256));
    animal->y = ((s32)((init->y)*256));
...
static void Task_BouncingAnimal(void)
{
    BouncingAnimal *animal = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &animal->s;
    s32 y;
    ...
    if (animal->inAirTimer > 0) {
        ...
        s32 clampedY = y + ((s32)((sub_801F07C(((int)((animal->y) >> 8)), ((int)((animal->x) >> 8)), 1, 8, ((void *)0), sub_801EE64))*256));
...
static void CreateStaticAnimal(SpawnOptions *init)
{
    ...
    StaticAnimal *animal = (void *)(0x03000000 + ((t)->data));
    Sprite *s;
    animal->x = ((s32)((init->x)*256));
    animal->y = ((s32)((init->y)*256));
...
static void Task_StaticAnimalMain(void)
{
    StaticAnimal *animal = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &animal->s;
    s32 y;
