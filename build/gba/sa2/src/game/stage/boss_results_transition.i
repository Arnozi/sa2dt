# 0 "src/game/stage/boss_results_transition.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/stage/boss_results_transition.c"
...
# 2 "src/game/stage/boss_results_transition.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/stage/boss_results_transition.c" 2
# 1 "include/flags.h" 1
# 4 "src/game/stage/boss_results_transition.c" 2
# 1 "include/task.h" 1
# 5 "src/game/stage/boss_results_transition.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "src/game/stage/boss_results_transition.c" 2
...
# 7 "src/game/stage/boss_results_transition.c" 2
...
# 8 "src/game/stage/boss_results_transition.c" 2
...
# 10 "src/game/stage/boss_results_transition.c" 2
...
# 11 "src/game/stage/boss_results_transition.c" 2
...
# 12 "src/game/stage/boss_results_transition.c" 2
...
# 13 "src/game/stage/boss_results_transition.c" 2
...
# 14 "src/game/stage/boss_results_transition.c" 2
...
# 15 "src/game/stage/boss_results_transition.c" 2

# 1 "include/constants/songs.h" 1
# 17 "src/game/stage/boss_results_transition.c" 2
...
{
    StageResultsInit *sri = (void *)(0x03000000 + ((gCurTask)->data));
    ScreenFade *ts = &sri->ts;

    if (UpdateScreenFade(ts) == 1) {
        ...
        if ((gSelectedCharacter == CHARACTER_SONIC) && gLoadedSaveGame->unlockedLevels[CHARACTER_SONIC] <= gCurrentLevel) {
            switch (((gCurrentLevel) >> 2)) {
                ...
                case 2: {
                    CreateStageResultsCutscene(1);
                } break;

                case 4: {
                    CreateStageResultsCutscene(2);
                } break;
...
void Task_802EE78(void)
{
    ...
    if (++sri->unk10 > 8) {
        ts->brightness = ((s32)((0)*256));
        ts->flags = 2;
        ts->speed = 0;
        ts->bldCnt = ((2 << 6) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5)));
        ts->bldAlpha = 0;

        if (gCurrentLevel != ((6)*(3 + 1)) + (2)) {
            gFlags &= ~0x4;
        }
        ...
        if (((gCurrentLevel) == ((7)*(3 + 1)) + (0))) {
            ...
            if (gCheese != ((void *)0)) {
                gCheese->posX += ((s32)((x)*256));
                gCheese->posY += ((s32)((y)*256));
            }
...
{
    struct Task *t = TaskCreate(Task_802EE78, sizeof(StageResultsInit), 0x6080, 0, ((void *)0));
    StageResultsInit *sri = (void *)(0x03000000 + ((t)->data));
    ScreenFade *ts = &sri->ts;
    ...
    ts->window = 0;
    ts->brightness = ((s32)((8.0)*256));
    ts->flags = 1;
    ts->speed = ((s32)((3. / 4.)*256));
    ts->bldCnt = ((2 << 6) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5)));
    ts->bldAlpha = 0;
...
void InitHBlankBgOffsets(u16 xOffset)
{
    if (gBgOffsetsHBlankPrimary == &gBgOffsetsBuffer) {
        ...
        { vu16 tmp = (vu16)(xOffset); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(&gBgOffsetsBuffer[0][0]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[0]))/(16/8)))); dmaRegs[2]; }; };

    } else {



        { vu16 tmp = (vu16)(xOffset); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(&gBgOffsetsBuffer[1][0]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer[1]))/(16/8)))); dmaRegs[2]; }; };
