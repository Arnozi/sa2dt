# 0 "src/game/sa1_sa2_shared/pause_menu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/pause_menu.c"
...
# 2 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 5 "src/game/sa1_sa2_shared/pause_menu.c" 2
# 1 "include/malloc_vram.h" 1
# 6 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 8 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 10 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 11 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 12 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 13 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
# 15 "src/game/sa1_sa2_shared/pause_menu.c" 2
# 1 "include/flags.h" 1
# 16 "src/game/sa1_sa2_shared/pause_menu.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/sa1_sa2_shared/pause_menu.c" 2
# 1 "include/constants/text.h" 1
# 18 "src/game/sa1_sa2_shared/pause_menu.c" 2
...
void CreatePauseMenu(void)
{
    ...
    if (!(gStageFlags & 0x0020)) {
        ...
        if (vramTiles != ewram_end) {
            ...
            PauseMenu *pm = (void *)(0x03000000 + ((t)->data));
            Sprite *s = &pm->s;
...
{
    PauseMenu *pm = (void *)(0x03000000 + ((gCurTask)->data));


    if ((gReleasedKeys & 0x0001) && (pm->flags & 0x2)) {
        pm->flags = 0x1;
    } else if ((gPressedKeys & 0x0008) || ((pm->cursor == 0) && (gReleasedKeys & 0x0001))
               || ((gGameMode != 0) && (gPressedKeys & 0x0002))) {

        gFlags &= ~0x400;
        m4aMPlayContinue(gMPlayTable[0].info);
        TaskDestroy(gCurTask);
        return;
    } else if ((gGameMode != 0) && (gReleasedKeys & 0x0001)) {
        gFlags &= ~0x400;
        m4aSongNumStart(106);
        ...
        return;
    } else if ((gGameMode == 0) && (pm->cursor != 0) && (gReleasedKeys & 0x0001)) {
        gFlags &= ~0x400;
        m4aSongNumStart(106);
    ...
    if ((gRepeatedKeys & 0x0040) && (pm->cursor != 0)) {
        pm->cursor = 0;
        m4aSongNumStart(108);
    } else if ((gRepeatedKeys & 0x0080) && pm->cursor == 0) {
        pm->cursor = 1;
        m4aSongNumStart(108);
    }
    ...
    if (pm->cursor != 0) {
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal6A); dmaRegs[1] = (vu32)(&(((u16 *)((u16 *)(0x5000000 + 0x200)))[249])); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8)))); dmaRegs[2]; };
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal64); dmaRegs[1] = (vu32)(&(((u16 *)((u16 *)(0x5000000 + 0x200)))[252])); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8)))); dmaRegs[2]; };

        if (gWater.isActive == 1) {
            u16 *somePalette = (void *)(0x03000000 + ((gWater.t)->data));

            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal6A); dmaRegs[1] = (vu32)(&somePalette[249]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8)))); dmaRegs[2]; };
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal64); dmaRegs[1] = (vu32)(&somePalette[252]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8)))); dmaRegs[2]; };
        }
    } else {
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal6A); dmaRegs[1] = (vu32)(&(((u16 *)((u16 *)(0x5000000 + 0x200)))[252])); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8)))); dmaRegs[2]; };
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal64); dmaRegs[1] = (vu32)(&(((u16 *)((u16 *)(0x5000000 + 0x200)))[249])); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8)))); dmaRegs[2]; };

        if (gWater.isActive == 1) {
            u16 *somePalette = (void *)(0x03000000 + ((gWater.t)->data));

            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal6A); dmaRegs[1] = (vu32)(&somePalette[252]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8)))); dmaRegs[2]; };
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(pm->pal64); dmaRegs[1] = (vu32)(&somePalette[249]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8)))); dmaRegs[2]; };
        }
    }
...
void Task_PauseMenuInit(void)
{
    ...
    gFlags |= 0x400;
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gObjPalette[(15)*16u + (+9)]); dmaRegs[1] = (vu32)(pm->pal64); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal64))/(16/8)))); dmaRegs[2]; };
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gObjPalette[(15)*16u + (+12)]); dmaRegs[1] = (vu32)(pm->pal6A); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(pm->pal6A))/(16/8)))); dmaRegs[2]; };
...
{
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&Tileset_zone_1_act_1_fg[(4 * 16 * 32) / sizeof(u16)]); dmaRegs[1] = (vu32)((void *)((u8*)(0x6000000 + 0x14000) + 0x3EC0)); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x140)/(16/8)))); dmaRegs[2]; };

    gObjPalette[(0)*16u + (1)] = ((31) | ((31) << 5) | ((31) << 10));
    gFlags |= 0x2;
    gFlags &= ~0x400;
}
