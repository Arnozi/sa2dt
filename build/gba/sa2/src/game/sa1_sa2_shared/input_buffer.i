# 0 "src/game/sa1_sa2_shared/input_buffer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/input_buffer.c"
...
# 2 "src/game/sa1_sa2_shared/input_buffer.c" 2
...
# 3 "src/game/sa1_sa2_shared/input_buffer.c" 2
...
# 5 "include/game/sa1_sa2_shared/input_buffer.h" 2
...
# 4 "src/game/sa1_sa2_shared/input_buffer.c" 2
...
# 7 "src/game/sa1_sa2_shared/input_buffer.c" 2
...
const u8 *unk_8C87198[3] = { gUnkMusicMgrData, gUnknown_080D5262, ((void *)((intptr_t)-1)) };




const u8 *unk_8C871A4[3] = { gUnknown_080D5270, gUnknown_080D527E, ((void *)((intptr_t)-1)) };

const u8 *unk_8C871B0[3] = { gUnknown_080D528C, gUnknown_080D529A, ((void *)((intptr_t)-1)) };

const u8 *unk_8C871BC[3] = { gUnknown_080D52A8, gUnknown_080D52B6, ((void *)((intptr_t)-1)) };

const u8 *unk_8C871C8[3] = { gUnknown_080D52C4, gUnknown_080D52D2, ((void *)((intptr_t)-1)) };
...
void InputBuffer_HandleFrameInput(Player *p)
{
    ...
    if (p->moveState & (0x00200000 | 0x00000080)) {
...
void InputBuffer_NewFrameInput(u16 frameInputs1, u16 frameInputs2)
{
    ...
    r5 &= frameInputs2;
    r5 = (r5) | r3;
    gFrameInputsBufIndex = (gFrameInputsBufIndex + 1) % (sizeof(gFrameInputsBuf) / sizeof((gFrameInputsBuf)[0]));
    gFrameInputsBuf[gFrameInputsBufIndex] = r5;
    r5 |= gFrameInputsBuf[(gFrameInputsBufIndex - 1) % (sizeof(gFrameInputsBuf) / sizeof((gFrameInputsBuf)[0]))];
    r5 |= gFrameInputsBuf[(gFrameInputsBufIndex - 2) % (sizeof(gFrameInputsBuf) / sizeof((gFrameInputsBuf)[0]))];
    r5 &= frameInputs1;
    ...
    if ((gNewInputCounters[gNewInputCountersIndex].unk0 == r5) && (gNewInputCounters[gNewInputCountersIndex].unk1 != 0xFF)) {
        ...
        gNewInputCountersIndex = (gNewInputCountersIndex + 1) % (sizeof(gNewInputCounters) / sizeof((gNewInputCounters)[0]));
...
void InitNewInputCounters(void)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(gNewInputCounters); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gNewInputCounters) - 4)/(32/8)))); dmaRegs[2]; }; };
}
