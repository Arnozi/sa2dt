...
const StagePreInitFunc gSpriteTileInits_PreStageEntry[] = {
    ...
    ((void *)0), ((void *)0), ((void *)0), ((void *)0),
    ((void *)0), ((void *)0), ((void *)0), ((void *)0),
    sub_80807CC, sub_80807CC, ((void *)0), ((void *)0),
    ((void *)0), ((void *)0), ((void *)0), ((void *)0),
    ((void *)0), ((void *)0), ((void *)0), ((void *)0),
    ((void *)0), ((void *)0), ((void *)0), ((void *)0),
    ((void *)0), ((void *)0),
...
void CreateStageEntitiesManager(void)
{
    ...
    if (gGameMode != 5) {
        ...
        t = TaskCreate(Task_8008DCC, sizeof(EntitiesManager), 0x2000, 0, ((void *)0));
    }

    em = (void *)(0x03000000 + ((t)->data));
...
void CreateEnemyDefeatScoreAndManageLives(s16 x, s16 y)
{
    ...
    { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += enemyDefeatScores[gPlayer.defeatScoreIndex]; divResA = Div(gLevelScore, 50000); divResB = Div(oldScore, 50000); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
...
{
    Sprite_Entity *s = (void *)(0x03000000 + ((t)->data));
