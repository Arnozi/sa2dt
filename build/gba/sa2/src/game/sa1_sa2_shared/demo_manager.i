# 0 "src/game/sa1_sa2_shared/demo_manager.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/demo_manager.c"
...
char *strlwr (char *);
char *strupr (char *);
# 2 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
# 4 "src/game/sa1_sa2_shared/demo_manager.c" 2
# 1 "include/core.h" 1
...
# 5 "src/game/sa1_sa2_shared/demo_manager.c" 2
# 1 "include/malloc_vram.h" 1
# 6 "src/game/sa1_sa2_shared/demo_manager.c" 2
# 1 "include/sprite.h" 1
# 7 "src/game/sa1_sa2_shared/demo_manager.c" 2
# 1 "include/task.h" 1
# 8 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
# 12 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
# 13 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
# 17 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
# 18 "src/game/sa1_sa2_shared/demo_manager.c" 2
...
# 20 "src/game/sa1_sa2_shared/demo_manager.c" 2
# 1 "include/constants/anim_sizes.h" 1
# 21 "src/game/sa1_sa2_shared/demo_manager.c" 2
# 32 "src/game/sa1_sa2_shared/demo_manager.c"
typedef struct {
...
void CreateDemoManager(void)
{
    ...
    s->graphics.dest = VramMalloc(((112 / 8) * (16 / 8)));
    s->graphics.size = 0;
    s->graphics.anim = 1044;
    s->variant = 0;
...
void Task_DemoManagerMain(void)
{
    DemoManager *dm = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    } else if (gCheckpointTime > (u32)(int)(((0 * 60.) + 24.5) * 60)) {
        dm->playerPressedStart = 0;
...
# 241 "src/game/sa1_sa2_shared/demo_manager.c"
...
{
    DemoManager *dm = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(Task_DemoManagerMusicFadeout, sizeof(DemoMusicFadeout), 0xFFFE, 0, ((void *)0));
    DemoMusicFadeout *mf = (void *)(0x03000000 + ((t)->data));
    mf->volume = 0x100;
...
void Task_DemoManagerMusicFadeout(void)
{
    DemoMusicFadeout *mf = (void *)(0x03000000 + ((gCurTask)->data));
