# 0 "src/game/sa1_sa2_shared/unused_flash_task.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/unused_flash_task.c"
...
# 2 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
# 1 "include/flags.h" 1
# 4 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
# 1 "include/task.h" 1
# 5 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
...
# 6 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
...
# 7 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
...
# 9 "src/game/sa1_sa2_shared/unused_flash_task.c" 2
...
void CreateUnusedFlashTask(void)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x6000000); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((2 * 32)/(32/8)))); dmaRegs[2]; }; };
...
void Task_UnusedFlashTask(void)
{
    RenderText((void *)(0x6000000 + 1 * 32), &Tileset_DebugAscii, 1, 10, 2, sTxtFlash, 0);
