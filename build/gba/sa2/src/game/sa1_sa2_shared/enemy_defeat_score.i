# 0 "src/game/sa1_sa2_shared/enemy_defeat_score.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/enemy_defeat_score.c"
...
# 2 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
...
# 3 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
# 1 "include/task.h" 1
...
# 4 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
# 1 "include/malloc_vram.h" 1
# 5 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
...
# 6 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
...
# 7 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
...
# 9 "src/game/sa1_sa2_shared/enemy_defeat_score.c" 2
...
void CreateEnemyDefeatScore(s16 x, s16 y)
{
    ...
    EnemyDefeatScore *score = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &score->s;
...
void Task_CreateEnemyDefeatScore_MoveUp(void)
{
    EnemyDefeatScore *score = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &score->s;
