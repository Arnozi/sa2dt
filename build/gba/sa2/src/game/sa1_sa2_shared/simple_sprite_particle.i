# 0 "src/game/sa1_sa2_shared/simple_sprite_particle.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/simple_sprite_particle.c"
...
# 2 "src/game/sa1_sa2_shared/simple_sprite_particle.c" 2
...
# 3 "src/game/sa1_sa2_shared/simple_sprite_particle.c" 2
...
# 4 "src/game/sa1_sa2_shared/simple_sprite_particle.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/sa1_sa2_shared/simple_sprite_particle.c" 2
# 1 "include/task.h" 1
# 6 "src/game/sa1_sa2_shared/simple_sprite_particle.c" 2
# 1 "include/malloc_vram.h" 1
# 7 "src/game/sa1_sa2_shared/simple_sprite_particle.c" 2
...
struct Task *CreateSimpleSpriteParticle(u16 taskPrio, void *vramTiles, AnimId anim, u8 variant, TaskDestructor dtor)
{
    ...
    Sprite_StageSprUnknown *su = (void *)(0x03000000 + ((t)->data));
    su->x = 0;
    su->y = 0;
    su->speedX = 0;
    su->speedY = 0;
...
void Task_SimpleSpriteParticleMain(void)
{
    Sprite_StageSprUnknown *su = (void *)(0x03000000 + ((gCurTask)->data));
    su->speedX += su->accX;
    su->speedY += su->accY;
    ...
    su->s.x = ((int)((su->x) >> 8)) - gCamera.x;
    su->s.y = ((int)((su->y) >> 8)) - gCamera.y;

    if (su->lifeTime != 0) {
        su->lifeTime--;
    }

    if (((u16)(su->s.x + 32) > (240 + 2 * 32)) || (((su->s.y - 32) > 160))) {
