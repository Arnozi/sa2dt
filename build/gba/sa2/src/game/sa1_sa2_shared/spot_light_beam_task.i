# 0 "src/game/sa1_sa2_shared/spot_light_beam_task.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/spot_light_beam_task.c"
...
# 2 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
# 1 "include/flags.h" 1
# 4 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
...
# 6 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
# 1 "include/task.h" 1
# 7 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
# 1 "include/trig.h" 1
...
# 8 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2

# 1 "include/game/sa1_sa2_shared/spot_light_beam_task.h" 1
...
# 10 "src/game/sa1_sa2_shared/spot_light_beam_task.c" 2
...
struct Task *CreateSpotlightBeamTask(void)
{
    ...
    SpotlightBeamTask *beam = (void *)(0x03000000 + ((t)->data));
...
__attribute__((naked)) void Task_SpotlightBeamTask(void) { asm(".include " "\"asm/non_matching/game/stage/Task_SpotlightBeamTask.inc\""); if (0)
{
    TriParam1 sp8;
    Struct_SP10 sp10;
    Struct_SP10 sp14;
    ...
    SpotlightBeamTask *beam = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    sp18 = 0x3FF;
    temp_r0_3 = beam->unk6 - ((int)((Div((((int)(((gSineTable[(temp_r5)])) >> 6)) << 8), ((int)(((gSineTable[(temp_r5) + 256])) >> 6))) * beam->unk8) >> 8));
    sp10.unk0 = temp_r0_3;
    temp_r0_4 = temp_r0_3;
    if ((s32)temp_r0_4 <= 0) {
        sp10.unk0 = 0;
        if (temp_r5 > 0xFFU) {
            ...
            var_r0_2 = Div((((int)(((gSineTable[(temp_r1_2)])) >> 6)) << 8), ((int)(((gSineTable[(temp_r1_2) + 256])) >> 6)));
            var_r1 = beam->unk6;
            goto block_16;
        }
        temp_r1_3 = (0x100 - temp_r5) & 0x3FF;
        sp10.unk2 = (s16)(beam->unk8 - ((int)((Div((((int)(((gSineTable[(temp_r1_3)])) >> 6)) << 8), ((int)(((gSineTable[(temp_r1_3) + 256])) >> 6))) * beam->unk6) >> 8)));
    } else if ((s32)temp_r0_4 > (240 - 1)) {
        sp10.unk0 = 240;
        if (temp_r5 > 0xFFU) {
    ...
    if (beam->unk0 <= 0x1FFU) {
        ...
        if (sp10.unk2 > (160 - 1)) {
            if (1 & beam->bg) {
                gWinRegs[3] = (((sp8.unk5) << 8) | (160));
            } else {
                gWinRegs[2] = (((sp8.unk5) << 8) | (160));
            }
    ...
    if (sp10.unk2 <= (160 - 1)) {
        if (sp14.unk2 > (160 - 1)) {
            if (beam->bg & 0x1) {
                gWinRegs[3] = (((sp8.unk1) << 8) | (160));
            } else {
                gWinRegs[2] = (((sp8.unk1) << 8) | (160));
            }
...
void TaskDestructor_SpotlightBeamTask(struct Task *t) { gFlags &= ~0x4; }
