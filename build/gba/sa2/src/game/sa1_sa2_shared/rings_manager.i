# 0 "src/game/sa1_sa2_shared/rings_manager.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/rings_manager.c"
...
char *strlwr (char *);
char *strupr (char *);
# 2 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 3 "src/game/sa1_sa2_shared/rings_manager.c" 2
# 1 "include/core.h" 1
...
# 4 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
void EwramFree(void *);
# 5 "src/game/sa1_sa2_shared/rings_manager.c" 2
# 1 "include/rect.h" 1
...
# 6 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 8 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 11 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 13 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 14 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 16 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 18 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 20 "src/game/sa1_sa2_shared/rings_manager.c" 2
...
# 50 "src/game/sa1_sa2_shared/rings_manager.c"
...
void CreateStageRingsManager(void)
{
    ...
    *mgrRings = ewramBuffer;
    ...
    s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x1F00);
    s->oamFlags = ((20) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 726;
    s->variant = 0;
...

{
    ...
    if (!(gStageFlags & 0x0002)) {
        ...
        if (((gCurrentLevel) == ((7)*(3 + 1)) + (1))) {
            u32 res = SuperSonicGetFlags() & (0x200 | 0x10 | 0x8 | 0x4);
            sp08 = 1;
                        ...
                        if (meRing->x != (u8)(-2)) {
                            ...
                            if (sp08 != 0
                                ...
                                if (((((rx - 8) <= (((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left) && (rx + 8) >= (((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left)) || ((rx - 8) >= (((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left) && ((((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left) + (((Rect8 *)rect)->right - ((Rect8 *)rect)->left)) >= (rx - 8))) && ((((ry - (8 * 2)) <= (((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top) && ry >= (((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top)) || ((ry - (8 * 2)) >= (((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top) && ((((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top) + (((Rect8 *)rect)->bottom - ((Rect8 *)rect)->top)) >= (ry - (8 * 2))))))) {
                                    ...
                                    { s32 prevLives, newLives; u16 oldRings = gRingCount; gRingCount = oldRings + (1); if (!(((gCurrentLevel) == ((7)*(3 + 1)) + (1)))) { newLives = Div(gRingCount, 100); prevLives = Div(oldRings, 100); if ((newLives != prevLives) && (gGameMode == 0)) { u16 lives = gNumLives + 1; gNumLives = ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); gMusicManagerState.unk3 = 0x10 | 0x0; } } };
# 259 "src/game/sa1_sa2_shared/rings_manager.c"
        ...
        if (gPlayer.itemEffect & 0x08 && gGameMode != 5) {
            for (; ((0)*8 + (regionY)*256) < gCamera.y + 160 && regionY < v_regionCount; regionY++) {

                while (0)
                    ;

                for (regionX = ((gCamera.x) >> 8); ((0)*8 + (regionX)*256) < gCamera.x + 240; regionX++) {
                    u32 offset = (*((u32 *)((((u8 *)(rings)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
...
{
    void *rings = *(void **)((void *)(0x03000000 + ((t)->data)) + ((size_t)&((RingsManager *)0)->rings));
    EwramFree(rings);
}
