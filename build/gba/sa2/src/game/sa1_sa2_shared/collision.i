...
bool32 Coll_Player_Enemy_Attack(Sprite *s, s32 sx, s32 sy, u8 hbIndex)
{
    ...
    eb = (void *)(0x03000000 + ((gCurTask)->data));
...
__attribute__((naked)) u32 sub_800D0A0(Sprite *s, s16 param1, s16 param2, s16 param3, s16 param4, u8 param5, u32 param6) { asm(".include " "\"asm/non_matching/game/sa1_sa2_shared/collision__sub_800D0A0.inc\""); if (0)
