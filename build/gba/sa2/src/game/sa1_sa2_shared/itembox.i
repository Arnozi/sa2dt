# 0 "src/game/sa1_sa2_shared/itembox.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/itembox.c"
...
# 2 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/task.h" 1
# 6 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/trig.h" 1
...
# 7 "src/game/sa1_sa2_shared/itembox.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/sa1_sa2_shared/itembox.c" 2
...
# 10 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/game/sa1_sa2_shared/dust_cloud.h" 1



void CreateDustCloud(s16 x, s16 y);
# 11 "src/game/sa1_sa2_shared/itembox.c" 2
...
# 13 "src/game/sa1_sa2_shared/itembox.c" 2
...
# 14 "src/game/sa1_sa2_shared/itembox.c" 2
...
# 18 "src/game/sa1_sa2_shared/itembox.c" 2
...
# 19 "src/game/sa1_sa2_shared/itembox.c" 2
...
# 21 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/constants/char_states.h" 1
# 22 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/constants/items.h" 1
# 23 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/constants/player_transitions.h" 1
# 24 "src/game/sa1_sa2_shared/itembox.c" 2
# 1 "include/constants/songs.h" 1
# 25 "src/game/sa1_sa2_shared/itembox.c" 2
...
const u16 ItemBox_MysteryIcons[13][3] = {
    ...
    [2] = { 725, 6, 4 }, [3] = { 725, 7, 4 },
    [4] = { 725, 8, 4 }, [5] = { 725, 9, 4 },
    [6] = { 725, 10, 4 }, [7] = { 725, 11, 4 },
    [8] = { 725, 13, 4 }, [9] = { 725, 14, 4 },
    [10] = { 725, 15, 4 }, [11] = { 725, 16, 4 },
    [12] = { 725, 12, 4 },
};

const u16 ItemBox_1UpIcons[5][3] = {
    { 725, CHARACTER_SONIC, 4 }, { 725, CHARACTER_CREAM, 4 },
    { 725, CHARACTER_TAILS, 4 }, { 725, CHARACTER_KNUCKLES, 4 },
    { 725, CHARACTER_AMY, 4 },
};

const u16 ItemBox_randTypeTable[8] = { 5, 13, 4, 13,
                                       3, 13, 6, 13 };

const u16 ItemBox_subRandTypeTable[] = { 8, 9, 10, 11 };
...
void CreateEntity_ItemBox(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    itembox = (void *)(0x03000000 + ((t)->data));
    itembox->kind = me->index;
    itembox->iconOffset = 0;
    itembox->x = ((me->x)*8 + (spriteRegionX)*256);
    itembox->y = ((me->y)*8 + (spriteRegionY)*256);
...
{
    if (itembox->noPlayerBreakRecoil != 1 || gPlayer.moveState & 0x00000002) {
...
# 192 "src/game/sa1_sa2_shared/itembox.c"
void ApplyItemboxEffect(Entity_ItemBox *itembox)
{
    ...
    switch (itembox->kind) {
        ...
        case 3: {
            ...
            if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) || !(gPlayer.itemEffect & 0x02)) {
        ...
        case 5: {
            s32 rnd = ItemBox_ringAmountTable[(u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % (sizeof(ItemBox_ringAmountTable) / sizeof((ItemBox_ringAmountTable)[0]))];
# 271 "src/game/sa1_sa2_shared/itembox.c"
            rings = &gRingCount;
            oldRingCount = *rings;
            newRingCount = *rings + rnd;
            { gRingCount = newRingCount; if (gCurrentLevel != ((7)*(3 + 1)) + (1)) { s32 newLivesCount = Div(gRingCount, 100); if (newLivesCount != Div(oldRingCount, 100) && (gGameMode == 0)) { u32 newLives = gNumLives; if (++newLives > 255) { newLives = 255; } gNumLives = newLives; gMusicManagerState.unk3 = 16; } } if (gGameMode == 5) { if (gRingCount > 255) { gRingCount = 255; } } m4aSongNumStart(117); };
        } break;
        ...
        case 8: {
            ...
            for (playerId = 0; playerId < 4 && gMultiplayerPlayerTasks[playerId] != ((void *)0); playerId++) {
                MultiplayerPlayer *mpp;
                s32 boxToPlayerX, boxToPlayerY;
                s32 boxToPlayerMagnitude;


                u32 sioId = (((volatile struct SioMultiCnt *)(0x4000000 + 0x128)))->id;
                if (playerId == sioId)
                    continue;

                mpp = (void *)(0x03000000 + ((gMultiplayerPlayerTasks[playerId])->data));
                boxToPlayerX = ((((int)((gPlayer.qWorldX) >> 8)) - mpp->pos.x) * (((int)((gPlayer.qWorldX) >> 8)) - mpp->pos.x));
                boxToPlayerY = ((((int)((gPlayer.qWorldY) >> 8)) - mpp->pos.y) * (((int)((gPlayer.qWorldY) >> 8)) - mpp->pos.y));
...
void Task_ItemBoxMain(void)
{
    Entity_ItemBox *itembox = (void *)(0x03000000 + ((gCurTask)->data));

    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && ((s8)itembox->base.me->x) == (-3)) {
        MultiplayerItemBoxBreak(itembox);
    } else {
        if (CheckItemBoxPlayerCollision(itembox)) {
            BreakItemBox(itembox);
        } else {
            InitItemBoxGraphics(itembox, 0);
        }

        if (CheckItemBoxOutOfBounds(itembox)) {
            { itembox->base.me->x = itembox->base.meX; };
            TaskDestroy(gCurTask);
        } else {
            DrawItemBox(itembox, 0);
        }
    }
}
...
void Task_ItemBoxIconMain_Rising(void)
{
    ...
    if (itembox->frames++ >= 60)
        ...
        itembox->iconOffset += -((s32)((1.0)*256));
    }

    DrawItemBox(itembox, 1);
}
...
{
    Entity_ItemBox *itembox = (void *)(0x03000000 + ((t)->data));
...
void DrawItemBox(Entity_ItemBox *itembox, bool32 disableBox)
{
    ...
    itembox->item.y = (((int)((itembox->iconOffset) >> 8)) + itembox->s.y);
