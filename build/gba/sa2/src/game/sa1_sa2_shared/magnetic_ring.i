# 0 "src/game/sa1_sa2_shared/magnetic_ring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/magnetic_ring.c"
...
# 2 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 3 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
# 1 "include/task.h" 1
...
# 4 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 7 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 8 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 6 "include/game/sa1_sa2_shared/rings_manager.h" 2
...
# 9 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 10 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 11 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
# 13 "src/game/sa1_sa2_shared/magnetic_ring.c" 2
...
void CreateMagneticRing(s16 x, s16 y)
{
    ...
    StageRing *ring = (void *)(0x03000000 + ((t)->data));
    Sprite *s;
...
void Task_MagneticRing(void)
{
    StageRing *ring = (void *)(0x03000000 + ((gCurTask)->data));
    Player *p = &gPlayer;
    ...
    if (((((ringX - 8) <= (((((int)((gPlayer.qWorldX) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].left) && (ringX + 8) >= (((((int)((gPlayer.qWorldX) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].left)) || ((ringX - 8) >= (((((int)((gPlayer.qWorldX) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].left) && (((((((int)((gPlayer.qWorldX) >> 8))))) + (gPlayerBodyPSI.s.hitboxes[0]).left) + ((gPlayerBodyPSI.s.hitboxes[0]).right - (gPlayerBodyPSI.s.hitboxes[0]).left)) >= (ringX - 8))) && ((((ringY - (8 * 2)) <= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].top) && ringY >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].top)) || ((ringY - (8 * 2)) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].top) && ((((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].top) + ((gPlayerBodyPSI.s.hitboxes[0]).bottom - (gPlayerBodyPSI.s.hitboxes[0]).top)) >= (ringY - (8 * 2))))))) {
