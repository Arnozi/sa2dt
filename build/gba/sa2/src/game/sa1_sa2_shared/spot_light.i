# 0 "src/game/sa1_sa2_shared/spot_light.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/spot_light.c"
...
# 2 "src/game/sa1_sa2_shared/spot_light.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/spot_light.c" 2
# 1 "include/task.h" 1
# 4 "src/game/sa1_sa2_shared/spot_light.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/sa1_sa2_shared/spot_light.c" 2
...
# 7 "src/game/sa1_sa2_shared/spot_light.c" 2
...
# 8 "src/game/sa1_sa2_shared/spot_light.c" 2
...
# 9 "src/game/sa1_sa2_shared/spot_light.c" 2
...
# 10 "src/game/sa1_sa2_shared/spot_light.c" 2
...
bool32 CreateSpotLightBeams(void)
{
    ...
    StageSpotLight *spotLight = (void *)(0x03000000 + ((t)->data));
    ...
    beam = (void *)(0x03000000 + ((spotLight->t0)->data));
    beam->unk6 = 60;
    beam->unk8 = 200;
    beam->unk0 = 0;
    beam->unk2 = 32;
    ...
    beam = (void *)(0x03000000 + ((spotLight->t1)->data));
    beam->unk6 = 200;
    beam->unk8 = 240;
    beam->unk0 = 0;
    beam->unk2 = 16;
...
void Task_SpotLightMain(void)
{
    StageSpotLight *spotLight = (void *)(0x03000000 + ((gCurTask)->data));
    SpotlightBeamTask *beam;
    s32 unkC;
    ...
    if (!(gStageFlags & 0x0100)) {
        ...
        if (((gStageTime & 0x7) == 0) && (beam->unkB != 0) && (gDispCnt & 0x0100)) {
        ...
        unkC = spotLight->unkC - ((s32)((2.0)*256));
        spotLight->unkC = unkC - ((int)(((gSineTable[(gStageTime & ((1024 - 1) - 512))])) >> 6));

        gBgScrollRegs[0][0] = ((int)((spotLight->unkC) >> 8)) & 0xFF;
        ...
        gWinRegs[5] = (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4)) & ~(1 << 0);
        ...
        if (gPlayer.moveState & (0x00000080 | 0x08000000)) {
