# 0 "src/game/sa1_sa2_shared/interactables/platform.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/platform.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/platform.c" 2
...
# 4 "src/game/sa1_sa2_shared/interactables/platform.c" 2
# 1 "include/task.h" 1
...
# 5 "src/game/sa1_sa2_shared/interactables/platform.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/sa1_sa2_shared/interactables/platform.c" 2
# 1 "include/malloc_vram.h" 1
# 7 "src/game/sa1_sa2_shared/interactables/platform.c" 2
...
# 9 "src/game/sa1_sa2_shared/interactables/platform.c" 2
...
# 6 "include/game/sa1_sa2_shared/interactables/platform.h" 2
...
# 10 "src/game/sa1_sa2_shared/interactables/platform.c" 2
...
# 14 "src/game/sa1_sa2_shared/interactables/platform.c" 2
...
# 16 "src/game/sa1_sa2_shared/interactables/platform.c" 2
# 1 "include/constants/interactables.h" 1
# 17 "src/game/sa1_sa2_shared/interactables/platform.c" 2
...
void CreateEntity_Platform(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Platform *platform = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &platform->s;
...
void Task_PlatformMain(void)
{
    ...
    Sprite_Platform *platform = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &platform->s;
    me = platform->base.me;
    ...
    if (!(p->moveState & 0x00400000)) {
        s32 x = (posX + ((int)((platform->offsetX) >> 8)));
        s32 y = (posY + ((int)((platform->offsetY) >> 8)));
    ...
    if ((((u32)(posX - gCamera.x + (256 / 2)) > 240 + 256) || (posY - gCamera.y + (256 / 2) < 0) || (posY - gCamera.y > 160 + (256 / 2)))) {
        ...
        if (!(gPlayer.moveState & 0x00400000)) {
            ...
            if (!(gStageFlags & 0x0080)) {
                s->y += ((int)(((gSineTable[(platform->stoodOffset)])) >> 6)) >> 6;
            } else {
                s->y -= ((int)(((gSineTable[(platform->stoodOffset)])) >> 6)) >> 6;
            }
        }
...
void Task_FallingPlatformMain_Idle(void)
{
    ...
    if (((posX > gCamera.x + (240 + 128)) || (posX < (gCamera.x - 128)) || (posY > (gCamera.y + (160 + 128)))
         || ((posY < gCamera.y - 128)))
        && ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2))))) {
        { me->x = platform->base.meX; };
        TaskDestroy(gCurTask);
    } else {
        if ((gPlayer.moveState & 0x00000008) && (gPlayer.stoodObj == s)) {
...
void Task_FallingPlatformMain_Falling(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        s->y = (posY - gCamera.y) + ((int)((platform->prevOffsetY[1]) >> 8));
    } else {
        s->y = (posY - gCamera.y) + ((int)((platform->offsetY) >> 8));
    }
    ...
    if (gPlayer.moveState & 0x00000008) {
        if (gPlayer.stoodObj == s) {
            if (platform->timer > 32) {
                ...
                gPlayer.qWorldY += ((s32)((1.0)*256)) + platform->velocityY;
            }
        }
    }

    if (platform->timer < 32) {
        result = Coll_Player_Platform(s, posX, posY + ((int)((platform->offsetY) >> 8)), &gPlayer);
        if (result & 0x10000) {
            gPlayer.qWorldY += ((s16)((result)*256));
        }
    }
