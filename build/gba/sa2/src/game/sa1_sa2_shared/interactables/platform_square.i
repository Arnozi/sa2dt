...
void CreateEntity_Platform_Square(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_PlatformSquare *platform = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &platform->s;
...
static void Task_Platform_Square(void)
{
    ...
    Sprite_PlatformSquare *platform = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &platform->s;
    me = platform->base.me;
    ...
    if ((((u32)(posX - gCamera.x + (256 / 2)) > 240 + 256) || (posY - gCamera.y + (256 / 2) < 0) || (posY - gCamera.y > 160 + (256 / 2)))) {
