...
{
    Sprite_ClearPipe *pipe = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct Task *t = TaskCreate(Task_Pipe_Start, sizeof(Sprite_ClearPipe), 0x2010, 0, ((void *)0));

    Sprite_ClearPipe *pipe = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(Task_Pipe_End, sizeof(Sprite_ClearPipe), 0x2010, 0, ((void *)0));
