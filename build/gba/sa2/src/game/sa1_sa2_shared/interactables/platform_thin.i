# 0 "src/game/sa1_sa2_shared/interactables/platform_thin.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/platform_thin.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
# 1 "include/sprite.h" 1
# 4 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
# 1 "include/task.h" 1
# 5 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
# 1 "include/malloc_vram.h" 1
# 6 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
...
# 9 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
...
# 6 "include/game/sa1_sa2_shared/interactables/platform_thin.h" 2

void CreateEntity_PlatformThin(MapEntity *, u16, u16, u8);
# 10 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
...
# 13 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
...
# 17 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
# 1 "include/constants/char_states.h" 1
# 18 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
# 1 "include/constants/songs.h" 1
# 19 "src/game/sa1_sa2_shared/interactables/platform_thin.c" 2
...
static const __attribute__((aligned(4))) u16 sPlatformThinAnimations[][3] = {
    { 24, 562, 0 },
    { 24, 566, 1 },
    { 24, 574, 2 },
    { 24, 581, 1 },
...
void CreateEntity_PlatformThin(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_CommonThinPlatform *platform = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &platform->s;
    ...
    s->graphics.dest = VramMalloc(sPlatformThinAnimations[((gCurrentLevel) >> 2)][0]);
    s->graphics.anim = sPlatformThinAnimations[((gCurrentLevel) >> 2)][1];
    s->variant = sPlatformThinAnimations[((gCurrentLevel) >> 2)][2];
...
static void Task_PlatformThinMain(void)
{
    ...
    player = &gPlayer;
    something = 0;
    platform = (void *)(0x03000000 + ((gCurTask)->data));
    s = &platform->s;
    me = platform->base.me;
    x = ((platform->base.meX)*8 + (platform->base.regionX)*256);
    y = ((me->y)*8 + (platform->base.regionY)*256);

    s->x = x - gCamera.x;
    s->y = y - gCamera.y;

    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)))) && (s8)me->x == -3) {
    ...
    if (!(player->moveState & (0x00400000 | 0x00000080))) {
        ...
        if (temp2 & 0x30000) {
            ...
            switch (player->character) {
                ...
                case CHARACTER_AMY: {
                    ...
                    if (charState == 36 && anim == 51 && variant == 1 && player->qSpeedAirY > 0) {
                        player->moveState &= ~0x00000008;
                        CreatePlatformBreakParticles(x, y);
                        something = 1;
                    }
    ...
    if ((((u32)(x - gCamera.x + (256 / 2)) > 240 + 256) || (y - gCamera.y + (256 / 2) < 0) || (y - gCamera.y > 160 + (256 / 2)))) {
...
# 227 "src/game/sa1_sa2_shared/interactables/platform_thin.c"
static void CreatePlatformBreakParticles(s16 x, s16 y)
{
    ...
    PlatformBreakParticles *particles = (void *)(0x03000000 + ((t)->data));
    ...
    particles->qSpeedX = 0;
    particles->qSpeedY = -((s32)((2)*256));
    x -= 128;
    y -= 50;


    s->graphics.dest = VramMalloc(sPlatformBreakAnimations[((gCurrentLevel) >> 2)][0]);
    s->graphics.anim = sPlatformBreakAnimations[((gCurrentLevel) >> 2)][1];
    s->variant = sPlatformBreakAnimations[((gCurrentLevel) >> 2)][2];
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(s); dmaRegs[1] = (vu32)(++s); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*s))/(16/8)))); dmaRegs[2]; };;

    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(transform); dmaRegs[1] = (vu32)(++transform); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*transform))/(16/8)))); dmaRegs[2]; };;
    ...
    s->graphics.dest = VramMalloc(sPlatformBreakAnimations[((gCurrentLevel) >> 2)][3]);
    s->graphics.anim = sPlatformBreakAnimations[((gCurrentLevel) >> 2)][4];
    s->variant = sPlatformBreakAnimations[((gCurrentLevel) >> 2)][5];
    s->oamFlags = ((8) << 6);
    s->graphics.size = 0;
    s->animCursor = 0;
    s->qAnimDelay = 0;
...
{
    s16 x, y;
    PlatformBreakParticles *particles = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s;
    s16 width;
    SpriteTransform *transform;
    ...
    particles->qSpeedY += ((s32)((0.15625)*256));


    s = &particles->unk0;
    transform = &particles->unkC0;

    transform->y += ((int)((particles->qSpeedY) >> 8));
...
{
    PlatformBreakParticles *platform = (void *)(0x03000000 + ((t)->data));
