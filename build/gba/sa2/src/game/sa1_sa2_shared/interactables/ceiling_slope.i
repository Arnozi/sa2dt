...
{
    Sprite_CeilingSlope *ceilingSlope = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if ((((u32)(screenX + (256 / 2)) > 240 + 256) || (screenY + (256 / 2) < 0) || (screenY > 160 + (256 / 2)))) {
        me->x = spriteX;
...
{
    struct Task *t = TaskCreate(Task_Interactable_CeilingSlope, sizeof(Sprite_CeilingSlope), 0x2010, 0, ((void *)0));
    Sprite_CeilingSlope *ceilingSlope = (void *)(0x03000000 + ((t)->data));
