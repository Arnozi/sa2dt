# 0 "src/game/sa1_sa2_shared/interactables/spring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/sa1_sa2_shared/interactables/spring.c"
...
# 2 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
void VramFree(void *);
# 4 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 5 "src/game/sa1_sa2_shared/interactables/spring.c" 2
# 1 "include/task.h" 1
...
# 6 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 10 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 11 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 12 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 13 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 15 "src/game/sa1_sa2_shared/interactables/spring.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/sa1_sa2_shared/interactables/spring.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/sa1_sa2_shared/interactables/spring.c" 2
...
# 47 "src/game/sa1_sa2_shared/interactables/spring.c"
...
static const u16 sSpringAnimationData[3][10][4] = {
    {
        [0] = { 536, 0, 20, 0x0000 },
        [1] = { 536, 0, 20, ((1) << (11)) },
        [2] = { 536, 2, 20, ((1) << (10)) },
    ...
    },
    {
        ...
        [4] = { 604, 4, 16, ((1) << (10)) },
        [5] = { 604, 4, 16, 0x0000 },
        [6] = { 604, 4, 16, ((1) << (10)) | ((1) << (11)) },
        [7] = { 604, 4, 16, ((1) << (11)) },
        [8] = { 604, 6, 12, ((1) << (10)) },
        [9] = { 604, 6, 12, 0x0000 },
    },
};
# 101 "src/game/sa1_sa2_shared/interactables/spring.c"
...
# 169 "src/game/sa1_sa2_shared/interactables/spring.c"
...
static void Task_Spring_Idle(void)
{
    ...
    if (CheckSpringPlayerCollisions(s, me, spring, &gPlayer) != 0) {
        ...
        if ((((gCurrentLevel) >> 2) == 2 && (spring->dir / 2) == 0))
            s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2B00);
