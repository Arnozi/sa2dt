...
{
    Sprite_SlidyIce *ice = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct Task *t = TaskCreate(Task_SlidyIce, sizeof(Sprite_SlidyIce), 0x2010, 0, ((void *)0));

    Sprite_SlidyIce *ice = (void *)(0x03000000 + ((t)->data));
