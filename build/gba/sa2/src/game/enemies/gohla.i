...
void CreateEntity_Gohla(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if (gGameMode == 1 || gDifficultyLevel != 1) {
        ...
        Sprite_Gohla *gohla = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &gohla->s;
        ...
        gohla->offsetX = 0;
        gohla->offsetY = ((s32)((sub_801F07C(((int)((gohla->spawnY) >> 8)), ((int)((gohla->spawnX) >> 8)), gohla->unk8C, 8, ((void *)0), sub_801EE64))*256));
        gohla->projX = 0;
        gohla->projY = 0;
        gohla->projZ = 0;
...
static void sub_8051928(void)
{
    ...
    Sprite_Gohla *gohla = (Sprite_Gohla *)(0x03000000 + (ref));
    ...
    { s32 delta = sub_801F07C(((int)((gohla->spawnY + gohla->offsetY) >> 8)), ((int)((gohla->spawnX + gohla->offsetX) >> 8)), gohla->unk8C, 8, ((void *)0), sub_801EE64); if (delta < 0) { gohla->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((gohla->spawnY + gohla->offsetY) >> 8)), ((int)((gohla->spawnX + gohla->offsetX) >> 8)), gohla->unk8C, 8, sub_801EC3C);; } if (delta > 0) { gohla->offsetY += ((s32)((delta)*256)); } };
    ...
    if (((((int)((gohla->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((gohla->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((gohla->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((gohla->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = gohla->base.meX; }; TaskDestroy(gCurTask); return; }; };
...
static void sub_8051AF0(void)
{
    Sprite_Gohla *gohla = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &gohla->s;
    MapEntity *me = gohla->base.me;
    Vec2_32 pos;
