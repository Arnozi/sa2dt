...
void CreateEntity_PikoPiko(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if ((gGameMode == 1 || gDifficultyLevel != 1)) {
        ...
        Sprite_PikoPiko *piko = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &piko->s;
        ...
        piko->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); piko->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));; piko->offsetX = 0; piko->offsetY = ((s32)((sub_801F07C(((int)((piko->spawnY) >> 8)), ((int)((piko->spawnX) >> 8)), piko->clampParam, 8, ((void *)0), sub_801EE64))*256));;
...
static void Task_PikoPiko(void)
{
    Sprite_PikoPiko *piko = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &piko->s;
    ...
    { s32 delta = sub_801F07C(((int)((piko->spawnY + piko->offsetY) >> 8)), ((int)((piko->spawnX + piko->offsetX) >> 8)), piko->clampParam, 8, ((void *)0), sub_801EE64); if (delta < 0) { piko->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((piko->spawnY + piko->offsetY) >> 8)), ((int)((piko->spawnX + piko->offsetX) >> 8)), piko->clampParam, 8, sub_801EC3C);; } if (delta > 0) { piko->offsetY += ((s32)((delta)*256)); } };
    ...
    if (((((int)((piko->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((piko->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((piko->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((piko->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = piko->base.meX; }; TaskDestroy(gCurTask); return; }; };
