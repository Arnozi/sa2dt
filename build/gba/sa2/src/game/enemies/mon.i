...
void CreateEntity_Mon(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Mon *mon = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &mon->s;
    ...
    mon->y += ((s32)((sub_801F07C(((int)((mon->y) >> 8)), ((int)((mon->x) >> 8)), r2 >> 31, 8, ((void *)0), sub_801EE64))*256));
...
static void Task_MonMain(void)
{
    Sprite_Mon *mon = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &mon->s;
    ...
    if (Coll_Player_Enemy_Attack(s, ((int)((mon->x) >> 8)), ((int)((mon->y) >> 8)), 0)) {
        ...
        if ((gPlayer.qWorldX > mon->x - ((s32)((240 / 2)*256))) && (gPlayer.qWorldX < mon->x + ((s32)((240 / 2)*256)))
