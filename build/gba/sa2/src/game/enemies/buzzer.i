...
void CreateEntity_Buzzer(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if ((gGameMode == 1 || gCurrentLevel > 3 || gDifficultyLevel != 1)) {
        ...
        Sprite_Buzzer *buzzer = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &buzzer->s;
...
static void Task_BuzzerMain(void)
{
    Sprite_Buzzer *buzzer = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &buzzer->s;
    ...
    if (((((int)((buzzer->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((buzzer->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((buzzer->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((buzzer->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = buzzer->base.meX; }; TaskDestroy(gCurTask); return; }; };
    ...
    if ((buzzer->unk68 == 0 ||
        ...
        buzzer->unk64 = Div(gPlayer.qWorldX - ((s32)((pos.x) << 8)), 0x20);
        buzzer->unk66 = Div(gPlayer.qWorldY - ((s32)((pos.y) << 8)), 0x20);
        ...
        buzzer->unk64 = Div(((s32)((pos.x) << 8)) - gPlayer.qWorldX, 0x20);
        buzzer->unk64 = Div(gPlayer.qWorldX - ((s32)((pos.x) << 8)), 0x20);
