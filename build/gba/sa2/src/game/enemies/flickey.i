...
void CreateEntity_Flickey(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    if ((gGameMode == 1 || gDifficultyLevel != 1)) {
        ...
        Sprite_Flickey *flickey = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &flickey->s;
...
{
    u8 i;
    Sprite_Flickey *flickey = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &flickey->s;
    ...
    if (((((int)((flickey->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((flickey->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((flickey->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((flickey->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = flickey->base.meX; }; TaskDestroy(gCurTask); return; }; };
