...
void CreateEntity_Hammerhead(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Enemy_Hammerhead *hammerhead = (void *)(0x03000000 + ((t)->data));
...
{
    Player *p = &gPlayer;
    Enemy_Hammerhead *hammerhead = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &hammerhead->s;
    ...
    if (Coll_Player_Enemy_Attack(s, posX, posY + ((int)((hammerhead->unk48) >> 8)), 1) == 1) {
        ...
        if (((s->x < -((256 / 2))) || (s->x > 240 + ((256 / 2))) || ((s->y) + (256) < 0) || (s->y > 160 + (256)))
            && ((posX < -((256 / 2))) || (posX > 240 + ((256 / 2))) || ((posY) + (256) < 0) || (posY > 160 + (256)))) {
