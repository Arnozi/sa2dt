...
void CreateEntity_Yado(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Yado *yado = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &yado->s;
...
void Task_YadoMain(void)
{
    Sprite_Yado *yado = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &yado->s;
    ...
    if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = yado->base.meX; }; TaskDestroy(gCurTask); return; };
...
void Task_8055084(void)
{
    ...
    if (!(gPlayer.moveState & 0x00000002)) {
        ...
        if (gCheese != ((void *)0)) {
            ...
            Sprite_Yado *yado2 = (void *)(0x03000000 + ((gCurTask)->data));
