...
void CreateEntity_Kubinaga(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Kubinaga *k = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &k->sBase;
...
static void sub_80524D0(void)
{
    Sprite_Kubinaga *k = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &k->sBase;
    ...
    if (((pos.x) > gCamera.x + (240 + (256 / 2)) || (pos.x) < gCamera.x - (256 / 2) || (pos.y) > gCamera.y + ((160) + ((256) / 2)) || (pos.y) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = k->base.meX; }; TaskDestroy(gCurTask); return; }; };
...
static void sub_80526C8(void)
{
    ...
    if (((pos.x) > gCamera.x + (240 + (256 / 2)) || (pos.x) < gCamera.x - (256 / 2) || (pos.y) > gCamera.y + ((160) + ((256) / 2)) || (pos.y) < gCamera.y - (256 / 2))) { if ((((u16)(sBase->x + (256 / 2)) > 240 + 256) || (sBase->y + (256 / 2) < 0) || (sBase->y > 160 + (256 / 2)))) { { me->x = k->base.meX; }; TaskDestroy(gCurTask); return; }; };
