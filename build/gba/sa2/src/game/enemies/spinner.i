# 0 "src/game/enemies/spinner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/enemies/spinner.c"
...
# 2 "src/game/enemies/spinner.c" 2
...
# 3 "src/game/enemies/spinner.c" 2
# 1 "include/task.h" 1
...
# 4 "src/game/enemies/spinner.c" 2
# 1 "include/malloc_vram.h" 1
# 5 "src/game/enemies/spinner.c" 2
...
# 7 "src/game/enemies/spinner.c" 2
...
# 9 "src/game/enemies/spinner.c" 2
...
# 11 "src/game/enemies/spinner.c" 2
...
void CreateEntity_Spinner(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Spinner *spinner = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &spinner->s;
    ...
    spinner->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256));
    spinner->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));
...
void Task_EnemySpinner(void)
{
    ...
    MapEntity *me;
    Sprite_Spinner *spinner = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &spinner->s;

    me = spinner->base.me;
    pos.x = ((int)((spinner->spawnX + 0) >> 8)); pos.y = ((int)((spinner->spawnY + 0) >> 8)); s->x = pos.x - gCamera.x; s->y = pos.y - gCamera.y;;
    ...
    if (!(gPlayer.moveState & (0x00400000 | 0x00000080))) {
        ...
        if ((s2->hitboxes[0].index != -1) && (s->hitboxes[1].index != -1)) {
            if ((((((pos.x) + s->hitboxes[1].left) <= ((((int)((p->qWorldX) >> 8))) + s2->hitboxes[0].left) && ((((pos.x)) + (s->hitboxes[1]).left) + ((s->hitboxes[1]).right - (s->hitboxes[1]).left)) >= ((((int)((p->qWorldX) >> 8))) + s2->hitboxes[0].left)) || (((pos.x) + s->hitboxes[1].left) >= ((((int)((p->qWorldX) >> 8))) + s2->hitboxes[0].left) && ((((((int)((p->qWorldX) >> 8)))) + (s2->hitboxes[0]).left) + ((s2->hitboxes[0]).right - (s2->hitboxes[0]).left)) >= ((pos.x) + s->hitboxes[1].left))) && (((((pos.y)) + s->hitboxes[1].top) <= (((((int)((p->qWorldY) >> 8)))) + s2->hitboxes[0].top) && ((((pos.y)) + s->hitboxes[1].top) + ((s->hitboxes[1]).bottom - (s->hitboxes[1]).top)) >= (((((int)((p->qWorldY) >> 8)))) + s2->hitboxes[0].top)) || ((((pos.y)) + s->hitboxes[1].top) >= (((((int)((p->qWorldY) >> 8)))) + s2->hitboxes[0].top) && ((((((int)((p->qWorldY) >> 8)))) + s2->hitboxes[0].top) + ((s2->hitboxes[0]).bottom - (s2->hitboxes[0]).top)) >= (((pos.y)) + s->hitboxes[1].top))))) {
    ...
    if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = spinner->base.meX; }; TaskDestroy(gCurTask); return; };
