...
void CreateEntity_Pen(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Pen *pen = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &pen->s;
    ...
    pen->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); pen->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));; pen->offsetX = 0; pen->offsetY = ((s32)((sub_801F07C(((int)((pen->spawnY) >> 8)), ((int)((pen->spawnX) >> 8)), pen->clampParam, 8, ((void *)0), sub_801EE64))*256));;
...
static void Task_PenMove(void)
{
    Sprite_Pen *pen = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &pen->s;
    ...
    { s32 delta = sub_801F07C(((int)((pen->spawnY + pen->offsetY) >> 8)), ((int)((pen->spawnX + pen->offsetX) >> 8)), pen->clampParam, 8, ((void *)0), sub_801EE64); if (delta < 0) { pen->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((pen->spawnY + pen->offsetY) >> 8)), ((int)((pen->spawnX + pen->offsetX) >> 8)), pen->clampParam, 8, sub_801EC3C);; } if (delta > 0) { pen->offsetY += ((s32)((delta)*256)); } };
    ...
    if (((((int)((pen->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((pen->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((pen->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((pen->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = pen->base.meX; }; TaskDestroy(gCurTask); return; }; };
