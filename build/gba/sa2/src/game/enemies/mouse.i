...
void CreateEntity_Mouse(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    if (gGameMode == 1 || gDifficultyLevel != 1) {
        ...
        Sprite_Mouse *mouse = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &mouse->s;
...
static void sub_8057348(void)
{
    Sprite_Mouse *mouse = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (mouse->unk51) {
        { s32 delta = sub_801F07C(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, -8, ((void *)0), sub_801EE64); if (delta < 0) { mouse->offsetY -= ((s32)((delta)*256)); delta = sub_801F100(((int)((mouse->spawnY + mouse->offsetY) >> 8)), ((int)((mouse->spawnX + mouse->offsetX) >> 8)), mouse->unk50, 8, sub_801EC3C);; } if (delta > 0) { mouse->offsetY -= ((s32)((delta)*256)); } };
    ...
    if (((((int)((mouse->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((mouse->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((mouse->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((mouse->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = mouse->base.meX; }; TaskDestroy(gCurTask); return; }; };
