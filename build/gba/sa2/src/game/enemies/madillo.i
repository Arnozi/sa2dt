...
void CreateEntity_Madillo(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Madillo *madillo = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &madillo->s;
    ...
    madillo->spawnX = ((s32)((((me->x)*8 + (spriteRegionX)*256))*256)); madillo->spawnY = ((s32)((((me->y)*8 + (spriteRegionY)*256))*256));; madillo->offsetX = 0; madillo->offsetY = ((s32)((sub_801F07C(((int)((madillo->spawnY) >> 8)), ((int)((madillo->spawnX) >> 8)), madillo->clampParam, 8, ((void *)0), sub_801EE64))*256));;
...
static void Task_MadilloMain(void)
{
    Sprite_Madillo *madillo = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &madillo->s;
    ...
    if (((((int)((madillo->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((madillo->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((madillo->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((madillo->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = madillo->base.meX; }; TaskDestroy(gCurTask); return; }; };
