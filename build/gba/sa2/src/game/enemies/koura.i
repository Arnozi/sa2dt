...
void CreateEntity_Koura(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Koura *koura = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &koura->s;
    ...
    koura->offsetX = 0;
    if (koura->unk54 < 2) {
        koura->offsetY = ((s32)((sub_801F07C(((int)((koura->spawnY) >> 8)), ((int)((koura->spawnX) >> 8)), koura->unk54, 8, ((void *)0), sub_801EE64)) << 8));
    } else {
        koura->offsetY = 0;
    }
...
static void sub_8054224(void)
{
    Sprite_Koura *koura = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &koura->s;
    ...
    if (koura->unk54 < 2) {
        { s32 delta = sub_801F07C(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, ((void *)0), sub_801EE64); if (delta < 0) { koura->offsetY += ((s32)((delta)*256)); delta = sub_801F100(((int)((koura->spawnY + koura->offsetY) >> 8)), ((int)((koura->spawnX + koura->offsetX) >> 8)), koura->unk54, 8, sub_801EC3C);; } if (delta > 0) { koura->offsetY += ((s32)((delta)*256)); } };
    ...
    if (((((int)((koura->spawnX) >> 8))) > gCamera.x + (240 + (256 / 2)) || (((int)((koura->spawnX) >> 8))) < gCamera.x - (256 / 2) || (((int)((koura->spawnY) >> 8))) > gCamera.y + ((160) + ((256) / 2)) || (((int)((koura->spawnY) >> 8))) < gCamera.y - (256 / 2))) { if ((((u16)(s->x + (256 / 2)) > 240 + 256) || (s->y + (256 / 2) < 0) || (s->y > 160 + (256 / 2)))) { { me->x = koura->base.meX; }; TaskDestroy(gCurTask); return; }; };
