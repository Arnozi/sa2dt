...
void CreateGameOverScreen(LostLifeCause lostLifeCause)
{
    struct Task *t = TaskCreate(Task_FadeoutToOverScreen, sizeof(GameOverScreenFade), 0x2220, 0, ((void *)0));
    GameOverScreenFade *screen = (void *)(0x03000000 + ((t)->data));
...
void Task_FadeoutToOverScreen(void)
{
    GameOverScreenFade *gameover_fade = (void *)(0x03000000 + ((gCurTask)->data));
...
void Task_GameOverScreenMain(void)
{
    GameOverScreen *screen = (void *)(0x03000000 + ((gCurTask)->data));
...
void UpdateTimeOverScreenSprites(GameOverScreen *screen)
{
    ...
    if (screen->framesUntilDone > 140) {
        ...
        s16 temp = (240 / 2) - ((40 - screen->framesUntilDone) * 2);
        s->x = temp;
        sprite2->x = temp;
    } else {
        return;
...
{
    GameOverScreen *screen = (void *)(0x03000000 + ((t)->data));
