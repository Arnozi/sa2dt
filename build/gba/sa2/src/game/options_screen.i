...
void *gProfileScreenNextVramAddress = ((void *)0);
void *gProfileScreenSubMenuNextVramAddress = ((void *)0);
...
void CreateOptionsScreen(u16 p1)
{
    ...
    optionsScreen = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(Task_TimeRecordsScreenCreateTimesUI, sizeof(struct TimeRecordsScreen), 0x2000, 0x0004, ((void *)0));
    struct TimeRecordsScreen *timeRecordsScreen = (void *)(0x03000000 + ((t)->data));
    s16 i;
...
void CreateNewProfileScreen(void)
{
    ...
    t = TaskCreate(Task_LanguageScreenFadeIn, sizeof(struct LanguageScreen), 0x2000, 0x0004, ((void *)0));
    languageScreen = (void *)(0x03000000 + ((t)->data));

    languageScreen->optionsScreen = ((void *)0);
...
void CreateNewProfileNameScreen(s16 mode)
{
    struct Task *t = TaskCreate(Task_ProfileNameScreenFadeIn, sizeof(struct ProfileNameScreen), 0x2000, 0x0004, ((void *)0));
    struct ProfileNameScreen *profileNameScreen = (void *)(0x03000000 + ((t)->data));
    s16 i;

    profileNameScreen->playerDataMenu = ((void *)0);
...
static void OptionsScreenInitRegisters(struct OptionsScreen *optionsScreen, s16 state)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)0x6000000); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x18000)/(32/8)))); dmaRegs[2]; }; };
...
static void OptionsScreenCreateUI(struct OptionsScreen *optionsScreen, s16 state)
{
    ...
    sub_806A568(((void *)0), 0, 0, 0x3c4, 0, 0, 0, 0, 0, 0);
    sub_806A568(((void *)0), 0, 0, 0x3c4, 0, 0, 0, 0, 1, 0);
    sub_806A568(((void *)0), 0, 0, 0x3c3, 0, 0, 0, 0, 0xc, 0);
    sub_806A568(((void *)0), 0, 0, 0x3c3, 0, 0, 0, 0, 0xd, 0);
}

static void Task_OptionsScreenMain(void)
{
    struct OptionsScreen *optionsScreen = (void *)(0x03000000 + ((gCurTask)->data));
...
static void Task_OptionsScreenSubMenuCloseAnim(void)
{
    ...
    if (++optionsScreen->subMenuAnimFrame >= 16) {
        ({ gProfileScreenSubMenuNextVramAddress = ((void *)0); });
        gCurTask->main = Task_OptionsScreenMain;
    }
}
...
{
    struct Task *t = TaskCreate(Task_PlayerDataMenuOpenAnimWait, sizeof(struct PlayerDataMenu), 0x2000, 0x0004, ((void *)0));
    struct PlayerDataMenu *playerDataMenu = (void *)(0x03000000 + ((t)->data));
...
static void Task_PlayerDataMenuOpenAnimWait(void)
{
    struct PlayerDataMenu *playerDataMenu = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *headerFooter = playerDataMenu->headerFooter;
    Sprite *menuItem = playerDataMenu->menuItems;
    Sprite *menuItemOutline = &playerDataMenu->menuItemOutline;
...
{
    struct SwitchMenu *difficultyMenu = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *headerFooter = difficultyMenu->headerFooter;
    Sprite *difficultyOption = difficultyMenu->options;
    Sprite *switchValueOutline = &difficultyMenu->switchValueOutline;
...
{
    struct SwitchMenu *timeLimitMenu = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *headerFooter = timeLimitMenu->headerFooter;
    Sprite *timeLimitOption = timeLimitMenu->options;
    Sprite *switchValueOutline = &timeLimitMenu->switchValueOutline;
...
{
    struct Task *t = TaskCreate(Task_ButtonConfigMenuOpenAnimWait, sizeof(struct ButtonConfigMenu), 0x2000, 4, ((void *)0));
    struct ButtonConfigMenu *buttonConfigMenu = (void *)(0x03000000 + ((t)->data));
...
static void Task_ButtonConfigMenuOpenAnimWait(void)
{
    struct ButtonConfigMenu *buttonConfigMenu = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *uiElement = buttonConfigMenu->staticElements;
    Sprite *buttonAction = buttonConfigMenu->buttonActions;
    Sprite *scrollArrow = buttonConfigMenu->scrollArrows;
    Sprite *controlFocus = &buttonConfigMenu->controlFocus;
...
{
    struct LanguageScreen *languageScreen = (void *)(0x03000000 + ((gCurTask)->data));
    ReseedRng();
...
{
    struct Task *t = TaskCreate(Task_DeleteScreenFadeIn, sizeof(struct DeleteScreen), 0x2000, 0x0004, ((void *)0));
    struct DeleteScreen *deleteScreen = (void *)(0x03000000 + ((t)->data));
...
{
    struct DeleteScreen *deleteScreen = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *option = deleteScreen->options;
    Sprite *optionOutline = &deleteScreen->optionOutline;
    s16 i;
...
{
    struct Task *t = TaskCreate(Task_ProfileNameScreenFadeIn, sizeof(struct ProfileNameScreen), 0x2000, 4, ((void *)0));
    struct ProfileNameScreen *profileNameScreen = (void *)(0x03000000 + ((t)->data));
    s16 i;
...
{
    struct ProfileNameScreen *profileNameScreen = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct Task *t = TaskCreate(Task_TimeRecordsScreenChoiceViewFadeIn, sizeof(struct TimeRecordsScreen), 0x2000, 4, ((void *)0));
    struct TimeRecordsScreen *timeRecordsScreen = (void *)(0x03000000 + ((t)->data));
...
{
    struct TimeRecordsScreen *timeRecordsScreen = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct Task *t = TaskCreate(Task_TimeRecordsScreenCreateTimesUI, sizeof(struct TimeRecordsScreen), 0x2000, 4, ((void *)0));
    struct TimeRecordsScreen *timeRecordsScreen = (void *)(0x03000000 + ((t)->data));
    s16 i;
    ...
    timeRecordsScreen->playerDataMenu = playerDataMenu;
    timeRecordsScreen->timeRecords = ((void *)0);
    timeRecordsScreen->character = 0;
    timeRecordsScreen->zone = 0;
    timeRecordsScreen->act = 0;
    timeRecordsScreen->animFrame = 0;
...
static void TimeRecordsScreenInitRegisters(void)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)(0x6000000 + ((1) << 14))); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(Background))/(32/8)))); dmaRegs[2]; }; };
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)(0x6000000 + ((2) << 14))); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(Background))/(32/8)))); dmaRegs[2]; }; };
}
...
static void TimeRecordsScreenCreateCoursesViewUI(struct TimeRecordsScreen *timeRecordsScreen)
{
    ...
    spriteSize = MaxSpriteSize(r0, (sizeof(sTimeRecordsZoneActTitleDigits) / sizeof((sTimeRecordsZoneActTitleDigits)[0])));
...
static void TimeRecordsScreenRenderTimeRowAnimFrame(s16 rowIndex, s16 frame)
{
    ...
    register u32 offsetB asm("r2") = 0x03000000 + ((size_t)&((struct TimeRecordsScreen *)0)->timeDisplays);
...
{
    struct Task *t
        = TaskCreate(Task_MultiplayerRecordsScreenCreateNextTableRowUI, sizeof(struct MultiplayerRecordsScreen), 0x2000, 4, ((void *)0));
    struct MultiplayerRecordsScreen *multiplayerRecordsScreen = (void *)(0x03000000 + ((t)->data));
...
static void MultiplayerRecordsScreenCreateTableRowUI(s16 rowIndex)
{
    ...
    struct MultiplayerRecordsScreen *screen = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    struct MultiplayerRecordsScreen *multiplayerRecordsScreen = (void *)(0x03000000 + ((gCurTask)->data));
...
void sub_806A568(Sprite *obj, s8 target, u32 size, u16 c, u32 assetId, s16 xPos, s16 yPos, u16 oamOrder, u8 variant, u8 palId)
{
    ...
    if (target != 0) {
        if (gProfileScreenSubMenuNextVramAddress == ((void *)0)) {
...
{
    struct Task *t = TaskCreate(Task_DifficultyMenuOpenAnimWait, sizeof(struct SwitchMenu), 0x2000, 4, ((void *)0));
    struct SwitchMenu *difficultyMenu = (void *)(0x03000000 + ((t)->data));
...
static void CreateTimeLimitMenu(struct OptionsScreen *optionsScreen)
{
    ...
    struct SwitchMenu *timeLimitMenu = (void *)(0x03000000 + ((t)->data));
...
{
    struct Task *t = TaskCreate(Task_LanguageScreenFadeIn, sizeof(struct LanguageScreen), 0x2000, 4, ((void *)0));
    struct LanguageScreen *languageScreen = (void *)(0x03000000 + ((t)->data));
...
{
    background->graphics.dest = (void *)(0x6000000 + ((a) << 14));
    background->graphics.anim = 0;
    background->layoutVram = (void *)(0x6000000 + (0x800 * (b)));
    background->unk18 = 0;
    background->unk1A = 0;
