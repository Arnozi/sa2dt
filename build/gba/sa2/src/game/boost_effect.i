...
static inline void sub_8015B64_inline(AnimId anim, u16 palId)
{
    ...
    if (*pAnim++ == -2) {
        ...
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gRefSpriteTables->palettes[animPalId * 16]); dmaRegs[1] = (vu32)(&gObjPalette[(0)*16u + (insertOffset)]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((numColors * sizeof(u16))/(32/8)))); dmaRegs[2]; };
...
void CreateBoostEffectTasks(void)
{
    ...
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) && !gBoostEffectTasksCreated && !((((gCurrentLevel) & ((3 + 1) - 1)) == 2) || (((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && !gFinalBossActive) || (((gCurrentLevel) == ((7)*(3 + 1)) + (1))))) {
        ...
        for (i = 0; i < (sizeof(gUnknown_080D5674) / sizeof((gUnknown_080D5674)[0])); i++) {
            ...
            PlayerActions *actions = (void *)(0x03000000 + ((t)->data));
...
void Task_80159C8(void)
{
    PlayerActions *actions = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &actions->s;
