# 0 "src/game/heart_particles_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/heart_particles_effect.c"
# 1 "include/core.h" 1
...
# 2 "src/game/heart_particles_effect.c" 2
# 1 "include/game/heart_particles_effect.h" 1



void CreateHeartParticles(void);
# 3 "src/game/heart_particles_effect.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/heart_particles_effect.c" 2
...
# 6 "src/game/heart_particles_effect.c" 2
...
# 8 "src/game/heart_particles_effect.c" 2
...
# 9 "src/game/heart_particles_effect.c" 2
# 1 "include/sprite.h" 1
# 10 "src/game/heart_particles_effect.c" 2
...
# 12 "src/game/heart_particles_effect.c" 2
...
void CreateHeartParticles(void)
{
    ...
    HeartParticles *unk998 = (void *)(0x03000000 + ((t)->data));
    unk998->unkC2 = 0;
    unk998->unkE4 = 0;
    unk998->unkC0 = 0;
...
{
    u8 i;
    HeartParticles *unk998 = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s;
...

{
    ...
    for (i = 0; i < 4; i++) {
        if (unk998->unkC0 & j) {
            s = &unk998->sprites[i];
            s->x = ((int)((unk998->unkC4[i]) >> 8)) - gCamera.x;
            s->y = ((int)((unk998->unkD4[i]) >> 8)) - gCamera.y;
