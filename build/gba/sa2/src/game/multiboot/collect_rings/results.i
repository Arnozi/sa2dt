# 0 "src/game/multiboot/collect_rings/results.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiboot/collect_rings/results.c"
...
# 2 "src/game/multiboot/collect_rings/results.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiboot/collect_rings/results.c" 2
...
# 5 "src/game/multiboot/collect_rings/results.c" 2
...
# 6 "src/game/multiboot/collect_rings/results.c" 2
...
# 7 "src/game/multiboot/collect_rings/results.c" 2
...
# 9 "src/game/multiboot/collect_rings/results.c" 2
...
# 10 "src/game/multiboot/collect_rings/results.c" 2
...
# 11 "src/game/multiboot/collect_rings/results.c" 2
# 1 "include/task.h" 1
# 12 "src/game/multiboot/collect_rings/results.c" 2
# 1 "include/sprite.h" 1
# 13 "src/game/multiboot/collect_rings/results.c" 2
...
# 14 "src/game/multiboot/collect_rings/results.c" 2
...
# 15 "src/game/multiboot/collect_rings/results.c" 2
...
# 16 "src/game/multiboot/collect_rings/results.c" 2
...
# 17 "src/game/multiboot/collect_rings/results.c" 2
...
# 18 "src/game/multiboot/collect_rings/results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 19 "src/game/multiboot/collect_rings/results.c" 2
...
# 20 "src/game/multiboot/collect_rings/results.c" 2
...
# 21 "src/game/multiboot/collect_rings/results.c" 2
...
# 27 "src/game/multiboot/collect_rings/results.c" 2
...
# 29 "src/game/multiboot/collect_rings/results.c" 2
# 1 "include/constants/songs.h" 1
# 30 "src/game/multiboot/collect_rings/results.c" 2
# 1 "include/constants/text.h" 1
# 31 "src/game/multiboot/collect_rings/results.c" 2
# 1 "include/constants/tilemaps.h" 1
# 32 "src/game/multiboot/collect_rings/results.c" 2
...
void CreateMultiplayerSinglePakResultsScreen(u32 a)
{
    ...
    CpuFastSet(bgStageTileset, (void *)0x6000000, ((0x8000)/(32/8) & 0x1FFFFF));
    CpuFastSet(tilemaps, (void *)0x02000000 + 0x33000, ((0x40000 - 0x33000)/(32/8) & 0x1FFFFF));
...
# 183 "src/game/multiboot/collect_rings/results.c"
        ...
        if (resultsScreen->unk434) {
            for (i = 0; i < 3; i++) {
                ...
                switch (gMultiplayerLanguage) {
                    ...
                    case 1:
                        s->graphics.anim = 1099;
                        break;



                    default:
                        s->graphics.anim = 1100;
                        break;
                }
...
void sub_80823FC(void)
{
    ...
    if (packet->pat0.unk0 == 0x4012) {
        ...
        gSelectedCharacter = ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id;
...
void sub_8082B80(struct MultiplayerSinglePakResultsScreen *resultsScreen)
{
    ...
    for (i = 0; i < (s32)(sizeof(resultsScreen->unk80) / sizeof((resultsScreen->unk80)[0])); i++) {
        ...
        sub_8082CEC(&resultsScreen->unk80[i].unk0, (u8*)(0x6000000 + 0x10000) + (i * 0x800), anim, 0, 0x78, (i * 40) + 20, ((16) << 6), i, 0x1000);
    }
}
...
void sub_8082BF8(struct MultiplayerSinglePakResultsScreen *resultsScreen)
{
    ...
    for (i = 0; i < (s32)(sizeof(resultsScreen->unk160) / sizeof((resultsScreen->unk160)[0])); i++) {
        sub_8082CEC(&resultsScreen->unk160[i], (u8*)(0x6000000 + 0x10000) + (i * 4 + 0x100) * 0x20, 1105, i, 0, 0, ((4) << 6), 0,
                    0x1000);
    }
}
...
void sub_8082C58(struct MultiplayerSinglePakResultsScreen *resultsScreen)
{
    ...
    for (i = 0; i < (s32)(sizeof(resultsScreen->unk370) / sizeof((resultsScreen->unk370)[0])); i++) {
        sub_8082CEC(&resultsScreen->unk370[i], (u8*)(0x6000000 + 0x10000) + 0x2500 + i * 0xC0, 1099, i, 0, 0,
                    ((4) << 6), 0, 0x1000);
    }
}
