...
void StartSinglePakConnect(void)
{
    ...
    t = TaskCreate(sub_8081604, sizeof(struct SinglePakConnectScreen), 0x2000, 0, ((void *)0));
...
void sub_8081604(void)
{
    struct SinglePakConnectScreen *connectScreen = (void *)(0x03000000 + ((gCurTask)->data));
    s8 result;
    s32 multiBootFlags;
...
void sub_8081AD4(struct SinglePakConnectScreen *connectScreen)
{
    ...
    gBgScrollRegs[1][1] = 0;
    gWinRegs[0] = (((40) << 8) | (40));
    gWinRegs[2] = (((136) << 8) | (144));
    gWinRegs[4] = 2;
    gWinRegs[5] = 1;
    gBgCntRegs[1] = temp;

    { vu16 tmp = (vu16)(0xF3FF); CpuSet((void *)&tmp, (void *)(0x6000000 + (0x800 * (31))), 0x00000000 | 0x01000000 | ((2049)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(0xFFFF); CpuSet((void *)&tmp, (void *)0x6000000 + 1023 * 32, 0x00000000 | 0x01000000 | ((32)/(16/8) & 0x1FFFFF)); };
...
{
    u8 val = (connectScreen->unkE4 * 160) / 0x12000;
