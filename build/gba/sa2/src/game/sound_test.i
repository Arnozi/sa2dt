...
static const u8 sBgGradient[] = {
    (u8)(0.0 * 160), (u8)(0.1 * 160), (u8)(0.2 * 160), (u8)(0.3 * 160),
    (u8)(0.4 * 160), (u8)(0.5 * 160), (u8)(0.6 * 160), (u8)(0.7 * 160),
    (u8)(0.8 * 160), (u8)(0.9 * 160), (u8)(1.0 * 160),
};
...
void CreateSoundTestScreen(struct OptionsScreen *optionsScreen)
{
    ...
    struct SoundTestScreen *soundTestScreen = (void *)(0x03000000 + ((t)->data));
    ScreenFade *fade;
    BgPaletteEffectState *bgPaletteEffect;
    u32 i;
    ...
    ({ gProfileScreenNextVramAddress = (void *)(u8*)(0x6000000 + 0x10000); gProfileScreenSubMenuNextVramAddress = ((void *)0); });
...
static void SoundTestScreenCreateUI(struct Task *t)
{
    ...
    sub_806A568(titleTrimAndControls, 0, sControlsText[(langOffset * 1 + (0 * 3) + 0)],
                sControlsText[(langOffset * 1 + (0 * 3) + 1)], 0x1000, 10, 160 - 26, 5,
                sControlsText[(langOffset * 1 + (0 * 3) + 2)], 0);


    sub_806A568(backControlName, 0, sBackButtonText[(langOffset * 2 + (1 * 3) + 0)],
                sBackButtonText[(langOffset * 2 + (1 * 3) + 1)], 0x1000, 90, 160 - 26, 5,
                sBackButtonText[(langOffset * 2 + (1 * 3) + 2)], 0);
    sub_806A568(scrollArrows, 0, 1, 0x3C5, 0x1000, (240 / 4) + 30, (160 / 2) + 10, 5, 2, 0);

    for (i = 0, xPos = (240 / 4) + 20, yPos = (160 / 2) + 16; i < 3; i++, songNumDisplayElement++, xPos -= 8) {
        if (i == 0) {
    ...
    for (i = 0; i < 4; i++) {
        sub_806A568(&speakerCone[i], 0, 0x40, 0x3ce, i | 0x1060, (240 / 4) + 16, (160 / 2) + 10, 6,
                    0, 0);
    }
    ...
    for (i = 0; i < 4; i++) {
        ...
        transforms[i].x = (240 / 4) + 16;
        transforms[i].y = (160 / 2) + 10;
    }
    ...
    sub_806A568(danceStage, 0, 0x14, 0x3CC, 0x1000, (240 / 4) * 3, (160 / 2) + 60, 6, 0, 4);
    sub_806A568(animatedCream, 0, 0x40, 0x3CA, 0x1000, (240 / 4) * 3, (160 / 2) + 36, 5, 0, 0);
    animatedCream++;
    sub_806A568(animatedCream, 0, 0x48, 0x3C8, 0x1000, (240 / 4) * 3, (160 / 2) + 36, 5, 0, 0);
...
{
    struct SoundTestScreen *soundTestScreen = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (++soundTestScreen->nameTickerPos > 240 + 160) {
        soundTestScreen->nameTickerPos = 0;
    }

    SoundTestScreenSetNameDisplayPos(soundsList[soundTestScreen->soundNumber - 1], (240 + 16) - soundTestScreen->nameTickerPos,
                                     160 - 2);
...
static void SoundTestScreenRenderUI(void)
{
    ...
    for (i = 0; i < 2; i++, numberDisplayDigit++) {
        numberDisplayDigit->y = (160 / 2) + 16;

        if (soundTestScreen->soundNumAnimSteps[i] != 0) {
            if (soundTestScreen->soundNumAnimSteps[i] > 0) {
                numberDisplayDigit->y = sDigitTransitionAnim[soundTestScreen->soundNumAnimSteps[i]] + (160 / 2) + 16;
                soundTestScreen->soundNumAnimSteps[i]--;
            }

            if (soundTestScreen->soundNumAnimSteps[i] < 0) {
                numberDisplayDigit->y = (160 / 2) + 16 - sDigitTransitionAnim[-soundTestScreen->soundNumAnimSteps[i]];
                soundTestScreen->soundNumAnimSteps[i]++;
            }
        }
    ...
    if (soundTestScreen->state == 1) {
        ...
        u16 amplification = 0;
        u32 testVal;
        testVal = (u32)(*(s16 *)(0x4000000 + ((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x2) & (0x1000 | 0x2000 | 0x4000 | 0x8000))
            >> 0xC;
        ...
        testVal = (u32)(*(s16 *)(0x4000000 + ((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x12) & (0x1000 | 0x2000 | 0x4000 | 0x8000))
            >> 0xC;
        ...
        testVal = (u32)(*(s16 *)(0x4000000 + ((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x18) & (0x1000 | 0x2000 | 0x4000 | 0x8000))
            >> 0xC;
    ...
    scrollArrows->x = (((gSineTable[((soundTestScreen->scrollArrowAnimFrame & 15) * 0x10) + 256]) >> 6) * 5 >> 7) + (240 / 4) + 34;
    DisplaySprite(scrollArrows);
    scrollArrows->x = (240 / 4 - 2) - (((gSineTable[((soundTestScreen->scrollArrowAnimFrame & 15) * 0x10) + 256]) >> 6) * 5 >> 7);
