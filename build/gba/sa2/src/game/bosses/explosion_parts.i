...
void CreateBossParticleWithExplosionUpdate(ExplosionPartsInfo *info, u8 *numCreatedParts)
{
    if (!(info->unk4 & 1) || *numCreatedParts < 16) {
        struct Task *t = TaskCreate(Task_BossParticleWithExplosionUpdate, sizeof(Sprite_ExplosionParts), 0x5432, 0, ((void *)0));
        Sprite_ExplosionParts *parts = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &parts->s;
        s32 cos, sin;
...
void Task_BossParticleWithExplosionUpdate(void)
{
    Sprite_ExplosionParts *parts = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &parts->s;
    ...
    if (((s->x < -32) && (parts->accelX < 0)) || ((s->x > (240 + 32)) && (parts->accelX > 0))
        || ((s->y < -32) && (parts->accelY < 0))
        || ((s->y > (160 + 32)) && (parts->accelY > 0))) {
...
{
    if (!(info->unk4 & 1) || *numCreatedParts < 16) {
        struct Task *t = TaskCreate(Task_BossParticleStatic, sizeof(Sprite_ExplosionParts), 0x5432, 0, ((void *)0));
        Sprite_ExplosionParts *parts = (void *)(0x03000000 + ((t)->data));
        Sprite *s = &parts->s;
        s32 cos, sin;
