...
{
    TA53Boss *boss = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    gFlags |= 0x4;
    gHBlankCopyTarget = (void *)&(*(vu16 *)(0x4000000 + 0x16));
    gHBlankCopySize = 2;
...
void Task_TrueArea53BossMain(void)
{
    ...
    if (--boss->unk12 == 0) {
        ...
        cockpit->graphics.dest = (void *)0x6000000;
        cockpit->graphics.anim = 0;
        cockpit->layoutVram = (void *)(0x6000000 + (0x800 * (28)));
        cockpit->unk18 = 0;
        cockpit->unk1A = 0;
...
void sub_804E15C(struct TA53_unk48 *unk48)
{
    ...
    if (sp14 > 2) {
        ...
        if (sp14 > 5) {
            ...
            r4 = (s8)Mod(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }), 8);
            if (r4 < 0) {
                r4 = -r4;
            }
...
void sub_804E974(struct TA53_unkA8 *unkA8)
{
    ...
    unkA8->unkE += Div((gSineTable[(unkA8->unkA) + 256]), 850);
    unkA8->unk10 += Div((gSineTable[(unkA8->unkA)]), 850);
...
void sub_804F6AC(u32 qX, u32 qY, s16 param2, u32 sinIndex_)
{
    struct TA53Boss *s = (void *)(0x03000000 + ((gCurTask)->data));
...
void sub_804FE24(struct TA53_unk654 *unk654)
{
    ...
    if (--unk654->unk8 == 0) {
        ...
        funcId = Mod((u8)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }), (sizeof(gUnknown_080D89AC) / sizeof((gUnknown_080D89AC)[0])));
...
void sub_80505B8(TA53Boss *boss)
{
    ...
    if (unk48->unk4C == 0) {
        if (boss->spr7B4.graphics.dest != ((void *)0)) {
            VramFree(boss->spr7B4.graphics.dest);
            boss->spr7B4.graphics.dest = ((void *)0);
...
{
    TA53Boss *boss = (void *)(0x03000000 + ((t)->data));
    u8 i;
    Sprite *s;
    void **vram;
