...
void CreateEggHammerTankII(void)
{
    ...
    if (!((gCurrentLevel) == ((7)*(3 + 1)) + (0)) && gSelectedCharacter == CHARACTER_SONIC && gLoadedSaveGame->unlockedLevels[0] <= gCurrentLevel) {
        ...
        boss->cream.graphics.dest = ((void *)0);
        boss->cheese.graphics.dest = ((void *)0);
    }
...
static void Task_EggHammerTankII_RollIn(void)
{
    EggHammerTankII *boss = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (sceneTimer < 127) {
        ...
        register u32 __attribute__((unused)) r1 asm("r1") = (sceneTimer - 61);
...
static void Render(EggHammerTankII *boss)
{
    ...
    if (boss->cream.graphics.dest != ((void *)0)) {
        s = &boss->cream;
        s->x = x3 + 5;
        s->y = y3 - 20;
        UpdateSpriteAnimation(s);
...
static void StateHandler_HammerPlunge(EggHammerTankII *boss)
{
    ...
    result = sub_801E6D4(y, x, 1, 8, ((void *)0), sub_801EE64);
...
static void StateHandler_HammerRetract(EggHammerTankII *boss)
{
    ...
    if (boss->timer > ((int)((((double)(270)) / 360.0) * 1024))) {
...
static void DestructionScene_UpdateComponents(EggHammerTankII *boss)
{
    ...
    if (result < 0) {
        ...
        if (ds->hammerState == 0) {
            ...
            parts.vram = (void *)(u8*)(0x6000000 + 0x10000) + 0x2980;
            parts.anim = 619;
            parts.variant = 0;
            parts.unk4 = 0;
...
static void InitDestructionScene(void)
{
    ...
    boss = (void *)(0x03000000 + ((gCurTask)->data));
...
static void DestructionScene_Render(EggHammerTankII *boss)
{
    ...
    if (!(boss->sceneTimer & 7)) {
        ...
        init.speed = 0x600;
        init.vram = (void *)(u8*)(0x6000000 + 0x10000) + (gTileInfoBossScrews[i][0] * 32);
    ...
    if (Mod(boss->sceneTimer + ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }), 13) == 0) {
        m4aSongNumStart(144);
    }
...
{
    u8 i;
    EggHammerTankII *boss = (void *)(0x03000000 + ((gActiveBossTask)->data));
    DestructionScene *ds = &boss->destructionScene;
...
{
    EggHammerTankII *boss = (void *)(0x03000000 + ((t)->data));
    ...
    if (boss->cheese.graphics.dest != ((void *)0)) {
