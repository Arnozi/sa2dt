...
# 252 "src/game/bosses/boss_5.c"
    ...
    s->x = 0;
    s->y = 0;
    s->graphics.dest = (void *)0x6000000 + 0xC000;
...
void Task_EggSaucerIntro(void)
{
    EggSaucer *boss = (void *)(0x03000000 + ((gCurTask)->data));
...
void sub_8043E2C(EggSaucer *boss)
{
    ...
    if (boss->gunHealth == 0 && boss->unk20 == 0) {
        ...
        bottomX = ((int)((x) >> 8));
        bottomY = ((int)((y) >> 8)) + 10;
        ground = sub_801E4E4(bottomY, bottomX, 1, 8, ((void *)0), sub_801EE64);
        if (ground < 0) {
...
{
    u8 i;
    EggSaucer *boss = (void *)(0x03000000 + ((gActiveBossTask)->data));
...
void HandleCollision(EggSaucer *boss)
{
    ...
    if (boss->gunHealth != 0 && boss->unk1F == 0) {
        ...
        if (Coll_Player_Boss_Attack(s, x, y, 0, &gPlayer) == 1) {
            ...
            if (boss->gunHealth == 0) {
                { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += 500; divResA = Div(gLevelScore, 50000); divResB = Div(oldScore, 50000); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
            }
        } else {
            if (Coll_Player_Enemy(s, x, y, 0, &gPlayer) == 1) {
                sub_80452F8(boss);
...
__attribute__((naked)) void sub_8045564(EggSaucer *boss) { asm(".include " "\"asm/non_matching/game/bosses/boss_5__sub_8045564.inc\""); if (0)
{
    s32 index;
    s32 new_var = 0xF;
    ...
    if (boss->unk15 == 0) {
        ...
        if (Mod(gStageTime, 7) == 0) {
            ...
            e.speed = 0x500;
            e.vram = (void *)(u8*)(0x6000000 + 0x10000) + 0x2980;
            e.anim = 619;
            e.variant = 0;
            e.unk4 = 0;
        ...
        if (Mod(gStageTime, 10) == 0) {
            ...
            e.speed = 0x600;
            e.vram = (void *)(u8*)(0x6000000 + 0x10000) + (gTileInfoBossScrews[val2][0] * 0x20);
...
{
    EggSaucer *boss = (void *)(0x03000000 + ((t)->data));
    VramFree(boss->vram);
