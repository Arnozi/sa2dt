...
{
    EggFrog *boss = (void *)(0x03000000 + ((gCurTask)->data));
...
__attribute__((naked)) bool8 sub_8048C7C(EggFrog *boss) { asm(".include " "\"asm/non_matching/game/bosses/boss_7__sub_8048C7C.inc\""); if (0)
{
...
{
    EggFrog *boss = (void *)(0x03000000 + ((gActiveBossTask)->data));
    boss->x += dX;
    boss->y += dY;
    boss->unk10 += dX;
}
...
{
    EggFrog *boss = (void *)(0x03000000 + ((t)->data));
...
{
    Sprite *s;
    struct Task *t = TaskCreate(sub_80494EC, sizeof(EggFrogBomb), 0x6100, 0, ((void *)0));
    EggFrogBomb *bomb = (void *)(0x03000000 + ((t)->data));
...
static void sub_80494EC(void)
{
    EggFrogBomb *bomb = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &bomb->s;
    s32 temp;
    s32 result;
    s32 x, y;
...
{
    Sprite *s;
    struct Task *t = TaskCreate(Task_80497E0, sizeof(EggFrogBomb), 0x6100, 0, ((void *)0));
    EggFrogBomb *bombFlame = (void *)(0x03000000 + ((t)->data));
...
static void Task_80497E0(void)
{
    EggFrogBomb *bombFlame = (void *)(0x03000000 + ((gCurTask)->data));
