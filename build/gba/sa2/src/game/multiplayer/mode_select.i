...
void CreateMultiplayerModeSelectScreen(void)
{
    ...
    modeScreen = (void *)(0x03000000 + ((t)->data));
...
{
    struct MultiplayerModeSelectScreen *modeScreen = (void *)(0x03000000 + ((gCurTask)->data));
    gHBlankCopySize = 2;
    gHBlankCopyTarget = (void *)(0x4000000 + (0x40 + sizeof(winreg_t) * 1));
    gWinRegs[4] = 0x1300;
    gWinRegs[5] = 0x11;
    gFlags |= 0x4;
...
static void Task_EnterAnimPart2(void)
{
    ...
    if (modeScreen->animFrame < 10) {
        ...
        unk80->x = modeScreen->animFrame * 0x10 - 240;
    } else {
        unk80->x = (240 / 3);
    }
    unk80->y = (160 * (3. / 8.));
...
{
    struct MultiplayerModeSelectScreen *modeScreen = (void *)(0x03000000 + ((t)->data));
