# 0 "src/game/multiplayer/communication_outcome.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/communication_outcome.c"
...
# 2 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/task.h" 1
# 4 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/multiplayer/communication_outcome.c" 2
...
# 6 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/flags.h" 1
# 7 "src/game/multiplayer/communication_outcome.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/multiplayer/communication_outcome.c" 2
...
# 11 "src/game/multiplayer/communication_outcome.c" 2
...
# 12 "src/game/multiplayer/communication_outcome.c" 2
...
# 13 "src/game/multiplayer/communication_outcome.c" 2
...
# 14 "src/game/multiplayer/communication_outcome.c" 2
...
# 15 "src/game/multiplayer/communication_outcome.c" 2
...
# 20 "src/game/multiplayer/communication_outcome.c" 2
...
# 22 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/constants/songs.h" 1
# 23 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/constants/text.h" 1
# 24 "src/game/multiplayer/communication_outcome.c" 2
# 1 "include/constants/tilemaps.h" 1
# 25 "src/game/multiplayer/communication_outcome.c" 2
...
# 56 "src/game/multiplayer/communication_outcome.c"
static const u16 sBackgroundAnims[2] = { 1075, 1075 };
static const u8 sBackgroundVariants[2]
    = { 0, 1 };
static const TileInfo sCommMessages[][7] = {
    {
        [0] = { .numTiles = (51), .anim = (1074), .variant = (1) },
        [1] = { .numTiles = (51), .anim = (1074), .variant = (1) },
        [2] = { .numTiles = (75), .anim = (1079), .variant = (1) },
        [3] = { .numTiles = (75), .anim = (1080), .variant = (1) },
        [4] = { .numTiles = (57), .anim = (1081), .variant = (1) },
        [5] = { .numTiles = (45), .anim = (1082), .variant = (1) },
        [6] = { .numTiles = (51), .anim = (1083), .variant = (1) },
    },
    {
        [0] = { .numTiles = (66), .anim = (1074), .variant = (3) },
        [1] = { .numTiles = (66), .anim = (1074), .variant = (3) },
        [2] = { .numTiles = (68), .anim = (1079), .variant = (3) },
        [3] = { .numTiles = (88), .anim = (1080), .variant = (3) },
        [4] = { .numTiles = (60), .anim = (1081), .variant = (3) },
        [5] = { .numTiles = (68), .anim = (1082), .variant = (3) },
        [6] = { .numTiles = (60), .anim = (1083), .variant = (3) },
    },
};
...
void CreateMultipackOutcomeScreen(u8 outcome)
{
    ...
    outcomeScreen = (void *)(0x03000000 + ((t)->data));
...
# 133 "src/game/multiplayer/communication_outcome.c"
    ...
    s->palId = 0;
    s->frameFlags = ((2) << (12));
# 166 "src/game/multiplayer/communication_outcome.c"
    s = &outcomeScreen->sprD0;
    s->x = (240 / 2);
    s->y = 36;
    s->graphics.dest = (void *)(u8*)(0x6000000 + 0x10000) + 0x2000;
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
    ...
    s->palId = 0;
    s->frameFlags = ((2) << (12));
# 199 "src/game/multiplayer/communication_outcome.c"
    s = &outcomeScreen->sprA0;
    s->x = (240 / 2);
    s->y = 160 - 40;
    s->graphics.dest = (void *)(u8*)(0x6000000 + 0x10000) + 0x4000;
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
    s->graphics.anim = sBackgroundAnims[outcome];
    s->variant = sBackgroundVariants[outcome];
    ...
    background->layoutVram = (void *)(0x6000000 + (0x800 * (8)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->unk1E = 0;
    background->unk20 = 0;
...
{
    Sprite *s;
    struct CommunicationOutcomeScreen *outcomeScreen = (void *)(0x03000000 + ((gCurTask)->data));
    u32 i;
...
# 273 "src/game/multiplayer/communication_outcome.c"
...
# 329 "src/game/multiplayer/communication_outcome.c"
    s = &outcomeScreen->spr100;
    UpdateSpriteAnimation(s);
    DisplaySprite(s);
    ...
    if (gBldRegs.bldY != 0x10) {
        ...
        if (outcome == 0) {
            ...
            CreateCharacterSelectionScreen(gSelectedCharacter, gMultiplayerUnlockedCharacters & (1 << (CHARACTER_AMY)));
