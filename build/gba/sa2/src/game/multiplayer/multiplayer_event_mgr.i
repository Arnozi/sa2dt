# 0 "src/game/multiplayer/multiplayer_event_mgr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/multiplayer_event_mgr.c"
# 1 "include/core.h" 1
...
# 2 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 4 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 5 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 6 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 8 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 10 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 11 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
# 12 "src/game/multiplayer/multiplayer_event_mgr.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 14 "src/game/multiplayer/multiplayer_event_mgr.c" 2

# 1 "include/constants/char_states.h" 1
# 16 "src/game/multiplayer/multiplayer_event_mgr.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/multiplayer/multiplayer_event_mgr.c" 2
        ...
        switch (recv->pat0.unkF) {
            ...
            case 0: {
                if (gGameMode != 4
                    ...
                    gPlayer.confusionTimer = (int)(((0 * 60.) + 10) * 60);
            ...
            case 1: {
                if ((u8)recv->pat0.unk10 == ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id && !(gPlayer.itemEffect & 0x80)) {
                    u32 prevMoveState = gPlayer.moveState & (0x40000000 | 0x00200000 | 0x00400000);
                    if (!(prevMoveState)) {
...
void ReceiveRoomEvent_ReachedStageGoal(union MultiSioData *recv, u8 i)
{
    ...
    for (j = 0; j < 4; j++) {
        ...
        count++;
        mpp2 = (void *)(0x03000000 + ((gMultiplayerPlayerTasks[j])->data));
        if (gGameMode != 4) {
    ...
    if (gGameMode == 4) {
        for (j = 0; j < 4 && gMultiplayerPlayerTasks[j] != ((void *)0); j++) {
            if (j != i && gMultiplayerRanks[j] == -1
                ...
                if (j == ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id) {
    ...
    if ((count3 + 1) >= (u32)(count - 1) || gGameMode == 4) {
        for (j = 0; j < 4; j++) {
            MultiplayerPlayer *mpp2;
