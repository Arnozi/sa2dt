# 0 "src/game/multiplayer/finish.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/finish.c"
...
# 2 "src/game/multiplayer/finish.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/multiplayer/finish.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/multiplayer/finish.c" 2
# 1 "include/task.h" 1
# 5 "src/game/multiplayer/finish.c" 2
...
# 6 "src/game/multiplayer/finish.c" 2
...
# 8 "src/game/multiplayer/finish.c" 2
...
# 9 "src/game/multiplayer/finish.c" 2
...
# 11 "src/game/multiplayer/finish.c" 2
...
# 14 "src/game/multiplayer/finish.c" 2
...
# 16 "src/game/multiplayer/finish.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 18 "src/game/multiplayer/finish.c" 2
...
# 20 "src/game/multiplayer/finish.c" 2
# 1 "include/constants/text.h" 1
# 21 "src/game/multiplayer/finish.c" 2
# 37 "src/game/multiplayer/finish.c"
typedef struct {
    Sprite s;
    u8 unk30;
    u8 unk31;
...
# 94 "src/game/multiplayer/finish.c"
void CreateMultiplayerFinishResult(u8 sioId, u8 count)
{
    u32 i = 0;
...

    {
        ...
        MpFinish1 *finish = (void *)(0x03000000 + ((t)->data));
        ...
        s = &finish->s;
        s->graphics.size = 0;
# 145 "src/game/multiplayer/finish.c"
        s->graphics.dest = VramMalloc(12);
        if (count == 5) {
            s->graphics.anim = ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (1)); })->anim;
            s->variant = ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (1)); })->variant;
        } else if (count == 4) {
            s->graphics.anim = ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (2)); })->anim;
            s->variant = ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (2)); })->variant;
        } else if ((i == 2) || gGameMode == 4) {
            s->graphics.anim = ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (0)); })->anim;
            s->variant = count + ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (0)); })->variant;
        } else {
            s->graphics.anim = ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (3)); })->anim;
            s->variant = count + ({ const TileInfo *source; u8 *info = (u8 *)sMPFinishTileInfo; s32 index; index = (((gLoadedSaveGame)->language == 0) || ((gLoadedSaveGame)->language == 1)) ? 0 : (7 * sizeof(TileInfo)); source = (TileInfo *)(info + index); (source + (3)); })->variant;
        }
...
void Task_8019E70(void)
{
    MpFinish1 *finish = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &finish->s;
    MultiplayerPlayer *mpp = (void *)(0x03000000 + ((gMultiplayerPlayerTasks[finish->unk30])->data));
...

{
    ...
    u32 r2;
    u8 r6;
# 219 "src/game/multiplayer/finish.c"
    {
        struct Task *mpt;
        struct Task *t = TaskCreate(Task_801A04C, sizeof(Finish2), 0x2000, 0, ((void *)0));
        Finish2 *f2 = (void *)(0x03000000 + ((t)->data));
...
{
    u32 x = 0;
    Finish2 *f2 = (void *)(0x03000000 + ((gCurTask)->data));
        ...
        if (gGameMode == 5) {
            ...
            *((u32 *)sp04) = *((u32 *)gMultiplayerCharRings);
            ...
            if (gGameMode == 5) {
                ...
                goto _0801A2DA;
# 519 "src/game/multiplayer/finish.c"
            }
...

        {
            ...
            for (pid = 0; pid < 4; pid++) {
                ...
                if (pid == ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id)
                    continue;

                if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id] < gMultiplayerRanks[pid]) {
                    foeResult = 0;
                } else if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id] > gMultiplayerRanks[pid]) {
                    foeResult = 1;
                    ownResult = 1;
                } else {
                    foeResult = 2;
    ...
    _0801A2DA:
        ...
        if (gGameMode != 5) {
            { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(&gMultiSioSend); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(struct MultiSioData_0_0))/(32/8)))); dmaRegs[2]; }; };
