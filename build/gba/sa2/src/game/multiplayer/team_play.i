# 0 "src/game/multiplayer/team_play.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/multiplayer/team_play.c"
...
# 2 "src/game/multiplayer/team_play.c" 2
# 1 "include/game/multiplayer/team_play.h" 1
...
# 3 "src/game/multiplayer/team_play.c" 2
...
# 4 "src/game/multiplayer/team_play.c" 2

# 1 "include/task.h" 1
# 6 "src/game/multiplayer/team_play.c" 2
# 1 "include/sprite.h" 1
# 7 "src/game/multiplayer/team_play.c" 2
...
# 9 "src/game/multiplayer/team_play.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "src/game/multiplayer/team_play.c" 2
# 1 "include/flags.h" 1
# 11 "src/game/multiplayer/team_play.c" 2
...
# 12 "src/game/multiplayer/team_play.c" 2
# 1 "include/trig.h" 1
...
# 13 "src/game/multiplayer/team_play.c" 2
...
# 15 "src/game/multiplayer/team_play.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/game/multiplayer/team_play.c" 2
# 1 "include/constants/text.h" 1
# 17 "src/game/multiplayer/team_play.c" 2
# 1 "include/constants/tilemaps.h" 1
# 18 "src/game/multiplayer/team_play.c" 2
...
static const TileInfo gUnknown_080D92BC[] = {
    { .numTiles = (8), .anim = (1076), .variant = (5) },
    { .numTiles = (8), .anim = (1076), .variant = (6) },
    { .numTiles = (8), .anim = (1076), .variant = (7) },
    { .numTiles = (8), .anim = (1076), .variant = (8) },
};

static const TileInfo gUnknown_080D92DC[] = {
    [(0 + ((0) * (5)))] = { .numTiles = (46), .anim = (1076), .variant = (0) }, [(1 + ((0) * (5)))] = { .numTiles = (42), .anim = (1076), .variant = (1) }, [(2 + ((0) * (5)))] = { .numTiles = (12), .anim = (1076), .variant = (2) },
    [(3 + ((0) * (5)))] = { .numTiles = (18), .anim = (1076), .variant = (3) }, [(4 + ((0) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) }, [(0 + ((1) * (5)))] = { .numTiles = (46), .anim = (1076), .variant = (0) },
    [(1 + ((1) * (5)))] = { .numTiles = (42), .anim = (1076), .variant = (1) }, [(2 + ((1) * (5)))] = { .numTiles = (12), .anim = (1076), .variant = (2) }, [(3 + ((1) * (5)))] = { .numTiles = (18), .anim = (1076), .variant = (3) },
    [(4 + ((1) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) }, [(0 + ((2) * (5)))] = { .numTiles = (38), .anim = (1084), .variant = (0) }, [(1 + ((2) * (5)))] = { .numTiles = (46), .anim = (1084), .variant = (1) },
    [(2 + ((2) * (5)))] = { .numTiles = (14), .anim = (1084), .variant = (2) }, [(3 + ((2) * (5)))] = { .numTiles = (10), .anim = (1084), .variant = (3) }, [(4 + ((2) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) },
    [(0 + ((3) * (5)))] = { .numTiles = (57), .anim = (1085), .variant = (0) }, [(1 + ((3) * (5)))] = { .numTiles = (46), .anim = (1085), .variant = (1) }, [(2 + ((3) * (5)))] = { .numTiles = (10), .anim = (1085), .variant = (2) },
    [(3 + ((3) * (5)))] = { .numTiles = (14), .anim = (1085), .variant = (3) }, [(4 + ((3) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) }, [(0 + ((4) * (5)))] = { .numTiles = (51), .anim = (1086), .variant = (0) },
    [(1 + ((4) * (5)))] = { .numTiles = (72), .anim = (1086), .variant = (1) }, [(2 + ((4) * (5)))] = { .numTiles = (10), .anim = (1086), .variant = (2) }, [(3 + ((4) * (5)))] = { .numTiles = (14), .anim = (1086), .variant = (3) },
    [(4 + ((4) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) }, [(0 + ((5) * (5)))] = { .numTiles = (75), .anim = (1087), .variant = (0) }, [(1 + ((5) * (5)))] = { .numTiles = (69), .anim = (1087), .variant = (1) },
    [(2 + ((5) * (5)))] = { .numTiles = (9), .anim = (1087), .variant = (2) }, [(3 + ((5) * (5)))] = { .numTiles = (15), .anim = (1087), .variant = (3) }, [(4 + ((5) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) },
    [(0 + ((6) * (5)))] = { .numTiles = (72), .anim = (1088), .variant = (0) }, [(1 + ((6) * (5)))] = { .numTiles = (75), .anim = (1088), .variant = (1) }, [(2 + ((6) * (5)))] = { .numTiles = (6), .anim = (1088), .variant = (2) },
    [(3 + ((6) * (5)))] = { .numTiles = (10), .anim = (1088), .variant = (3) }, [(4 + ((6) * (5)))] = { .numTiles = (6), .anim = (1076), .variant = (4) },
};
...
void CreateMultiplayerTeamPlayScreen(void)
{
    ...
    t = TaskCreate(sub_805CB34, sizeof(struct MultiplayerTeamPlayScreen), 0x3000, 0, ((void *)0));
    teamPlayScreen = (void *)(0x03000000 + ((t)->data));
    ...
    for (i = 0, vram = (u8*)(0x6000000 + 0x10000); i < 4; i++) {
        s = &teamPlayScreen->unk0[i];
        s->x = 0;
        s->y = 0;
        s->graphics.dest = (void *)vram;
        vram += gUnknown_080D92BC[i].numTiles * 32;
        s->oamFlags = ((4) << 6);
        s->graphics.size = 0;
    ...
    for (i = 0; i < 5; i++) {
        ...
        s->y = 0;
        s->graphics.dest = (void *)vram;
        vram += gUnknown_080D92DC[(i + ((lang) * (5)))].numTiles * 32;
        s->oamFlags = ((3) << 6);
        s->graphics.size = 0;
        s->graphics.anim = gUnknown_080D92DC[(i + ((lang) * (5)))].anim;
        s->variant = gUnknown_080D92DC[(i + ((lang) * (5)))].variant;
        s->animCursor = 0;
        s->qAnimDelay = 0;
        s->prevVariant = -1;
        s->animSpeed = ((int)((float)(1.0)*0x10));
    ...
    background->layoutVram = (void *)(0x6000000 + (0x800 * (6)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 123;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(0x6000000 + (0x800 * (14)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->tilemapId = 122;
    background->unk1E = 0;
    background->unk20 = 0;
    background->unk22 = 0;
    background->unk24 = 0;
...
static void sub_805CB34(void)
{
    ...
    teamPlayScreen = (void *)(0x03000000 + ((gCurTask)->data));
    gWinRegs[5] = 0x3F;
    gBldRegs.bldCnt = 0x3F48;
    gBldRegs.bldAlpha = 0x810;
    gWinRegs[2] = 160;

    if (gBgScrollRegs[1][1] < 160) {
        gBgScrollRegs[1][1] += 4;
    } else {
        gBgScrollRegs[1][1] = 160;
...
static void sub_805CC34(void)
{
    ...
    if (gMultiSioStatusFlags & 0x0080 && !teamPlayScreen->unk317) {
        if (gPressedKeys & 0x0020) {
            if (teamPlayScreen->unk31E == 0) {
                m4aSongNumStart(108);
            }
            teamPlayScreen->unk316 = 1;
        } else {
            if (gPressedKeys & 0x0010) {
                if (teamPlayScreen->unk31E != 0) {
                    m4aSongNumStart(108);
                }
    ...
    count = 1;
    for (i = 0; i < 4; i++) {
        if (i != ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id && (((gMultiplayerConnections) >> (i)) & 1)) {
            count++;
            if (i == 0) {
                msd = gMultiSioRecv;
    ...
    if (gMultiSioStatusFlags & 0x0080) {
        if (gPressedKeys & 0x0001 && teamPlayScreen->unk317 == 0) {
            ...
            if (count == j) {
                if (teamPlayScreen->unk316 != 0) {
                    ...
                    gFlags &= ~0x4;
                    gGameMode = 3;
                    CreateCourseSelectionScreen(0, gMultiplayerUnlockedLevels, 0);
                    gMultiSioSend.pat0.unk0 = 0x4035;
                    return;
                }
            }
...
static void sub_805D1F8(void)
{
    ...
    if (((!(gInput & (0x0020 | 0x0010)) && (gPressedKeys & 0x0001))
    ...
    for (i = 0; i < 4 && (((gMultiplayerConnections) >> (i)) & 1); i++) {
        if (((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id != i) {
            packet = &gMultiSioRecv[i];
            if (packet->pat0.unk0 > 0x4041) {
...
static void sub_805D5C8(void)
{
    struct MultiplayerTeamPlayScreen *teamPlayScreen = (void *)(0x03000000 + ((gCurTask)->data));
    teamPlayScreen->unk31E = ((volatile struct SioMultiCnt *)(0x4000000 + 0x128))->id & 1;
    teamPlayScreen->unk31F = 0;
