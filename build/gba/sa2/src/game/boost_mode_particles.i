...
void CreateBoostModeParticles(void)
{
    ...
    struct BoostModeParticles *particles = (void *)(0x03000000 + ((t)->data));
    ...
    for (i = 0; i < 16; i++) {
...

        {
            ...
            ip = 0x3ff;
            particles->accelerations[i][0] = ((((int)(((gSineTable[(temp1 * 4) + 256])) >> 6)) * (var = (rand & ip) + 512)) >> 8);
...
{
    s32 i;
    struct BoostModeParticles *particles = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s;
