...
void CreateCourseSelectionScreen(u8 currentLevel, u8 maxLevel, u8 cutScenes)
{
    ...
    if (((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2)) && (Mod(maxLevel, 3 + 1) & 2) != 0) {
        maxLevel &= ~3;
    }
    ...
    coursesScreen = (void *)(0x03000000 + ((t)->data));
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(0x6000000 + (0x800 * (16)));
    background->unk18 = 0;
    background->unk1A = 0;
    ...
    for (i = 0; i < (sizeof(coursesScreen->chaosEmeralds) / sizeof((coursesScreen->chaosEmeralds)[0])); i++) {
        ...
        s->x = 0;
        s->y = 160 - 24;
        s->graphics.dest = (void *)(u8*)(0x6000000 + 0x10000) + (i * (9 * 32));
...
static void Task_FadeInIntro(void)
{
    struct CourseSelectionScreen *coursesScreen = (void *)(0x03000000 + ((gCurTask)->data));
    ({ (coursesScreen)->cameraScrollX = (coursesScreen->cameraScrollX + (256 * 3)); if ((coursesScreen)->cameraScrollX < 0) { (coursesScreen)->cameraScrollX = 0; } else if ((coursesScreen)->cameraScrollX > (240 * 256)) { (coursesScreen)->cameraScrollX = (240 * 256); } });


    if (UpdateScreenFade(&coursesScreen->fade) == 1) {
        if (coursesScreen->cameraScrollX == (240 * 256)
            || coursesScreen->cameraScrollX >= coursesScreen->avatarTargetX - ((240 * 256) / 2)) {
            coursesScreen->cameraScrollX = coursesScreen->avatarTargetX - ((240 * 256) / 2);
    ...
    if (coursesScreen->cameraScrollX >= coursesScreen->avatarTargetX - ((240 * 256) / 2)) {
        coursesScreen->cameraScrollX = coursesScreen->avatarTargetX - ((240 * 256) / 2);
...
static void Task_FadeInIntroAndStartUnlockCutScene(void)
{
    ...
    ({ (zoneName)->x -= 16; if ((zoneName)->x < (240 - 160)) { (zoneName)->x = (240 - 160); } });

    if (UpdateScreenFade(&coursesScreen->fade) == 1) {
        if (coursesScreen->cameraScrollX == (240 * 256)
            || coursesScreen->cameraScrollX
                >= ((sZoneMapCourseXPositions[coursesScreen->unlockedCourse] * 256) - ((240 * 256) / 2))) {
            coursesScreen->cameraScrollX
                = (sZoneMapCourseXPositions[coursesScreen->unlockedCourse] * 256) - ((240 * 256) / 2);
            m4aSongNumStart(214);
    ...
    ({ (coursesScreen)->cameraScrollX = ((sZoneMapCourseXPositions[coursesScreen->unlockedCourse] * 256) - ((240 * 256) / 2)); if ((coursesScreen)->cameraScrollX < 0) { (coursesScreen)->cameraScrollX = 0; } else if ((coursesScreen)->cameraScrollX > (240 * 256)) { (coursesScreen)->cameraScrollX = (240 * 256); } });
    ({ gBgScrollRegs[0][0] = (((coursesScreen)->cameraScrollX) >> 8); RenderZoneMapPathsAndUI(coursesScreen); });
}
...
static void Task_CourseSelectMain(void)
{
    ...
    ({ (coursesScreen)->cameraScrollX = (coursesScreen->avatarTargetX - ((240 * 256) / 2)); if ((coursesScreen)->cameraScrollX < 0) { (coursesScreen)->cameraScrollX = 0; } else if ((coursesScreen)->cameraScrollX > (240 * 256)) { (coursesScreen)->cameraScrollX = (240 * 256); } });
    ({ gBgScrollRegs[0][0] = (((coursesScreen)->cameraScrollX) >> 8); RenderZoneMapPathsAndUI(coursesScreen); });
}
...
static void DestroyUI(struct CourseSelectionScreen *coursesScreen)
{
    ...
    if (coursesScreen->playerAvatar.graphics.dest != ((void *)0)) {
        VramFree(coursesScreen->playerAvatar.graphics.dest);
        coursesScreen->playerAvatar.graphics.dest = ((void *)0);
    }

    for (i = 0; i < 8; i++) {
        if (coursesScreen->mapPaths[i].graphics.dest != ((void *)0)) {
            VramFree(coursesScreen->mapPaths[i].graphics.dest);
            coursesScreen->mapPaths[i].graphics.dest = ((void *)0);
        }
    }

    if (coursesScreen->zoneActUnits[0].graphics.dest != ((void *)0)) {
        VramFree(coursesScreen->zoneActUnits[0].graphics.dest);
        coursesScreen->zoneActUnits[0].graphics.dest = ((void *)0);
    }

    if (coursesScreen->zoneActUnits[1].graphics.dest != ((void *)0)) {
        VramFree(coursesScreen->zoneActUnits[1].graphics.dest);
        coursesScreen->zoneActUnits[1].graphics.dest = ((void *)0);
    }

    if (coursesScreen->zoneType.graphics.dest != ((void *)0)) {
        VramFree(coursesScreen->zoneType.graphics.dest);
        coursesScreen->zoneType.graphics.dest = ((void *)0);
    }

    if (coursesScreen->zoneName.graphics.dest != ((void *)0)) {
        VramFree(coursesScreen->zoneName.graphics.dest);
        coursesScreen->zoneName.graphics.dest = ((void *)0);
    }

    if (coursesScreen->screenTitle.graphics.dest != ((void *)0)) {
        VramFree(coursesScreen->screenTitle.graphics.dest);
        coursesScreen->screenTitle.graphics.dest = ((void *)0);
    }
}
...
static void CourseSelectionScreenOnDestroy(struct Task *t) { DestroyUI((void *)(0x03000000 + ((t)->data))); }
