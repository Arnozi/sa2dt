...
void sub_8088944(struct TimeAttackLobbyScreen *lobbyScreen)
{
    ...
    background->graphics.anim = 0;
    background->layoutVram = (void *)(0x6000000 + (0x800 * (7)));
    background->unk18 = 0;
    background->unk1A = 0;
...
{
    struct TimeAttackLobbyScreen *lobbyScreen = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s;
    u32 i;
...
void CreateTimeAttackLobbyScreen()
{
    ...
    struct TimeAttackLobbyScreen *lobbyScreen = (void *)(0x03000000 + ((t)->data));
