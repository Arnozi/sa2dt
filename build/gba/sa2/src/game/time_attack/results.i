...
u32 CreateTimeAttackResults(u32 finishTime)
{
    ...
    resultsCutScene = (void *)(0x03000000 + ((t)->data));
    ...
    resultsCutScene->transform.x = (240 / 2);
    resultsCutScene->transform.y = (160 / 2) + 40;
...
{
    TimeAttackResultsCutScene *resultsCutScene = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s;
...
{
    u32 i;
    TimeAttackResultsCutScene *resultsCutScene = (void *)(0x03000000 + ((t)->data));
