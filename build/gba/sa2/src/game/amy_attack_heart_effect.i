# 0 "src/game/amy_attack_heart_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/amy_attack_heart_effect.c"
...
# 2 "src/game/amy_attack_heart_effect.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/amy_attack_heart_effect.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/amy_attack_heart_effect.c" 2
# 1 "include/task.h" 1
# 5 "src/game/amy_attack_heart_effect.c" 2
...
# 7 "src/game/amy_attack_heart_effect.c" 2
...
# 8 "src/game/amy_attack_heart_effect.c" 2
...
# 9 "src/game/amy_attack_heart_effect.c" 2
...
# 10 "src/game/amy_attack_heart_effect.c" 2
...
# 12 "src/game/amy_attack_heart_effect.c" 2

# 1 "include/constants/char_states.h" 1
# 14 "src/game/amy_attack_heart_effect.c" 2
...
void Task_AmyAttackHeartEffect(void)
{
    ...
    if ((!(!(gPlayer.moveState & 0x00000080))) || ((*(u32 *)&hearts->unk100 != *(u32 *)&gPlayer.anim) && (*(u32 *)&gPlayer.anim != 0x0001019F)))
...
{
    AmyAtkHearts *hearts = (void *)(0x03000000 + ((gCurTask)->data));
    u8 i = 0;
