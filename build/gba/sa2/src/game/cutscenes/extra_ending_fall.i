# 0 "src/game/cutscenes/extra_ending_fall.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/extra_ending_fall.c"
...
# 2 "src/game/cutscenes/extra_ending_fall.c" 2
...
# 3 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/game/cutscenes/extra_ending_slides.h" 1
...
# 4 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/core.h" 1
...
# 5 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/sprite.h" 1
# 6 "src/game/cutscenes/extra_ending_fall.c" 2
...
# 7 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/task.h" 1
# 8 "src/game/cutscenes/extra_ending_fall.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/trig.h" 1
...
# 10 "src/game/cutscenes/extra_ending_fall.c" 2
...
# 11 "src/game/cutscenes/extra_ending_fall.c" 2
...
# 12 "src/game/cutscenes/extra_ending_fall.c" 2
...
# 14 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/cutscenes/extra_ending_fall.c" 2
# 1 "include/constants/tilemaps.h" 1
# 16 "src/game/cutscenes/extra_ending_fall.c" 2
...
__attribute__((unused)) static const u32 gUnknown_080E155C[] = {
...
void CreateExtraEndingFallCutScene(void)
{
    u8 j, i;
    struct Task *t;
    struct ExtraEndingCutScene *scene = ((void *)0);
    ...
    for (i = 0; i < 6; i++) {
        ...
        s = &scene->unkD0[i];
        s->graphics.dest = (void *)scene->unk398;
        scene->unk398 += gUnknown_080E12FC[i + 0xD].numTiles * 32;
...

    {
        ...
        s = &scene->unk1F0;
        s->graphics.dest = (void *)scene->unk398;
        scene->unk398 += gUnknown_080E12FC[19].numTiles * 32;
...

    {
        ...
        s = &scene->unk220;
        s->graphics.dest = (void *)scene->unk398;
        scene->unk398 += gUnknown_080E12FC[20].numTiles * 32;
...

    {
        ...
        s = &scene->unk340;
        s->graphics.dest = (void *)scene->unk398;
        scene->unk398 += gUnknown_080E12FC[9].numTiles * 64;
...

    {
        ...
        s = &scene->unk250;
        s->graphics.dest = (void *)scene->unk398;
        scene->unk398 += gUnknown_080E12FC[8].numTiles * 32;
...
void sub_8090480(void)
{
    struct ExtraEndingCutScene *scene = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    if (scene->unk37C < 0xD) {
        scene->unk3E0[0] = ((s32)((scene->unk460)*256));
        scene->unk3E0[1] = ((s32)((80)*256));
    } else if (scene->unk37C == 0xD) {
        if (scene->unk3E0[1] > -((s32)((50)*256))) {
            scene->unk3E0[1] -= ((s32)((1)*256));

            if (scene->unk3E0[0] < ((s32)((170)*256))) {
                if (scene->unk38E < ((s32)((4)*256))) {
                    scene->unk38E++;
                }
                scene->unk3E0[0] += (gSineTable[(scene->unk38E)]);
            }
        } else {
            scene->unk3E0[0] = ((s32)((120)*256));
            scene->unk37C++;
        }
    } else if (scene->unk37C == 0xF) {
        if (scene->unk3E0[1] < ((s32)((85)*256))) {
            scene->unk3E0[1] += ((s32)((0.3125)*256));
        } else {
            scene->unk37C++;
            scene->unk394 = 0x3C;
        }
        ...
        scene->unk3E0[1] += ((gSineTable[(((scene->unk394 << 1) & 0xFF) * 4)]) >> 6) >> val;
        ...
        if ((scene->unk3E0[1] > (scene->unk470[1] - ((s32)((60)*256)))) && (scene->unk37C == 0x11)) {
            scene->unk37C++;
        }
        if (scene->unk3E0[1] < (scene->unk470[1] - ((s32)((40)*256)))) {
            scene->unk3E0[1] += ((s32)((1)*256));
        }
    }
...
{
    if (scene->unk37C < 0xD) {
        scene->unk470[0] = ((s32)((120)*256));
        scene->unk470[1] = ((s32)((70)*256));
    } else if (scene->unk37C == 0xD && scene->unk470[1] < ((s32)((140)*256))) {
        scene->unk470[1] += ((s32)((0.5)*256));
    } else if (scene->unk37C == 0xE) {
        if (scene->unk470[1] > ((s32)((85)*256))) {
            scene->unk470[1] -= ((s32)((0.25)*256));
        } else {
            scene->unk37C++;
        }
    } else if (scene->unk37C < 0x11) {
        if (scene->unk470[1] < ((s32)((135)*256))) {
            scene->unk470[1] += ((s32)((0.25)*256));
        }
    } else {
        scene->unk470[1] -= 8;
    ...
    if (scene->unk37C > 0xD) {
        if (scene->unk396 < ((s32)((4)*256))) {
            scene->unk396 += ((s32)((0.125)*256));
        } else {
            scene->unk396 = 0;
        }

        scene->unk470[1] += (gSineTable[((scene->unk396 & 0xFF) * 4)]) >> 6;
    }
}
...
void sub_8090904(struct ExtraEndingCutScene *scene)
{
    ...
    if (scene->unk37C == 0xE || scene->unk37C == 0xD) {
        for (i = 0; i < 6; i++) {
            if ((scene->unk47C[i][0] > -((s32)((10)*256)) && scene->unk47C[i][0] < ((s32)((250)*256)))
                || (scene->unk47C[i][1] > -((s32)((10)*256)) && scene->unk47C[i][1] < ((s32)((170)*256)))) {
                if (i < 3) {
                    scene->unk47C[i][0] -= ((s32)((scene->unk47C[i][2])*256));
                } else {
                    scene->unk47C[i][0] += ((s32)((scene->unk47C[i][2])*256));
                }
                scene->unk47C[i][1] -= ((s32)((scene->unk47C[i][2])*256));
            }
        }
    }
    ...
    if (scene->unk37C > 0xE) {
        for (i = 0; i < 6; i++) {
            if (scene->unk381[i] < 0x11) {
                if (i < 3) {
                    if (scene->unk47C[i][0] < (scene->unk470[0] + ((s32)((60)*256)))) {
                        scene->unk47C[i][0] += scene->unk47C[i][2] * ((s32)((0.5)*256));
                    } else {
                        scene->unk381[i] |= 0x10;
                    }

                    if ((scene->unk381[i] & 1) == 0) {
                        if (scene->unk47C[i][1] < (scene->unk470[1] - ((s32)((30)*256)))) {
                            scene->unk47C[i][1] += scene->unk47C[i][2] * ((s32)((0.5)*256));
                        } else {
                            scene->unk381[i] |= 1;
                        }
            ...
            if (scene->unk381[i] > 0xF) {
                ...
                if (scene->unk47C[i][3] > ((s32)((1023)*256))) {
                    scene->unk47C[i][3] = 0;
                }

                if ((gSineTable[(((scene->unk47C[i][3] >> 2) & 0xFF) * 4) + 256]) >> 8 < 0) {
                    scene->unk387[i] = 1;
                } else {
                    scene->unk387[i] = 2;
                }

                scene->unk47C[i][0] += (gSineTable[(((scene->unk47C[i][3] >> 2) & 0xFF) * 4) + 256]) >> 8;
            }

            if ((scene->unk381[i] & 1) != 0) {
                scene->unk47C[i][4] += scene->unk47C[i][2] * 2;

                if (scene->unk47C[i][4] > ((s32)((1023)*256))) {
                    scene->unk47C[i][4] = 0;
                }

                scene->unk47C[i][1] = scene->unk470[1] - ((s32)((30)*256)) + (((gSineTable[((scene->unk47C[i][4] & 0xFF) * 4)]) >> 6) * 8);
            }
...
void sub_8090CA0(struct ExtraEndingCutScene *scene)
{
    ...
    if (scene->unk37C > 12) {
        for (i = 0; i < 6; i++) {
            if ((scene->unk584[i][0] > -((s32)((10)*256)) && scene->unk584[i][0] < ((s32)((250)*256)))
                || (scene->unk584[i][1] > -((s32)((10)*256)) && scene->unk584[i][1] < ((s32)((170)*256)))) {
                if (i < 3) {
...
void sub_8090F6C(struct ExtraEndingCutScene *scene)
{
    if (scene->unk37C < 0xD) {
        ...
        if (scene->unk37F != 0) {
            scene->unk37F--;
            if (scene->unk37E <= 3) {
                { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gUnknown_080E15C8[scene->unk37E]); dmaRegs[1] = (vu32)(&gObjPalette[(3)*16u + (0)]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gUnknown_080E15C8[0]))/(32/8)))); dmaRegs[2]; };
            } else {
                { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gUnknown_080E15C8[6 - scene->unk37E]); dmaRegs[1] = (vu32)(&gObjPalette[(3)*16u + (0)]); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gUnknown_080E15C8[0]))/(32/8)))); dmaRegs[2]; };
            }
        } else {
            scene->unk37E++;
