...
void CreateCreditsEndCutScene(u8 creditsVariant)
{
    ...
    s32 r6 = 1;
    struct Task *t;
    struct CreditsEndCutScene *scene = ((void *)0);
    ScreenFade *fade;
    gDispCnt = 0x1040;
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((0x6000000 + (((++r6, --r6)) << 14))); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(Background) * 256)/(32/8)))); dmaRegs[2]; }; };
    ...
    scene->unk16C = (u8*)(0x6000000 + 0x10000);
...
{
    struct CreditsEndCutScene *scene = (void *)(0x03000000 + ((gCurTask)->data));
