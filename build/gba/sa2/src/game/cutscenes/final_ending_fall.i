...
void CreateFinalEndingFallCutScene(void)
{
    ...
    struct Task *t;
    struct FinalEndingFallCutScene *scene = ((void *)0);
    ...
    scene->unk494 = (u8*)(0x6000000 + 0x10000);
    {
        Sprite *s;
        s = &scene->unk80;
        s->graphics.dest = (u8*)(0x6000000 + 0x10000);
...
{
    struct FinalEndingFallCutScene *scene = (void *)(0x03000000 + ((gCurTask)->data));
    sub_8091F68(scene);
    sub_809205C(scene);
    sub_80920E4(scene);
    sub_8092804(scene);
...
{
    CpuFastSet((void *)((u16 *)(0x5000000 + 0x200)) + 0x100, (void *)0x5000000 + 0x100, 1);
    CpuFastSet((void *)((u16 *)(0x5000000 + 0x200)) + 0x120, (void *)0x5000000 + 0x120, 1);
}
