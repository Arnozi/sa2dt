# 0 "src/game/cutscenes/endings.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/cutscenes/endings.c"
...
# 2 "src/game/cutscenes/endings.c" 2
...
# 3 "src/game/cutscenes/endings.c" 2
# 1 "include/core.h" 1
...
# 4 "src/game/cutscenes/endings.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/cutscenes/endings.c" 2
...
# 6 "src/game/cutscenes/endings.c" 2
# 1 "include/task.h" 1
# 7 "src/game/cutscenes/endings.c" 2
# 1 "include/game/cutscenes/extra_ending_fall.h" 1
...
# 8 "src/game/cutscenes/endings.c" 2
# 1 "include/game/cutscenes/final_ending_fall.h" 1
...
# 9 "src/game/cutscenes/endings.c" 2
# 1 "include/malloc_vram.h" 1
# 10 "src/game/cutscenes/endings.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 11 "src/game/cutscenes/endings.c" 2
# 1 "include/trig.h" 1
...
# 12 "src/game/cutscenes/endings.c" 2
...
# 13 "src/game/cutscenes/endings.c" 2

# 1 "include/constants/songs.h" 1
# 15 "src/game/cutscenes/endings.c" 2
...
void StartEndingCutscenes(void)
{
    ...
    struct EndingCutSceneTransition *fade = (void *)(0x03000000 + ((t)->data));
...
void sub_808E8F8(s16 *ptr, s16 a, u8 b)
{
    if (*ptr != a) {
        *ptr = a;
        ...
        u16 rand = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
        if (rand >> 8 != 0) {
            *ptr += ((rand) >> ((16 - b)));
        } else {
            *ptr -= ((rand) >> ((8 - b)));
...
void sub_808E9AC(void)
{
    struct EndingCutSceneTransition *fade = (void *)(0x03000000 + ((gCurTask)->data));

    if (fade->unk6E != 0) {
        fade->unk6E--;
    } else {
        if (gCurrentLevel == (((7)*(3 + 1)) + (1) + 1)) {
...
void sub_808E9F8(__attribute__((unused)) struct Task *t)
{

}

__attribute__((unused)) void sub_808E9FC(void)
{
    struct EndingCutSceneTransition *fade = (void *)(0x03000000 + ((gCurTask)->data));
    if (gLoadedSaveGame->unlockedLevels[gSelectedCharacter] > (((7)*(3 + 1)) + (1))) {
        fade->unk6D = 2;
    } else {
        fade->unk6D = 1;
    }
