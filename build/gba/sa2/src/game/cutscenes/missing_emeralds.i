...
void CreateMissingChaosEmaraldsCutScene(void)
{
    u8 i;
    struct Task *t;
    struct MissingChaosEmaraldsCutScene *scene = ((void *)0);
    ...
    scene->unkC4 = (u8*)(0x6000000 + 0x10000);
...
void Task_8094360(void)
{
    ...
    struct MissingChaosEmaraldsCutScene *scene = (void *)(0x03000000 + ((gCurTask)->data));
