# 0 "src/game/interactables_2/egg_utopia/pole.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/egg_utopia/pole.c"
...
# 2 "src/game/interactables_2/egg_utopia/pole.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/egg_utopia/pole.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_2/egg_utopia/pole.c" 2
...
# 6 "src/game/interactables_2/egg_utopia/pole.c" 2
...
# 7 "src/game/interactables_2/egg_utopia/pole.c" 2
...
# 10 "src/game/interactables_2/egg_utopia/pole.c" 2

# 1 "include/constants/char_states.h" 1
# 12 "src/game/interactables_2/egg_utopia/pole.c" 2
# 1 "include/constants/player_transitions.h" 1
# 13 "src/game/interactables_2/egg_utopia/pole.c" 2
# 1 "include/constants/songs.h" 1
# 14 "src/game/interactables_2/egg_utopia/pole.c" 2
...
void CreateEntity_Pole(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Pole *pole = (void *)(0x03000000 + ((t)->data));
    pole->worldX = ((me->x)*8 + (spriteRegionX)*256);
    pole->worldY = ((me->y)*8 + (spriteRegionY)*256);

    pole->left = me->d.sData[0] * 8;
    pole->top = me->d.sData[1] * 8;
    pole->right = pole->left + me->d.uData[2] * 8;
    pole->bottom = pole->top + me->d.uData[3] * 8;
...
static void Task_807EA8C(void)
{
    Sprite_Pole *pole = (void *)(0x03000000 + ((gCurTask)->data));

    if (gPlayer.moveState & 0x00000080) {
        sub_807ED68(pole);
        return;
    }
    if (gPlayer.timerInvulnerability == (int)(((0 * 60.) + 2) * 60)) {
        sub_807ED88(pole);
        return;
    }
    ...
    if (gPlayer.frameInput & gPlayerControls.jump) {
        u16 leftPressed = gPlayer.heldInput & 0x0020;
        if (leftPressed != 0) {
            leftPressed = 1;
        }
...
static void Pole_TransitionPlayerSliding(Sprite_Pole *pole)
{
    ...
    gPlayer.qWorldX = ((s32)((pole->middleX)*256));
...
static bool32 PoleIsOffScreen(Sprite_Pole *pole)
{
    ...
    if (screenX + pole->right < -((256) / 2) || screenX + pole->left > (240 + ((256) / 2))
        || screenY + pole->bottom < -((256) / 2) || screenY + pole->top > (160 + ((256) / 2))) {
        return 1;
    }
