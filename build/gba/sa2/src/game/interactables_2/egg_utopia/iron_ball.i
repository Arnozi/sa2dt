# 0 "src/game/interactables_2/egg_utopia/iron_ball.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/egg_utopia/iron_ball.c"
...
# 2 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
# 1 "include/task.h" 1
# 5 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
...
# 8 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
...
# 10 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
...
# 11 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
...
# 6 "include/game/interactables_2/egg_utopia/iron_ball.h" 2

void CreateEntity_IronBall(MapEntity *, u16, u16, u8);
# 12 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
...
# 14 "src/game/interactables_2/egg_utopia/iron_ball.c" 2
...
void CreateEntity_IronBall(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_IronBall *ball = (void *)(0x03000000 + ((t)->data));
    Sprite *s;
    ball->unk44 = 0;
    ball->unk48 = 0;
...
static void UpdatePosition(Sprite_IronBall *ball)
{
    ...
    if (ball->unk4C != 0) {
        s32 temp = me->d.uData[2] * ((s32)((8)*256));
        ball->unk44 = (temp * (gSineTable[((ball->unk4C * ((gStageTime + ball->unk50) & 255)) & (1024 - 1))])) >> 15;
    }

    if (ball->unk4E != 0) {
        s32 temp = (me->d.uData[3] * ((s32)((8)*256)));
        ball->unk48 = (temp * (gSineTable[((ball->unk4E * ((gStageTime + ball->unk50) & 255)) & (1024 - 1))])) >> 15;
    }

    ball->posX = ((ball->base.meX)*8 + (ball->base.regionX)*256) + ((int)((ball->unk44) >> 8));
    ball->posY = ((me->y)*8 + (ball->base.regionY)*256) + ((int)((ball->unk48) >> 8));
}

static void Task_Interactable095Main(void)
{
    Sprite_IronBall *ball = (void *)(0x03000000 + ((gCurTask)->data));
