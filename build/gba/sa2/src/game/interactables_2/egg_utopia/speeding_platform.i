...
void CreateEntity_SpeedingPlatform(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_SpeedingPlatform *platform = (void *)(0x03000000 + ((t)->data));
    Sprite *s;
    platform->unk54 = 0;
    platform->unk58 = 0;
    platform->unk5A = 0;
...
{
    Sprite_SpeedingPlatform *platform = (void *)(0x03000000 + ((gCurTask)->data));
...
static bool32 ShouldDespawn(Sprite_SpeedingPlatform *platform)
{
    ...
    if (x < -((256 / 2) + 64) || x > (240 + ((256 / 2) + 64)) || y + 32 < -(256 / 2)
        || y - 32 > (160 + (256 / 2))) {
        return 1;
    }
