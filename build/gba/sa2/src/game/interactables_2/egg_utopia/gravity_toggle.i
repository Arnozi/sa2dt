# 0 "src/game/interactables_2/egg_utopia/gravity_toggle.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/egg_utopia/gravity_toggle.c"
# 1 "include/core.h" 1
...
# 2 "src/game/interactables_2/egg_utopia/gravity_toggle.c" 2
...
# 3 "src/game/interactables_2/egg_utopia/gravity_toggle.c" 2
...
# 4 "src/game/interactables_2/egg_utopia/gravity_toggle.c" 2
...
# 6 "include/game/interactables_2/egg_utopia/gravity_toggle.h" 2
...
# 5 "src/game/interactables_2/egg_utopia/gravity_toggle.c" 2
...
static void CreateEntity_Toggle_Gravity(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 id, u8 toggleKind)
{
    ...
    Sprite_GravityToggle *toggle = (void *)(0x03000000 + ((t)->data));

    toggle->kind = toggleKind;
    toggle->x = ((me->x)*8 + (spriteRegionX)*256);
    toggle->y = ((me->y)*8 + (spriteRegionY)*256);
    toggle->left = (me->d.sData[0] * 8);
    toggle->top = (me->d.sData[1] * 8);
    toggle->right = toggle->left + (me->d.uData[2] * 8);
    toggle->bottom = toggle->top + (me->d.uData[3] * 8);
...
{
    Sprite_GravityToggle *toggle = (void *)(0x03000000 + ((gCurTask)->data));
...
void TaskDestructor_GravityToggle(__attribute__((unused)) struct Task *t) { }
...
{
    CreateEntity_Toggle_Gravity(me, spriteRegionX, spriteRegionY, id, 0);
}

void CreateEntity_Toggle_Gravity__Up(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 id)
{
    CreateEntity_Toggle_Gravity(me, spriteRegionX, spriteRegionY, id, 1);
}

void CreateEntity_Toggle_Gravity__Toggle(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 id)
{
    CreateEntity_Toggle_Gravity(me, spriteRegionX, spriteRegionY, id, 2);
}
