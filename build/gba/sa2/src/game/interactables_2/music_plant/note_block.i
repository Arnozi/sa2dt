...
void CreateEntity_NoteBlock(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_NoteBlock *block = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &block->s;
    ...
    s->graphics.dest = &((u8 *)(u8*)(0x6000000 + 0x10000))[sAnims[block->type][2] * 32];
...
{
    Sprite_NoteBlock *block = (void *)(0x03000000 + ((gCurTask)->data));
...
static void LaunchPlayer(Sprite_NoteBlock *block)
{
    ...
    if (--block->health == 1) {
        block->s.graphics.dest = &((u8 *)(u8*)(0x6000000 + 0x10000))[sAnims[(sizeof(sAnims) / sizeof((sAnims)[0])) - 1][2] * 32];
...
static bool32 ShouldDespawn(Sprite_NoteBlock *block)
{
    ...
    screenY -= gCamera.y;
# 226 "src/game/interactables_2/music_plant/note_block.c"
    otherY = screenY;
    otherX = screenX;
