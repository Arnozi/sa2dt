# 0 "src/game/interactables_2/music_plant/keyboard.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/music_plant/keyboard.c"
...
# 2 "src/game/interactables_2/music_plant/keyboard.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/interactables_2/music_plant/keyboard.c" 2
# 1 "include/task.h" 1
...
# 4 "src/game/interactables_2/music_plant/keyboard.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/interactables_2/music_plant/keyboard.c" 2
...
# 7 "src/game/interactables_2/music_plant/keyboard.c" 2
...
# 10 "src/game/interactables_2/music_plant/keyboard.c" 2
...
# 11 "src/game/interactables_2/music_plant/keyboard.c" 2

# 1 "include/constants/char_states.h" 1
# 13 "src/game/interactables_2/music_plant/keyboard.c" 2
# 1 "include/constants/player_transitions.h" 1
# 14 "src/game/interactables_2/music_plant/keyboard.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/interactables_2/music_plant/keyboard.c" 2
...
const s16 sKeyboardAccelMusicPlant[3][2] = {
    { ((s16)((3.0)*256)), ((s16)((4.0)*256)) },
    { ((s16)((5.0)*256)), ((s16)((8.0)*256)) },
    { ((s16)((5.0)*256)), ((s16)((8.0)*256)) },
};

const s16 sKeyboardAccelTechnoBase[3][2] = {
    { ((s16)((7.5)*256)), ((s16)((7.5)*256)) },
    { ((s16)((5.0)*256)), ((s16)((8.0)*256)) },
    { ((s16)((5.0)*256)), ((s16)((8.0)*256)) },
};
...
void CreateEntity_Keyboard(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u32 type)
{
    ...
    Sprite_Keyboard *kb = (void *)(0x03000000 + ((t)->data));
    kb->kbType = type;
    kb->cooldown = 0;
    kb->posX = ((me->x)*8 + (spriteRegionX)*256);
    kb->posY = ((me->y)*8 + (spriteRegionY)*256);

    kb->left = me->d.sData[0] * 8;
    kb->top = me->d.sData[1] * 8;
    kb->right = kb->left + me->d.uData[2] * 8;
    kb->bottom = kb->top + me->d.uData[3] * 8;
...
static void BouncePlayer(Sprite_Keyboard *kb)
{
    ...
    switch (kb->kbType) {
        case 0: {
            if (kb->left > 0) {
                ...
                noteAccelX1 = ((s16)((7. / 8.)*256));
                noteAccelY1 = -((s16)((4.5)*256));
                noteAccelX2 = -((s16)((7. / 8.)*256));
    ...
    if (((gCurrentLevel) >> 2) != 5) {
        CreateNoteParticle(((int)((gPlayer.qWorldX) >> 8)), ((int)((gPlayer.qWorldY) >> 8)), 5, 30, noteAccelX1, noteAccelY1, 0);
        CreateNoteParticle(((int)((gPlayer.qWorldX) >> 8)), ((int)((gPlayer.qWorldY) >> 8)), 5, 30, noteAccelX2, noteAccelY2, 1);
    }
}
...
static void Task_Keyboard(void)
{
    Sprite_Keyboard *kb = (void *)(0x03000000 + ((gCurTask)->data));
...
static void TaskDestructor_Keyboard(struct Task *__attribute__((unused)) t) { }
...
static bool32 ShouldDespawn(Sprite_Keyboard *kb)
{
    ...
    if (((screenX + kb->radiusRight) < -(256 / 2)) || ((screenX + kb->radiusLeft) > 240 + (256 / 2))
        || (screenY + kb->radiusBottom < -(256 / 2))
        || ((screenY + kb->radiusTop) > 160 + (256 / 2))) {
        return 1;
    }
