# 0 "src/game/interactables_2/music_plant/french_horn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/music_plant/french_horn.c"
# 1 "include/core.h" 1
...
# 2 "src/game/interactables_2/music_plant/french_horn.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/interactables_2/music_plant/french_horn.c" 2
...
# 5 "src/game/interactables_2/music_plant/french_horn.c" 2
# 1 "include/game/interactables_2/music_plant/french_horn.h" 1



# 1 "include/global.h" 1
# 5 "include/game/interactables_2/music_plant/french_horn.h" 2
...
# 6 "include/game/interactables_2/music_plant/french_horn.h" 2
...
# 7 "include/game/interactables_2/music_plant/french_horn.h" 2
...
# 6 "src/game/interactables_2/music_plant/french_horn.c" 2



# 1 "include/constants/player_transitions.h" 1
# 10 "src/game/interactables_2/music_plant/french_horn.c" 2
# 1 "include/constants/char_states.h" 1
# 11 "src/game/interactables_2/music_plant/french_horn.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/game/interactables_2/music_plant/french_horn.c" 2
...
# 14 "src/game/interactables_2/music_plant/french_horn.c" 2
...
const PipeSegment gFrenchHornPipeSequence0[] = {
    {
        .type = 0,
        .step = 34,
        { ._16 = { ((s16)((8.0)*256)), ((s16)((8.0)*256)) } },
    },
    {
        .type = 0,
        .step = 120,
        { ._16 = { ((s16)((96.0)*256)), ((s16)((96.0)*256)) } },
    },
    {
        .type = 0,
        .step = 341,
        { ._16 = { ((s16)((32.0)*256)), ((s16)((32.0)*256)) } },
    },
    {
        9,
        640,
...
const PipeSegment gFrenchHornPipeSequence1[] = {
    ...
    },
    {
        9,
        640,
        { ._16 = { ((s16)((40.0)*256)), ((s16)((0.0)*256)) } },
    },
    {
        3,
        320,
        { ._16 = { ((s16)((56.0)*256)), ((s16)((0.0)*256)) } },
    },
    {
        5,
        320,
...
{
    Sprite_FrenchHorn *horn = (void *)(0x03000000 + ((gCurTask)->data));
...
static void FrenchHorn_BeginPipeSequence(Sprite_FrenchHorn *horn)
{
    ...
    InitPipeSequence(&horn->pipeSequence, ((s32)((horn->entryPosX)*256)), ((s32)((horn->entryPosY)*256)));
...
void CreateEntity_FrenchHorn_Entry(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_FrenchHorn *horn = (void *)(0x03000000 + ((t)->data));
    ...
    horn->entryPosX = ((me->x)*8 + (spriteRegionX)*256);
    horn->entryPosY = ((me->y)*8 + (spriteRegionY)*256);
