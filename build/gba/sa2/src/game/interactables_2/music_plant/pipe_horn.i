# 0 "src/game/interactables_2/music_plant/pipe_horn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/music_plant/pipe_horn.c"
...
# 2 "src/game/interactables_2/music_plant/pipe_horn.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/interactables_2/music_plant/pipe_horn.c" 2
# 1 "include/trig.h" 1
...
# 4 "src/game/interactables_2/music_plant/pipe_horn.c" 2
...
# 5 "src/game/interactables_2/music_plant/pipe_horn.c" 2
...
# 7 "src/game/interactables_2/music_plant/pipe_horn.c" 2
...
# 10 "src/game/interactables_2/music_plant/pipe_horn.c" 2
...
# 13 "src/game/interactables_2/music_plant/pipe_horn.c" 2

# 1 "include/constants/char_states.h" 1
# 15 "src/game/interactables_2/music_plant/pipe_horn.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/interactables_2/music_plant/pipe_horn.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/interactables_2/music_plant/pipe_horn.c" 2
...
const PipeSegment gPipeHornPipeSequence0[] = {
    {
        .type = 0,
        .step = 34,
        { .translate = { .dX = ((s32)((8.0)*256)), .dY = ((s32)((0.0)*256)) } },
    },
    {
        .type = 0,
        .step = 204,
        { ._16 = ((s32)((80.0)*256)), ((s32)((0.0)*256)) },
    },
    {
        2,
        .step = 320,
...
const PipeSegment gUnknown_080DFD40[] = {
    {
        .type = 0,
        .step = 34,
        { ._16 = { ((s16)((8.0)*256)), ((s16)((0.0)*256)) } },
    },
    {
        .type = 0,
        .step = 204,
        { ._16 = { ((s16)((80.0)*256)), ((s16)((0.0)*256)) } },
    },
    {
        2,
        .step = 320,
...
const PipeSegment gUnknown_080DFDD8[] = {
    ...
    },
    {
        .type = 0,
        .step = 170,
        { ._16 = { ((s16)((96.0)*256)), ((s16)((0.0)*256)) } },
    },
    {
        .type = 0,
        256,
        { ._16 = { ((s16)((64.0)*256)), ((s16)((0.0)*256)) } },
    },
    {
        2,
        320,
...
static const s16 sExitSpeeds[9][2] = {
    { ((s16)((0.0)*256)), ((s16)((-9.0)*256)) }, { ((s16)((0.0)*256)), ((s16)((-12.0)*256)) }, { ((s16)((0.0)*256)), ((s16)((-9.0)*256)) },
    { ((s16)((0.0)*256)), ((s16)((-12.0)*256)) }, { ((s16)((9.0)*256)), ((s16)((-9.0)*256)) }, { ((s16)((0.0)*256)), ((s16)((-9.0)*256)) },
    { ((s16)((0.0)*256)), ((s16)((-12.0)*256)) }, { ((s16)((0.0)*256)), ((s16)((-9.0)*256)) }, { ((s16)((0.0)*256)), ((s16)((-12.0)*256)) },
};

static const s16 sExitRotations[14] = {
    ((s16)((0.75)*256)), ((s16)((0.75)*256)), ((s16)((0.75)*256)), ((s16)((0.75)*256)), ((s16)((0.875)*256)), ((s16)((0.75)*256)), ((s16)((0.75)*256)),
    ((s16)((0.75)*256)), ((s16)((0.75)*256)), ((s16)((-63.25)*256)), ((s16)((-63.25)*256)), ((s16)((-63.125)*256)), ((s16)((-63.25)*256)), ((s16)((0.75)*256)),
};
...
static void Task_Idle(void)
{
    Sprite_PipeHorn *pipe = (void *)(0x03000000 + ((gCurTask)->data));
...
static void BeginPipeSequence(Sprite_PipeHorn *pipe)
{
    ...
    InitPipeSequence(&pipe->pipeSequence, ((s32)((pipe->entryPosX)*256)), ((s32)((pipe->entryPosY + 4)*256)));
...
static bool32 ShouldDespawn(Sprite_PipeHorn *pipe)
{
    ...
    if (((screenX < -((256 / 2))) || (screenX > 240 + ((256 / 2))) || (screenY < -((256 / 2))) || (screenY > 160 + ((256 / 2))))) {
        return 1;
    }
...
void CreateEntity_PipeInstrument_Entry(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_PipeHorn *pipe = (void *)(0x03000000 + ((t)->data));
    ...
    pipe->entryPosX = ((me->x)*8 + (spriteRegionX)*256);
    pipe->entryPosY = ((me->y)*8 + (spriteRegionY)*256);
