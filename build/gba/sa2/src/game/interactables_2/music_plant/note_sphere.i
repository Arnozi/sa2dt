# 0 "src/game/interactables_2/music_plant/note_sphere.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/music_plant/note_sphere.c"
...
# 2 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
# 6 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
# 7 "src/game/interactables_2/music_plant/note_sphere.c" 2
# 1 "include/task.h" 1
...
# 8 "src/game/interactables_2/music_plant/note_sphere.c" 2
# 1 "include/trig.h" 1
...
# 9 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
# 11 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
# 14 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
# 15 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
# 17 "src/game/interactables_2/music_plant/note_sphere.c" 2
# 1 "include/constants/player_transitions.h" 1
# 18 "src/game/interactables_2/music_plant/note_sphere.c" 2
# 1 "include/constants/songs.h" 1
# 19 "src/game/interactables_2/music_plant/note_sphere.c" 2
...
static const u16 sNoteSphereAnimInfo[8][3] = {
    { 575, 7, 0x188 }, { 575, 8, 0x18E }, { 575, 9, 0x194 },
    { 575, 10, 0x19A }, { 575, 11, 0x1A0 }, { 575, 12, 0x1A6 },
    { 575, 13, 0x1AC }, { 575, 14, 0x1B2 },
};

static const s16 sNoteSphereVelocities[8] = {
    ((s16)((4.5)*256)), ((s16)((5.0)*256)), ((s16)((5.5)*256)), ((s16)((6.0)*256)), ((s16)((6.5)*256)), ((s16)((7.0)*256)), ((s16)((7.5)*256)), ((s16)((8.0)*256)),
};
...
void CreateEntity_NoteSphere(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_NoteSphere *note = (void *)(0x03000000 + ((t)->data));
    Sprite *s = &note->disp;
    note->unk44 = 0;
    note->unk46 = 0;
    ...
    s->graphics.dest = &((u8 *)(u8*)(0x6000000 + 0x10000))[sNoteSphereAnimInfo[note->kind][2] * 32];
    s->graphics.anim = sNoteSphereAnimInfo[note->kind][0];
    s->variant = sNoteSphereAnimInfo[note->kind][1];

    note->posX = ((me->x)*8 + (spriteRegionX)*256);
    note->posY = ((me->y)*8 + (spriteRegionY)*256);
...
{
    Sprite_NoteSphere *note = (void *)(0x03000000 + ((gCurTask)->data));

    switch (note->unk4A++) {
        case 0: {
            note->unk44 = (((int)(((gSineTable[(note->angle * 4) + 256])) >> 6)) * 8);
            note->unk46 = (((int)(((gSineTable[(note->angle * 4)])) >> 6)) * 8);
        } break;

        case 4: {
            note->unk44 = -(((int)(((gSineTable[(note->angle * 4) + 256])) >> 6)) * 4);
            note->unk46 = -(((int)(((gSineTable[(note->angle * 4)])) >> 6)) * 4);
        } break;
...
static void NoteSphere_ApplyCollisionPlayer(Sprite_NoteSphere *note)
{
    ...
    gPlayer.moveState = ((gPlayer.moveState | 0x00000002) & ~(0x00000100));
    note->unk4A = 0;
...
static u8 NoteSphere_BouncePlayer(Sprite_NoteSphere *note)
{
    ...
    vecPlayerToNoteX = ((int)((gPlayer.qWorldX) >> 8)) - note->posX;
    vecPlayerToNoteY = ((int)((gPlayer.qWorldY) >> 8)) - note->posY;
...

    {
        ...
        gPlayer.qSpeedAirX = ((int)((sNoteSphereVelocities[note->kind] * ((int)(((gSineTable[(r4 * 4) + 256])) >> 6))) >> 8));
        gPlayer.qSpeedAirY = ((int)((sNoteSphereVelocities[note->kind] * ((int)(((gSineTable[(r4 * 4)])) >> 6))) >> 8));
    }
...
static bool32 NoteSphere_IsPlayerColliding(Sprite_NoteSphere *note)
{
    if (!(gPlayer.moveState & 0x00000080)) {
        ...
        distanceX = ((note->posX - ((int)((gPlayer.qWorldX) >> 8))) >= 0 ? (note->posX - ((int)((gPlayer.qWorldX) >> 8))) : -(note->posX - ((int)((gPlayer.qWorldX) >> 8))));
        distanceY = ((note->posY - ((int)((gPlayer.qWorldY) >> 8))) >= 0 ? (note->posY - ((int)((gPlayer.qWorldY) >> 8))) : -(note->posY - ((int)((gPlayer.qWorldY) >> 8))));

        if ((((distanceX) > (distanceY)) ? (distanceX) : (distanceY)) < 25) {
...
static void TaskDestructor_Interactable_MusicPlant_Note_Sphere(struct Task *__attribute__((unused)) t) { }

static void NoteSphere_UpdateSpritePos(Sprite_NoteSphere *note)
{
    Sprite *s = &note->disp;

    s->x = (note->posX - gCamera.x) + ((int)((note->unk44) >> 8));
    s->y = (note->posY - gCamera.y) + ((int)((note->unk46) >> 8));
}
...
static bool32 NoteSphere_ShouldDespawn(Sprite_NoteSphere *note)
{
    ...
    screenX = (note->posX + (256 / 2));
    screenX -= gCamera.x;

    screenY = (note->posY + (256 / 2));
    screenY -= gCamera.y;

    posY = screenY;
    posX = screenX;

    if ((posX > (240 + 256)) || (posY > (160 + 256))) {
        return 1;
    }
