# 0 "src/game/interactables_2/music_plant/german_flute.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/music_plant/german_flute.c"
...
# 2 "src/game/interactables_2/music_plant/german_flute.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "src/game/interactables_2/music_plant/german_flute.c" 2
# 1 "include/task.h" 1
...
# 4 "src/game/interactables_2/music_plant/german_flute.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/interactables_2/music_plant/german_flute.c" 2
...
# 7 "src/game/interactables_2/music_plant/german_flute.c" 2
...
# 12 "src/game/interactables_2/music_plant/german_flute.c" 2
...
# 13 "src/game/interactables_2/music_plant/german_flute.c" 2

# 1 "include/constants/char_states.h" 1
# 15 "src/game/interactables_2/music_plant/german_flute.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/interactables_2/music_plant/german_flute.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/interactables_2/music_plant/german_flute.c" 2
...
static void sub_8076C88(Sprite_GermanFlute __attribute__((unused)) *);
static void sub_8076CC0(Sprite_GermanFlute __attribute__((unused)) *);
static void sub_8076CF4(Sprite_GermanFlute __attribute__((unused)) *);
static void sub_8076D08(Sprite_GermanFlute __attribute__((unused)) *);
...
static const s16 sFluteUpdraft[4] = {
    ((s16)((7)*256)),
    ((s16)((8)*256)),
    ((s16)((9)*256)),
    ((s16)((10)*256)),
...
static void sub_8076928(void)
{
    Sprite_GermanFlute *flute = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (gPlayer.moveState & 0x00000080) {
        ...
        s32 posX, posY;
        posX = ((s32)((flute->posX)*256));
        posY = ((s32)((flute->posY)*256)) + ((s32)((24)*256));

        if (gPlayer.qWorldX != posX) {
            if (gPlayer.qWorldX > posX) {
                gPlayer.qWorldX -= ((s32)((0.5)*256));
        ...
        if (((gPlayer.qWorldX - posX) >= 0 ? (gPlayer.qWorldX - posX) : -(gPlayer.qWorldX - posX)) <= ((s32)((8)*256))) {
            if (gPlayer.qWorldY != posY) {
                gPlayer.qSpeedAirY += ((s32)((1. / 6.)*256));
...
static void sub_80769E0(void)
{
    ...
    res = sub_801F100(((int)((gPlayer.qWorldY) >> 8)) - gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)), gPlayer.layer, -8, sub_801EC3C);
...
static void Task_8076A6C(void)
{
    ...
    flute->unkA = ((int)(((gSineTable[((u8)flute->timer * 4)])) >> 6)) * 8;
    r1 = gPlayer.qWorldX;
    gPlayer.qWorldY += flute->unkA;


    res = sub_801F100(((int)((gPlayer.qWorldY) >> 8)) - gPlayer.spriteOffsetY, ((int)((r1) >> 8)), gPlayer.layer, -8, sub_801EC3C);
    if (res < 0) {
        gPlayer.qWorldY -= ((s32)((res)*256));
    }
    ...
    if ((((s32)((flute->posX)*256)) - ((s32)((16)*256)) > gPlayer.qWorldX) || (((s32)((flute->posX)*256)) + ((s32)((16)*256)) < gPlayer.qWorldX)) {
        sub_8076C88(flute);
    }
...
static void sub_8076B84(Sprite_GermanFlute *flute)
{
    ...
    gPlayer.qWorldY = ((s32)((flute->posY - 8)*256));
...
static void sub_8076C88(Sprite_GermanFlute __attribute__((unused)) *flute)
{
    gPlayer.moveState &= ~0x00400000;
...
static void sub_8076CC0(Sprite_GermanFlute __attribute__((unused)) *flute)
{
    gPlayer.moveState &= ~0x00400000;
    gPlayer.transition = 5;
    gPlayer.qSpeedAirX = 0;
...
static void sub_8076CF4(Sprite_GermanFlute __attribute__((unused)) *flute) { gCurTask->main = Task_GermanFlute; }

static void sub_8076D08(Sprite_GermanFlute __attribute__((unused)) *flute)
{
    gPlayer.moveState &= ~0x00400000;
    gCurTask->main = Task_GermanFlute;
}
...
void CreateEntity_GermanFlute(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_GermanFlute *flute = (void *)(0x03000000 + ((t)->data));
    s32 posX, posY;

    posX = ((me->x)*8 + (spriteRegionX)*256);
    flute->posX = posX + (8 / 2);

    posY = ((me->y)*8 + (spriteRegionY)*256);
    flute->posY = posY;
...
{
    gPlayer.charState = 58;
    gPlayer.qSpeedAirX = 0;

    gPlayer.qSpeedAirY = -sFluteUpdraft[flute->kind];
    flute->timer = 0;
    CreateAngledNoteParticle(flute->posX, (flute->posY + 24), 0, 30, 0, ((int)((((double)(270)) / 360.0) * 1024)) / 4, 3);
...
static bool32 sub_8076EAC(Sprite_GermanFlute *flute)
{
    ...
    if ((screenX < -((256 + 8) / 2)) || (screenX > 240 + ((256 + 8) / 2))
        || (screenY < -(256 / 2)) || (screenY > 160 + (256 / 2))) {
        return 1;
    }
