# 0 "src/game/interactables_2/techno_base/light_globe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/techno_base/light_globe.c"
...
# 2 "src/game/interactables_2/techno_base/light_globe.c" 2
...
# 3 "src/game/interactables_2/techno_base/light_globe.c" 2
...
# 4 "src/game/interactables_2/techno_base/light_globe.c" 2
...
# 5 "src/game/interactables_2/techno_base/light_globe.c" 2

# 1 "include/task.h" 1
# 7 "src/game/interactables_2/techno_base/light_globe.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "src/game/interactables_2/techno_base/light_globe.c" 2
...
# 9 "src/game/interactables_2/techno_base/light_globe.c" 2
# 1 "include/malloc_vram.h" 1
# 10 "src/game/interactables_2/techno_base/light_globe.c" 2
# 1 "include/trig.h" 1
...
# 11 "src/game/interactables_2/techno_base/light_globe.c" 2
...
# 13 "src/game/interactables_2/techno_base/light_globe.c" 2
# 1 "include/constants/player_transitions.h" 1
# 14 "src/game/interactables_2/techno_base/light_globe.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/game/interactables_2/techno_base/light_globe.c" 2
...
void CreateEntity_LightGlobe(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_LightGlobe *globe = (void *)(0x03000000 + ((t)->data));
    Sprite *s;

    globe->unk44 = 0;
    globe->unk46 = 0;
    globe->unk48 = 0;
    globe->unk3C = ((me->x)*8 + (spriteRegionX)*256);
    globe->unk40 = ((me->y)*8 + (spriteRegionY)*256);
...
static bool32 sub_807B190(Sprite_LightGlobe *globe)
{
    ...
    temp3 = globe->unk3C;
    temp3 -= gCamera.x;
    temp3 += ((int)((globe->unk44) >> 8));

    temp4 = globe->unk40;
    temp4 -= gCamera.y;
    temp4 += ((int)((globe->unk46) >> 8));

    temp5 = temp3;
    temp6 = temp4;

    if (temp5 < -128 || temp5 > (240 + 128) || temp6 < -128 || (temp6 > (160 + 128) + 128)) {
        return 1;
    }
    return 0;
}
...
static bool32 sub_807B1F0(Sprite_LightGlobe *globe)
{
    ...
    r3 = globe->unk3C;
    r3 -= gCamera.x;
    r3 += ((int)((globe->unk44) >> 8));

    r2 = globe->unk40;
    r2 -= gCamera.y;
    r2 += ((int)((globe->unk46) >> 8));

    r0 = ((int)((gPlayer.qWorldX) >> 8));
    r0 -= gCamera.x;
    r1 = ((int)((gPlayer.qWorldY) >> 8));
    r1 -= gCamera.y;
...
static void Task_Interactable080(void)
{
    Sprite_LightGlobe *globe = (void *)(0x03000000 + ((gCurTask)->data));
...
{
    globe->unk44 = 0;
    globe->unk46 = ((int)(((gSineTable[(globe->unk48)])) >> 6));
    globe->unk48 = (globe->unk48 + 0x10) & (1024 - 1);
}

static void sub_807B350(Sprite_LightGlobe *globe)
{
    Sprite *s = &globe->s;
    s->x = globe->unk3C - gCamera.x + ((int)((globe->unk44) >> 8));
    s->y = globe->unk40 - gCamera.y + ((int)((globe->unk46) >> 8));
