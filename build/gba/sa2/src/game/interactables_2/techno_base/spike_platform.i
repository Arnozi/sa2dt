# 0 "src/game/interactables_2/techno_base/spike_platform.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/techno_base/spike_platform.c"
...
# 2 "src/game/interactables_2/techno_base/spike_platform.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/techno_base/spike_platform.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/techno_base/spike_platform.c" 2
# 1 "include/task.h" 1
# 5 "src/game/interactables_2/techno_base/spike_platform.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
# 9 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
# 11 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
# 12 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
# 13 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
# 14 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
# 15 "src/game/interactables_2/techno_base/spike_platform.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/game/interactables_2/techno_base/spike_platform.c" 2
...
static const u16 gUnknown_080E00B4[][2] = {
    { 596, 2 }, { 596, 3 }, { 596, 4 }, { 596, 5 },
    { 596, 6 }, { 596, 7 }, { 596, 8 }, { 596, 9 },
};
...
void CreateEntity_SpikePlatform(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_IA78 *ia78 = (void *)(0x03000000 + ((t)->data));
    ...
    ia78->unk3C = ((me->x)*8 + (spriteRegionX)*256);
    ia78->unk40 = ((me->y)*8 + (spriteRegionY)*256);
...
static void Task_Interactable078(void)
{
    Sprite_IA78 *ia78 = (void *)(0x03000000 + ((gCurTask)->data));
    sub_807ACF4(ia78, 0);
    sub_807AE60(ia78);
