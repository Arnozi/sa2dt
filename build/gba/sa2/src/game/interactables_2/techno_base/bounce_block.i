...
void CreateEntity_BounceBlock(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_TecBaseNoteBlock *noteBlock = (void *)(0x03000000 + ((t)->data));
    ...
    s->frameFlags = 0x2000;
    s->graphics.dest = (void *)(u8*)(0x6000000 + 0x10000) + sNoteBlockAssets[noteBlock->unk4C][2] * 0x20;
...
{
    Sprite_TecBaseNoteBlock *noteBlock = (void *)(0x03000000 + ((gCurTask)->data));
...
static bool32 sub_8079D60(Sprite_TecBaseNoteBlock *noteBlock)
{
    ...
    if (temp3 > (128 + (240 + 128)) || temp4 > (128 + (160 + 128))) {
        return 1;
    }
    return 0;
}
