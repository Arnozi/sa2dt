# 0 "src/game/interactables_2/techno_base/arrow_platform.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/techno_base/arrow_platform.c"
...
# 2 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/task.h" 1
# 5 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/techno_base/arrow_platform.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/techno_base/arrow_platform.c" 2
...
# 8 "src/game/interactables_2/techno_base/arrow_platform.c" 2
...
# 9 "src/game/interactables_2/techno_base/arrow_platform.c" 2
...
# 12 "src/game/interactables_2/techno_base/arrow_platform.c" 2
...
# 14 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/constants/char_states.h" 1
# 15 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/interactables_2/techno_base/arrow_platform.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/interactables_2/techno_base/arrow_platform.c" 2
...
static void sub_807A33C(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u8 param)
{
    ...
    Sprite_IA75 *ia75 = (void *)(0x03000000 + ((t)->data));
    ia75->unk94 = param;
    ia75->unk8C = 0;
    ia75->unk90 = 0;
    ia75->width = me->d.sData[0] * 8 + 0x18;
    ia75->height = me->d.sData[1] * 8 + 0x18;
    ia75->offsetX = me->d.uData[2] * 8 + ia75->width - 0x18;
    ia75->offsetY = me->d.uData[3] * 8 + ia75->height - 0x18;
    ...
    switch (ia75->unk94) {
        case 0:
            ia75->unk74 = ((s32)((ia75->offsetX)*256));
            ia75->unk78 = ((s32)((ia75->height)*256));
            break;
        case 1:
            ia75->unk74 = ((s32)((ia75->width)*256));
            ia75->unk78 = ((s32)((ia75->height)*256));
            break;
        case 2:
            ia75->unk74 = ((s32)((ia75->width)*256));
            ia75->unk78 = ((s32)((ia75->offsetY)*256));
            break;
    }
    ...
    ia75->x = ((me->x)*8 + (spriteRegionX)*256);
    ia75->y = ((me->y)*8 + (spriteRegionY)*256);
...
{
    u8 someBool = 0;
    Sprite_IA75 *ia75 = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    switch (ia75->unk94) {
        case 0:
            ia75->unk74 -= ((s16)((7.5)*256));
            if (((int)((ia75->unk74) >> 8)) <= ia75->width) {
                ia75->unk74 = ((s32)((ia75->width)*256));
                someBool = 1;
            }
            break;
        case 1:
            ia75->unk74 += ((s16)((7.5)*256));
            if (((int)((ia75->unk74) >> 8)) >= ia75->offsetX) {
                ia75->unk74 = ((s32)((ia75->offsetX)*256));
                someBool = 1;
            }
            break;
        case 2:
            ia75->unk78 -= ((s16)((7.5)*256));
            if (((int)((ia75->unk78) >> 8)) <= ia75->height) {
                ia75->unk78 = ((s32)((ia75->height)*256));
                someBool = 1;
            }
    ...
    if ((!(gPlayer.moveState & 0x00000080)) && ia75->unk90) {
        sub_807AB18(ia75);
    }
...
{
    Sprite *s;
    ia75->unk7C = gPlayer.qWorldX - (((s32)((ia75->x)*256)) + ia75->unk74);
    ia75->unk80 = gPlayer.qWorldY - (((s32)((ia75->y)*256)) + ia75->unk78);
...
static void sub_807A73C(Sprite_IA75 *ia75)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080)) && ia75->unk90) {
        ...
        switch (ia75->unk94) {
            case 0:
                gPlayer.qSpeedGround = -((s16)((7.5)*256));
                gPlayer.moveState |= 1;
                gPlayer.transition = 1;
                break;
            case 1:
...
static void sub_807A7F4(Sprite_IA75 *ia75)
{
    Sprite *s = &ia75->s1;
    if ((!(((gGameMode == 0) || (gGameMode == 1) || (gGameMode == 2))))) {
        s->x = ia75->x + ((int)((ia75->unk98[1][0]) >> 8)) - gCamera.x;
        s->y = ia75->y + ((int)((ia75->unk98[1][1]) >> 8)) - gCamera.y;
    } else {
        s->x = ia75->x + ((int)((ia75->unk74) >> 8)) - gCamera.x;
        s->y = ia75->y + ((int)((ia75->unk78) >> 8)) - gCamera.y;
    }
...
static bool32 sub_807A920(Sprite_IA75 *ia75)
{
    ...
    if ((x + ia75->offsetX + 24) < -128 || (x + ia75->width - 24) > (240 + 128) || (y + ia75->offsetY + 24) < -128
        || (y + ia75->height - 24) > (160 + 128)) {
        return 1;
    }
    return 0;
}
...
static u32 sub_807A99C(Sprite_IA75 *ia75)
{
    if ((!(gPlayer.moveState & 0x00000080))) {
        u32 temp = Coll_Player_Platform(&ia75->s2, ia75->x + ((int)((ia75->unk74) >> 8)), ia75->y + ((int)((ia75->unk78) >> 8)), &gPlayer);
        if (temp != 0) {
            if (temp & 0x10000) {
...
{
    gPlayer.moveState |= 0x00400000;
    gPlayer.qWorldX = ia75->unk7C + ((s32)((ia75->x)*256)) + ia75->unk74;
    gPlayer.qWorldY = ia75->unk80 + ((s32)((ia75->y)*256)) + ia75->unk78;
    sub_807A99C(ia75);
}

static void sub_807AB54(Sprite_IA75 *ia75)
{
    { ia75->base.me->x = ia75->base.meX; };
