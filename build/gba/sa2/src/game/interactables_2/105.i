# 0 "src/game/interactables_2/105.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/105.c"
...
# 2 "src/game/interactables_2/105.c" 2
...
# 5 "src/game/interactables_2/105.c" 2
...
# 7 "src/game/interactables_2/105.c" 2
...
# 8 "src/game/interactables_2/105.c" 2
...
# 9 "src/game/interactables_2/105.c" 2

# 1 "include/task.h" 1
# 11 "src/game/interactables_2/105.c" 2
# 1 "include/trig.h" 1
...
# 12 "src/game/interactables_2/105.c" 2
...
void CreateEntity_Interactable105(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_IA105 *ia105 = (void *)(0x03000000 + ((t)->data));

    ia105->posX = ((me->x)*8 + (spriteRegionX)*256);
    ia105->posY = ((me->y)*8 + (spriteRegionY)*256);
    ia105->offsetX = me->d.sData[0] * 8;
    ia105->offsetY = me->d.sData[1] * 8;
    ia105->width = me->d.uData[2] * 8 + ia105->offsetX;
    ia105->height = me->d.uData[3] * 8 + ia105->offsetY;
    ia105->me = me;
    ia105->spriteX = me->x;
...
static void Task_Interactable105(void)
{
    Sprite_IA105 *ia105 = (void *)(0x03000000 + ((gCurTask)->data));
...
static void TaskDestructor_Interactable105(struct Task __attribute__((unused)) *t) { }
