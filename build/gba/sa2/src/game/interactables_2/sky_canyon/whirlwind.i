...
void CreateEntity_Whirlwind(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u32 kind)
{
    ...
    Sprite_IA86 *ia086 = (void *)(0x03000000 + ((t)->data));
    s32 someX, someY;
    s32 value;
    u32 width;
...
# 173 "src/game/interactables_2/sky_canyon/whirlwind.c"
void sub_807C9C0(Sprite_IA86 *ia086)
{
    ...
    p1->moveState |= 0x00400000;
    p1->charState = 44;


    r0 = 0x23C;
    r0 = ((s32)((*(s32 *)((void *)ia086 + r0))*256));
    asm("" ::"r"(r0));
    r1 = p1->qWorldX;
    asm("" ::"r"(r1));
    p = p1;
    ...
    *p184 = ((s32)((0.5)*256));
    ...
    ia086->unk188 = p->qWorldX - ((s32)((ia086->unk228.centerX)*256));
    ia086->unk18C = p->qWorldY - ((s32)((ia086->unk228.centerY)*256));
    ia086->unk190 = zero;
    ia086->unk194 = zero;
...
bool32 sub_807CF2C(Sprite_IA86 *ia086)
{
    ...
    if (((screenX + ia086->unk228.right) < -128) || ((screenX + ia086->unk228.left) > (240 + 128))
        || ((screenY + ia086->unk228.bottom) < -128) || ((screenY + ia086->unk228.top) > (160 + 128))) {
...
{
    Sprite_IA86 *ia086 = (void *)(0x03000000 + ((gCurTask)->data));
...
void Task_807D268(void)
{
    Sprite_IA86 *sprite = (void *)(0x03000000 + ((gCurTask)->data));
