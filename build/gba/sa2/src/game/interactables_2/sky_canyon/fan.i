# 0 "src/game/interactables_2/sky_canyon/fan.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/sky_canyon/fan.c"
...
# 2 "src/game/interactables_2/sky_canyon/fan.c" 2
...
# 5 "src/game/interactables_2/sky_canyon/fan.c" 2




# 1 "include/task.h" 1
# 10 "src/game/interactables_2/sky_canyon/fan.c" 2
# 1 "include/trig.h" 1
...
# 11 "src/game/interactables_2/sky_canyon/fan.c" 2

# 1 "include/malloc_vram.h" 1
# 13 "src/game/interactables_2/sky_canyon/fan.c" 2
...
# 15 "src/game/interactables_2/sky_canyon/fan.c" 2
...
# 61 "src/game/interactables_2/sky_canyon/fan.c"
...
static void CreateEntity_Fan(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, u32 kind)
{
    ...
    Sprite_Fan *prop = (void *)(0x03000000 + ((t)->data));
    Sprite *s;

    prop->kind = kind;
    prop->fanSpeed = ((s32)((1.0)*256));
    prop->posX = ((me->x)*8 + (spriteRegionX)*256);
    prop->posY = ((me->y)*8 + (spriteRegionY)*256);
    prop->left = me->d.sData[0] * 8;
    prop->top = me->d.sData[1] * 8;
    prop->right = me->d.uData[2] * 8 + prop->left;
    prop->bottom = me->d.uData[3] * 8 + prop->top;
...
static void sub_807D468(Sprite_Fan *prop)
{
    s32 temp;
    s32 r3;
    if ((((prop->kind) == (((0) << 1) | (0))) || ((prop->kind) == (((1) << 1) | (0))))) {
        r3 = ((s32)((prop->posX + prop->right)*256)) - gPlayer.qWorldX;
    } else {
        r3 = gPlayer.qWorldX - ((s32)((prop->posX + prop->left)*256));
    }

    r3 = (((s32)((prop->width)*256)) - r3) / prop->width;
    ...
    prop->playerDeltaX = ((int)((prop->playerDeltaX * prop->fanSpeed) >> 8));

    if ((((prop->kind) == (((0) << 1) | (0))) || ((prop->kind) == (((1) << 1) | (0))))) {
        if (gPlayer.qSpeedAirX < 0) {
            gPlayer.qSpeedGround = ClampPlayerSpeed(gPlayer.qSpeedGround - ((s32)((0.25)*256)));
            gPlayer.qSpeedAirX = ClampPlayerSpeed(gPlayer.qSpeedAirX - ((s32)((0.25)*256)));
        } else {
            s32 newPlayerX = gPlayer.qWorldX - prop->playerDeltaX;
            gPlayer.qWorldX = newPlayerX;

            r3 = ((s32)((prop->posX + prop->right)*256)) - ((s32)((48)*256));

            if ((prop->kind != (((1) << 1) | (0))) && newPlayerX > r3) {
                gPlayer.qWorldX = r3;
            }
        ...
        if (gPlayer.qSpeedAirX > 0) {
            ...
            r3 = ((s32)((prop->posX + prop->left)*256)) + ((s32)((48)*256));

            if ((prop->kind != (((1) << 1) | (1))) && newPlayerX < r3) {
                gPlayer.qWorldX = r3;
            }
...
static void UpdateFanSpeed(Sprite_Fan *prop)
{
    ...
    if ((((prop->kind) == (((1) << 1) | (0))) || ((prop->kind) == (((1) << 1) | (1))))) {
        u32 fanSpeed = gStageTime % ((((((int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 4) * 60)) + (int)(((0 * 60.) + 1) * 60)));
        if (fanSpeed < ((int)(((0 * 60.) + 1) * 60))) {
            prop->fanSpeed = ((s32)((0.0)*256));
        } else if (fanSpeed < (((int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 1) * 60))) {
            u32 another;
            s32 temp;
            s16 res2;

            fanSpeed -= ((int)(((0 * 60.) + 1) * 60));
        ...
        } else if (fanSpeed < ((((int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 4) * 60))) {
            prop->fanSpeed = ((s32)((1.0)*256));
        } else {
            s32 temp;
            s16 res2;

            fanSpeed -= ((((int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 1) * 60)) + (int)(((0 * 60.) + 4) * 60));
            ...
            prop->fanSpeed = ((s32)((1.0)*256)) - temp;
        }
...
static void Task_IA_Fan_UpdateRegular(void)
{
    Sprite_Fan *prop = (void *)(0x03000000 + ((gCurTask)->data));
...
static s16 ClampPlayerSpeed(s16 speed)
{
    if (gPlayer.isBoosting) {
        ({ if ((speed) > (((s32)((15.0)*256)))) { speed = (((s32)((15.0)*256))); } else if ((speed) < (-((s32)((15.0)*256)))) { speed = (-((s32)((15.0)*256))); } });
    } else {




        ({ if ((speed) > (+((s32)((9.0)*256)))) { speed = (+((s32)((9.0)*256))); } else if ((speed) < (-((s32)((15.0)*256)))) { speed = (-((s32)((15.0)*256))); } });
...
static bool32 IsPropellerOffScreen(Sprite_Fan *prop)
{
    ...
    if (((posX + prop->right) < -128) || ((posX + prop->left) > 240 + 128) || ((posY + prop->bottom) < -128)
        || ((posY + prop->top) > 160 + 128))
        return 1;
