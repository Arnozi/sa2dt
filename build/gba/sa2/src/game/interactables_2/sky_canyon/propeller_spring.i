# 0 "src/game/interactables_2/sky_canyon/propeller_spring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/sky_canyon/propeller_spring.c"
...
# 2 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
# 4 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
# 7 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
# 9 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
# 10 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
# 12 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2



# 1 "include/constants/player_transitions.h" 1
# 16 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/game/interactables_2/sky_canyon/propeller_spring.c" 2
...
{
    Sprite_IA85 *ia85 = (void *)(0x03000000 + ((gCurTask)->data));
    ia85->unk46 = ((int)(((gSineTable[(ia85->unk49 * 4)])) >> 6)) * 2;
    ia85->unk49 += 2;
    if (sub_807C424(ia85)) {
        sub_807C4A0(ia85);
    }
...
static void sub_807C2E0(void)
{
    s16 r1;
    Sprite_IA85 *ia85 = (void *)(0x03000000 + ((gCurTask)->data));
    ia85->unk46 = ((int)(((gSineTable[(ia85->unk49 * 4)])) >> 6)) * 16;
    sub_807C52C(ia85);
...
static void sub_807C360(void)
{
    ...
    if (ia85->unk49 == 0x80) {
        ...
        ia85->unk46 = ((int)(((gSineTable[(ia85->unk49 * 4)])) >> 6)) * 6;
    } else {
        ia85->unk46 = ((int)(((gSineTable[(ia85->unk49 * 4)])) >> 6)) * 3;
    }
...
static bool32 sub_807C424(Sprite_IA85 *ia85)
{
    ...
    temp2 = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x;
    temp4 = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y;
...
{
    gPlayer.transition = 26;
    if (ia85->unk48 & 1)
        gPlayer.qSpeedAirY = -((s32)((5.5)*256));
    else
        gPlayer.qSpeedAirY = -((s32)((5.5)*256));
    ia85->unk49 = 0;
    ia85->unk48 = 0;
...
static void sub_807C558(Sprite_IA85 *ia85)
{
    ...
    sprite->x = ia85->unk3C - gCamera.x + ((int)((ia85->unk44) >> 8));
    sprite->y = ia85->unk40 - gCamera.y + ((int)((ia85->unk46) >> 8));
...
static bool32 sub_807C598(Sprite_IA85 *ia85)
{
    ...
    temp2 = temp1;
    temp3 = temp;
    if (temp2 < -128 || temp2 > (240 + 128) || temp3 < -128 || temp3 > (160 + 128)) {
        return 1;
    }
...
void CreateEntity_PropellerSpring(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_IA85 *ia85 = (void *)(0x03000000 + ((t)->data));
    ia85->unk3C = ((me->x)*8 + (spriteRegionX)*256);
    ia85->unk40 = ((me->y)*8 + (spriteRegionY)*256);
