# 0 "src/game/interactables_2/sky_canyon/propeller.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/sky_canyon/propeller.c"
# 1 "include/core.h" 1
...
# 2 "src/game/interactables_2/sky_canyon/propeller.c" 2
# 1 "include/sprite.h" 1
# 3 "src/game/interactables_2/sky_canyon/propeller.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/sky_canyon/propeller.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/interactables_2/sky_canyon/propeller.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/sky_canyon/propeller.c" 2
...
# 1 "include/global.h" 1
# 5 "include/game/sa1_sa2_shared/entities_manager.h" 2
...
# 9 "src/game/interactables_2/sky_canyon/propeller.c" 2
...
# 16 "src/game/interactables_2/sky_canyon/propeller.c" 2
...
# 17 "src/game/interactables_2/sky_canyon/propeller.c" 2
...
# 19 "src/game/interactables_2/sky_canyon/propeller.c" 2
# 1 "include/constants/char_states.h" 1
# 20 "src/game/interactables_2/sky_canyon/propeller.c" 2
# 1 "include/constants/player_transitions.h" 1
# 21 "src/game/interactables_2/sky_canyon/propeller.c" 2
# 1 "include/constants/songs.h" 1
# 22 "src/game/interactables_2/sky_canyon/propeller.c" 2
...
{
    Sprite_Propeller *propeller = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (!(!(gPlayer.moveState & 0x00000080))) {
        ...
        gPlayer.qWorldY -= ((s32)((4)*256));
        if (((int)((gPlayer.qWorldY) >> 8)) <= propeller->y - 48) {
            gPlayer.qWorldY = ((s32)((propeller->y - 48)*256));
            sub_807B74C(propeller);
        }

        if (gPlayer.heldInput & 0x0010) {
        ...
        temp = sub_801F100(({ ((int)((gPlayer.qWorldX) >> 8)) + 2; }) + gPlayer.spriteOffsetX, ((int)((gPlayer.qWorldY) >> 8)), gPlayer.layer, +8, sub_801EB44);
        if (temp < 0) {
            gPlayer.qWorldX += ((s32)((temp)*256));
        }
        temp = sub_801F100(({ ((int)((gPlayer.qWorldX) >> 8)) - 2; }) - gPlayer.spriteOffsetX, ((int)((gPlayer.qWorldY) >> 8)), gPlayer.layer, -8, sub_801EB44);
        if (temp < 0) {
            gPlayer.qWorldX -= ((s32)((temp)*256));
        ...
        temp = sub_801F100(((int)((gPlayer.qWorldY) >> 8)) + gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)), gPlayer.layer, 8, sub_801EC3C);
        if (temp < 0) {
            gPlayer.qWorldY += ((s32)((temp)*256));
        }
        temp = sub_801F100(((int)((gPlayer.qWorldY) >> 8)) - gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)), gPlayer.layer, -8, sub_801EC3C);
        if (temp < 0) {
            gPlayer.qWorldY -= ((s32)((temp)*256));
...
static void sub_807B530(void)
{
    ...
    if (!(!(gPlayer.moveState & 0x00000080))) {
        ...
        propeller->unk46 = ((int)(((gSineTable[(propeller->unk48 * 4)])) >> 6)) * 16;
        gPlayer.qWorldY += propeller->unk46;
        propeller->unk48 -= 4;
...
{
    propeller->unk48 = 0;
    propeller->unk46 = ((int)(((gSineTable[(0)])) >> 6)) * 16;
    ...
    if (gPlayer.qSpeedAirX >= 1) {
        ...
        propeller->unk44 = gPlayer.moveState & 0x00000001 ? -32 : 32;
    }
...
static void sub_807B7BC(Sprite_Propeller *propeller)
{
    ...
    if (propeller->unk48 <= (128 / 2) || propeller->unk48 >= 192) {
        propeller->unk48 += (128 / 2);
        propeller->unk48 = 128 - propeller->unk48;
...
bool32 IsPlayerInteracting(Sprite_Propeller *propeller)
{
    ...
    if (x - (148 / 2) <= playerX && x + (148 / 2) >= playerX) {
        if (y - (128 / 2) <= playerY && y + (128 / 2) >= playerY) {
            return 1;
        }
    }
...
static bool32 sub_807B9F0(Sprite_Propeller *propeller)
{
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if (y - 96 <= playerY && y + (128 / 2) >= playerY) {
            return 1;
        }
    }
...
{
    { propeller->base.me->x = propeller->base.meX; };
    TaskDestroy(gCurTask);
}

Sprite_OnInit_SkyCanyon *sub_807BA54(void)
{
    EntitiesManager *em = (void *)(0x03000000 + (((struct Task *)(0x03000000 + ((gCurTask)->parent)))->data));
    return (void *)(0x03000000 + ((em->preInit)->data));
}

static void sub_807BA70(void)
{
    EntitiesManager *em = (void *)(0x03000000 + (((struct Task *)(0x03000000 + ((gCurTask)->parent)))->data));
    Sprite_OnInit_SkyCanyon *level = (void *)(0x03000000 + ((em->preInit)->data));
...
void CreateEntity_Propeller(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_Propeller *propeller = (void *)(0x03000000 + ((t)->data));
    propeller->x = ((me->x)*8 + (spriteRegionX)*256);
    propeller->y = ((me->y)*8 + (spriteRegionY)*256);
