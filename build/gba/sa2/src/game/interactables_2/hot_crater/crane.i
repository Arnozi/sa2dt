...
void CreateEntity_Crane(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_HCCrane *crane = (void *)(0x03000000 + ((t)->data));
    CranePart *part;
    u16 i;
    ...
    part->s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2BC0);
    ...
    for (i = 0; i < 6; i++) {
        ...
        if (i == 0) {
            ...
            if (i == 1) {
                ...
                part->s->hitboxes[0].index = -1;
                part->s->frameFlags = ((2) << (12));
                part->s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2B80);
    ...
    part->s->hitboxes[0].index = -1;
    part->s->frameFlags = ((2) << (12));
    part->s->graphics.dest = (void *)((u8*)(0x6000000 + 0x10000) + 0x2980);
    part->s->graphics.anim = 564;
    part->s->variant = 0;
    UpdateSpriteAnimation(part->s);
...
static void Task_Inactive(void)
{
    Sprite_HCCrane *crane = (void *)(0x03000000 + ((gCurTask)->data));
...
static bool32 ShouldDespawn(Sprite_HCCrane *crane)
{
    ...
    if (((screenX + 64) < -(256 / 2)) || ((screenX - 64) > (240 + (256 / 2)))
        || ((screenY + 64) < -(256 / 2)) || ((screenY - 64) > (160 + (256 / 2)))) {
        return 1;
    }
