# 0 "src/game/interactables_2/hot_crater/turnaround_bar.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/hot_crater/turnaround_bar.c"
...
# 2 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
...
# 4 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
...
# 5 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
...
# 8 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
# 1 "include/task.h" 1
# 9 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2

# 1 "include/malloc_vram.h" 1
# 11 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
...
# 13 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
# 1 "include/constants/char_states.h" 1
# 14 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
# 1 "include/constants/player_transitions.h" 1
# 15 "src/game/interactables_2/hot_crater/turnaround_bar.c" 2
...
void CreateEntity_TurnAroundBar(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_TurnAroundBar *turnAroundBar = (void *)(0x03000000 + ((t)->data));
    ...
    turnAroundBar->x = ((me->x)*8 + (spriteRegionX)*256);
    turnAroundBar->y = ((me->y)*8 + (spriteRegionY)*256);
...
static void sub_8073474(Sprite_TurnAroundBar *turnAroundBar)
{
    ...
    if (gPlayer.qSpeedGround > 0) {
        gPlayer.qWorldX = ((s32)((turnAroundBar->x - 6)*256));
        gPlayer.qSpeedGround += ((s16)((1.25)*256));
    } else {
        gPlayer.qWorldX = ((s32)((turnAroundBar->x + 6)*256));
        gPlayer.qSpeedGround -= ((s16)((1.25)*256));
    }
...
static u32 sub_8073520(Sprite_TurnAroundBar *turnAroundBar)
{
    ...
    if (temp - 6 <= temp2 && temp + 6 >= temp2) {
        if (temp3 - 32 <= temp4 && temp3 >= temp4) {
            if (abs(gPlayer.qSpeedGround) < ((s16)((4)*256))) {
                return 1;
            }
...
static void Task_TurnAroundBarMain(void)
{
    Sprite_TurnAroundBar *turnAroundBar = (void *)(0x03000000 + ((gCurTask)->data));
    Sprite *s = &turnAroundBar->s;
...
static void sub_8073670(Sprite_TurnAroundBar *turnAroundBar)
{
    ...
    gPlayer.moveState |= 0x00400000;
    turnAroundBar->unk44 = ((s32)((turnAroundBar->y)*256)) - gPlayer.qWorldY;
    gPlayer.qWorldX = ((s32)((turnAroundBar->x)*256));
    gPlayer.qWorldY = ((s32)((turnAroundBar->y)*256));
    gPlayer.charState = 56;
...
static bool32 sub_8073784(Sprite_TurnAroundBar *turnAroundBar)
{
    ...
    if (temp4 < -128 || temp4 > (240 + 128) || temp3 < -128 || temp3 > (160 + 128)) {
        return 1;
    }
