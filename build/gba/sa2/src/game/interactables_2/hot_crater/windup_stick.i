# 0 "src/game/interactables_2/hot_crater/windup_stick.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/hot_crater/windup_stick.c"
...
# 2 "src/game/interactables_2/hot_crater/windup_stick.c" 2
...
# 3 "src/game/interactables_2/hot_crater/windup_stick.c" 2
...
# 6 "src/game/interactables_2/hot_crater/windup_stick.c" 2
# 1 "include/task.h" 1
# 7 "src/game/interactables_2/hot_crater/windup_stick.c" 2

# 1 "include/malloc_vram.h" 1
# 9 "src/game/interactables_2/hot_crater/windup_stick.c" 2
...
# 11 "src/game/interactables_2/hot_crater/windup_stick.c" 2
# 1 "include/constants/char_states.h" 1
# 12 "src/game/interactables_2/hot_crater/windup_stick.c" 2
# 1 "include/constants/player_transitions.h" 1
# 13 "src/game/interactables_2/hot_crater/windup_stick.c" 2
...
void CreateEntity_WindUpStick(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_WindUpStick *windUpStick = (void *)(0x03000000 + ((t)->data));
    windUpStick->unk11 = 0;
    windUpStick->unk0 = ((me->x)*8 + (spriteRegionX)*256);
    windUpStick->unk4 = ((me->y)*8 + (spriteRegionY)*256);
...
{
    Sprite_WindUpStick *windUpStick = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (gPlayer.spriteInfoBody->s.frameFlags & ((1) << (14))) {
...
static void sub_80726E8(Sprite_WindUpStick *windUpStick)
{
    ...
    windUpStick->unk12 = (gPlayerBodyPSI.s.frameFlags & ((3) << (12))) >> 12;
    gPlayerBodyPSI.s.frameFlags &= ~((3) << (12));
    gPlayerBodyPSI.s.frameFlags |= ((1) << (12));
    gPlayer.qWorldY = ((s32)((windUpStick->unk4 + 3)*256));

    switch (windUpStick->unk10) {
        case 1:
            gPlayer.charState = 51;
            gPlayer.qSpeedAirX = 0;
            gPlayer.qSpeedAirY -= ((s32)((6.5)*256));
            break;
        case 2:

        {
            ...
            *unk64 = 52;
            ...
            break;
        case 3:
            gPlayer.charState = 53;
            if (gPlayer.moveState & 0x00000001) {
                gPlayer.qSpeedGround -= ((s32)((2.5)*256));
            } else {
                gPlayer.qSpeedGround += ((s32)((2.5)*256));
            }
            break;
        case 4:
            gPlayer.charState = 54;
            if (gPlayer.moveState & 0x00000001) {
                gPlayer.qSpeedGround -= ((s32)((1.25)*256));
            } else {
                gPlayer.qSpeedGround += ((s32)((1.25)*256));
            }
            gPlayer.moveState ^= 1;
...
static void sub_80727F4(Sprite_WindUpStick *windUpStick)
{
    ...
    gPlayerBodyPSI.s.frameFlags &= ~((3) << (12));
    gPlayerBodyPSI.s.frameFlags |= ((windUpStick->unk12) << (12));

    switch (windUpStick->unk10) {
        case 1:
        case 3:
            gPlayer.qWorldY = ((s32)((windUpStick->unk4 + windUpStick->unkA)*256));
            break;
        case 2:
        case 4:
            gPlayer.qWorldY = ((s32)((windUpStick->unk4 + windUpStick->unkE)*256));
            break;
    }
...
bool32 sub_80729F4(Sprite_WindUpStick *windUpStick)
{
    ...
    s16 r0 = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x;
    return r1 < r0;
}
...
bool32 sub_8072A5C(Sprite_WindUpStick *windUpStick)
{
    ...
    if (x + windUpStick->unkC < -128 || x + windUpStick->unk8 > (240 + 128) || y + windUpStick->unkE < -128
        || y + windUpStick->unkA > (160 + 128)) {
        return 1;
    }
    return 0;
}
