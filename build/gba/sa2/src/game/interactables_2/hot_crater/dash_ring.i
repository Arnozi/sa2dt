# 0 "src/game/interactables_2/hot_crater/dash_ring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/hot_crater/dash_ring.c"
...
# 2 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
void VramFree(void *);
# 3 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "src/game/interactables_2/hot_crater/dash_ring.c" 2
# 1 "include/trig.h" 1
...
# 5 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
# 5 "include/game/sa1_sa2_shared/player.h" 2
...
# 7 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
# 8 "src/game/interactables_2/hot_crater/dash_ring.c" 2
# 1 "include/task.h" 1
# 9 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
# 11 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
# 12 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
# 15 "src/game/interactables_2/hot_crater/dash_ring.c" 2
# 1 "include/constants/char_states.h" 1
# 16 "src/game/interactables_2/hot_crater/dash_ring.c" 2
# 1 "include/constants/player_transitions.h" 1
# 17 "src/game/interactables_2/hot_crater/dash_ring.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_2/hot_crater/dash_ring.c" 2
...
static const u16 sAnimInfoDashRing[2][8][2][6] = {
    {
        {
            { 584, 0x0002, 12, 0x0000, 0x0000, 0x0000 },
            { 584, 0x0003, 6, 0x0000, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0004, 36, 0x0400, 0x0000, 0x0000 },
            { 584, 0x0005, 25, 0x0400, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0000, 12, 0x0000, 0x0000, 0x0000 },
            { 584, 0x0001, 6, 0x0000, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0004, 36, 0x0C00, 0x0000, 0x0000 },
            { 584, 0x0005, 25, 0x0C00, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0002, 12, 0x0800, 0x0000, 0x0000 },
            { 584, 0x0003, 6, 0x0800, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0004, 36, 0x0800, 0x0000, 0x0000 },
            { 584, 0x0005, 25, 0x0800, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0000, 12, 0x0400, 0x0000, 0x0000 },
            { 584, 0x0001, 6, 0x0400, 0x0000, 0x0000 },
        },
        {
            { 584, 0x0004, 36, 0x0000, 0x0000, 0x0000 },
            { 584, 0x0005, 25, 0x0000, 0x0000, 0x0000 },
        },
    },
    {
        {
            { 605, 0x0002, 12, 0x0000, 0x0000, 0x0000 },
            { 605, 0x0003, 6, 0x0000, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0004, 36, 0x0400, 0x0000, 0x0000 },
            { 605, 0x0005, 25, 0x0400, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0000, 12, 0x0000, 0x0000, 0x0000 },
            { 605, 0x0001, 6, 0x0000, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0004, 36, 0x0C00, 0x0000, 0x0000 },
            { 605, 0x0005, 25, 0x0C00, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0002, 12, 0x0800, 0x0000, 0x0000 },
            { 605, 0x0003, 6, 0x0800, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0004, 36, 0x0800, 0x0000, 0x0000 },
            { 605, 0x0005, 25, 0x0800, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0000, 12, 0x0400, 0x0000, 0x0000 },
            { 605, 0x0001, 6, 0x0400, 0x0000, 0x0000 },
        },
        {
            { 605, 0x0004, 36, 0x0000, 0x0000, 0x0000 },
            { 605, 0x0005, 25, 0x0000, 0x0000, 0x0000 },
        },
    },
};
...
void CreateEntity_DashRing(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_DashRing *ring = (void *)(0x03000000 + ((t)->data));
    ring->orientation = me->d.sData[0];
    ring->posX = ((me->x)*8 + (spriteRegionX)*256);
    ring->posY = ((me->y)*8 + (spriteRegionY)*256);
    ring->spriteX = me->x;
    ring->spriteY = spriteY;
    ring->me = me;

    if (((gCurrentLevel) >> 2) == 5)
        ringType = 1;
...
static void DashRing_SetPlayerSpeedAndDir(Sprite_DashRing *ring)
{
    gPlayer.transition = 24;


    gPlayer.qWorldX = ((s32)((ring->posX)*256));
    gPlayer.qWorldY = ((s32)((ring->posY)*256));
    gPlayer.unk72 = 0x10;

    switch (ring->orientation) {
        case 0: {
            gPlayer.charState = 38;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(270)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(270)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 1: {
            gPlayer.moveState &= ~0x00000001;
            gPlayer.charState = 38;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(315)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(315)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 2: {
            gPlayer.moveState &= ~0x00000001;
            gPlayer.charState = 40;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(0)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(0)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 3: {
            gPlayer.moveState &= ~0x00000001;
            gPlayer.charState = 14;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(45)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(45)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 4: {
            gPlayer.charState = 14;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(90)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(90)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 5: {
            gPlayer.moveState |= 0x00000001;
            gPlayer.charState = 14;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(135)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(135)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 6: {
            gPlayer.moveState |= 0x00000001;
            gPlayer.charState = 40;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(180)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(180)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;

        case 7: {
            gPlayer.moveState |= 0x00000001;
            gPlayer.charState = 38;
            gPlayer.qSpeedAirX = ((int)((gSineTable[((int)((((double)(225)) / 360.0) * 1024)) + 256]) >> 6)) * 8;
            gPlayer.qSpeedAirY = ((int)((gSineTable[((int)((((double)(225)) / 360.0) * 1024))]) >> 6)) * 8;
        } break;
    }
...
static bool32 DashRing_PlayerIsColliding(Sprite_DashRing *ring)
{
    ...
    playerScreenX = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x;
    playerScreenY = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y;

    for (i = 0; i < (sizeof(ring->positions) / sizeof((ring->positions)[0])); i++) {
...
static void Task_Interactable_DashRing(void)
{
    Sprite_DashRing *ring = (void *)(0x03000000 + ((gCurTask)->data));
...
bool32 DashRing_ShouldDespawn(Sprite_DashRing *ring)
{
    ...
    if ((screenX + 12) < -(256 / 2) || (screenX - 12) > 240 + (256 / 2)
        || (screenY + 12) < -(256 / 2) || ((screenY - 12) > 160 + (256 / 2))) {
        return 1;
    }
