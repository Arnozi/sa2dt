# 0 "src/game/interactables_2/hot_crater/hook_rail.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/hot_crater/hook_rail.c"
...
# 2 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/sprite.h" 1
# 5 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/hot_crater/hook_rail.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/hot_crater/hook_rail.c" 2
...
# 9 "src/game/interactables_2/hot_crater/hook_rail.c" 2
...
# 10 "src/game/interactables_2/hot_crater/hook_rail.c" 2
...
# 13 "src/game/interactables_2/hot_crater/hook_rail.c" 2
...
# 15 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/constants/char_states.h" 1
# 16 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/constants/player_transitions.h" 1
# 17 "src/game/interactables_2/hot_crater/hook_rail.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_2/hot_crater/hook_rail.c" 2
...
# 65 "src/game/interactables_2/hot_crater/hook_rail.c"
void CreateEntity_HookRail(u32 triggerType, MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    hookRail = (void *)(0x03000000 + ((t)->data));
    hookRail->triggerType = triggerType;
    hookRail->x = ((me->x)*8 + (spriteRegionX)*256);
    hookRail->y = ((me->y)*8 + (spriteRegionY)*256);

    hookRail->width = me->d.sData[0] * 8;
    hookRail->height = me->d.sData[1] * 8;
    hookRail->offsetX = me->d.uData[2] * 8 + hookRail->width;
    hookRail->offsetY = me->d.uData[3] * 8 + hookRail->height;
...
static void sub_8072BB8(void)
{
    Sprite_HookRail *hookRail = (void *)(0x03000000 + ((gCurTask)->data));
...
static void sub_8072C90(void)
{
    ...
    if (gPlayer.timerInvulnerability == 120) {
        ...
        gPlayer.qWorldY = hookRail->joinedY + (((hookRail->grindDistance) >= 0 ? (hookRail->grindDistance) : -(hookRail->grindDistance)) >> 1);
...
static void sub_8072D40(void)
{
    ...
    if (gPlayer.timerInvulnerability == 120) {
        ...
        if (IsPlayerTouching(hookRail) == 0) {
...
static void sub_8072DCC(Sprite_HookRail *hookRail)
{
    ...
    gPlayer.qWorldY = ((s32)((hookRail->y + 20)*256));
    hookRail->grindDistance = 0;
    if (hookRail->triggerType == 0) {
        gPlayer.moveState |= 0x00000001;
        gPlayer.qSpeedGround = gPlayer.qSpeedAirX;

        if (gPlayer.qSpeedGround > -((s32)((1)*256))) {
            gPlayer.qSpeedGround = -((s32)((1)*256));
        }
...
static void sub_8072F8C(void)
{
    ...
    if (IsPlayerTouching(hookRail) != 0 && gPlayer.charState == 55) {
...
{
    if (hookRail->triggerType == 0) {
        gPlayer.qWorldX = ((s32)((hookRail->x + hookRail->width)*256));
        hookRail->joinedX = gPlayer.qWorldX;
        hookRail->joinedY = gPlayer.qWorldY;
        gPlayer.rotation = 109;
    } else {
        gPlayer.qWorldX = ((s32)((hookRail->x + hookRail->offsetX)*256));
        hookRail->joinedX = gPlayer.qWorldX;
        hookRail->joinedY = gPlayer.qWorldY;
        gPlayer.rotation = 19;
    }
...
static void sub_8073034(__attribute__((unused)) Sprite_HookRail *hookRail) { gCurTask->main = sub_8072F38; }

static void sub_8073048(__attribute__((unused)) Sprite_HookRail *hookRail)
{
    m4aSongNumStop(283);
    gCurTask->main = sub_8073320;
}

static void sub_8073068(__attribute__((unused)) Sprite_HookRail *hookRail)
{
    m4aSongNumStop(283);
    gCurTask->main = sub_8072F38;
}

static void sub_8073088(__attribute__((unused)) Sprite_HookRail *hookRail)
{
    gPlayer.moveState &= ~0x00400000;
    m4aSongNumStop(283);
    gCurTask->main = sub_8073320;
...
static void sub_80730F0(__attribute__((unused)) Sprite_HookRail *hookRail)
{
    gPlayer.moveState &= ~0x00400000;
...
static void sub_8073148(__attribute__((unused)) Sprite_HookRail *hookRail)
{
    m4aSongNumStop(283);
    gCurTask->main = sub_8072F8C;
}

static void sub_8073168(__attribute__((unused)) Sprite_HookRail *hookRail)
{
    gPlayer.moveState &= ~0x00400000;
    m4aSongNumStop(283);
    gCurTask->main = sub_8072F8C;
...
static void sub_80731D4(void)
{
    gPlayer.qSpeedAirX = ((int)((gPlayer.qSpeedGround * ((int)(((gSineTable[(gPlayer.rotation * 4) + 256])) >> 6))) >> 8));
    gPlayer.qSpeedAirY = ((int)((gPlayer.qSpeedGround * ((int)(((gSineTable[(gPlayer.rotation * 4)])) >> 6))) >> 8));
}
...
static bool32 sub_8073238(Sprite_HookRail *hookRail)
{
    ...
    if (x < -128 || x > (240 + 128) || y < -128 || y > (160 + 128)) {
        return 1;
    }
...
{
    { hookRail->me->x = hookRail->spriteX; };
