# 0 "src/game/interactables_2/ice_paradise/half_pipe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/ice_paradise/half_pipe.c"
...
# 2 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
...
# 4 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
# 1 "include/core.h" 1
...
# 5 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
# 1 "include/task.h" 1
# 6 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
# 1 "include/trig.h" 1
...
# 7 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
...
# 8 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
...
# 9 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
...
# 12 "src/game/interactables_2/ice_paradise/half_pipe.c" 2

# 1 "include/constants/char_states.h" 1
# 14 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
# 1 "include/constants/player_transitions.h" 1
# 15 "src/game/interactables_2/ice_paradise/half_pipe.c" 2
...
static void CreateEntity_HalfPipe(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY, s32 direction)
{
    ...
    Sprite_IceParadiseHalfPipe *halfPipe = (void *)(0x03000000 + ((t)->data));
    halfPipe->direction = direction;
    halfPipe->x = ((s32)((spriteRegionX)*256)) + me->x * 8;
    halfPipe->y = ((s32)((spriteRegionY)*256)) + me->y * 8;
    halfPipe->offsetX = me->d.sData[0] * 8;
    halfPipe->offsetY = me->d.sData[1] * 8;
    halfPipe->width = me->d.uData[2] * 8 + halfPipe->offsetX;
    halfPipe->height = me->d.uData[3] * 8 + halfPipe->offsetY;
    halfPipe->me = me;
...
{
    Sprite_IceParadiseHalfPipe *halfPipe = (void *)(0x03000000 + ((gCurTask)->data));
    if (!(!(gPlayer.moveState & 0x00000080))) {
        gPlayer.moveState &= ~0x00008000;
    ...
    if (!sub_80789AC(halfPipe)) {
        gPlayer.moveState &= ~0x00008000;
        if (gPlayer.charState == 59 || gPlayer.charState == 60
        ...
        gPlayer.moveState |= 0x00008000;
        posWithinHalfPipe = halfPipe->direction == 0 ? ((int)((gPlayer.qWorldX) >> 8)) - (halfPipe->x + halfPipe->offsetX)
                                                                               : (halfPipe->x + halfPipe->width) - ((int)((gPlayer.qWorldX) >> 8));
...
static void UpdatePlayerPosOnHalfPipe(Sprite_IceParadiseHalfPipe *halfPipe, u16 playerX)
{
    ...
    temp4 = (playerX * ((1024 - 1) + 1)) / (halfPipe->width - halfPipe->offsetX);
    temp4 = (({ s16 clamped; if ((temp4) >= (0)) { clamped = (temp4) > ((1024 - 1) + 1) ? ((1024 - 1) + 1) : (temp4); } else { clamped = (0); } clamped; }) + 768) & (1024 - 1);
    ...
    temp2 = (airSpeed << 8) / ((s32)((10)*256));
    height = halfPipe->height;
    height -= halfPipe->offsetY;
    r3 = (height - 16) >> 1;

    sin = (r3 * ((int)(((gSineTable[(temp4)])) >> 6)));
    sin += ((s32)((r3)*256));
    sin = ((int)((sin * temp2) >> 8));
...
{
    if (gPlayer.qSpeedAirX <= -((s32)((2)*256)) || gPlayer.qSpeedAirX >= ((s32)((2.25)*256))) {
...
static bool32 ShouldDespawn(Sprite_IceParadiseHalfPipe *halfPipe)
{
    ...
    if (x + halfPipe->width < -128 || x + halfPipe->offsetX > (240 + 128) || y + halfPipe->height < -128
        || y + halfPipe->offsetY > (160 + 128)) {
        return 1;
    }
    return 0;
}
...
static bool32 ShouldTriggerHalfPipe(Sprite_IceParadiseHalfPipe *halfPipe)
{
    ...
    switch (halfPipe->direction) {
        case 0:
            if (gPlayer.qSpeedAirX < ((s32)((2.25)*256))) {
                return 0;
            }
            break;
        case 1:
...
{
    CreateEntity_HalfPipe(me, spriteRegionX, spriteRegionY, spriteY, 1);
}

void CreateEntity_HalfPipe_Start(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    CreateEntity_HalfPipe(me, spriteRegionX, spriteRegionY, spriteY, 0);
}
