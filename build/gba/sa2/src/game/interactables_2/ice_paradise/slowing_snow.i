# 0 "src/game/interactables_2/ice_paradise/slowing_snow.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/ice_paradise/slowing_snow.c"
...
# 2 "src/game/interactables_2/ice_paradise/slowing_snow.c" 2
...
# 4 "src/game/interactables_2/ice_paradise/slowing_snow.c" 2
...
# 5 "src/game/interactables_2/ice_paradise/slowing_snow.c" 2
...
# 6 "src/game/interactables_2/ice_paradise/slowing_snow.c" 2
...
# 6 "include/game/interactables_2/ice_paradise/slowing_snow.h" 2

void CreateEntity_SlowingSnow(MapEntity *, u16, u16, u8);
# 7 "src/game/interactables_2/ice_paradise/slowing_snow.c" 2
...
void CreateEntity_SlowingSnow(MapEntity *in_ia, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_SlowingSnow *snow = (void *)(0x03000000 + ((t)->data));
    MapEntity *me = in_ia;
    ...
    snow->posX = ((me->x)*8 + (spriteRegionX)*256);
    snow->posY = ((me->y)*8 + (spriteRegionY)*256);
...
static bool32 PlayerIsTouchingSnow(Sprite_SlowingSnow *snow)
{
    if (!(gPlayer.moveState & 0x00000080)) {
        if (!(gPlayer.moveState & 0x00000002)) {
            ...
            s16 playerScreenX = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x;
            s16 playerScreenY = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y;
...
{
    Sprite_SlowingSnow *snow = (void *)(0x03000000 + ((gCurTask)->data));

    if (PlayerIsTouchingSnow(snow)) {
        gPlayer.qSpeedGround = ((gPlayer.qSpeedGround * ((s32)((0.95)*256))) >> 8);
    }
...
static bool32 ShouldDespawn(Sprite_SlowingSnow *snow)
{
    ...
    if ((screenX + snow->right < -(256 / 2)) || (screenX + snow->left > 240 + (256 / 2))
        || (screenY + snow->bottom < -(256 / 2)) || (screenY + snow->top > ((160) + ((256) / 2))))
        return 1;
