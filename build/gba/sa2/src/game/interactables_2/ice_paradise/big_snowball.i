# 0 "src/game/interactables_2/ice_paradise/big_snowball.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/ice_paradise/big_snowball.c"
...
# 2 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/core.h" 1
...
# 3 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/malloc_vram.h" 1
# 4 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/task.h" 1
# 5 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/trig.h" 1
...
# 6 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
# 8 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
# 9 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
# 10 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
# 11 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
# 13 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/constants/char_states.h" 1
# 14 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/constants/player_transitions.h" 1
# 15 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/game/interactables_2/ice_paradise/big_snowball.c" 2
...
void CreateEntity_BigSnowball(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite *s;
    Sprite_IA69 *ia69 = (void *)(0x03000000 + ((t)->data));
    void *vramBase;
    void *vram;
    u32 temp;
    ia69->unk1AC = me->d.sData[0] * 8;
    ia69->unk1AE = me->d.sData[1] * 8;
    ia69->unk1B0 = me->d.uData[2] * 8 + ia69->unk1AC;
    ia69->unk1B2 = me->d.uData[3] * 8 + ia69->unk1AE;
    ia69->me = me;
    ia69->unk1BC = me->x;
    ia69->unk1BD = spriteY;

    ia69->unk158 = ((me->x)*8 + (spriteRegionX)*256);
    ia69->unk15C = ((me->y)*8 + (spriteRegionY)*256);

    temp = ((s32)((ia69->unk1B2 - ia69->unk1AE)*256));
    ia69->unk160 = (temp / ((s32)((6)*256))) + 0x78;
    ia69->unk164 = 0;
    ia69->unk168 = 0;
    ia69->unk16C = -1;
    ia69->unk170 = 0;
...
void sub_8078E48(Sprite_IA69 *ia69)
{
    ...
    for (i = 0; i < 2; i++, unk178++) {
        if (i & 1) {
            u32 temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x14);
            temp += 0x1000;
            unk178->unk0 = temp;
            unk178->unk2 = -((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x14);
        } else {
            u32 temp = -((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x14);
            temp -= 0x1000;
            unk178->unk0 = temp;
    ...
    for (i = 0; i < 2; i++, unk178++) {
        if (i & 1) {
            u32 temp;
            temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x14);
            temp += 0x800;
            unk178->unk0 = temp;
            unk178->unk2 = -((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x13) - 0x1000;
        } else {
            u32 temp;
            temp = -((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x14);
            temp -= 0x800;
    ...
    for (i = 0; i < 4; i++, unk178++) {
        u32 temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x12);
        temp -= 0x2000;
        unk178->unk0 = temp;
        unk178->unk2 = -((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 0x12);
    }
    ...
    for (i = 0; i < 2; i++, unkF0++) {
        if (i & 1) {
            u32 temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x7FF);
            temp -= 0x400;
            unkF0->unk0 = temp;
            unkF0->unk2 = 0;
            unkF0->unk4 = (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x1F) + 0x20;
            unkF0->unk6 = -0x2C0;
        } else {
            u32 temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x7FF);
            u32 temp2 = 0x400;
            ...
            unkF0->unk0 = temp2;
            unkF0->unk2 = 0;
            unkF0->unk4 = -(((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x1F) + 0x20);
            unkF0->unk6 = -0x2C0;
        }
    }
    ...
    for (i = 0; i < 2; i++, unkF0++) {
        if (i & 1) {
            u32 temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x1FFF);
            temp -= 0x1000;
            unkF0->unk0 = temp;
            unkF0->unk2 = 0;
            unkF0->unk4 = (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x3F) + 0x30;
            unkF0->unk6 = -0x280;
    ...
    for (i = 0; i < 8; i++, unkF0++) {
        ...
        temp = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x3FFF) - 0x2000;
        unkF0->unk0 = temp;
        temp2 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0xFFF);
        unkF0->unk2 = temp2;

        if (unkF0->unk0 > 0) {
            unkF0->unk4 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x3F) + 0x40;
            unkF0->unk6 = -0x240;
        } else {
            unkF0->unk4 = -(((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x3F) + 0x40);
            unkF0->unk6 = -0x240;
...
void sub_80792AC(Sprite_IA69 *ia69)
{
    ...
    if ((ia69->unk168 - ia69->unk1B2 * 0x100) <= 0x3C00) {
        ...
        for (i = 0; i < 1; i++, unk178++) {
            s32 temp2 = ((int)((ia69->unk168 + unk178->unk2) >> 8));
            if (temp2 < temp) {
                ia69->unk0.x = ia69->unk158 - gCamera.x + ((int)((ia69->unk164 + unk178->unk0) >> 8));
        ...
        for (i = 0; i < 2; i++, unk178++) {
            s32 temp2 = ((int)((ia69->unk168 + unk178->unk2) >> 8));
            if (temp2 < temp) {
                ia69->unk30.x = ia69->unk158 - gCamera.x + ((int)((ia69->unk164 + unk178->unk0) >> 8));
        ...
        for (i = 0; i < 2; i++, unk178++) {
            s32 temp2 = ((int)((ia69->unk168 + unk178->unk2) >> 8));
            if (temp2 < temp) {
                ia69->unk60.x = ia69->unk158 - gCamera.x + ((int)((ia69->unk164 + unk178->unk0) >> 8));
        ...
        for (i = 0; i < 4; i++, unk178++) {
            s32 temp2 = ((int)((ia69->unk168 + unk178->unk2) >> 8));
            if (temp2 < temp) {
                ia69->unk90.x = ia69->unk158 - gCamera.x + ((int)((ia69->unk164 + unk178->unk0) >> 8));
        ...
        for (i = 0; i < 4; i++, unk178++) {
            s32 temp2 = ((int)((ia69->unk168 + unk178->unk2) >> 8));
            if (temp2 < temp) {
                ia69->unkC0.x = ia69->unk158 - gCamera.x + ((int)((ia69->unk164 + unk178->unk0) >> 8));
...
void sub_8079560(Sprite_IA69 *ia69)
{
    ...
    for (i = 0; i < 13; i++, unkF0++) {
        if (unkF0->unk6 < 1 || unkF0->unk2 < 1) {
            if (i & 1) {
                ia69->unk90.x = (unk158 - gCamera.x) + ((int)((unkF0->unk0) >> 8));
                ia69->unk90.y = (temp - gCamera.y) + ((int)((unkF0->unk2) >> 8));
                DisplaySprite(&ia69->unk90);
            } else {
                ia69->unkC0.x = (unk158 - gCamera.x) + ((int)((unkF0->unk0) >> 8));
                ia69->unkC0.y = (temp - gCamera.y) + ((int)((unkF0->unk2) >> 8));
                DisplaySprite(&ia69->unkC0);
            }
        }
    }
...
bool32 sub_8079624(Sprite_IA69 *ia69)
{
    ...
    temp2 = temp1;
    temp3 = temp;
    if ((temp2 + ia69->unk1B0) < -128 || (temp2 + ia69->unk1AC) > (240 + 128) || (temp3 + ia69->unk1B2) < -128
        || (temp3 + ia69->unk1AE) > (160 + 128)) {
        return 1;
    }
...
bool32 sub_80796A8(Sprite_IA69 *ia69)
{
    ...
    if (!(!(gPlayer.moveState & 0x00000080)) || ia69->unk1B2 - ((int)((ia69->unk168) >> 8)) <= 0x3F) {
        return 0;
    } else {
        s16 posX = ia69->unk158 + ((int)((ia69->unk164) >> 8)) - gCamera.x;
        s16 posY = ia69->unk15C + ((int)((ia69->unk168) >> 8)) - gCamera.y;
...
void Task_Interactable069(void)
{
    Sprite_IA69 *ia69 = (void *)(0x03000000 + ((gCurTask)->data));
    sub_80791B4(ia69);
