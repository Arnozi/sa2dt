# 0 "src/game/interactables_2/ice_paradise/funnel_sphere.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/game/interactables_2/ice_paradise/funnel_sphere.c"
...
# 2 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
...
# 4 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/core.h" 1
...
# 5 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/malloc_vram.h" 1
# 6 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/task.h" 1
# 7 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/trig.h" 1
...
# 8 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
...
# 10 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
...
# 13 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
...
# 15 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/constants/char_states.h" 1
# 16 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/constants/player_transitions.h" 1
# 17 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/game/interactables_2/ice_paradise/funnel_sphere.c" 2
...
static void sub_8077F7C(void)
{
    ...
    u16 r7;
    s32 r4;
    Sprite_FunnelSphere *funnelSphere = (void *)(0x03000000 + ((gCurTask)->data));
    ...
    if (funnelSphere->unk1C == 1) {
        r7 = ((int)((funnelSphere->unkC) >> 8)) - funnelSphere->y;

        r4 = (0x20 - r7) * 0x40;
        r4 = ((int)((r4 * ((int)(((gSineTable[(({ (r6) * 4; }))])) >> 6))) >> 8));
        gPlayer.qWorldY = funnelSphere->unkC + r4;

        r4 = r7 * 2;
        r4 = ((int)((((int)(((gSineTable[(({ (r6) * 4; })) + 256])) >> 6)) * 0x20 * ((int)(((gSineTable[(({ (r4 & 0xFF) * 4; })) + 256])) >> 6))) >> 8));
        ...
        gPlayer.rotation = ((int)(((0x40 - r4) * ((int)(((gSineTable[(({ ((r7 * 2) & 0xFF) * 4; })) + 256])) >> 6))) >> 8)) + 0x40;

        gPlayer.qSpeedAirX = ((int)(((gSineTable[(({ (gPlayer.rotation) * 4; })) + 256])) >> 6));
        gPlayer.qSpeedAirY = ((int)(((gSineTable[(({ (gPlayer.rotation) * 4; }))])) >> 6));
        funnelSphere->unkC += 0x40;
    } else {
        r7 = funnelSphere->y - ((int)((funnelSphere->unkC) >> 8));
        r4 = (0x20 - r7) * 0x40;
        r4 = ((int)((-(r4 * ((int)(((gSineTable[(({ (r6) * 4; }))])) >> 6)))) >> 8));
        gPlayer.qWorldY = funnelSphere->unkC + r4;
        ...
        gPlayer.rotation = ((int)(((0xC0 - r4) * ((int)(((gSineTable[(({ ((r7 * 2) & 0xFF) * 4; })) + 256])) >> 6))) >> 8)) - 0x40;
...
static void sub_8078170(Sprite_FunnelSphere *funnelSphere)
{
    ...
    switch (gPlayer.character) {
        ...
        case CHARACTER_TAILS:
            funnelSphere->unk14 = (gPlayer.spriteInfoLimbs->s.frameFlags & ((3) << (12))) >> 12;
            gPlayer.spriteInfoLimbs->s.frameFlags &= ~((3) << (12));
            gPlayer.spriteInfoLimbs->s.frameFlags |= ((1) << (12));
        case CHARACTER_SONIC:
        case CHARACTER_KNUCKLES:
        case CHARACTER_AMY:
            funnelSphere->unk12 = (gPlayer.spriteInfoBody->s.frameFlags & ((3) << (12))) >> 12;
            gPlayer.spriteInfoBody->s.frameFlags &= ~((3) << (12));
            gPlayer.spriteInfoBody->s.frameFlags |= ((1) << (12));
    }

    if (gPlayer.qSpeedAirX < ((s16)((9)*256))) {
...
static void sub_8078254(Sprite_FunnelSphere *funnelSphere)
{
    ...
    switch (gPlayer.character) {
        ...
        case CHARACTER_TAILS:
            gPlayer.spriteInfoLimbs->s.frameFlags &= ~((3) << (12));
            gPlayer.spriteInfoLimbs->s.frameFlags |= ((funnelSphere->unk14) << (12));
        case CHARACTER_SONIC:
        case CHARACTER_KNUCKLES:
        case CHARACTER_AMY:
            gPlayer.spriteInfoBody->s.frameFlags &= ~((3) << (12));
            gPlayer.spriteInfoBody->s.frameFlags |= ((funnelSphere->unk12) << (12));
    }
...
static void sub_807844C(void)
{
    ...
    if (((int)((gPlayer.qWorldX) >> 8)) >= funnelSphere->x + 0x20) {
...
{
    gPlayer.qWorldX = ((s32)((funnelSphere->x + 0x20)*256));
    funnelSphere->unk10 = 0x200;
    funnelSphere->unk8 = ((s32)((funnelSphere->x + 0x40)*256));
    funnelSphere->unkC = ((s32)((funnelSphere->y)*256));
    m4aSongNumStart(293);
...
{
    { funnelSphere->me->x = funnelSphere->spriteX; };
...
void CreateEntity_FunnelSphere(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    Sprite_FunnelSphere *funnelSphere = (void *)(0x03000000 + ((t)->data));
    funnelSphere->me = me;
    funnelSphere->spriteX = me->x;
    funnelSphere->spriteY = spriteY;
    funnelSphere->x = ((me->x)*8 + (spriteRegionX)*256);
    funnelSphere->y = ((me->y)*8 + (spriteRegionY)*256);
...
static void sub_8078634(void)
{
    ...
    y = funnelSphere->y - ((int)((gPlayer.qWorldY) >> 8));
...
static void sub_8078688(__attribute__((unused)) struct Task *t)
{
