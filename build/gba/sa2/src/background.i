...
static AnimCmdResult animCmd_AddHitbox_BG(void *cursor, Sprite *s)
{
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&cmd->hitbox); dmaRegs[1] = (vu32)(&s->hitboxes[index].index); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(Hitbox))/(32/8)))); dmaRegs[2]; };
...
__attribute__((naked)) bool32 sub_80039E4(void) { asm(".include " "\"asm/non_matching/engine/sub_80039E4.inc\""); if (0)
{
    ...
    if (gBgSpritesCount != 0) {
        ...
        for (r5 = 0; r5 < gBgSpritesCount; r5++) {
            ...
            if (dims != (void *)-1) {
                ...
                void *bgVram = (void *)(0x6000000 + (((gBgCntRegs[bgId] & ((3) << 2)) >> 2) << 14));
                void *bgBase = bgVram + ((gBgCntRegs[bgId] & 0x1F00) << 3);
                ...
                if ((bgId >= 2) && ((gDispCnt & 0x3) != 0x0000)) {
                    ...
                    for (sp08 = 0; sp08 < dims->numSubframes; sp08++) {
                        ...
                        sp30 = sp10;
                        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(sp1C); dmaRegs[1] = (vu32)(&oam); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(OamDataShort))/(16/8)))); dmaRegs[2]; };
                        sp1C++;
...
void sub_8003EE4(u16 p0, s16 p1, s16 p2, s16 p3, s16 p4, s16 p5, s16 p6, BgAffineReg *affine)
{
    affine->pa = (((int)(((gSineTable[(p0) + 256])) >> 6)) * (s16)Div(0x10000, p1)) >> 8;
    affine->pb = (((int)(((gSineTable[(p0)])) >> 6)) * (s16)Div(0x10000, p1)) >> 8;
    affine->pc = ((-(gSineTable[(p0)]) >> 6) * (s16)Div(0x10000, p2)) >> 8;
    affine->pd = (((int)(((gSineTable[(p0) + 256])) >> 6)) * (s16)Div(0x10000, p2)) >> 8;
