...

{
    ...
    if (((*(vu16 *)(0x4000000 + 0x134)) & 0xC000) != 0x8000) {
        gFlags = 0x200;


        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)((void *)(u8*)(0x6000000 + 0x10000)); dmaRegs[1] = (vu32)(0x02000000 + 0x3B000); dmaRegs[2] = (vu32)((u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x5000)/(16/8)))); dmaRegs[2]; };
...
# 320 "src/core.c"
    ...
    *(u32 *)gBgSprites_Unknown1 = 0;
    ...
    gVramHeapStartAddr = (u8*)(0x6000000 + 0x14000) - (48 * 32);
...
void UpdateScreenCpuSet(void)
{
    u8 i, j = 0;
    (*(vu16 *)(0x4000000 + 0x0)) = gDispCnt;
    CpuSet(gBgCntRegs, (void *)(0x4000000 + 0x8), 0x04000000 | ((sizeof(gBgCntRegs))/(32/8) & 0x1FFFFF));

    if (gFlags & 0x1) {
        CpuFastSet(gBgPalette, (void *)((u16 *)(0x5000000)), ((sizeof(gBgPalette))/(32/8) & 0x1FFFFF));
        gFlags ^= 0x1;
    }

    if (gFlags & 0x2) {
        CpuFastSet(gObjPalette, (void *)((u16 *)(0x5000000 + 0x200)), ((sizeof(gObjPalette))/(32/8) & 0x1FFFFF));
        gFlags ^= 0x2;
    }

    CpuSet(gWinRegs, (void *)(0x4000000 + (0x40 + sizeof(winreg_t) * 0)), 0x04000000 | ((sizeof(gWinRegs))/(32/8) & 0x1FFFFF));
    CpuSet(&gBldRegs, (void *)(0x4000000 + ((0x40 + sizeof(winreg_t) * 6) + 4)), 0x00000000 | ((6)/(16/8) & 0x1FFFFF));
    ...
    CpuSet(&gMosaicReg, (void *)(0x4000000 + (0x40 + sizeof(winreg_t) * 6)), 0x00000000 | ((4)/(16/8) & 0x1FFFFF));


    CpuSet(gBgScrollRegs, (void *)(0x4000000 + 0x10), 0x00000000 | ((sizeof(gBgScrollRegs))/(16/8) & 0x1FFFFF));
    CpuSet(&gBgAffineRegs, (void *)(0x4000000 + 0x20), 0x04000000 | ((sizeof(gBgAffineRegs))/(32/8) & 0x1FFFFF));
    ...
    if (sLastCalledVblankFuncId == 0xFF) {
        ProcessOamBuffers();
        CpuFastSet(gOamBuffer, (void *)0x7000000, (((128*sizeof(OamData)))/(32/8) & 0x1FFFFF));
    }
